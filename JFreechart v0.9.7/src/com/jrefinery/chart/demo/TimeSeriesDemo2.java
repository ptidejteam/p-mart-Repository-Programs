 ...
 * Contributor(s):   -;
 *
 * $Id: TimeSeriesDemo2.java,v 1.1 2007/10/10 20:00:14 vauchers Exp $
 *
 * Changes
 * -------
...
import com.jrefinery.data.time.Quarter;
...
public class TimeSeriesDemo2 extends ApplicationFrame {
    ...
    public TimeSeriesDemo2(String title) {
        ...
        chart.getXYPlot().addDomainMarker(new Marker((double) q.getMiddleMillisecond()));
