 ...
 * Contributor(s):   -;
 *
 * $Id: TooltipsPackageTests.java,v 1.1 2007/10/10 20:00:13 vauchers Exp $
 *
 * Changes:
 * --------
...
/**
 * A collection of tests for the com.jrefinery.chart.tooltips package.
 * <P>
...
public class TooltipsPackageTests extends TestCase {
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite("com.jrefinery.chart.tooltips");
