 ...
 *
 * $Id: StandardPieToolTipGenerator.java,v 1.1 2007/10/10 20:00:13 vauchers Exp $
 *
 * Changes
 * -------
...
/**
 * A standard tool tip generator for plots that use data from a {@link KeyedValuesDataset}.
 *
...
public class StandardPieToolTipGenerator implements PieToolTipGenerator, Serializable {
     ...
     */
    public String generateToolTip(KeyedValuesDataset data, Comparable key, int pieIndex) {
