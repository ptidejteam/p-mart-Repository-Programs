 ...
 *                   Jeremy Bowman;
 *
 * $Id: VerticalCategoryPlot.java,v 1.1 2007/10/10 20:00:17 vauchers Exp $
 *
 ...
 * 
 */
public class VerticalCategoryPlot extends CategoryPlot 
                                  implements VerticalValuePlot, Serializable {
    ...
    public void draw(Graphics2D g2, Rectangle2D plotArea, ChartRenderingInfo info) {
        ...
        if (getAnnotations() != null) {
            ...
            while (iterator.hasNext()) {
                ...
                if (annotation instanceof CategoryAnnotation) {
                    CategoryAnnotation ca = (CategoryAnnotation) annotation;
                    ca.draw(g2, this, dataArea, getDomainAxis(), getRangeAxis());
                }
            }
        }
        if (renderer != null) {
