 ...
 *
 * $Id: PiePlot.java,v 1.1 2007/10/10 20:00:17 vauchers Exp $
 *
...
public class PiePlot extends Plot implements Serializable {
     ...
     * @param data  the data.
     */
    public PiePlot(KeyedValuesDataset data) {
     ...
     */
    public PiePlot(KeyedValues2DDataset data, int type) {
...
     */
    ...
    public void draw(Graphics2D g2, Rectangle2D plotArea, ChartRenderingInfo info) {
        ...
        if (d instanceof PieDataset) {
            ...
            drawPie(g2, plotArea, info, 0, pieDataset, null); 
        }
            ...
            for (int pieIndex = 0; pieIndex < pieCount; pieIndex++) {
                ...
                PieDataset dd = new CategoryToPieDataset(categoryDataset, this.extractType, 
                                                         pieIndex);
                String title = null;
                if (this.extractType == PER_ROW) {
                    title = categoryDataset.getRowKey(pieIndex).toString();
                }
                else {
                    title = categoryDataset.getColumnKey(pieIndex).toString();
                }
                        ...
                        if (Math.abs(angle) > this.minimumArcAngleToDraw) {
                            ...
                            if (info != null) {
                                ...
                                if (entities != null) {
                                    ...
                                    PieSectionEntity entity = new PieSectionEntity(pieIndex, 
                                        section, currentKey, arc, tip, url);
