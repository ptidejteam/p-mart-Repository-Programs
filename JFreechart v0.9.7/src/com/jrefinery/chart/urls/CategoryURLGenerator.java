 ...
 *
 * $Id: CategoryURLGenerator.java,v 1.1 2007/10/10 20:00:10 vauchers Exp $
 *
 * Changes:
 * --------
...
/**
 * A URL generator for items in a {@link KeyedValues2DDataset}.
 *
...
public interface CategoryURLGenerator extends URLGenerator {
     ...
     */
    public String generateURL(KeyedValues2DDataset data, int series, int category);
