 ...
 *
 * $Id: DateAxis.java,v 1.1 2007/10/10 20:00:06 vauchers Exp $
 *
 ...
 * 
 */
public abstract class DateAxis extends ValueAxis implements Serializable {
    ...
    /**
     * Returns <code>true</code> if the tick marks are displayed at the start of each time unit,
     * and <code>false</code> if they are displayed in the middle of each time unit.
     * 
     * @return A boolean.
     */
    ...
    /**
     * Sets the flag that controls whether the tick marks are displayed at the start or the middle
     * of each tick unit.
     * 
     * @param flag  a boolean.
     */
    public void setTickMarksAtStartOfUnit(boolean flag) {
        this.tickMarksAtStartOfUnit = flag;
        notifyListeners(new AxisChangeEvent(this));
    }
    ...
    protected Date previousStandardDate(Date date, DateTickUnit unit) {
        ...
        switch (unit.getUnit()) {
            ...
            case (DateTickUnit.SECOND) : {
                ...
                hours = calendar.get(Calendar.HOUR_OF_DAY);
                minutes = calendar.get(Calendar.MINUTE);
                milliseconds = (this.tickMarksAtStartOfUnit ? 0 : 500);
            ...
            case (DateTickUnit.MINUTE) : {
                ...
                days = calendar.get(Calendar.DATE);
                hours = calendar.get(Calendar.HOUR_OF_DAY);
                seconds = (this.tickMarksAtStartOfUnit ? 0 : 30);
            ...
            case (DateTickUnit.HOUR) : {
                ...
                months = calendar.get(Calendar.MONTH);
                days = calendar.get(Calendar.DATE);
                minutes = (this.tickMarksAtStartOfUnit ? 0 : 30);
                calendar.clear(Calendar.MILLISECOND);
                calendar.set(years, months, days, value, minutes, 0);
                return calendar.getTime();
            }
            ...
            case (DateTickUnit.DAY) : {
                years = calendar.get(Calendar.YEAR);
                months = calendar.get(Calendar.MONTH);
                hours = (this.tickMarksAtStartOfUnit ? 0 : 12);
                calendar.clear(Calendar.MILLISECOND);
            ...
            case (DateTickUnit.MONTH) : {
                years = calendar.get(Calendar.YEAR);
                days = (this.tickMarksAtStartOfUnit ? 1 : 15);
                calendar.clear(Calendar.MILLISECOND);
            ...
            case(DateTickUnit.YEAR) : {
                months = (this.tickMarksAtStartOfUnit ? 1 : 7);
                calendar.clear(Calendar.MILLISECOND);
