 ...
 *
 * $Id: StackedAreaRenderer.java,v 1.1 2007/10/10 20:00:08 vauchers Exp $
 *
 * Changes:
 * --------
...
public class StackedAreaRenderer extends AreaRenderer implements Serializable {
     ...
     */
    protected double getPreviousHeight(KeyedValues2DDataset data, int series, int category) {
