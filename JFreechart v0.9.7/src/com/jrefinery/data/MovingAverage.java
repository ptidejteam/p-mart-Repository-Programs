 ...
 *
 * $Id: MovingAverage.java,v 1.1 2007/10/10 20:00:04 vauchers Exp $
 *
 * Changes
 * -------
...
import com.jrefinery.data.time.RegularTimePeriod;
import com.jrefinery.data.time.TimeSeries;
import com.jrefinery.data.time.TimeSeriesDataItem;
    ...
    public static TimeSeries createMovingAverage(TimeSeries source, 
        ...
        if (source.getItemCount() > 0) {
            ...
            for (int i = source.getItemCount() - 1; i >= 0; i--) {
                ...
                TimeSeriesDataItem current = source.getDataPair(i);
                ...
                if (serial >= firstSerial) {
                    ...
                    while ((offset < periodCount) && (!finished)) {
                        if ((i - offset) >= 0) {
                            TimeSeriesDataItem item = source.getDataPair(i - offset);
    ...
    public static TimeSeries createPointMovingAverage(TimeSeries source, 
        ...
        for (int i = 0; i < source.getItemCount(); i++) {
            ...
            if (i > pointCount - 1) {
                ...
                TimeSeriesDataItem startOfMovingAvg = source.getDataPair(i - pointCount);
