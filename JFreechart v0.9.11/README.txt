...
(jfreechart-0.9.11-install.pdf) from the JFreeChart home
...
(b)  JCommon - version 0.8.6 or later.  The runtime jar file is
...
it you need the files jcommon-0.8.6.jar, jfreechart-0.9.11.jar and
jfreechart-0.9.11-demo.jar.
...
Use the following command:
    ...
    java -jar jfreechart-0.9.11-demo.jar
...
java -classpath lib/jcommon-0.8.6.jar:jfreechart-0.9.11.jar:jfreechart-0.9.11-demo.jar org.jfree.chart.demo.JFreeChartDemo
