 ...
 * Contributor(s):   -;
 *
 * $Id: BoxAndWhiskerToolTipGenerator.java,v 1.1 2007/10/10 19:09:17 vauchers Exp $
 *
 * Changes
 * -------
...
/**
 * A standard tooltip generator for plots that use data from a {@link BoxAndWhiskerDataset}.
 *
 * @author David Browning
 */
public class BoxAndWhiskerToolTipGenerator implements XYToolTipGenerator, Serializable {
    ...
    public String generateToolTip(XYDataset data, int series, int item) {
        ...
        if (data instanceof BoxAndWhiskerDataset) {
            BoxAndWhiskerDataset d = (BoxAndWhiskerDataset) data;
            Number median = d.getMedianValue(series, item);
            Number max = d.getMaxValue(series, item);
            Number min = d.getMinValue(series, item);
            Number q1 = d.getQ1MedianValue(series, item);
            Number q3 = d.getQ3MedianValue(series, item);
