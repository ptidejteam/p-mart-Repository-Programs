 ...
 *
 * $Id: ContourPlot.java,v 1.1 2007/10/10 19:09:08 vauchers Exp $
 *
 * Changes
 * -------
...
*/
    ...
    public void zoom(double percent) {
        ...
        if (percent > 0) {
            double range = this.domainAxis.getMaximumAxisValue() - domainAxis.getMinimumAxisValue();
            double scaledRange = range * percent;
          //  domainAxis.setAnchoredRange(scaledRange);

            range = this.rangeAxis.getMaximumAxisValue() - rangeAxis.getMinimumAxisValue();
