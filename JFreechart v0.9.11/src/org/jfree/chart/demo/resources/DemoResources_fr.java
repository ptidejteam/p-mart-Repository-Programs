 ...
 * Contributor(s):   -;
 *
 * $Id: DemoResources_fr.java,v 1.1 2007/10/10 19:09:07 vauchers Exp $
 *
 * Changes
 * -------
...
public class DemoResources_fr extends ListResourceBundle {
    ...
    private static final Object[][] CONTENTS = {
        ...
        {"chart3.description",
            "Affiche des barres verticales à partir des données d'un CategoryDataset."},

        {"chart4.title", "Diagramme en Barre 3D Verticale: "},
        {"chart4.description",
            "Affiche des barres verticales avec un effet 3D à partir des données "
            + "d'un CategoryDataset."},
        ...
        {"chart6.description",
            "Affiche des barres empilées verticale avec un effet 3D à partir des données "
            + "d'un CategoryDataset."},
        ...
        {"chart8.description",
        "Un diagramme en secteur montrant des pourcentages sur les labels de catégories. De plus, "
        + "ce graphique a une image de fond."},

        {"chart9.title", "Tracé XY: "},
        {"chart9.description",
        "Un diagramme en ligne à partir de données d'un XYDataset. Les deux axes sont "
        + "numériques."},

        {"chart10.title", "Série Temporelle 1: "},
        {"chart10.description",
        "Un diagramme de séries temporelles à partir de données d'un XYDataset. Ce "
        + "diagramme montre de plus l'utilisation de plusieurs titres de diagramme."},

        {"chart11.title", "Série Temporelle 2: "},
        {"chart11.description",
        "Un diagramme de séries temporelles à partir de données d'un XYDataset. "
        ...
        {"chart13.description",
        "Un diagramme max/min/ouverture/fermeture basé sur les données d'un HighLowDataset."},

        {"chart14.title", "Diagramme en Chandelier: "},
        {"chart14.description",
        "Un diagramme en Chandelier basé sur les données d'un HighLowDataset."},
        ...
        {"chart16.description",
        "Un tracé de vents, représente la direction et l'intensité du vent (fourni "
        ...
        {"chart18.description",
        "Un diagramme affichant des lignes ou des formes à partir des données "
        ...
        {"chart21.description",
        "Diagramme à partir d'un ensemble de données contenant des séries de zéros."},
        ...
        {"chart23.description",
        "Un diagramme en barre avec série unique. Ce diagramme montre de plus l'utilisation "
        + "d'une bordure autour d'un ChartPanel."},

        {"chart24.title", "Diagramme dynamique: "},
        {"chart24.description",
        "Un diagramme dynamique, pour tester le mécanisme de notification des événements."},

        {"chart25.title", "Diagramme Superposé: "},
        {"chart25.description",
        "Affiche un diagramme superposé d'un tracé max/min/ouverture/fermeture et "
        + "de moyenne mobile."},

        {"chart26.title", "Diagramme Combiné Horizontalement: "},
        {"chart26.description",
        "Affiche un diagramme combiné horizontalement d'un tracé de séries temporelles et "
        + "de barres XY."},

        {"chart27.title", "Diagramme Combiné Verticalement: "},
        {"chart27.description",
        "Affiche un diagramme combiné verticalement d'un tracé XY, de séries temporelles et "
        + "de barres XY vertical."},

        {"chart28.title", "Diagramme Combiné et Superposé: "},
        {"chart28.description",
        "Un diagramme combiné d'un tracé XY, d'un tracé superposé de deux séries temporelles et "
        ...
        {"chart29.description",
        "Affiche un diagramme dynamique combiné et superposé, pour tester le mécanisme "
