 ...
 * Contributor(s):   -;
 *
 * $Id: BoxAndWhiskerDemo.java,v 1.1 2007/10/10 19:09:08 vauchers Exp $
 *
 * Changes
 * -------
...
/**
 * A demo showing a box and whisker chart chart.
 *
...
public class BoxAndWhiskerDemo extends ApplicationFrame {
    ...
    public BoxAndWhiskerDemo(String title) {
        ...
        BoxAndWhiskerDataset dataset = DemoDatasetFactory.createBoxAndWhiskerDataset();
     ...
     * @return The dataset.
     */
    private JFreeChart createChart(BoxAndWhiskerDataset dataset) {
    ...
    public static void main(String[] args) {
        ...
        BoxAndWhiskerDemo demo = new BoxAndWhiskerDemo("BoxAndWhisker Demo");
        demo.pack();
