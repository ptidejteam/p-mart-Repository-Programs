...

{
...

	{
		...
		final StringTokenizer tokens = new StringTokenizer(s, Constants.s_LINE_SEP, true);
...

		{
			...
			if (!Constants.s_LINE_SEP.equals(current))
			...
			else if (Constants.s_LINE_SEP.equals(last))
...

	{
...

		{
...

			{
				...
				final ArrayList campList = new ArrayList();
...

		{
...

			{
				...
				final String message =
					...
					"Class not found: " + aName + "." + Constants.s_LINE_SEP +
				...
				case 0:
...

					{
						...
						final String message =
							...
							"Race not found: " + token + "." + Constants.s_LINE_SEP +
...

					{
...

						{
...

							{
								...
								Logging.debugPrint("loadSkillsLine: ", bRank);
...

				{
...

					{
						...
						final String message =
							...
							"Ranked skill not found: " + skillName + "(" + aFloat + ")." + Constants.s_LINE_SEP +
				...
				case 0:
...

					{
						...
						final String message =
							...
							"Deity not found: " + token + "." + Constants.s_LINE_SEP +
...

						{
...

							{
								...
								final String message =
									...
									"Domain not found: " + token + "." + Constants.s_LINE_SEP +
...
//		}
		...
		final ArrayList myProfs = new ArrayList();
		...
		final ArrayList nonproficient = new ArrayList();
...

		{
...

			{
				...
				final String message = "Remaining class skill points incorrect (i.e. " +
					...
					")." + Constants.s_LINE_SEP + "Please correct manually on the Skills tab";
...

	{
		...
		final ArrayList headerChildren = new ArrayList();
...

		{
...

			{
				...
				Equipment aEq = Globals.getEquipmentKeyed(aName);
			...
			if (eq.qty() > 1 && eq.acceptsChildren())

			{

				final int origQty = new Double(eq.qty()).intValue();
...

				{
					...
					Logging.debugPrint("Correct Path ", cTok.countTokens());
...

				{
...

					{
						...
						// aHChild.setIsEquipped("Y".equals(cTok.nextToken()));

						cTok.nextToken();

						final StringTokenizer bTok = new StringTokenizer(cTok.nextToken(), "@", false);

						aHChild.setCarried(parseCarried(new Float(aHChild.qty()), bTok.nextToken()));

						if (bTok.hasMoreTokens())

						{

							containers.put(aHChild.getKeyName(), bTok.nextToken());
...

			{
				...
				// eq.setIsEquipped("Y".equals(aTok.nextToken()));
...

			{
...

				{
					...
					final String message =
						...
						"Equipment not found: " + aName + " (" + eq.qty() + ")." + Constants.s_LINE_SEP +
...

		{
...

			{
...

				{
					...
					Logging.debugPrint("Line " + i + ": " + cString);
...

	{
		...
		final PCClass aClass = aPC.getClassKeyed(token);
