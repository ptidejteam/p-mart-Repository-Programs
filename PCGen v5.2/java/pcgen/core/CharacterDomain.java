...
public final class CharacterDomain
{
	...
	public void setDomainSource(String aSource)
	{
		...
		{
			Logging.debugPrint("Invalid Domain Source:", aSource);
			return;
		}
	...
	/**
	 * return true if this has the named variable
	 */
	public boolean hasVariableNamed(String variableName)
	{
		if (domain != null)
		{
			return domain.hasVariableNamed(variableName);
		}
		return false;
	}
}
