 ...
 *
 * $Id: Feat.java,v 1.1 2006/02/21 01:13:12 vauchers Exp $
 */
...
public final class Feat extends PObject implements HasCost
{
	...
	{
		return (SettingsHandler.isBoolBypassFeatPreReqs() || super.passesPreReqTestsForList(aPC, aObj, argList));
	}
	...
	void modAdds(boolean addIt)
	{
		...
		{
			Logging.debugPrint("Badly formed ADD. ", addString);
			return;
		}
