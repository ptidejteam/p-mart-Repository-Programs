...
public final class PCAlignment extends PObject
{
	...
	public final void setValidForDeity(boolean argValid)
	{
		validForDeity = argValid;
	}

	public final boolean isValidForDeity()
	{
		return validForDeity;
	}

	public final void setValidForFollower(boolean argValid)
	{
		validForFollower = argValid;
	}

	public final boolean isValidForFollower()
	{
