...
public final class GameMode implements Comparable
{
	...
	private int babMaxAtt = 4;
	private int babMaxLvl = 20;
	private int babAttCyc = 6;
	private int babMinVal = 1;
	private int checksMaxLvl = 20;
	...
	public void setDisplayOrder(String aString)
	{
		...
		{
			Logging.debugPrint("Will use default for displayOrder: " + displayOrder, exc);
		}
	}
	...
	public final int getBabMaxAtt()
	{
		return babMaxAtt;
	}

	public final void setBabMaxAtt(int arg)
	{
		babMaxAtt = arg;
	}

	public final int getBabMaxLvl()
	{
		return babMaxLvl;
	}

	public final void setBabMaxLvl(int arg)
	{
		babMaxLvl = arg;
	}

	public final int getBabAttCyc()
	{
		return babAttCyc;
	}

	public final void setBabAttCyc(int arg)
	{
		babAttCyc = arg;
	}

	public final int getBabMinVal()
	{
		return babMinVal;
	}

	public final void setBabMinVal(int arg)
	{
		babMinVal = arg;
	}

	public final int getChecksMaxLvl()
	{
		return checksMaxLvl;
	}

	public final void setChecksMaxLvl(int arg)
	{
		checksMaxLvl = arg;
	}
	
	public final void setAcTouchBonus(String arg)
	{
		acTouchBonus = arg;
	}
	
	public final String getAcTouchBonus()
	{
		return acTouchBonus;
	}
	
	public final void setAcFlatBonus(String arg)
	{
		acFlatBonus = arg;
	}
	
	public final String getAcFlatBonus()
	{
		return acFlatBonus;
	}
}
