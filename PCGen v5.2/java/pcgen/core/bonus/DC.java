 ...
 *
 * @(#) $Id: DC.java,v 1.1 2006/02/21 01:13:21 vauchers Exp $
 */
...
{
	private static final String[] bonusTags = {"TYPE", "CLASS", "DOMAIN", "SCHOOL", "SUBSCHOOL", "DESCRIPTOR"};
	...
	boolean parseToken(String token)
	{
		...
		{
			if (token.startsWith(bonusTags[i]))
			{
