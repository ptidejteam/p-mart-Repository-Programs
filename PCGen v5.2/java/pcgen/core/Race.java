 ...
 *
 * $Id: Race.java,v 1.1 2006/02/21 01:13:12 vauchers Exp $
 */
...
public final class Race extends PObject
{
	...
	public int getHitPointListLength()
	{
		return hitPointList.length;
	}
...
//	}
	...
	public HashMap getVisionTable()
	{
		return vision;
	}

	public void setVisionTable(HashMap visionTable)
	{
		vision = visionTable;
	}
...
//	}
	...
	/** TODO: Note that this code does *not* work like that in PCClass. Is this correct? */
	public void rollHP()
	{
		if (hitDice == 0)
		{
		...
		if (!aPC.isImporting())
		{
			...
			{
				hitPointList[x] = new Integer(Globals.rollHP(min, max, getName(), x + 1));
			}
		}
