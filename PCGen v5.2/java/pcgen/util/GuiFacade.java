 ...
 *
 * $Id: GuiFacade.java,v 1.1 2006/02/21 01:13:27 vauchers Exp $
 */
package pcgen.util;
...
public final class GuiFacade
{
	...
	private static void showMessageDialog(Component parent, Object message, String title, int messageType, Icon icon)
	{
		...
		{
			Logging.debugPrint("Dialog parent: " + parent.toString() + " message: " + message + "title: " + title + " messageType: " + messageType);
		}
	}
