...
public class MainSource extends FilterAdapterPanel
{
	...
	private void loadCampaigns_actionPerformed()
	{
		...
		Logging.debugPrint("Loaded: (all must be non-zero to be able to create a new character)");
		...
		Logging.debugPrint("Equipment=", Globals.getEquipmentList().size());
		Logging.debugPrint("WeaponProfs=", Globals.getWeaponProfSize());
		Logging.debugPrint("ArmorProfs=", Globals.getArmorProfListSize());
	}
