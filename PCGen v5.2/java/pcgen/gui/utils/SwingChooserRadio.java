 ...
 * Last Edited: $Date: 2006/02/21 01:13:10 $
 */
...
final class SwingChooserRadio extends JDialog implements ChooserRadio
{
  static final long serialVersionUID = -2156072283857697398L;
	...
	public void setComboData(final String cmbLabelText, ArrayList cmbData)
	{
		cmbCombo = new JComboBox(cmbData.toArray());
	...
	private void initComponents()
	{
		...
		Utility.buildConstraints(c, 0, 0, 3, 1, 1, 1);
	...
	{
		final ArrayList mAvailableData = new ArrayList();
