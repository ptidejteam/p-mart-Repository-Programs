...
public final class BrowserLauncher
{
	...
	public static void openURL(String url) throws IOException
	{
		...
		{
			Logging.debugPrint(PropertyFactory.getString("in_BLEr4"));
		...
		{
			Logging.errorPrint(PropertyFactory.getString("in_BLEr15") + " " + SettingsHandler.getBrowserPath());
			// On MacOS X, one must use open -a to launch an app.
			if (jvm == MRJ_3_1 && SettingsHandler.getBrowserPath().toLowerCase().endsWith(".app"))
			{
				Logging.errorPrint(PropertyFactory.getString("in_BLEr16") + " " + SettingsHandler.getBrowserPath() + " " + url);
				Runtime.getRuntime().exec(new String[]{"open", "-a", SettingsHandler.getBrowserPath(), url});
			}
			else
			{
				Logging.errorPrint(PropertyFactory.getString("in_BLEr17") + " " + SettingsHandler.getBrowserPath() + " " + url);
				Runtime.getRuntime().exec(new String[]{SettingsHandler.getBrowserPath(), url});
			}
		}
