 ...
 *
 * $Id: SubClassLoader.java,v 1.1 2006/02/21 01:13:22 vauchers Exp $
 */
...
final class SubClassLoader
{
	...
	public static void parseLine(SubClass pcClass, String inputLine, URL sourceURL, int lineNum) throws PersistenceLayerException
	{
		...
		while(colToken.hasMoreTokens())
		{
			...
			if (!colString.startsWith("SUBCLASS:") && PCClassLoader.parseLine(pcClass, colString, sourceURL, lineNum))
			{
				continue;
			}
