...
public interface Document extends Node {
     ...
     * is no way to specify the order of the attributes in the DOM. What 
     * happen to other features? are they ignored? if yes, how do you know 
     * if a feature is ignored? </dd>
     ...
     * implementation does not have any information available.How does 
     * exactly work? What's the comment about level 1 implementations?Remove 
     * "Level 1" (Telcon 16 Jan 2002).</dd>
     * <dt><code>false</code></dt>
     ...
     * <dt><code>true</code></dt>
     * <dd>[
     * required] (default)Keep <code>EntityReference</code> and 
     * <code>Entity</code> nodes in the document.How does that interact with 
     * expand-entity-references? ALH suggests consolidating the two to a 
     * single feature called "entity-references" that is used both for load 
     * and save.Consolidate both features into a single feature called 
     * 'entities'. (Telcon 27 Jan 2002).</dd>
     * <dt><code>false</code></dt>
     * <dd>[optional]Remove 
     * all <code>EntityReference</code> and <code>Entity</code> nodes from 
     * the document, putting the entity expansions directly in their place. 
     * <code>Text</code> nodes are into "normal" form. Only 
     * <code>EntityReference</code> nodes to non-defined entities are kept 
     * in the document.</dd>
     * </dl></dd>
     ...
     * change this to setting the relevant options back to their default 
     * value?No, this is more like a convenience function, it's better to 
     * keep it simple. (F2F 28 Feb 2002).</dd>
     * </dl></dd>
     * <dt>
     ...
     * <code>validate-if-schema</code> and <code>validate</code> are 
     * mutually exclusive, setting one of them to <code>true</code> will set 
     * the other one to <code>false</code>. How does that interact with the 
     * notion of active AS?If document has AS model, than it "has a schema", 
     * thus validation will be performed against the active AS model. 
     * (Telcon 16 Jan 2002).</dd>
     * <dt><code>false</code></dt>
