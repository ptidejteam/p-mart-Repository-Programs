	...
	private static final Object[][] CONTENTS =
		{
				...
				{
						"Ptidej UI Viewer Standalone::ProjectViewerPanel::ADD_JAVA_PACKAGE_FILE",
						new String("classes depuis un paquetage") },
				{
						"Ptidej UI Viewer Standalone::ProjectViewerPanel::ADD_JAVA_PACKAGE_TEXT",
						new String("Ajouter un paquetage Java (.class)") },
				{
