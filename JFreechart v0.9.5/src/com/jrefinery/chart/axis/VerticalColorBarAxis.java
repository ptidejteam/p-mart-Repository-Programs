 ...
 *
 * $Id: VerticalColorBarAxis.java,v 1.1 2007/10/10 19:54:25 vauchers Exp $
 *
 * Changes
 * -------
 ...
 */
public class VerticalColorBarAxis extends VerticalNumberAxis implements ColorBarAxis {
    ...
    public void draw(Graphics2D g2, Rectangle2D drawArea, Rectangle2D plotArea) {
        ...
        refreshTicks(g2, drawArea, colorBarArea, Axis.LEFT);
