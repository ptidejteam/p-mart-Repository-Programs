 ...
 * Contributor(s):   -;
 *
 * $Id: EventFrequencyDemo.java,v 1.1 2007/10/10 19:54:11 vauchers Exp $
 *
...
public class EventFrequencyDemo extends ApplicationFrame {
    ...
    public EventFrequencyDemo(String title) {
        ...
        CategoryDataset d = DatasetUtilities.createCategoryDataset("Series ", 
                                                                   "Requirement ", 
                                                                   data);
                                                                   
        DefaultCategoryDataset dataset = (DefaultCategoryDataset) d;
        ...
        dataset.setValue(0, "Requirement 1", new Long(d1.getMiddleMillisecond()));
        dataset.setValue(0, "Requirement 2", new Long(d1.getMiddleMillisecond()));
        dataset.setValue(0, "Requirement 3", new Long(d2.getMiddleMillisecond()));
        dataset.setValue(1, "Requirement 1", new Long(d3.getMiddleMillisecond()));
        dataset.setValue(1, "Requirement 3", new Long(d4.getMiddleMillisecond()));
        dataset.setValue(2, "Requirement 2", new Long(d5.getMiddleMillisecond()));
        dataset.setValue(0, "Requirement 4", new Long(d6.getMiddleMillisecond()));
