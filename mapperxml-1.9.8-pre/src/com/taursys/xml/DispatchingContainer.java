...
public class DispatchingContainer extends Container {
  ...
  public void add(Component c) {
    super.add(c);
    Dispatcher parentDispatcher = getDispatcher(InputEvent.class.getName());
    if (c instanceof DispatchingContainer) {
      Dispatcher childDispatcher = ((DispatchingContainer)c).getDispatcher(InputEvent.class.getName());
      childDispatcher.setParentDispatcher(parentDispatcher);
    }
//    if (parent != null && parent instanceof DispatchingContainer) {
//      Dispatcher pd = parent.getDispatcher(InputEvent.class.getName());
//      d.setParentDispatcher(pd);
//    }
  }
  
  // TODO add remove(Component c) method as above
