...
public abstract class Header implements Serializable {
    ...
    */
    ...
    public Header(HeaderField[] fields) {
        ...
        if(fields.length > 0) this.fields = new ArrayList(fields.length);
        else this.fields = new ArrayList(10);
        
        for(int i = 0; i < fields.length; i++) this.fields.add(fields[i]);
    ...
    */
    ...
    public void removeAll(String fieldName) {
        ...
        for(Iterator i = fields.iterator(); i.hasNext();) {
	       ...
	       if(field.getName().equalsIgnoreCase(fieldName)) i.remove();
