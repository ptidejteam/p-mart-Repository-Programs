...
public class BinaryBody extends EncodedBody {
    ...
    static final long serialVersionUID = 185593163096322372L;
    ...
    */
	...
	/**
	* Get body binary size. This size might not be consistent with
	* the encoded size  which is used by transports.
	*/
    ...
    */
	...
	public void write(OutputStream out) throws IOException { 
        header.write(out);
	    if(encoder == null) throw new IOException("Binary body transport encoding failed: No Encoder object available.");
