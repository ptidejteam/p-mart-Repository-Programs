...
public abstract class Container extends Component {
   ...
   * Old components are first removed, then new components added.
   * @param newComponents array of new Components for this Container
   */
  ...
  public DocumentAdapter getDocumentAdapter() {
    if (getParent() != null)
      return getParent().getDocumentAdapter();
    else
      return null;
  }
  ...
  public Dispatcher getDispatcher(String eventType) {
    ...
    if (d == null && getParent() != null)
      d = getParent().getDispatcher(eventType);
    return d;
  }
  
  /**
   * Get the dispatchers that belong to this container
   * @return the dispatchers that belong to this container
   */
  protected HashMap getDispatchers() {
    return dispatchers;
  }
