 ...
 * @version 1.0
 */
public class DocumentElementRenderer extends VisibleRenderer {
  ...
  /**
   * Renders the DocumentElement by simply invoking the DocumentElement's 
   * renderDispatcher to dispatch the RenderEvent to the children.
