...
public class MainFrame extends JFrame {
  ...
  public void loadProjectSettings(File projectFile) {
    try {
      projectSettings = new ProjectSettings(settings);
      projectSettings.loadSettings(projectFile);
      jMenuWizards.setEnabled(true);
      this.setTitle("Mapper CodeGen: " + projectFile.getAbsolutePath());
