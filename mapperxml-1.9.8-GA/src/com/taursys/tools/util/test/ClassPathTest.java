...
public class ClassPathTest extends TestCase {
  private String MAPPER_JAR =
      "/lib/mapperxml.jar";
  private String MAPPER_CLASSES =
      "/build/classes";
  private String MAPPER_SRC =
      "/src";
  private String MAPPER_ZIP =
      "/build/website.zip";
  ...
  protected void setUp() {
    ...
    MAPPER_JAR = testdir + MAPPER_JAR;
    MAPPER_CLASSES = testdir + MAPPER_CLASSES;
    MAPPER_SRC = testdir + MAPPER_SRC;
    MAPPER_ZIP = testdir + MAPPER_ZIP;
  }
