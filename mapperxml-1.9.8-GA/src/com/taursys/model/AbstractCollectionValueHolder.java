...
public class AbstractCollectionValueHolder implements CollectionValueHolder,
  ...
  public String toString() {
    ...
    result += " parentValueHolder=" + StringUtil.identityString(parentValueHolder);
    result += " parentPropertyName=" + parentPropertyName;
    result += " objectValueHolder=[" + objectValueHolder +"]";
    return  result; 
  }
