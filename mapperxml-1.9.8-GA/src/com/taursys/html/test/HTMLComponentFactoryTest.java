...
public class HTMLComponentFactoryTest extends TestCase {
  ...
  private String measureAbstractField(Class clazz, Component component,
      Container parent, int i, String id, ValueHolder holder, String propertyName,
    ...
    if (holder != null) {
      assertEquals(identity + "valueHolder", holder.getAlias(),
          ((AbstractField) component).getValueHolder().getAlias());
    }
    assertEquals(identity + "propertyName", propertyName, ((AbstractField) component)
        .getPropertyName());
  ...
  private String measureAttribute(Attribute attribute, ValueHolder holder,
    ...
    if (holder != null) {
      assertEquals(identity + "valueHolder", holder.getAlias(), attribute.getValueHolder().getAlias());
    }
  ...
  private String measureAttribute(Attribute attribute, ValueHolder holder,
      String attributeName, String propertyName, Class formatClazz, 
      String formatPattern) {
    String identity = 
      measureAttribute(attribute, holder, attributeName, propertyName);
    if (formatClazz == null) {
      assertNull(identity + "format (expected NULL)",
          attribute.getFormat());
    } else {
      assertNotNull(identity + "format (expected NOT null)",
          attribute.getFormat());
      assertEquals(identity + "formatClass", formatClazz,
          attribute.getFormat().getClass());
    }
    assertEquals(identity + "formatPattern", formatPattern,
        attribute.getFormatPattern());
    return identity;
  }

  private String measureTextNode(TextNode text, ValueHolder holder,
      String id, String propertyName) {
    String identity = "TextNode=" + id + " ";
    assertNotNull(identity + "(expected NOT null)", text);
    if (holder != null) {
      assertEquals(identity + "valueHolder", holder.getAlias(), text.getValueHolder().getAlias());
    }
    assertEquals(identity + "propertyName", propertyName, text
        .getPropertyName());
    return identity;
  }
  
  private String measureTextNode(TextNode text, ValueHolder holder,
      String id, String propertyName, Class formatClazz, 
      String formatPattern) {
    String identity = measureTextNode(text, holder, id, propertyName);
    if (formatClazz == null) {
      assertNull(identity + "format (expected NULL)",
          text.getFormat());
    } else {
      assertNotNull(identity + "format (expected NOT null)",
          text.getFormat());
      assertEquals(identity + "formatClass", formatClazz,
          text.getFormat().getClass());
    }
    assertEquals(identity + "formatPattern", formatPattern,
        text.getFormatPattern());
    return identity;
  }
  ...
  private void measureTestPage1(boolean withButton) throws Exception {
    ...
    i++;
    measureAbstractField(TextField.class, components[i], container, i,
        "Person__", personHolder, null, null, null, null);
    i++;
...
// NOTE: With new syntax, this is no longer "BAD" syntax
//  /**
//   * Test method: createComponentForElement Case: P invalid ID
//   */
...
//  }
  ...
  // =========================================================================
  // Tests for Parsing Binding Syntax for new syntax
  //
  // valueHolder__
  // valueHolder__1
  ...
  public void testParseBindSyntaxNull() {
    NodeDescriptor nd = factory.parseBindSyntax(null);
    assertNull("valueHolderAlias", nd.getValueHolderAlias());
    assertNull("propertyName", nd.getPropertyName());
    assertNull("formatDescriptor", nd.getFormatDescriptor());
  }

  public void testParseBindSyntaxBlank() {
    NodeDescriptor nd = factory.parseBindSyntax("");
    assertNull("valueHolderAlias", nd.getValueHolderAlias());
    assertNull("propertyName", nd.getPropertyName());
    assertNull("formatDescriptor", nd.getFormatDescriptor());
  }

  public void testParseBindSyntaxBad() {
    NodeDescriptor nd = factory.parseBindSyntax("__");
    assertNull("valueHolderAlias", nd.getValueHolderAlias());
    assertNull("propertyName", nd.getPropertyName());
    assertNull("formatDescriptor", nd.getFormatDescriptor());
  }

  public void testParseBindSyntaxInvalid() {
    NodeDescriptor nd = factory.parseBindSyntax("widget");
    assertNull("valueHolderAlias", nd.getValueHolderAlias());
    assertNull("propertyName", nd.getPropertyName());
    assertNull("formatDescriptor", nd.getFormatDescriptor());
  }

  public void testParseBindSyntaxValueHolder() {
    NodeDescriptor nd = factory.parseBindSyntax("valueHolder__");
    assertEquals("valueHolder", nd.getValueHolderAlias());
    assertNull("propertyName", nd.getPropertyName());
    assertNull("formatDescriptor", nd.getFormatDescriptor());
  }

  public void testParseBindSyntaxValueHolder1() {
    NodeDescriptor nd = factory.parseBindSyntax("valueHolder__1");
    assertEquals("valueHolder", nd.getValueHolderAlias());
    assertNull("propertyName", nd.getPropertyName());
    assertNull("formatDescriptor", nd.getFormatDescriptor());
  }

  public void testParseBindSyntaxValueHolderTEMPLATE_NODE() {
    NodeDescriptor nd = factory.parseBindSyntax("valueHolder__TEMPLATE_NODE");
    assertEquals("valueHolder", nd.getValueHolderAlias());
    assertEquals("TEMPLATE_NODE", nd.getPropertyName());
    assertNull("formatDescriptor", nd.getFormatDescriptor());
  }

  public void testParseBindSyntaxValueHolderTEMPLATE_NODE1() {
    NodeDescriptor nd = factory.parseBindSyntax("valueHolder__TEMPLATE_NODE__1");
    assertEquals("valueHolder", nd.getValueHolderAlias());
    assertEquals("TEMPLATE_NODE", nd.getPropertyName());
    assertNull("formatDescriptor", nd.getFormatDescriptor());
  }

  public void testParseBindSyntaxValueHolderPropertyName() {
    NodeDescriptor nd = factory.parseBindSyntax("valueHolder__propertyName");
    assertEquals("valueHolder", nd.getValueHolderAlias());
    assertEquals("propertyName", nd.getPropertyName());
    assertNull("formatDescriptor", nd.getFormatDescriptor());
  }

  public void testParseBindSyntaxValueHolderPropertyName1() {
    NodeDescriptor nd = factory.parseBindSyntax("valueHolder__propertyName__1");
    assertEquals("valueHolder", nd.getValueHolderAlias());
    assertEquals("propertyName", nd.getPropertyName());
    assertNull("formatDescriptor", nd.getFormatDescriptor());
  }

  public void testParseBindSyntaxValueHolderPropertyNameFormat() {
    NodeDescriptor nd = factory.parseBindSyntax("valueHolder__propertyName__DATE:MM/dd/yyyy");
    assertEquals("valueHolder", nd.getValueHolderAlias());
    assertEquals("propertyName", nd.getPropertyName());
    assertEquals("DATE:MM/dd/yyyy", nd.getFormatDescriptor());
  }

  public void testParseBindSyntaxValueHolderPropertyNameFormat1() {
    NodeDescriptor nd = factory.parseBindSyntax("valueHolder__propertyName__DATE:MM/dd/yyyy__1");
    assertEquals("valueHolder", nd.getValueHolderAlias());
    assertEquals("propertyName", nd.getPropertyName());
    assertEquals("DATE:MM/dd/yyyy", nd.getFormatDescriptor());
  }

  public void testParseBindSyntaxPropertyName() {
    NodeDescriptor nd = factory.parseBindSyntax("__propertyName");
    assertNull("valueHolderAlias", nd.getValueHolderAlias());
    assertEquals("propertyName", nd.getPropertyName());
    assertNull("formatDescriptor", nd.getFormatDescriptor());
  }

  public void testParseBindSyntaxPropertyName1() {
    NodeDescriptor nd = factory.parseBindSyntax("__propertyName__1");
    assertNull("valueHolderAlias", nd.getValueHolderAlias());
    assertEquals("propertyName", nd.getPropertyName());
    assertNull("formatDescriptor", nd.getFormatDescriptor());
  }

  public void testParseBindSyntaxPropertyNameFormat() {
    NodeDescriptor nd = factory.parseBindSyntax("__propertyName__DATE:MM/dd/yyyy");
    assertNull("valueHolderAlias", nd.getValueHolderAlias());
    assertEquals("propertyName", nd.getPropertyName());
    assertEquals("DATE:MM/dd/yyyy", nd.getFormatDescriptor());
  }

  public void testParseBindSyntaxPropertyNameFormat1() {
    NodeDescriptor nd = factory.parseBindSyntax("__propertyName__DATE:MM/dd/yyyy__1");
    assertNull("valueHolderAlias", nd.getValueHolderAlias());
    assertEquals("propertyName", nd.getPropertyName());
    assertEquals("DATE:MM/dd/yyyy", nd.getFormatDescriptor());
  }
  ...
  // =========================================================================
  // Tests for method createComponentForElement for new syntax
  // =========================================================================

  /**
   * Test for createComponentForElement: 
   * 
   * <a id="Person__" href="__personId__MSG:{0}">__fullName__DATE:MM/dd/yyyy</a>
   */
  public void testNewSyntax1() throws Exception {
    setupTestPage("TestPage5.html");
    Component component = factory.createComponentForElement("Person__",
        container.getDocumentAdapter().getElementById("Person__"),
        holders);
    measureAbstractField(HTMLAnchorURL.class, component, null, 0,
        "Person__", personHolder, "personId", null,
        EmptyMessageFormat.class, "{0}");
    com.taursys.xml.Element element = (com.taursys.xml.Element) component;
    
    TextNode text = element.getTextNode();
    assertNotNull("Expected a TextNode", text);
    assertNotNull("Expected format not null", text.getFormat());
    assertEquals(SimpleDateFormat.class, text.getFormat().getClass());
    assertEquals("MM/dd/yyyy", text.getFormatPattern());
  }

  /**
   * Test for createComponentForElement: 
   * 
   * <p id="Person__lastName__MSG:Something for {0}"></p>
   */
  public void testNewSyntax2() throws Exception {
    setupTestPage("TestPage5.html");
    String id = "Person__lastName__MSG:Something for {0}";
    Component component = factory.createComponentForElement(id,
        container.getDocumentAdapter().getElementById(id),
        holders);
    measureAbstractField(TextField.class, component, null, 0,
        id, personHolder, "lastName", null,
        EmptyMessageFormat.class, "Something for {0}");
  }
   ...
   * Test for createComponentForElement: 
   * 
   * <p id="something">unknown__widget</p>
   */
  public void testNewSyntax3() throws Exception {
    setupTestPage("TestPage5.html");
    String id = "something";
    Component component = factory.createComponentForElement(id,
        container.getDocumentAdapter().getElementById(id),
        holders);
    assertNull("Expected null component", component);
  }

  /**
   * Test for createComponentForElement: 
   * 
   * <p id="another">Person__lastName</p>
   */
  public void testNewSyntax4() throws Exception {
    setupTestPage("TestPage5.html");
    String id = "another";
    Component component = factory.createComponentForElement(id,
        container.getDocumentAdapter().getElementById(id),
        holders);
    assertNotNull("Expected component", component);
    measureAbstractField(TextField.class, component, null, 0,
        id, personHolder, "lastName", null,
        null, null);
  }
   ...
   * <p id="another">Person__lastName</p>
   */
  public void testNewSyntax5() throws Exception {
    setupTestPage("TestPage1.html");
    String id = "__";
    Component component = factory.createComponentForElement(id,
        container.getDocumentAdapter().getElementById(id),
        holders);
    assertNull("Expected NO component", component);
  }

  // =========================================================================
  // Tests for method createComponents for new syntax
  // and new behavior which can modify existing components
  // =========================================================================

  /**
   * Test for createComponents:
   * 
   * <p id="attribTest" class="Person__lastName__MSG:Hello {0}"></p>
   */
  public void testNewSyntax6() throws Exception {
    setupTestPage("TestPage5.html");
    String id = "attribTest";
    factory.createComponents(container, holders);
    Component component = (Component) container.get("attribTest");
    measureAbstractField(TextField.class, component, container, 0,
        id, null, null, null,
        null, null);
    Attribute attrib = ((TextField)component).getAttribute("class");
    measureAttribute(attrib, personHolder, "class", "lastName", 
        EmptyMessageFormat.class, "Hello {0}");
  }
   ...
   * <p id="attribTest" class="Person__lastName__MSG:Hello {0}"></p>
   * 
   * Already defined in container with holder/propName.
   * 
   * Ensure factory does not modify holder/propName, but adds format.
   */
  public void testNewSyntax7() throws Exception {
    setupTestPage("TestPage5.html");
    String id = "attribTest";
    // Create a component
    TextField p = new TextField();
    p.setId(id);
    p.createAttribute("class","terms",invoiceHolder);
    container.add(p);
    // Now have factory create
    factory.createComponents(container, holders, true);
    Component component = (Component) container.get("attribTest");
    measureAbstractField(TextField.class, component, container, 0,
        id, null, null, null,
        null, null);
    Attribute attrib = ((TextField)component).getAttribute("class");
    measureAttribute(attrib, invoiceHolder, "class", "terms", 
        EmptyMessageFormat.class, "Hello {0}");
  }
   ...
   * Test for createComponents:
   * 
   * <p id="textNodeTest">Person__lastName__MSG:Hello {0}</p>
   * 
   * Already defined in container with holder/propName.
   * 
   * Ensure factory does not modify holder/propName, but adds format.
   */
  public void testNewSyntax8() throws Exception {
    setupTestPage("TestPage5.html");
    String id = "textNodeTest";
    // Create a component
    TextField p = new TextField();
    p.setId(id);
    p.createTextNode("terms",invoiceHolder);
    container.add(p);
    // Now have factory create
    factory.createComponents(container, holders, true);
    Component component = (Component) container.get(id);
    measureAbstractField(TextField.class, component, container, 0,
        id, invoiceHolder, "terms", null,
        EmptyMessageFormat.class, "Hello {0}");
    TextNode text = ((TextField)p).getTextNode();
    measureTextNode(text, invoiceHolder, id, "terms", 
        EmptyMessageFormat.class, "Hello {0}");
  }
   ...
   * Button text predefined
   * Input with no name attribute ?
   * Review factory for more needed tests
   */
...
//  }
  ...
  class TestFactory extends HTMLComponentFactory {
    ...
    protected NodeDescriptor parseBindSyntax(String id) {
      return super.parseBindSyntax(id);
    }
  }
