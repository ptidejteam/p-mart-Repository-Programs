...
public class MessageBody extends Body {
    ...
    static final long serialVersionUID = -8790672830039242857L;
    ...
    */
    ...
    /**
    * Get the byte size of the enclosed message body
    */
    
    public long getSize() {
        return message.getMessageBody().getSize();   
    }
