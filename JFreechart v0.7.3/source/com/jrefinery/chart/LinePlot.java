 ...
 *
 * $Id: LinePlot.java,v 1.1 2007/10/10 18:57:06 vauchers Exp $
 *
 * Changes (from 21-Jun-2001)
 * --------------------------
 * 21-Jun-2001 : Removed redundant JFreeChart parameter from constructor (DG);
 * 18-Sep-2001 : Updated header and fixed DOS encoding (DG);
 ...
 * 13-Feb-2002 : Renamed getCategoryAxis() --> getDomainAxis(),
 *               and getValueAxis() --> getRangeAxis() (DG);
 *
 */
...
public class LinePlot extends Plot implements CategoryPlot, VerticalValuePlot {
     ...
     * <P>
     * For the LinePlot class, the domain is a set of categories plotted against a CategoryAxis.
     */
     ...
     * <P>
     * For the LinePlot class, the range is numerical data plotted against a ValueAxis.
     */
