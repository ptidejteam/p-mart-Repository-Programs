 ...
 *
 * $Id: VerticalCategoryPlot.java,v 1.1 2007/10/10 18:59:08 vauchers Exp $
 *
...
public class VerticalCategoryPlot extends CategoryPlot implements VerticalValuePlot {
     ...
     */
    public VerticalCategoryPlot(CategoryAxis horizontalAxis, ValueAxis verticalAxis,
        ...
        if ((plotArea.getWidth()>=MINIMUM_WIDTH_TO_DRAW)
         && (plotArea.getHeight()>=MINIMUM_HEIGHT_TO_DRAW)) {
		    ...
		    for (int series=0; series<seriesCount; series++) {
                        Shape region = renderer.drawCategoryItem(g2,
                                                                 dataArea, this,
                                                                 getRangeAxis(),
                                                                 data, series,
