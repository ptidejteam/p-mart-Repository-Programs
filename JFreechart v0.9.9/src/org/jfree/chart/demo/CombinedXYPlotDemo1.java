...
public class CombinedXYPlotDemo1 extends ApplicationFrame {
    ...
    private JFreeChart createCombinedChart() {
        ...
        XYPlot subplot1 = new XYPlot(data1, null, new NumberAxis("Range 1"), renderer1);
        
        XYTextAnnotation annotation = new XYTextAnnotation("Hello!", 50.0, 10000.0);
        annotation.setFont(new Font("SansSerif", Font.PLAIN, 9));
        annotation.setRotationAngle(Math.PI / 4.0);
        subplot1.addAnnotation(annotation);
        subplot1.setRangeAxisLocation(AxisLocation.LEFT);
        
        // create subplot 2...
        XYDataset data2 = createDataset2();
        XYPlot subplot2 = new XYPlot(data2, null, new NumberAxis("Range 2"));
        subplot2.setRangeAxisLocation(AxisLocation.RIGHT);
        ...
        return new JFreeChart("Combined (Domain) XY Plot",
    ...
    public static void main(String[] args) {
        ...
        CombinedXYPlotDemo1 demo = new CombinedXYPlotDemo1("Combined (Domain) XY Plot Demo");
        demo.pack();
