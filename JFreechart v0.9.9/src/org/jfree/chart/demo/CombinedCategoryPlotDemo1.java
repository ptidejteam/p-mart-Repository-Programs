 ...
 *
 * -----------------------------------
 * CombinedDomainCategoryPlotDemo.java
 * -----------------------------------
 ...
 * Contributor(s):   -;
 *
 * $Id: CombinedCategoryPlotDemo1.java,v 1.1 2007/10/10 20:07:29 vauchers Exp $
 *
 * Changes
 * -------
...
/**
 * A demo for the {@link SharedDomainCategoryPlot} class.
 *
...
public class CombinedCategoryPlotDemo1 extends ApplicationFrame {
    ...
    private JFreeChart createChart() {
        ...
        CombinedDomainCategoryPlot plot = new CombinedDomainCategoryPlot(new CategoryAxis(null));
        plot.add(subplot1, 2);
        plot.add(subplot2, 1);
    ...
    public static void main(String[] args) {
        ...
        String title = "Combined (Domain) Category Plot Demo";
