 ...
 * Contributor(s):   -;
 *
 * $Id: DualAxisDemo2.java,v 1.1 2007/10/10 20:07:29 vauchers Exp $
 *
 * Changes
 * -------
...
public class DualAxisDemo2 extends ApplicationFrame {
    ...
    public DualAxisDemo2(String title) {
        ...
        plot.setSecondaryRenderer(new StandardXYItemRenderer());
        plot.getSecondaryRenderer().setSeriesPaint(0, Color.black);
