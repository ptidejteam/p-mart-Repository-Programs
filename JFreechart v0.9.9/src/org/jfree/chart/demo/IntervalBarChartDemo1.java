 ...
 *
 * $Id: IntervalBarChartDemo1.java,v 1.1 2007/10/10 20:07:29 vauchers Exp $
 *
 * Changes
 * -------
...
public class IntervalBarChartDemo1 {
    ...
    public IntervalBarChartDemo1() {
        ...
        IntervalBarRenderer renderer = null;
        renderer = new IntervalBarRenderer(new IntervalCategoryItemLabelGenerator(), null);
        renderer.setSeriesPaint(0, new Color(51, 102, 153));
        renderer.setItemLabelsVisible(Boolean.TRUE);
        renderer.setItemLabelAnchor(ItemLabelAnchor.CENTER);
        renderer.setItemLabelTextAnchor(TextAnchor.CENTER);
