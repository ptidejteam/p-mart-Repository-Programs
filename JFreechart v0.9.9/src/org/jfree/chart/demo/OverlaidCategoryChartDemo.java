 ...
 *
 * $Id: OverlaidCategoryChartDemo.java,v 1.1 2007/10/10 20:07:29 vauchers Exp $
 *
 * Changes
 * -------
...
public class OverlaidCategoryChartDemo extends ApplicationFrame {
    ...
    public OverlaidCategoryChartDemo(String title) {
        ...
        OverlaidCategoryPlot plot = new OverlaidCategoryPlot(xAxis, yAxis);
        ...
        CategoryPlot barPlot = new CategoryPlot(barData, null, null, barRenderer);
        plot.add(barPlot);
        ...
        CategoryPlot dotPlot = new CategoryPlot(dotData, null, null, dotRenderer);
        dotPlot.setOrientation(PlotOrientation.VERTICAL);
        plot.add(dotPlot);

        LineAndShapeRenderer lineRenderer = null;
        lineRenderer = new LineAndShapeRenderer(LineAndShapeRenderer.SHAPES_AND_LINES);
        CategoryPlot lines = null;
        lines = new CategoryPlot(lineData, null, null, lineRenderer);
        lines.setOrientation(PlotOrientation.VERTICAL);
        plot.add(lines);
