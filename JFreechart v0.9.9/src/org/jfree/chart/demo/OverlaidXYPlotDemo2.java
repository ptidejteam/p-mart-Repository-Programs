 ...
 * Contributor(s):   -;
 *
 * $Id: OverlaidXYPlotDemo2.java,v 1.1 2007/10/10 20:07:29 vauchers Exp $
 *
 * Changes
 * -------
...
public class OverlaidXYPlotDemo2 extends ApplicationFrame {
    ...
    private JFreeChart createOverlaidChart() {
        ...
        XYPlot subplot2 = new XYPlot(data2A, null, null, renderer2A);
        
        XYDataset data2B = createDataset2B();
        subplot2.setSecondaryDataset(data2B);
        subplot2.setSecondaryRenderer(new StandardXYItemRenderer());
    ...
    private XYDataset createDataset2A() {
        ...
        tsc.setPosition(TimeSeriesCollection.MIDDLE);
        return tsc;
