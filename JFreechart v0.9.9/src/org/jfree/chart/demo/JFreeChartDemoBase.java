 ...
 *                   Bryan Scott;
 *
 * $Id: JFreeChartDemoBase.java,v 1.1 2007/10/10 20:07:29 vauchers Exp $
 *
 * Changes
 * -------
...
public class JFreeChartDemoBase {
    ...
    public JFreeChart createOverlaidChart() {
        ...
        OverlaidXYPlot plot = new OverlaidXYPlot(domain, range);
...
//        TimeSeries usd = DemoDatasetFactory.createUSDTimeSeries();
        ...
        NumberAxis valueAxis = new NumberAxis(range);
        valueAxis.setAutoRangeIncludesZero(false);  // override default

        // make a horizontally combined plot
        CombinedRangeXYPlot multiPlot = new CombinedRangeXYPlot(valueAxis);
    ...
    public JFreeChart createVerticallyCombinedChart() {
        ...
        // add subplot3...
        XYPlot subplot3 = new XYPlot(dataset2, null, new NumberAxis(ranges[2]));
        ...
        // add subplot4...
        XYPlot subplot4 = new XYPlot(dataset3, null, new NumberAxis(ranges[3]));
    ...
    public JFreeChart createCombinedAndOverlaidChart1() {
        ...
        // create CombinedPlot...
        CombinedDomainXYPlot multiPlot = new CombinedDomainXYPlot(new DateAxis(domain));
        ...
        OverlaidXYPlot subplot2 = new OverlaidXYPlot(null, new NumberAxis(ranges[1]));
        ...
        OverlaidXYPlot subplot3 = new OverlaidXYPlot(null, new NumberAxis(ranges[2]));
    ...
    public JFreeChart createCombinedAndOverlaidDynamicXYChart() {
        ...
        NumberAxis timeAxis = new NumberAxis(domain);
