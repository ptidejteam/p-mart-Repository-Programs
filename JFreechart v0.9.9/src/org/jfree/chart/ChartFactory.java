 ...
 *                   Jelai Wang;
 *
 * $Id: ChartFactory.java,v 1.1 2007/10/10 20:07:37 vauchers Exp $
 *
 * Changes
 * -------
...
public class ChartFactory {
    ...
    public static JFreeChart createAreaChart(String title,
        ...
        if (tooltips) {
            renderer.setDefaultLabelGenerator(new StandardCategoryItemLabelGenerator());
        }
        if (urls) {
            renderer.setURLGenerator(new StandardCategoryURLGenerator());
        }
    ...
    public static JFreeChart createStackedBarChart3D(String title,
        ...
        CategoryItemRenderer renderer = new StackedBarRenderer3D(toolTipGenerator, urlGenerator);
    ...
    public static JFreeChart createGanttChart(String title,
        ...
        CategoryItemRenderer renderer = new IntervalBarRenderer(toolTipGenerator, urlGenerator);
    ...
    public static JFreeChart createXYBarChart(String title,
        ...
        XYItemRenderer renderer = new XYBarRenderer(0.0,  tooltipGenerator, urlGenerator);
        plot.setRenderer(renderer);
        plot.setOrientation(orientation);
     ...
     * a special timeline. This timeline can be a SegmentedTimeline such as the
     * Monday trough Friday timeline that will remove Saturdays and Sundays from
     * the axis.
     *
