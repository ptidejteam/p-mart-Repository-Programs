 ...
 *                   Rich Unger;
 *
 * $Id: BarRenderer3D.java,v 1.1 2007/10/10 20:07:35 vauchers Exp $
 *
 * Changes
 * -------
 ...
 */
public class BarRenderer3D extends BarRenderer implements Effect3D, Serializable {
     ...
     */
    public BarRenderer3D(CategoryItemLabelGenerator toolTipGenerator,
    ...
    */
    ...
    public void drawRangeGridline(Graphics2D g2,
        ...
        PlotOrientation orientation = plot.getOrientation();
        if (orientation == PlotOrientation.HORIZONTAL) {
            double x0 = axis.translateValueToJava2D(value, adjusted, plot.getRangeAxisLocation());
            double x1 = x0 + getXOffset();
            double y0 = dataArea.getMaxY();
            double y1 = y0 - getYOffset();
            double y2 = dataArea.getMinY();
            ...
            double y0 = axis.translateValueToJava2D(value, adjusted, plot.getRangeAxisLocation());
            double y1 = y0 - getYOffset();
            double x0 = dataArea.getMinX();
            double x1 = x0 + getXOffset();
    ...
    protected void drawHorizontalItem(Graphics2D g2,
        ...
        if (dataValue != null) {
            ...
            double transX1 = rangeAxis.translateValueToJava2D(base, adjusted, location);
            double transX2 = rangeAxis.translateValueToJava2D(value, adjusted, location);
            ...
            if (getInfo() != null) {
                ...
                if (entities != null) {
                    String tip = null;
                    generator = getDefaultLabelGenerator();
                    if (generator != null) {
    ...
    protected void drawVerticalItem(Graphics2D g2,
        ...
        if (value != null) {
            ...
            AxisLocation location = plot.getRangeAxisLocation();
            double transY1 = rangeAxis.translateValueToJava2D(base, adjusted, location);
            double transY2 = rangeAxis.translateValueToJava2D(y, adjusted, location);
            ...
            CategoryItemLabelGenerator generator = getItemLabelGenerator(row, column);
            if (generator != null && isItemLabelVisible(row, column)) {
                drawItemLabel(g2, data, row, column, plot, generator, bar, (transY1 > transY2));
            }        
