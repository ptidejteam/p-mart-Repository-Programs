 ...
 *
 * $Id: AreaRenderer.java,v 1.1 2007/10/10 20:07:35 vauchers Exp $
 *
 * Changes:
 * --------
...
public class AreaRenderer extends AbstractCategoryItemRenderer implements Serializable {
     ...
     */
    public AreaRenderer(CategoryItemLabelGenerator toolTipGenerator,
    ...
    public void drawItem(Graphics2D g2,
        ...
        if (value != null) {
            ...
            AxisLocation axisLocation = plot.getDomainAxisLocation();
            int count = data.getColumnCount();
            float x0 = (float) domainAxis.getCategoryStart(column, count, dataArea, axisLocation);
            float x1 = (float) domainAxis.getCategoryMiddle(column, count, dataArea, axisLocation);
            float x2 = (float) domainAxis.getCategoryEnd(column, count, dataArea, axisLocation);
            ...
            float y0 = (float) rangeAxis.translateValueToJava2D(yy0, dataArea, location);
            float y1 = (float) rangeAxis.translateValueToJava2D(yy1, dataArea, location);
            float y2 = (float) rangeAxis.translateValueToJava2D(yy2, dataArea, location);
            float yz = (float) rangeAxis.translateValueToJava2D(0.0, dataArea, location);
            ...
            if (getInfo() != null) {
                ...
                if (entities != null) {
                    String tip = null;
                    CategoryItemLabelGenerator generator = getDefaultLabelGenerator();
                    if (generator != null) {
