 ...
 *                   Richard Atkinson;
 *
 * $Id: LineAndShapeRenderer.java,v 1.1 2007/10/10 20:07:35 vauchers Exp $
 *
 * Changes
 * -------
...
public class LineAndShapeRenderer extends AbstractCategoryItemRenderer implements Serializable {
    ...
    private BooleanTable seriesShapesFilled;
    ...
    public LineAndShapeRenderer(int type, int labelPosition,
        ...
        this.seriesShapesFilled = new BooleanTable();
    ...
    public boolean getSeriesShapesFilled(int series) {
        ...
        Boolean flag = this.seriesShapesFilled.getBoolean(0, series);
        if (flag != null) {
     ...
     */
    public void setShapesFilled(boolean flag) {
        setShapesFilled(Boolean.valueOf(flag));
    }
    ...
    public void setSeriesShapesFilled(int series, Boolean flag) {
        this.seriesShapesFilled.setBoolean(0, series, flag);
    }
