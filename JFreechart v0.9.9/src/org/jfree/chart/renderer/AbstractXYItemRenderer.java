 ...
 *
 * $Id: AbstractXYItemRenderer.java,v 1.1 2007/10/10 20:07:35 vauchers Exp $
 *
 * Changes:
 * --------
...
public abstract class AbstractXYItemRenderer extends AbstractRenderer
    ...
    public void fillDomainGridBand(Graphics2D g2,
        ...
        double x1 = axis.translateValueToJava2D(start, dataArea, plot.getDomainAxisLocation());
        double x2 = axis.translateValueToJava2D(end, dataArea, plot.getDomainAxisLocation());
    ...
    public void fillRangeGridBand(Graphics2D g2,
        ...
        double y1 = axis.translateValueToJava2D(start, dataArea, plot.getRangeAxisLocation());
        double y2 = axis.translateValueToJava2D(end, dataArea, plot.getRangeAxisLocation());
    ...
    public void drawDomainGridLine(Graphics2D g2,
        ...
        double v = axis.translateValueToJava2D(value, dataArea, plot.getDomainAxisLocation());
        Line2D line = null;
