 ...
 * Contributor(s):   -;
 *
 * $Id: FastScatterPlot.java,v 1.1 2007/10/10 20:07:31 vauchers Exp $
 *
...
public class FastScatterPlot extends Plot implements ValueAxisPlot, Serializable {
    ...
    public void draw(Graphics2D g2, Rectangle2D plotArea, ChartRenderingInfo info) {
        ...
        if (this.domainAxis != null) {
            this.domainAxis.draw(g2, plotArea, dataArea, AxisLocation.BOTTOM);
        }
        if (this.rangeAxis != null) {
            this.rangeAxis.draw(g2, plotArea, dataArea, AxisLocation.LEFT);
        }
    ...
    public void render(Graphics2D g2, Rectangle2D dataArea,
        ...
        if (this.data != null) {
            ...
            for (int i = 0; i < data[0].length; i++) {
                float x = data[0][i];
                float y = data[1][i];
                int transX = (int) domainAxis.translateValueToJava2D(x, dataArea, AxisLocation.BOTTOM);
                int transY = (int) rangeAxis.translateValueToJava2D(y, dataArea, AxisLocation.TOP);
