 ...
 *                   Gideon Krause;
 *
 * $Id: Plot.java,v 1.1 2007/10/10 20:07:31 vauchers Exp $
 *
...
//        this.index = 0;
     ...
     */
    protected double getRectX(double x, double w1, double w2, AxisLocation location) {
     ...
     */
    protected double getRectY(double y, double h1, double h2, AxisLocation location) {
     ...
     */
    protected AxisLocation getOppositeAxisLocation(AxisLocation location) {
