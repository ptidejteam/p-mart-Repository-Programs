 ...
 * @author Bryan Scott
 */
public class ThermometerPlot extends Plot implements ValueAxisPlot, Serializable {
    ...
    public void draw(Graphics2D g2, Rectangle2D plotArea, ChartRenderingInfo info) {
        ...
        if ((data != null) && (data.getValue() != null)){
            ...
            double ds = rangeAxis.translateValueToJava2D(current, dataArea, AxisLocation.LEFT);
            ...
            this.rangeAxis.draw(g2, plotArea, drawArea, AxisLocation.LEFT);
            ...
            if (this.subrangeIndicatorsVisible) {
                ...
                if (range.contains(value)) {
                    ...
                    double y = rangeAxis.translateValueToJava2D(value, dataArea, AxisLocation.LEFT);
    ...
    public boolean isCompatibleVerticalAxis(Axis axis) {
        return (axis instanceof NumberAxis);
    }
