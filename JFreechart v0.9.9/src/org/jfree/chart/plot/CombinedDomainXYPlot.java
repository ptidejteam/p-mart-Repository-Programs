 ...
 *
 * $Id: CombinedDomainXYPlot.java,v 1.1 2007/10/10 20:07:31 vauchers Exp $
 *
 * Changes:
 * --------
...
public class CombinedDomainXYPlot extends XYPlot implements Serializable {
    ...
    public void draw(Graphics2D g2, Rectangle2D plotArea, ChartRenderingInfo info) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            final AxisLocation location = plot.getRangeAxisLocation();
            space = rangeAxis.reserveSpace(g2, plot, subplotArea[i], location, space);
