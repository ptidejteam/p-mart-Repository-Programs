 ...
 *                   Xavier Poinsard;
 *
 * $Id: XYPlot.java,v 1.1 2007/10/10 20:07:31 vauchers Exp $
 *
...
public class XYPlot extends Plot implements ValueAxisPlot, PropertyChangeListener, Serializable {
    ...
    public XYPlot(XYDataset data,
        ...
        this.domainAxisLocation = AxisLocation.BOTTOM;
        ...
        this.rangeAxisLocation = AxisLocation.LEFT;
    ...
    public ValueAxis getSecondaryRangeAxis() {
        ...
        ValueAxis result = this.secondaryRangeAxis;
        
        if (result == null) {
            Plot parent = getParent();
            if (parent instanceof XYPlot) {
                XYPlot xy = (XYPlot) parent;
                result = xy.getSecondaryRangeAxis();
            }
        }
    ...
    public DrawingSupplier getDrawingSupplier() {
        ...
        XYPlot parent = (XYPlot) getParent();
        if (parent != null) {
    ...
    protected Rectangle2D getDataArea(Graphics2D g2, Rectangle2D plotArea) {
        ...
        if (this.fixedRangeAxisSpace != null) {
            ...
            if (rangeAxis1 != null) {
                space = rangeAxis1.reserveSpace(g2, this, plotArea, 
                                                getRangeAxisLocation(), space);
            }
    ...
    public void draw(Graphics2D g2, Rectangle2D plotArea, ChartRenderingInfo info) {
        ...
        if (this.secondaryRangeAxis != null) {
            this.secondaryRangeAxis.draw(g2, plotArea, dataArea,
                                         getOppositeAxisLocation(this.rangeAxisLocation));
        }
        ...
        if (this.renderer != null) {
            ...
            if (bandPaint != null) {
                ...
                double previous = domainAxis.getMinimumAxisValue();
                Iterator iterator = domainAxis.getTicks().iterator();
                while (iterator.hasNext()) {
                    Tick tick = (Tick) iterator.next();
                    double current = tick.getNumericalValue();
                    if (fillBand) {
                        renderer.fillDomainGridBand(g2, this, domainAxis, dataArea, previous, current);
                    }
                    previous = current;
                    fillBand = !fillBand;
                }
                double end = domainAxis.getMaximumAxisValue();
                if (fillBand) {
                    renderer.fillDomainGridBand(g2, this, domainAxis, dataArea, previous, end);
                }
            }

            // draw the range tick bands, if any...
            bandPaint = getRangeTickBandPaint();
            if (bandPaint != null) {
                boolean fillBand = false;
    ...
    public void render2(Graphics2D g2, Rectangle2D dataArea,
        ...
        if (!DatasetUtilities.isEmptyOrNull(dataset)) {
            ...
            int passCount = renderer.initialise(g2, dataArea, this, dataset, info);
    ...
    protected void drawVerticalLine(Graphics2D g2, Rectangle2D dataArea,
        ...
        double xx = getDomainAxis().translateValueToJava2D(value, dataArea, getDomainAxisLocation());
    ...
    protected void drawHorizontalLine(Graphics2D g2, Rectangle2D dataArea,
        ...
        double yy = getRangeAxis().translateValueToJava2D(value, dataArea, getRangeAxisLocation());
    ...
    public void handleClick(int x, int y, ChartRenderingInfo info) {
        ...
        if (hva != null) {
            double hvalue = hva.translateJava2DtoValue((float) x, info.getDataArea(), getDomainAxisLocation());
        ...
        if (vva != null) {
            double vvalue = vva.translateJava2DtoValue((float) y, info.getDataArea(), getRangeAxisLocation());
    ...
    public Range getDataRange(ValueAxis axis) {
        ...
        if (axis == getDomainAxis()) {
            ...
            result = Range.combine(
                DatasetUtilities.getDomainExtent(dataset),
                DatasetUtilities.getDomainExtent(getSecondaryDataset())
            );
        }
        else if (axis == getRangeAxis()) {
            result = DatasetUtilities.getRangeExtent(dataset);
        }
        else if (axis == getSecondaryRangeAxis()) {
            Dataset dataset2 = getSecondaryDataset();
            if (dataset2 != null) {
                result = DatasetUtilities.getRangeExtent(dataset2);
            }
//            else {
//                result = DatasetUtilities.getRangeExtent(dataset);
//            }
