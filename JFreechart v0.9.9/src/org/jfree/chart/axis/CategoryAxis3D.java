...
public class CategoryAxis3D extends CategoryAxis implements Serializable {
    ...
    public void draw(Graphics2D g2,
        ...
        if (location == AxisLocation.TOP || location == AxisLocation.BOTTOM) {
            drawHorizontalCategoryLabels(g2, plotArea, adjustedDataArea2, location);
        }
        else if (location == AxisLocation.LEFT || location == AxisLocation.RIGHT) {
            drawVerticalCategoryLabels(g2, plotArea, adjustedDataArea2, location);
        }
        ...
        if (isTickLabelsVisible()) {
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof Tick) {
                    Tick tick = (Tick) obj;
                    if (getVerticalCategoryLabels()) {   //KR
