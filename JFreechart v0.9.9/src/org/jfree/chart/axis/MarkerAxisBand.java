 ...
 * Contributor(s):   -;
 *
 * $Id: MarkerAxisBand.java,v 1.1 2007/10/10 20:07:40 vauchers Exp $
 *
...
public class MarkerAxisBand implements Serializable {
    ...
    public void draw(Graphics2D g2, Rectangle2D plotArea, Rectangle2D dataArea,
        ...
        while (iterator.hasNext()) {
            ...
            double s = axis.translateValueToJava2D(start, dataArea, AxisLocation.BOTTOM);
            double e = axis.translateValueToJava2D(end, dataArea, AxisLocation.BOTTOM);
