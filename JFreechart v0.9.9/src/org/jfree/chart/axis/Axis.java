 ...
 *
 * $Id: Axis.java,v 1.1 2007/10/10 20:07:40 vauchers Exp $
 *
...
public abstract class Axis implements AxisConstants, Serializable {
     ...
     */
    public abstract AxisSpace reserveSpace(Graphics2D g2, Plot plot, Rectangle2D plotArea, 
     ...
     */
    protected Rectangle2D getLabelEnclosure(Graphics2D g2, AxisLocation location) {
    ...
    protected double drawLabel(String label,
                               ...
                               AxisLocation location, double cursor) {
        ...
        if (location == AxisLocation.TOP) {
            ...
            double labely = plotArea.getY() + insets.top + labelBounds.getHeight() / 2.0;
            RefineryUtilities.drawRotatedString(label, g2,
                                                (float) labelx, (float) labely,
                                                TextAnchor.CENTER, TextAnchor.CENTER,
                                                getLabelAngle());
            cursor = cursor + insets.top + labelBounds.getHeight() + insets.bottom;
            ...
            labelBounds = rotatedLabelBounds.getBounds2D();
            double labelx = dataArea.getCenterX();
            double labely = plotArea.getMaxY() - insets.bottom - labelBounds.getHeight() / 2.0;
            RefineryUtilities.drawRotatedString(label, g2,
                                                (float) labelx, (float) labely,
                                                TextAnchor.CENTER, TextAnchor.CENTER,
                                                getLabelAngle());
            ...
            Shape rotatedLabelBounds = t.createTransformedShape(labelBounds);
            labelBounds = rotatedLabelBounds.getBounds2D();
            double labelx = plotArea.getX() + insets.left + labelBounds.getWidth() / 2.0;
            ...
            Shape rotatedLabelBounds = t.createTransformedShape(labelBounds);
            labelBounds = rotatedLabelBounds.getBounds2D();
            double labelx = plotArea.getMaxX() - insets.right - labelBounds.getWidth() / 2.0;
            double labely = plotArea.getY() + dataArea.getHeight() / 2.0;
            RefineryUtilities.drawRotatedString(label, g2,
                                                (float) labelx, (float) labely,
                                                TextAnchor.CENTER, TextAnchor.CENTER,
                                                getLabelAngle() + Math.PI / 2.0);
