 ...
 * Contributor(s):   -;
 *
 * $Id: XYTextAnnotation.java,v 1.1 2007/10/10 20:07:43 vauchers Exp $
 *
 * Changes:
 * --------
...
public class XYTextAnnotation extends TextAnnotation
    ...
    public void draw(Graphics2D g2, XYPlot plot, Rectangle2D dataArea,
        ...
        float anchorX = (float) domainAxis.translateValueToJava2D(this.x, dataArea,
                                                                  plot.getDomainAxisLocation());
        float anchorY = (float) rangeAxis.translateValueToJava2D(this.y, dataArea,
