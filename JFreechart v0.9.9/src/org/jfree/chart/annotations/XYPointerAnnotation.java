 ...
 * Contributor(s):   -;
 *
 * $Id: XYPointerAnnotation.java,v 1.1 2007/10/10 20:07:43 vauchers Exp $
 *
 * Changes:
 * --------
 ...
 */
public class XYPointerAnnotation extends XYTextAnnotation implements XYAnnotation, Serializable {
    ...
    public void draw(Graphics2D g2, XYPlot plot, Rectangle2D dataArea,
        ...
        double j2DX = domainAxis.translateValueToJava2D(getX(), dataArea,
                                                        plot.getDomainAxisLocation());
        double j2DY = rangeAxis.translateValueToJava2D(getY(), dataArea,
