 ...
 * Contributor(s):   -;
 *
 * $Id: HorizontalBarChart3DTests.java,v 1.1 2007/10/10 20:07:43 vauchers Exp $
 *
 * Changes:
 * --------
...
public class HorizontalBarChart3DTests extends TestCase {
    ...
    protected void setUp() {
        ...
        this.horizontalBarChart = createBarChart3D();
    ...
    private static JFreeChart createBarChart3D() {
        ...
        // create the chart...
        return ChartFactory.createBarChart3D("Bar Chart 3D",
                                             "Domain", "Range",
                                             dataset,
