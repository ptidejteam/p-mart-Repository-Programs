/**
 * InitContextListener - an EventListener interface for InitContextEvents
 *
 * Copyright (c) 2002
...
public interface InitContextListener extends EventListener {
  ...
  /**
   * Message to tell a Component to initialize its context from the given
   * <code>InitContextEvent</code>.
