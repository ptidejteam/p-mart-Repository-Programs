...
import com.taursys.examples.simpleweb.delegate.InvoiceItemVO;
import com.taursys.examples.simpleweb.delegate.WarehouseVO;
...
//  private HTMLInputText removeBox = new HTMLInputText();
  ...
  private void jbInit() throws Exception {
    this.setDocumentURI("resource:///forms/InventoryEditPage.html");
