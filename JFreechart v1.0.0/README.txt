...
(jfreechart-1.0.0-install.pdf) from the JFreeChart home
...
other respects GNU Classpath is "ready" for JFreeChart.  There are plans to 
implement Graphics2D using Cairo (a free vector graphics library), and we are 
hopeful that JFreeChart will soon work well on GNU Classpath-based runtimes.
...
demo (using JDK 1.3 or later), use the following command:
    ...
    java -jar jfreechart-1.0.0-demo.jar
