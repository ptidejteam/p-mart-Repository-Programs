 ...
 * Contributor(s):   -;
 *
 * $Id: LevelRenderer.java,v 1.1 2007/10/10 20:11:23 vauchers Exp $
 *
 * Changes
 * -------
    ...
    protected double calculateBarW0(CategoryPlot plot, 
        ...
        if (seriesCount > 1) {
            ...
            barW0 = domainAxis.getCategoryMiddle(
                column, getColumnCount(), dataArea,
    ...
    public void drawItem(Graphics2D g2,
        ...
        if (orientation == PlotOrientation.HORIZONTAL) {
            ...
            line = new Line2D.Double(
                barL, barW0, barL, barW0 + state.getBarWidth()
            );
        }
        else {
            ...
            y = barL;
            line = new Line2D.Double(
                barW0, barL, barW0 + state.getBarWidth(), barL
            );
        }
        ...
        if (generator != null && isItemLabelVisible(row, column)) {
            drawItemLabel(
                g2, orientation, dataset, row, column, x, y, (value < 0.0)
            );
        }        
