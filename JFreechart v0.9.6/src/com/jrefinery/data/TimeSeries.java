 ...
 * Contributor(s):   -;
 *
 * $Id: TimeSeries.java,v 1.1 2007/10/10 19:57:54 vauchers Exp $
 *
 * Changes
 * -------
...
public class TimeSeries extends Series {
     ...
     *
     */
    public TimeSeriesDataPair getDataPair(RegularTimePeriod period) {
     ...
     */
    public TimeSeriesDataPair addOrUpdate(RegularTimePeriod period, Number value) {
