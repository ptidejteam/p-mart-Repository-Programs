 ...
 *                   Klaus Rheinwald;
 *
 * $Id: JFreeChart.java,v 1.1 2007/10/10 19:57:58 vauchers Exp $
 *
...
public class JFreeChart implements JFreeChartConstants,
    ...
    /** A flag that can be used to suppress notification of chart change events. */
    private boolean suppressChartChangeEvents;
    ...
    public JFreeChart(String title, Font titleFont, Plot plot, boolean createLegend) {
        ...
        this.suppressChartChangeEvents = false;
    ...
    public void setSuppressChartChangeEvents(boolean flag) {
        this.suppressChartChangeEvents = flag;
    }
    ...
    public void addProgressListener(ChartProgressListener listener) {
        this.listenerList.add(ChartProgressListener.class, listener);
    }
    ...
    public void removeProgressListener(ChartProgressListener listener) {
        this.listenerList.remove(ChartProgressListener.class, listener);
    }
