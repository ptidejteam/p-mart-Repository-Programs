 ...
 *
 * $Id: ContourPlot.java,v 1.1 2007/10/10 19:57:54 vauchers Exp $
 *
 * Changes
 * -------
...
import com.jrefinery.chart.entity.ContourEntity;
import com.jrefinery.chart.entity.EntityCollection;
import com.jrefinery.chart.event.PlotChangeEvent;
import com.jrefinery.chart.tooltips.ContourToolTipGenerator;
...
public class ContourPlot extends Plot implements HorizontalValuePlot,
    ...
    public void draw(Graphics2D g2, Rectangle2D plotArea, ChartRenderingInfo info) {
        ...
        if (colorBar != null) {
            if (colorBar instanceof VerticalAxis) {
                ...
                vColorWidth = vColor.reserveWidth(g2, this, dataArea, Axis.RIGHT);
            }
            else {
 ...
 //           renderer.initialise(g2, dataArea, this, data, info);
            ...
            fillplot(g2, dataArea, info, this,
     ...
     */
    public void fillplot(Graphics2D g2,
   ...
   /**
    ...
    public Range getContourDataRange() {
        ...
        if (data != null) {
            ...
            result = ContourPlotUtilities.visibleRange(data, h, v);
        }
