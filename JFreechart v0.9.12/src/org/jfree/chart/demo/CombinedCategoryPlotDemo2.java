 ...
 * Contributor(s):   -;
 *
 * $Id: CombinedCategoryPlotDemo2.java,v 1.1 2007/10/10 19:12:16 vauchers Exp $
 *
 * Changes
 * -------
...
public class CombinedCategoryPlotDemo2 extends ApplicationFrame {
    ...
    private JFreeChart createChart() {
        ...
        subplot1.getDomainAxis().setVerticalCategoryLabels(true);
        ...
        subplot2.getDomainAxis().setVerticalCategoryLabels(true);
