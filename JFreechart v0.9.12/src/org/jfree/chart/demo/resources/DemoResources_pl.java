 ...
 *
 * $Id: DemoResources_pl.java,v 1.1 2007/10/10 19:12:30 vauchers Exp $
 *
 * Changes
 * -------
...
public class DemoResources_pl extends ListResourceBundle {
    ...
    private static final Object[][] CONTENTS = {
        ...
        {"chart1.description", "Wy\u015bwietla poziome s\u0142upki, por\u00f3wnuje zgrupowane warto\u015bci  "
            + "dla r\u00f3\u017cnych kategorii.  Uwaga: skala na osi poziomej jest odwr\u00f3cona."},

        {"chart2.title",       "S\u0142upkowy skumulowany: "},
        {"chart2.description", "Wy\u015bwietla poziome s\u0142upki, por\u00f3wnuje wk\u0142ad poszczeg\u00f3lnych warto\u015bci "
                              + "do sumy dla r\u00f3\u017cnych kategorii."},

        {"chart3.title",       "Kolumnowy grupowany: "},
        {"chart3.description",
            "Wy\u015bwietla pionowe kolumny, por\u00f3wnuje zgrupowane warto\u015bci dla r\u00f3\u017cnych kategorii."},
        ...
        {"chart7.description",
        "Wy\u015bwietla wk\u0142ad poszczeg\u00f3lnych warto\u015bci do sumy ca\u0142kowitej, podkre\u015blaj\u0105c jedn\u0105 z "
        + "warto\u015bci poprzez wysuni\u0119cie."},

        {"chart8.title",       "Ko\u0142owy tradycyjny: "},
        {"chart8.description", "Wy\u015bwietla procentowy wk\u0142ad poszczeg\u00f3lnych warto\u015bci do sumy "
        ...
        {"chart10.description", "Wykres liniowy - wy\u015bwietla trend w czasie lub dla r\u00f3\u017cnych"
          + " kategorii danych XY. "
          + "Ponadto demonstruje u\u017cycie wielu etykiet/nazw na jednym wykresie."},

        {"chart11.title",       "Liniowy 2: "},
        {"chart11.description", "Wykres liniowy - wy\u015bwietla trend w czasie lub dla r\u00f3\u017cnych"
        + " kategorii danych XY. "
                               + "O\u015b pionowa jest wyskalowana logarytmicznie."},

        {"chart12.title",       "Liniowy 3: "},
        {"chart12.description", "Wykres liniowy - wy\u015bwietla trend w czasie lub dla r\u00f3\u017cnych "
        ...
        {"chart14.description", "Wykres gie\u0142dowy typu Candlestick (Max/Min/Otwarcie/Zamkni\u0119cie) "
            + "oparty o dane HighLowDataset(serie warto\u015bci podawane w odpowiedniej kolejno\u015bci)."},

        {"chart15.title",       "Sygna\u0142owy: "},
        {"chart15.description", "Wykres sygna\u0142owy oparty o dane z SignalDataset."},

        {"chart16.title",       "Wiatrowy: "},
        {"chart16.description", "Ilustracja graficzna wiatru, przedstawiaj\u0105ca jego kierunek i si\u0142\u0119 "
        ...
        {"chart18.description",
            "Wykres wy\u015bwielta linie i/lub kszta\u0142ty, przedstawiaj\u0105ce dane z CategoryDataset. "
        ...
        {"chart26.description", "Wy\u015bwietla 3 r\u00f3\u017cne poziome wykresy liniowe /czasowe i XY kolumnowy "
                               + "."},

        {"chart27.title",       "Pionowy - kombinowany: "},
        {"chart27.description",
            "Wy\u015bwietla 4 r\u00f3\u017cne wykresy umo\u017cliwiaj±ce por\u00f3wnanie danych w pionie na jednym rysunku "
                               + "dla XY, liniowe /czasowe oraz kolumn pionowych XY."},

        {"chart28.title",       "Kombinowany i nak\u0142adany: "},
        {"chart28.description", "Kombinowany wykres XY, nak\u0142adany liniowy/TimeSeries i nak\u0142adany "
                               + "Max/Min & liniowy."},

        {"chart29.title",       "Kombinowany i nak\u0142adany dynamiczny: "},
        {"chart29.description", "Wy\u015bwietla kombinowany i nak\u0142adany wykres dynamiczny w celu "
