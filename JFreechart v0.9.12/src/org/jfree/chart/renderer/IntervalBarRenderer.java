 ...
 *
 * $Id: IntervalBarRenderer.java,v 1.1 2007/10/10 19:12:28 vauchers Exp $
 *
 * Changes
 * -------
...
public class IntervalBarRenderer extends BarRenderer
    ...
    public void drawItem(Graphics2D g2,
         ...
         if (dataset instanceof MultiIntervalCategoryDataset) {
             ...
             drawSubIntervals(g2, dataArea, plot, domainAxis, rangeAxis, d, row, column);
         }
         else if (dataset instanceof IntervalCategoryDataset) {
             IntervalCategoryDataset d = (IntervalCategoryDataset) dataset;
             drawInterval(g2, dataArea, plot, domainAxis, rangeAxis, d, row, column);
         }
         else {
             // how do we want to handle a standard CategoryDataset
         } 
     }
    ...
    private void drawSubIntervals(Graphics2D g2,
        ...
        if (count == 0) {
            drawInterval(g2, dataArea, plot, domainAxis, rangeAxis, dataset, row, column);
        }
