 ...
 *                   Arnaud Lelievre;
 *
 * $Id: PiePlot.java,v 1.1 2007/10/10 19:12:29 vauchers Exp $
 *
...
� � �*/
    ...
    public boolean equals(Object obj) {
        ...
        if (super.equals(obj) && obj instanceof PiePlot) {
            ...
            boolean b17 = true; //(this.paintTableActive == p.paintTableActive);
            ...
            boolean b20 = true;  //(this.outlinePaintTableActive == p.outlinePaintTableActive);
...
//                PublicCloneable
//            }
       // clone.toolTipGenerator = (PieToolTipGenerator) this.toolTipGenerator.clone();
//        boolean b13 = ObjectUtils.equal(this.urlGenerator, p.urlGenerator);
//        boolean b14 = (this.showSeriesLabels == p.showSeriesLabels);
//        boolean b15 = ObjectUtils.equal(this.seriesLabelFont, p.seriesLabelFont);
//        boolean b16 = ObjectUtils.equal(this.seriesLabelPaint, p.seriesLabelPaint);
//        boolean b17 = (this.paintTableActive == p.paintTableActive);
//        boolean b18 = ObjectUtils.equal(this.paintTable, p.paintTable);
//        boolean b19 = ObjectUtils.equal(this.defaultPaint, p.defaultPaint);
//        boolean b20 = (this.outlinePaintTableActive == p.outlinePaintTableActive);
//        boolean b21 = ObjectUtils.equal(this.outlinePaintTable, p.outlinePaintTable);
//        boolean b22 = ObjectUtils.equal(this.defaultOutlinePaint, p.defaultOutlinePaint);
//        boolean b23 = (this.outlineStrokeTableActive == p.outlineStrokeTableActive);
//        boolean b24 = ObjectUtils.equal(this.outlineStrokeTable, p.outlineStrokeTable);
//        boolean b25 = ObjectUtils.equal(this.defaultOutlineStroke, p.defaultOutlineStroke);
//
//        boolean b26 = (this.extractType == p.extractType);
//        boolean b27 = (this.minimumArcAngleToDraw == p.minimumArcAngleToDraw);
//        
