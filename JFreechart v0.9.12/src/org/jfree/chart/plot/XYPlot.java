 ...
 *                   Nicolas Brodu;
 *
 * $Id: XYPlot.java,v 1.1 2007/10/10 19:12:29 vauchers Exp $
 *
...
public class XYPlot extends Plot implements ValueAxisPlot,
    ...
    public boolean equals(Object obj) {
        ...
        if (super.equals(obj) && obj instanceof XYPlot) {
            ...
            boolean b30 = ObjectUtils.equal(this.domainMarkers, p.domainMarkers);
            boolean b31 = ObjectUtils.equal(this.rangeMarkers, p.rangeMarkers);
            boolean b32 = ObjectUtils.equal(this.secondaryRangeMarkers, p.secondaryRangeMarkers);
            boolean b33 = ObjectUtils.equal(this.annotations, p.annotations);
            boolean b34 = (this.weight == p.weight);
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        clone.secondaryDomainMarkers = ObjectUtils.clone(this.secondaryDomainMarkers);
