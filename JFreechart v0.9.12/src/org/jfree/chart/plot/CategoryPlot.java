 ...
 *                   Arnaud Lelievre;
 *
 * $Id: CategoryPlot.java,v 1.1 2007/10/10 19:12:29 vauchers Exp $
 *
...
public class CategoryPlot extends Plot implements ValueAxisPlot, Cloneable, Serializable {
    ...
    public void render2(Graphics2D g2, Rectangle2D dataArea, ChartRenderingInfo info) {
        ...
        for (int i = 0; i < this.secondaryDatasets.size(); i++) {
            ...
            if (!DatasetUtilities.isEmptyOrNull(data2)) {
                ...
                ValueAxis rangeAxis = getRangeAxisForSecondaryDataset(i);
                if (rangeAxis == null) {
                    rangeAxis = getRangeAxis();
                }
                CategoryItemRenderer renderer = getSecondaryRenderer(i);
                if (renderer != null) {
                    renderer.initialise(g2, dataArea, this, new Integer(i), info);
    ...
    public Range getDataRange(ValueAxis axis) {
        ...
        while (iterator.hasNext()) {
            ...
            if (this.renderer != null) {
                rangeType = renderer.getRangeType();
            }
    ...
    public boolean equals(Object object) {
        ...
        if (super.equals(object) && object instanceof CategoryPlot) {
            ...
            boolean b28 = ObjectUtils.equal(this.rangeMarkers, p.rangeMarkers);
            boolean b29 = ObjectUtils.equal(this.secondaryRangeMarkers, p.secondaryRangeMarkers);
                
            boolean b30 = ObjectUtils.equal(this.annotations, p.annotations);
            boolean b31 = (this.weight == p.weight);
