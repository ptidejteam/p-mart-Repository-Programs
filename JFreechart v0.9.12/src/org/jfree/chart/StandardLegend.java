 ...
 *
 * $Id: StandardLegend.java,v 1.1 2007/10/10 19:12:21 vauchers Exp $
 *
...
     * <P>
    ...
    private DrawableLegendItem createDrawableLegendItem(Graphics2D graphics,
        ...
        float yloc = (float) (y + innerGap + 0.5f * lineHeight);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StandardLegend) {
            ...
            if (super.equals(obj)) {
                ...
                boolean b0 = ObjectUtils.equal(this.outerGap, l.outerGap);
                boolean b1 = ObjectUtils.equal(this.outlineStroke, l.outlineStroke);
                boolean b2 = ObjectUtils.equal(this.outlinePaint, l.outlinePaint);
                boolean b3 = ObjectUtils.equal(this.backgroundPaint, l.backgroundPaint);
                boolean b4 = ObjectUtils.equal(this.innerGap, l.innerGap);
                boolean b5 = ObjectUtils.equal(this.title, l.title);
                boolean b6 = ObjectUtils.equal(this.titleFont, l.titleFont);
                boolean b7 = ObjectUtils.equal(this.itemFont, l.itemFont);
                boolean b8 = ObjectUtils.equal(this.itemPaint, l.itemPaint);
                boolean b9 = (this.outlineShapes == l.outlineShapes);
                boolean b10 = ObjectUtils.equal(this.shapeOutlineStroke, l.shapeOutlineStroke);
                boolean b11 = ObjectUtils.equal(this.shapeOutlinePaint, l.shapeOutlinePaint);
