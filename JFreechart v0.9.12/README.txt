...
(jfreechart-0.9.12-install.pdf) from the JFreeChart home
...
applets, this means that you cannot rely on the JVM integrated with Internet
Explorer - your users will need to have the Java 2 plug-in installed.  Most
other browsers (e.g. Mozilla/Netscape, Galeon, Konqueror) support JDK 1.4

(b)  JCommon - version 0.8.7 or later.  The runtime jar file is
included in the JFreeChart distribution.  You can obtain the complete
source code for JCommon from http://www.jfree.org.  JCommon
is licensed under the terms of the GNU Lesser General Public Licence.
...
Classes in the com.jrefinery.data.xml package require this library, or
...
recompile JFreeChart.  Classes in the com.jrefinery.chart.servlet
...
it you need the files jcommon-0.8.7.jar, jfreechart-0.9.12.jar and
jfreechart-0.9.12-demo.jar.
...
Use the following command:
    ...
    java -jar jfreechart-0.9.12-demo.jar
...
java -classpath lib/jcommon-0.8.7.jar:jfreechart-0.9.12.jar:jfreechart-0.9.12-demo.jar org.jfree.chart.demo.JFreeChartDemo
...
org.jfree.chart.demo.HorizontalBarChartDemo
org.jfree.chart.demo.HorizontalBarChartDemo2
org.jfree.chart.demo.HorizontalBarChartDemo3
...
org.jfree.chart.demo.VerticalBarChartDemo
org.jfree.chart.demo.VerticalBarChartDemo2
