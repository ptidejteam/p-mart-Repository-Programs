 ...
 * Contributor(s):   -;
 *
 * $Id: MeterPlotDemo.java,v 1.1 2007/10/10 19:02:28 vauchers Exp $
 *
 * Changes
 * -------
...
public class MeterPlotDemo {
    ...
    void displayMeterChart(double value, int type) {
        ...
        data.setNormalRange(new Double(70), new Double(85));
        data.setWarningRange(new Double(85), new Double(100));
        data.setCriticalRange(new Double(50), new Double(120));
