 ...
 *
 * @version $Id: DefaultGlobalModel.java,v 1.2 2005/08/23 23:34:59 huynhduc Exp $
 */
public class DefaultGlobalModel implements GlobalModel, OptionConstants {
  ...
  public String getClasspath() {
    ...
    if(extraClasspath != null) {
        Enumeration<File> enume = extraClasspath.elements();
        while(enume.hasMoreElements()) {
            classpath += enume.nextElement().getAbsolutePath() + separator;
        }
    }
  ...
  private void _resetInteractionsClasspath() {
    ...
    if(cp!=null) {
      Enumeration<File> enume = cp.elements();
      while(enume.hasMoreElements()) {
        _interpreterControl.addClassPath(enume.nextElement().getAbsolutePath());
      }
    }
  }
