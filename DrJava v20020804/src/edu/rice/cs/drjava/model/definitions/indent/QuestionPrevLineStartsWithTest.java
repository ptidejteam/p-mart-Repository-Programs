 ...
 * @version $Id: QuestionPrevLineStartsWithTest.java,v 1.1 2005/03/03 19:29:46 toeivesb Exp $
 */
public class QuestionPrevLineStartsWithTest extends IndentRulesTestCase {
  ...
  public void testNoPrefix() throws BadLocationException {
    ...
    // Open brace
    _setDocText("}\nfoo();\n}\n");
    assertTrue("line after close brace (no open brace)", !rule.applyRule(_doc, 2));
    assertTrue("line after text (no open brace)", !rule.applyRule(_doc, 9));
  ...
  public void testPrefixOnCurrLine() throws BadLocationException {
    ...
    assertTrue("after brace", !rule.applyRule(_doc, 2));
  ...
  public void testStartsWithPrefixWithText() throws BadLocationException {
    ...
    _setDocText("}bar();\nfoo();\nbar();");
    assertTrue("line of brace (no space)", !rule.applyRule(_doc, 2));
    assertTrue("line after brace (no space)", rule.applyRule(_doc, 8));
  ...
  public void testStartsWithPrefixNoText() throws BadLocationException {
    ...
    _setDocText("foo();\n*\nbar();\n}");
    assertTrue("line of star (no space)", !rule.applyRule(_doc, 8));
    assertTrue("line after star (no space)", rule.applyRule(_doc, 10));
    assertTrue("two lines after star (no space)", !rule.applyRule(_doc, 16));
  ...
  public void testMultipleCharPrefix() throws BadLocationException {
    ...
    // Multi-char prefix
    _setDocText("*\n *\n * \n * foo\nbar");
    assertTrue("star", !rule.applyRule(_doc, 2));
