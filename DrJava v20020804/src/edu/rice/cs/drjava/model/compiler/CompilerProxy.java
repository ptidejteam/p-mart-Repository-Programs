 ...
 * @version $Id: CompilerProxy.java,v 1.2 2005/08/23 23:34:59 huynhduc Exp $
 */
    ...
    try {
      ...
      //if(cp!=null) {
        ...
        while(enume.hasMoreElements()) {
          newclasspath.append(System.getProperty("path.separator")).append(enume.nextElement().getAbsolutePath());
        }
      //}
