 ...
 *
 * @version $Id: JavacGJCompiler.java,v 1.2 2005/08/23 23:34:59 huynhduc Exp $
 */
public class JavacGJCompiler implements CompilerInterface {
  ...
  */
  ...
  protected gjc.v6.util.Hashtable<String, String> createOptionsHashtable(File[] sourceRoots) {
  ...
  protected void initCompiler(File[] sourceRoots) {
	  gjc.v6.util.Hashtable<String, String> options = createOptionsHashtable(sourceRoots);
