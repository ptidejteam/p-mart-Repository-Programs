 ...
 * @version $Id: NonNegativeIntegerOption.java,v 1.1 2005/03/03 19:29:45 toeivesb Exp $
 */
...
{  
   ...
   * @exception IllegalArgumentException if "s" does
   * not represent an non-negative integer value: only Strings that
   * can be generated by the method NonNegativeInteger.toString()
   * are supported.
   */
