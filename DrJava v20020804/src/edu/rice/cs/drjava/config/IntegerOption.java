 ...
 * @version $Id: IntegerOption.java,v 1.1 2005/03/03 19:29:45 toeivesb Exp $
 */
...
{  
   ...
   * not represent an integer value: only Strings that
   * can be generated by the method Integer.toString()
   * are supported.
   */
