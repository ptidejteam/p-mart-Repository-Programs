 ...
 *                   Jonathan Nash;
 *
 * $Id: VerticalNumberAxis.java,v 1.1 2007/10/10 19:02:36 vauchers Exp $
 *
...
public class VerticalNumberAxis extends NumberAxis implements VerticalAxis {
    ...
    /**
     * Translates a Java2D coordinate to a data value.  To do this, you need to know the area
     * in Java2D space that is defined by the axes.
     *
     * @param value The data value.
     * @param plotArea The plot area in Java 2D User Space.
     */
