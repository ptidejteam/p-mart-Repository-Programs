 ...
 * Contributor(s):   -;
 *
 * $Id: OverlaidPlot.java,v 1.1 2007/10/10 19:02:39 vauchers Exp $
 *
 * Changes:
 * --------
...
/**
 * Extends a CombinedPlot to implement an OverlaidPlot.  At this time does not add anything new to
 * a CombinedPlot, except a easier to read name when creating an OverlaidPlot.
 *
