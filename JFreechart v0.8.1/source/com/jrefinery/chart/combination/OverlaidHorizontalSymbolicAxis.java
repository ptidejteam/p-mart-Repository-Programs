 ...
 *
 * -----------------------------------
 * OverlaidHorizontalSymbolicAxis.java
 * -----------------------------------
 *
 * Original Author:  Bill Kelemen;
 * Contributor(s):   David Gilbert (for Simba Management Limited), Anthony Boulestreau;
 *
 * $Id: OverlaidHorizontalSymbolicAxis.java,v 1.1 2007/10/10 19:02:39 vauchers Exp $
 *
 * Changes:
 * --------
...
public class OverlaidHorizontalSymbolicAxis extends CombinedHorizontalSymbolicAxis {

    // list of all the CombinedHorizontalSymbolicAxis we contain
    ...
    /**
     * Constructor.
     * @param plot CombinedPlot where this OverlaidHorizontalSymbolicAxis will be
     *        contained.
     */
    public OverlaidHorizontalSymbolicAxis(CombinedPlot plot) {

        super((HorizontalSymbolicAxis)plot.getHorizontalAxis(), false);
        this.plot = plot;
        ...
        while (iter.hasNext()) {
            ...
            if ((axis instanceof CombinedHorizontalSymbolicAxis)) {
                CombinedHorizontalSymbolicAxis combAxis = (CombinedHorizontalSymbolicAxis)axis;
