...
public class SampleYSymbolicDataset extends AbstractSeriesDataset implements XYDataset, YisSymbolic {
	 ...
	 * same symbolic value list.<P>
	 * The sharing symbolic value list is obtained adding the symbolic data list of the fist data set
	 * to the symbolic data list of the second data set.<P>
