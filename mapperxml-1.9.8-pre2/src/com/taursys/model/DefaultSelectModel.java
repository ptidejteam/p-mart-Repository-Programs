...
public class DefaultSelectModel extends DefaultTextModel implements SelectModel {
  ...
  public String toString() {
    ...
    result += " displayPropertyName=" + displayPropertyName;
    result += " listPropertyNames=[" + StringUtil.arrayToString(listPropertyNames) + "]";
    result += " propertyNames=[" + StringUtil.arrayToString(propertyNames) + "]";
    result += " nullAllowed=" + nullAllowed;
    result += " nullDisplay=" + nullDisplay;
    return  result; 
  }
