...
public class StringUtil {
   ...
   * The string is composed of the class name and a hexidecimal
   * representation of its hash code. If the object is null, "null" is
   * returned.
   * @param obj the object to return the identity string for
