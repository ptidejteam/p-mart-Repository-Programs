...
import com.taursys.dom.HTMLWriter;
...
public class ServletForm extends Form {
  ...
  public String toString() {
    ...
    result += " enableActions=" + enableActions;
    result += " enableInput=" + enableInput;
    return  result; 
  }
  
  boolean indent;
  /**
   * Testing method to initialize, open and render the form to the screen and to
   * a file results/Test.html
   * 
   * @throws Exception
   */
  public void testFullCycle(String outputFilePath, boolean indent) throws Exception {
    this.indent = indent;
    initForm();
    dispatchInitContext();
    dispatchInitForm();
...
//    FileOutputStream file = new FileOutputStream("live/"
//        + getDocumentURI().substring(RESOURCE_PREFIX.length()));
