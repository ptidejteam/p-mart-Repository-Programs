...
public abstract class Component implements MapperComponent {
   ...
   * @return the list of event types that this component responds to
   */
  protected ArrayList getEventTypeList() {
