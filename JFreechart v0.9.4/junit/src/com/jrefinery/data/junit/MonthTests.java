 ...
 * Contributor(s):   -;
 *
 * $Id: MonthTests.java,v 1.1 2007/10/10 21:48:09 vauchers Exp $
 *
 * Changes
 * -------
...
public class MonthTests extends TestCase {
    ...
    public void testDateConstructor1() {
        ...
        assertEquals(951868799999L, m1.getEnd(zone));

        assertEquals(Month.MARCH, m2.getMonth());
        assertEquals(951868800000L, m2.getStart(zone));
    ...
    public void testDateConstructor2() {
        ...
        assertEquals(Month.FEBRUARY, m1.getMonth());
        assertEquals(951821999999L, m1.getEnd(zone));

        assertEquals(Month.MARCH, m2.getMonth());
        assertEquals(951822000000L, m2.getStart(zone));
