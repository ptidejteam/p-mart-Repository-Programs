 ...
 * Contributor(s):   -;
 *
 * $Id: SecondTests.java,v 1.1 2007/10/10 21:48:09 vauchers Exp $
 *
 * Changes
 * -------
...
public class SecondTests extends TestCase {
    ...
    public void testDateConstructor1() {
        ...
        assertEquals(1016729758999L, s1.getEnd(zone));

        assertEquals(59, s2.getSecond());
        assertEquals(1016729759000L, s2.getStart(zone));
    ...
    public void testDateConstructor2() {
        ...
        assertEquals(58, s1.getSecond());
        assertEquals(1016751358999L, s1.getEnd(zone));

        assertEquals(59, s2.getSecond());
        assertEquals(1016751359000L, s2.getStart(zone));
