 ...
 * Contributor(s):   -;
 *
 * $Id: HourTests.java,v 1.1 2007/10/10 21:48:09 vauchers Exp $
 *
 * Changes
 * -------
...
public class HourTests extends TestCase {
    ...
    public void testDateConstructor1() {
        ...
        assertEquals(1014307199999L, h1.getEnd(zone));

        assertEquals(16, h2.getHour());
        assertEquals(1014307200000L, h2.getStart(zone));
    ...
    public void testDateConstructor2() {
        ...
        assertEquals(15, h1.getHour());
        assertEquals(1014267599999L, h1.getEnd(zone));

        assertEquals(16, h2.getHour());
        assertEquals(1014267600000L, h2.getStart(zone));
