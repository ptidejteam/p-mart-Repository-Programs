 ...
 * Contributor(s):   -;
 *
 * $Id: DayTests.java,v 1.1 2007/10/10 21:48:09 vauchers Exp $
 *
 * Changes
 * -------
...
public class DayTests extends TestCase {
    ...
    public void testDateConstructor1() {
        ...
        assertEquals(1078099199999L, d1.getEnd(zone));

        assertEquals(SerialDate.MARCH, d2.getMonth());
        assertEquals(1078099200000L, d2.getStart(zone));
    ...
    public void testDateConstructor2() {
        ...
        assertEquals(SerialDate.FEBRUARY, d1.getMonth());
        assertEquals(1078091999999L, d1.getEnd(zone));

        assertEquals(SerialDate.MARCH, d2.getMonth());
        assertEquals(1078092000000L, d2.getStart(zone));
