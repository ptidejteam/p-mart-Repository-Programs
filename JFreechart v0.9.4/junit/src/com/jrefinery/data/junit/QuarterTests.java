 ...
 * Contributor(s):   -;
 *
 * $Id: QuarterTests.java,v 1.1 2007/10/10 21:48:09 vauchers Exp $
 *
 * Changes
 * -------
...
public class QuarterTests extends TestCase {
    ...
    public void testDateConstructor1() {
        ...
        assertEquals(1017619199999L, q1.getEnd(zone));

        assertEquals(2, q2.getQuarter());
        assertEquals(1017619200000L, q2.getStart(zone));
    ...
    public void testDateConstructor2() {
        ...
        assertEquals(1, q1.getQuarter());
        assertEquals(1017608399999L, q1.getEnd(zone));

        assertEquals(2, q2.getQuarter());
        assertEquals(1017608400000L, q2.getStart(zone));
