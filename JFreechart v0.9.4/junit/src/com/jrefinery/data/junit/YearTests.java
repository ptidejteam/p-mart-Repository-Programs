 ...
 * Contributor(s):   -;
 *
 * $Id: YearTests.java,v 1.1 2007/10/10 21:48:09 vauchers Exp $
 *
 * Changes
 * -------
...
public class YearTests extends TestCase {
    ...
    public void testDateConstructor1() {
        ...
        assertEquals(1009843199999L, y1.getEnd(zone));

        assertEquals(2002, y2.getYear());
        assertEquals(1009843200000L, y2.getStart(zone));
    ...
    public void testDateConstructor2() {
        ...
        assertEquals(2001, y1.getYear());
        assertEquals(1009871999999L, y1.getEnd(zone));

        assertEquals(2002, y2.getYear());
        assertEquals(1009872000000L, y2.getStart(zone));
