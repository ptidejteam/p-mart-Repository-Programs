 ...
 * @version $Id: DynamicJavaAdapter.java,v 1.2 2005/08/22 21:24:36 huynhduc Exp $
 */
...
/*      Throwable cause = ie.getException();*/
  ...
  public static class InterpreterExtension extends TreeInterpreter {
    ...
    public InterpreterExtension() {
      ...
      classLoader = new ClassLoaderExtension((koala.dynamicjava.interpreter.Interpreter) this);
