 ...
 *
 * @version $Id: JavacGJCompiler.java,v 1.2 2005/08/22 21:24:36 huynhduc Exp $
 */
public class JavacGJCompiler implements CompilerInterface, OptionConstants {
  ...
  */
  ...
  public CompilerError[] compile(File sourceRoot, File[] files) {
    ...
    gjc.v6.util.List<String> filesToCompile = new gjc.v6.util.List<String>();
  ...
  protected gjc.v6.util.Hashtable<String, String> createOptionsHashtable(File sourceRoot) {
    gjc.v6.util.Hashtable<String, String> options = gjc.v6.util.Hashtable.make();
    ...
    if(ecp!=null) {
        Enumeration<String> enume = ecp.elements();
        while(enume.hasMoreElements()) {
            cp += System.getProperty("path.separator") + enume.nextElement();
        }
    }
  ...
  protected void initCompiler(File sourceRoot) {
    gjc.v6.util.Hashtable<String, String> options = createOptionsHashtable(sourceRoot);
    ...
    // compiler = gjc.v6.JavaCompiler.make((gjc.v6.util.Log) compilerLog, options);
  }
