 ...
 *
 * @version $Id: DefaultGlobalModel.java,v 1.2 2005/08/22 21:24:36 huynhduc Exp $
 */
public class DefaultGlobalModel implements GlobalModel, OptionConstants {
  ...
  public String getClasspath() {
    ...
    if(extraClasspath != null) {
        Enumeration<String> enume = extraClasspath.elements();
        while(enume.hasMoreElements()) {
            classpath += enume.nextElement() + separator;
        }
    }
  ...
  private void _resetInteractionsClasspath() {
    ...
    if(cp!=null) {
      Enumeration<String> enume = cp.elements();
      while(enume.hasMoreElements()) {
        _interpreterControl.addClassPath(enume.nextElement());
      }
    }
  }
