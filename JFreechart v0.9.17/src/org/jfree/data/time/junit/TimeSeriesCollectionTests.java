 ...
 * Contributor(s):   -;
 *
 * $Id: TimeSeriesCollectionTests.java,v 1.1 2007/10/10 19:29:20 vauchers Exp $
 *
 * Changes
 * -------
...
public class TimeSeriesCollectionTests extends TestCase {
    ...
    /**
     * Problem the getSurroundingItems() method to ensure it is returning the values we expect.
     */
