 ...
 *
 * $Id: Week.java,v 1.1 2007/10/10 19:29:24 vauchers Exp $
 *
 * Changes
 * -------
...
public class Week extends RegularTimePeriod implements Serializable {
    ...
    public long getFirstMillisecond(Calendar calendar) {
        ...
        day1FirstWeek.set(this.year.getYear(), Calendar.JANUARY, 1);
    ...
    public long getLastMillisecond(Calendar calendar) {
        ...
        cal.set(this.year.getYear(), Calendar.JANUARY, 1);
        ...
        if (this.week == actualMaxWeek) {
            ...
            firstDayOfFirstWeek.set(this.year.getYear(), Calendar.JANUARY, 1);
