 ...
 * Contributor(s):   -;
 *
 * $Id: XYLineAnnotation.java,v 1.1 2007/10/10 19:29:17 vauchers Exp $
 *
 * Changes:
 * --------
...
public class XYLineAnnotation implements XYAnnotation, Cloneable, Serializable {
    ...
    public void draw(Graphics2D g2, XYPlot plot, Rectangle2D dataArea,
        ...
        RectangleEdge rangeEdge = Plot.resolveRangeAxisLocation(plot.getRangeAxisLocation(), 
                                                                orientation);
        float j2DX1 = (float) domainAxis.valueToJava2D(this.x1, dataArea, domainEdge);
        float j2DY1 = (float) rangeAxis.valueToJava2D(this.y1, dataArea, rangeEdge);
        float j2DX2 = (float) domainAxis.valueToJava2D(this.x2, dataArea, domainEdge);
        float j2DY2 = (float) rangeAxis.valueToJava2D(this.y2, dataArea, rangeEdge);
