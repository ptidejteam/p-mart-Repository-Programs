 ...
 *                   Dave Crane;
 *
 * $Id: PiePlot3D.java,v 1.1 2007/10/10 19:29:15 vauchers Exp $
 *
 * Changes
 * -------
...
public class PiePlot3D extends PiePlot implements Serializable {
    ...
    public void draw(Graphics2D g2, Rectangle2D plotArea, PlotState parentState,
        ...
        double gapHorizontal = plotArea.getWidth() 
            * (gapPercent + getLabelGap() + getMaximumLabelWidth() + getLabelLinkMargin());
        ...
        double hh = linkArea.getWidth() * getLabelLinkMargin();
        double vv = linkArea.getHeight() * getLabelLinkMargin();
        ...
        if (dataset.getKeys().size() > plotArea.getWidth()) {
            ...
            int stringWidth = (int) fm.getStringBounds(text, g2).getWidth();
