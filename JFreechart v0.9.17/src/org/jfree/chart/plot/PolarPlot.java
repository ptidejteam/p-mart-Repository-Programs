 ...
 *
 * $Id: PolarPlot.java,v 1.1 2007/10/10 19:29:15 vauchers Exp $
 *
 * Changes
 * -------
...
public class PolarPlot extends Plot implements ValueAxisPlot, 
   ...
   /**
    ...
    public PolarPlot(XYDataset dataset, 
        ...
        this.angleTicks.add(new NumberTick(new Double(0.0), "0", 0.0f, 0.0f,
                TextAnchor.CENTER, TextAnchor.CENTER, 0.0));
        this.angleTicks.add(new NumberTick(new Double(45.0), "45", 0.0f, 0.0f,
                TextAnchor.CENTER, TextAnchor.CENTER, 0.0));
        this.angleTicks.add(new NumberTick(new Double(90.0), "90", 0.0f, 0.0f,
                TextAnchor.CENTER, TextAnchor.CENTER, 0.0));
        this.angleTicks.add(new NumberTick(new Double(135.0), "135", 0.0f, 0.0f,
                TextAnchor.CENTER, TextAnchor.CENTER, 0.0));
        this.angleTicks.add(new NumberTick(new Double(180.0), "180", 0.0f, 0.0f,
                TextAnchor.CENTER, TextAnchor.CENTER, 0.0));
        this.angleTicks.add(new NumberTick(new Double(225.0), "225", 0.0f, 0.0f,
                TextAnchor.CENTER, TextAnchor.CENTER, 0.0));
        this.angleTicks.add(new NumberTick(new Double(270.0), "270", 0.0f, 0.0f,
                TextAnchor.CENTER, TextAnchor.CENTER, 0.0));
        this.angleTicks.add(new NumberTick(new Double(315.0), "315", 0.0f, 0.0f,
                TextAnchor.CENTER, TextAnchor.CENTER, 0.0));
