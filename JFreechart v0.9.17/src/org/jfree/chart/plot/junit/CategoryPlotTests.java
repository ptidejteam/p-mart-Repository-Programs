 ...
 * Contributor(s):   -;
 *
 * $Id: CategoryPlotTests.java,v 1.1 2007/10/10 19:29:17 vauchers Exp $
 *
 * Changes
 * -------
...
public class CategoryPlotTests extends TestCase {
    ...
    public void testEquals() {
        ...
        plot1.addSecondaryRangeMarker(0, new ValueMarker(4.0), Layer.FOREGROUND);
        assertFalse(plot1.equals(plot2));
        plot2.addSecondaryRangeMarker(0, new ValueMarker(4.0), Layer.FOREGROUND);
        assertTrue(plot1.equals(plot2));
        
        plot1.addSecondaryRangeMarker(0, new ValueMarker(5.0), Layer.BACKGROUND);
        assertFalse(plot1.equals(plot2));
        plot2.addSecondaryRangeMarker(0, new ValueMarker(5.0), Layer.BACKGROUND);
        assertTrue(plot1.equals(plot2));
    ...
    /**
     * Problem to reproduce a bug in serialization.  The bug is a null pointer exception that occurs
