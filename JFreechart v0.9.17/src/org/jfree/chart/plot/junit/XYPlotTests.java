 ...
 * Contributor(s):   -;
 *
 * $Id: XYPlotTests.java,v 1.1 2007/10/10 19:29:17 vauchers Exp $
 *
 * Changes
 * -------
...
public class XYPlotTests extends TestCase {
    ...
    public void testEquals() {
        ...
        plot1.addSecondaryRangeMarker(new ValueMarker(4.0));
        assertFalse(plot1.equals(plot2));
        plot2.addSecondaryRangeMarker(new ValueMarker(4.0));
        assertTrue(plot1.equals(plot2));
    ...
    public void testCloning2() {
        ...
        p1.setSecondaryRangeAxis(1, new NumberAxis("Range Axis 2"));
        p1.setSecondaryRenderer(0, new XYBarRenderer());
        XYPlot p2 = null;
        try {
            p2 = (XYPlot) p1.clone();
        }
    ...
    public void testCloneIndependence() {
        ...
        p1.setSecondaryDomainAxis(0, new NumberAxis("Domain Axis 2"));
        p1.setSecondaryDomainAxisLocation(0, AxisLocation.BOTTOM_OR_LEFT);
        p1.setSecondaryRangeAxis(0, new NumberAxis("Range Axis 2"));
        p1.setSecondaryRangeAxisLocation(0, AxisLocation.TOP_OR_RIGHT);
        p1.setSecondaryRenderer(0, new XYBarRenderer());
        XYPlot p2 = null;        
        try {
            p2 = (XYPlot) p1.clone();
        ...
        p1.getSecondaryDomainAxis(0).setLabel("S1");
        assertFalse(p1.equals(p2));
        p2.getSecondaryDomainAxis(0).setLabel("S1");
        assertTrue(p1.equals(p2));
        
        p1.setSecondaryDomainAxisLocation(0, AxisLocation.TOP_OR_RIGHT);
        assertFalse(p1.equals(p2));
        p2.setSecondaryDomainAxisLocation(0, AxisLocation.TOP_OR_RIGHT);
        assertTrue(p1.equals(p2));
        ...
        p1.getSecondaryRangeAxis(0).setLabel("S1");
        assertFalse(p1.equals(p2));
        p2.getSecondaryRangeAxis(0).setLabel("S1");
        assertTrue(p1.equals(p2));
        
        p1.setSecondaryRangeAxisLocation(0, AxisLocation.TOP_OR_LEFT);
        assertFalse(p1.equals(p2));
        p2.setSecondaryRangeAxisLocation(0, AxisLocation.TOP_OR_LEFT);
        assertTrue(p1.equals(p2));
        ...
        p1.getSecondaryRenderer(0).setOutlinePaint(Color.red);
        assertFalse(p1.equals(p2));
        p2.getSecondaryRenderer(0).setOutlinePaint(Color.red);
        assertTrue(p1.equals(p2));
     ...
     * and a {@link StandardXYItemLabelGenerator}.
     */
    public void testSerialization2() {
        ...
        renderer1.setToolTipGenerator(
            new StandardXYItemLabelGenerator(new SimpleDateFormat("d-MMM-yyyy"))
        );
