 ...
 * Contributor(s):   -;
 *
 * $Id: JFreeChartTestSuite.java,v 1.1 2007/10/10 19:29:24 vauchers Exp $
 *
 * Changes:
 * --------
...
import org.jfree.data.statistics.junit.StatisticsPackageTests;
...
public class JFreeChartTestSuite extends TestCase {
    ...
    public static Test suite() {
        ...
        // sv modified since test suites aren't around
...
//        suite.addTest(ChartUIPackageTests.suite());
        ...
        suite.addTest(StatisticsPackageTests.suite());
