 ...
 *                   Nicolas Brodu;
 *
 * $Id: JFreeChart.java,v 1.1 2007/10/10 19:29:12 vauchers Exp $
 *
...
public class JFreeChart implements JFreeChartConstants,
    ...
    public void draw(Graphics2D g2, 
        ...
        if (logger.isInfoEnabled()) {
            logger.info("Entering draw() method, chartArea = " + chartArea.toString());   
        }
        ...
        if (this.backgroundImage != null) {
            ...
            if (logger.isInfoEnabled()) {
                logger.info("Drawing background image into " + dest.toString());   
            }
            g2.drawImage(
