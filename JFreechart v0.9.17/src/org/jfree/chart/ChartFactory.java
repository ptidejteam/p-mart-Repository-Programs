 ...
 *
 * $Id: ChartFactory.java,v 1.1 2007/10/10 19:29:12 vauchers Exp $
 *
 * Changes
 * -------
...
import org.jfree.chart.labels.StandardXYZItemLabelGenerator;
...
public abstract class ChartFactory {
    ...
    public static JFreeChart createPieChart(String title,
        ...
        if (tooltips) {
            plot.setToolTipGenerator(new StandardPieItemLabelGenerator("{0} = {2}"));
        }
        if (urls) {
    ...
    public static JFreeChart createMultiplePieChart(String title,
        ...
        if (tooltips) {
            PieItemLabelGenerator tooltipGenerator = new StandardPieItemLabelGenerator();
    ...
    public static JFreeChart createBarChart(String title,
        ...
        if (tooltips) {
            renderer.setToolTipGenerator(new StandardCategoryItemLabelGenerator());
        }
        if (urls) {
    ...
    public static JFreeChart createGanttChart(String title,
        ...
        if (tooltips) {
            renderer.setToolTipGenerator(
                new IntervalCategoryItemLabelGenerator(DateFormat.getDateInstance())
            );
        }
        if (urls) {
            renderer.setItemURLGenerator(new StandardCategoryURLGenerator());
    ...
    public static JFreeChart createScatterPlot(String title,
        ...
        XYItemLabelGenerator toolTipGenerator = null;
        if (tooltips) {
            toolTipGenerator = new StandardXYItemLabelGenerator();
        }
    ...
    public static JFreeChart createXYBarChart(String title,
        ...
        if (tooltips) {
            renderer.setToolTipGenerator(new StandardXYItemLabelGenerator());
        }
        if (urls) {
    ...
    public static JFreeChart createXYAreaChart(String title,
        ...
        XYItemLabelGenerator labelGenerator = null;
        if (tooltips) {
        ...
        plot.setRenderer(new XYAreaRenderer(XYAreaRenderer.AREA, labelGenerator, urlGenerator));
    ...
    public static JFreeChart createStackedXYAreaChart(String title,
        ...
        StackedXYAreaRenderer renderer = new StackedXYAreaRenderer(
            XYAreaRenderer.AREA, labelGenerator, urlGenerator
        );
    ...
    public static JFreeChart createXYStepChart(String title,
        ...
        XYItemRenderer renderer = new XYStepRenderer(labelGenerator, urlGenerator);
    ...
    public static JFreeChart createXYStepAreaChart(String title,
        ...
        XYItemRenderer renderer = new XYStepAreaRenderer(
            XYStepAreaRenderer.AREA_AND_SHAPES, labelGenerator, urlGenerator
        );
    ...
    public static JFreeChart createTimeSeriesChart(String title,
        ...
        XYItemLabelGenerator labelGenerator = null;
        if (tooltips) {
            labelGenerator = new StandardXYItemLabelGenerator(DateFormat.getDateInstance());
        }
    ...
    public static JFreeChart createBubbleChart(String title,
        ...
        if (tooltips) {
            renderer.setToolTipGenerator(new StandardXYZItemLabelGenerator());
        }
        if (urls) {
