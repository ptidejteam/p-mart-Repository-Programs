 ...
 *                   Matthias Rose;
 *
 * $Id: XYStepRenderer.java,v 1.1 2007/10/10 19:29:17 vauchers Exp $
 *
 * Changes
 * -------
...
public class XYStepRenderer extends AbstractXYItemRenderer 
     ...
     */
    public XYStepRenderer(XYItemLabelGenerator toolTipGenerator,
    ...
    public void drawItem(Graphics2D g2, 
        ...
        double transX1 = horizontalAxis.valueToJava2D(x1.doubleValue(), dataArea, xAxisLocation);
        double transY1 = verticalAxis.valueToJava2D(y1.doubleValue(), dataArea, yAxisLocation);
        ...
        if (item > 0) {
            ...
            if (y0 != null) {
                double transX0 = horizontalAxis.valueToJava2D(
                    x0.doubleValue(), dataArea, xAxisLocation
                );
                double transY0 = verticalAxis.valueToJava2D(
