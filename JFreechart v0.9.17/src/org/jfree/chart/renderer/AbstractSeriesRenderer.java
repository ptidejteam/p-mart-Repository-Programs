 ...
 *
 * $Id: AbstractSeriesRenderer.java,v 1.1 2007/10/10 19:29:17 vauchers Exp $
 *
 * Changes:
 * --------
 ...
 */
public abstract class AbstractSeriesRenderer extends AbstractRenderer
    ...
    public Paint getSeriesItemLabelPaint(int series) {
        ...
        // otherwise look up the paint list
        Paint result = this.itemLabelPaintList.getPaint(series);
        if (result == null) {
    ...
    /**
     * Notifies all registered listeners that the renderer has been changed.
     *
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AbstractSeriesRenderer) {
            AbstractSeriesRenderer renderer = (AbstractSeriesRenderer) obj;
...
//        result = 37 * result + ObjectUtils.hashCode(this.baseItemLabelAngle);    
    ...
    protected Object clone() throws CloneNotSupportedException {
        AbstractSeriesRenderer clone = (AbstractSeriesRenderer) super.clone();
