 ...
 *
 * $Id: AbstractCategoryItemRenderer.java,v 1.1 2007/10/10 19:29:17 vauchers Exp $
 *
 * Changes:
 * --------
 ...
 */
public abstract class AbstractCategoryItemRenderer extends AbstractSeriesRenderer
    ...
    private CategoryItemLabelGenerator baseLabelGenerator;
    ...
    /** The base item label generator. */
    private CategoryItemLabelGenerator baseToolTipGenerator;
    ...
    public CategoryItemLabelGenerator getSeriesLabelGenerator(int series) {
        ...
        CategoryItemLabelGenerator generator
            = (CategoryItemLabelGenerator) this.labelGeneratorList.get(series);
        if (generator == null) {
     ...
     * to the {@link #getSeriesToolTipGenerator(int)} method.  If, for some reason, you want a 
     * different generator for individual items, you can override this method.
     *
     * @param row  the row index (zero based).
     * @param column  the column index (zero based).
     *
     * @return the generator (possibly <code>null</code>).
     */
    public CategoryItemLabelGenerator getToolTipGenerator(int row, int column) {
    ...
    public CategoryItemLabelGenerator getSeriesToolTipGenerator(int series) {
        ...
        // otherwise look up the generator table
        CategoryItemLabelGenerator generator
            = (CategoryItemLabelGenerator) this.toolTipGeneratorList.get(series);
        if (generator == null) {
    ...
    public LegendItem getLegendItem(int datasetIndex, int series) {
        ...
        if (datasetIndex == 0) {
            ...
            dataset = cp.getSecondaryDataset(datasetIndex - 1);
        }
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        if (this.labelGenerator != null) {
            if (this.labelGenerator instanceof PublicCloneable) {
                ...
                clone.labelGenerator = (CategoryItemLabelGenerator) pc.clone();
            }
            else {
        ...
        if (this.baseLabelGenerator != null) {
            if (this.baseLabelGenerator instanceof PublicCloneable) {
                ...
                clone.baseLabelGenerator = (CategoryItemLabelGenerator) pc.clone();
            }
            else {
                throw new CloneNotSupportedException("ItemLabelGenerator not cloneable.");
            }
        ...
        if (this.toolTipGenerator != null) {
            if (this.toolTipGenerator instanceof PublicCloneable) {
                ...
                clone.toolTipGenerator = (CategoryItemLabelGenerator) pc.clone();
            }
            else {
        ...
        if (this.baseToolTipGenerator != null) {
            if (this.baseToolTipGenerator instanceof PublicCloneable) {
                ...
                clone.baseToolTipGenerator = (CategoryItemLabelGenerator) pc.clone();
            }
            else {
