 ...
 *
 * $Id: AbstractXYItemRenderer.java,v 1.1 2007/10/10 19:29:17 vauchers Exp $
 *
 * Changes:
 * --------
...
public abstract class AbstractXYItemRenderer extends AbstractRenderer
    ...
    private XYItemLabelGenerator toolTipGenerator;

    /** A list of tool tip generators (one per series). */
    private ObjectList toolTipGeneratorList;

    /** The base tool tip generator. */
    private XYItemLabelGenerator baseToolTipGenerator;
     ...
     * the {@link #getSeriesLabelGenerator} method.  If, for some reason, you want a different
     ...
     */
    public XYItemLabelGenerator getLabelGenerator(int row, int column) {
     ...
     * @return the generator (possibly <code>null</code>).
     */
    public XYItemLabelGenerator getSeriesLabelGenerator(int series) {
     ...
     */
    public void setLabelGenerator(XYItemLabelGenerator generator) {
     ...
     * @param generator  the generator (<code>null</code> permitted).
     */
    public void setSeriesLabelGenerator(int series, XYItemLabelGenerator generator) {
     ...
     * @return the generator (possibly <code>null</code>).
     */
    public XYItemLabelGenerator getBaseLabelGenerator() {
     ...
     * @param generator  the generator (<code>null</code> permitted).
     */
    public void setBaseLabelGenerator(XYItemLabelGenerator generator) {
     ...
     * @return the generator (possibly <code>null</code>).
     */
    public XYItemLabelGenerator getToolTipGenerator(int row, int column) {
     ...
     * @return the generator (possibly <code>null</code>).
     */
    public XYItemLabelGenerator getSeriesToolTipGenerator(int series) {
        ...
        // otherwise look up the generator table
        XYItemLabelGenerator generator
            = (XYItemLabelGenerator) this.toolTipGeneratorList.get(series);
        if (generator == null) {
     ...
     * @param generator  the generator (<code>null</code> permitted).
     */
    public void setToolTipGenerator(XYItemLabelGenerator generator) {
     ...
     * @param generator  the generator (<code>null</code> permitted).
     */
    public void setSeriesToolTipGenerator(int series, XYItemLabelGenerator generator) {
     ...
     * @return the generator (possibly <code>null</code>).
     */
    public XYItemLabelGenerator getBaseToolTipGenerator() {
     ...
     * @param generator  the generator (<code>null</code> permitted).
     */
    public void setBaseToolTipGenerator(XYItemLabelGenerator generator) {
    ...
    public LegendItem getLegendItem(int datasetIndex, int series) {
        ...
        if (xyplot != null) {
            XYDataset dataset;
            if (datasetIndex == 0) {
                dataset = xyplot.getDataset();
            }
            else {
                dataset = xyplot.getSecondaryDataset(datasetIndex - 1);
            }
    ...
    public void drawDomainMarker(Graphics2D g2,
        ...
        if (marker instanceof ValueMarker) {
            ...
            if (orientation == PlotOrientation.HORIZONTAL) {
                rect = new Rectangle2D.Double(dataArea.getMinX(), v0, dataArea.getWidth(), v1 - v0);
            }
            else if (orientation == PlotOrientation.VERTICAL) {
    ...
    protected void drawItemLabel(Graphics2D g2, 
        ...
        XYItemLabelGenerator generator = getLabelGenerator(series, item);
        if (generator != null) {
            Font labelFont = getItemLabelFont(series, item);
            Paint paint = getItemLabelPaint(series, item);
            g2.setFont(labelFont);
            g2.setPaint(paint);
            String label = generator.generateItemLabel(dataset, series, item);
