 ...
 *
 * $Id: XYAreaRenderer.java,v 1.1 2007/10/10 19:29:18 vauchers Exp $
 *
 * Changes:
 * --------
...
public class XYAreaRenderer extends AbstractXYItemRenderer 
     ...
     */
    public XYAreaRenderer(int type,
                          XYItemLabelGenerator labelGenerator, XYURLGenerator urlGenerator) {
    ...
    public void drawItem(Graphics2D g2,
        ...
        if (y1n == null) {
            y1n = AbstractSeriesRenderer.ZERO;
        }
