 ...
 *
 * $Id: StandardXYItemRenderer.java,v 1.1 2007/10/10 19:29:18 vauchers Exp $
 *
 * Changes:
 * --------
...
public class StandardXYItemRenderer extends AbstractXYItemRenderer 
    ...
    public StandardXYItemRenderer() {
        this(LINES, new StandardXYItemLabelGenerator());
    }
    ...
    public StandardXYItemRenderer(int type) {
        this(type, new StandardXYItemLabelGenerator());
    }
     ...
     * @param labelGenerator  the item label generator (<code>null</code> permitted).
     */
    public StandardXYItemRenderer(int type, XYItemLabelGenerator labelGenerator) {
        this(type, labelGenerator, null);
    }
     ...
     */
    public StandardXYItemRenderer(int type,
                                  XYItemLabelGenerator toolTipGenerator,
    ...
    public void drawItem(Graphics2D g2,
        ...
        if (entities != null) {
            ...
            String tip = null;
            XYItemLabelGenerator generator = getToolTipGenerator(series, item);
            if (generator != null) {
