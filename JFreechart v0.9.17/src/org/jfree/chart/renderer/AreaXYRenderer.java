 ...
 *
 * $Id: AreaXYRenderer.java,v 1.1 2007/10/10 19:29:18 vauchers Exp $
 *
 * Changes:
 * --------
...
public class AreaXYRenderer extends AbstractXYItemRenderer 
     ...
     */
    public AreaXYRenderer(int type,
                          XYItemLabelGenerator toolTipGenerator, XYURLGenerator urlGenerator) {
    ...
    public void drawItem(Graphics2D g2,
        ...
        if (y1 == null) {
            y1 = AbstractSeriesRenderer.ZERO;
        }
        ...
        if (y0 == null) {
            y0 = AbstractSeriesRenderer.ZERO;
        }
        ...
        if (y2 == null) {
            y2 = AbstractSeriesRenderer.ZERO;
        }
        ...
        updateCrosshairValues(crosshairState, x1.doubleValue(), y1.doubleValue(), 
