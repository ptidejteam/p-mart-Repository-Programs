 ...
 * Contributor(s):   -;
 *
 * $Id: CustomXYItemLabelGeneratorTests.java,v 1.1 2007/10/10 19:29:20 vauchers Exp $
 *
 * Changes
 * -------
...
import org.jfree.chart.labels.CustomXYItemLabelGenerator;
...
public class CustomXYItemLabelGeneratorTests extends TestCase {
    ...
    public void testCloning() {
        CustomXYItemLabelGenerator g1 = new CustomXYItemLabelGenerator();
        CustomXYItemLabelGenerator g2 = null;
        try {
            g2 = (CustomXYItemLabelGenerator) g1.clone();
        }
    ...
    public void testSerialization() {
        ...
        try {
            ...
            g2 = (CustomXYItemLabelGenerator) in.readObject();
            in.close();
        }
        catch (Exception e) {
