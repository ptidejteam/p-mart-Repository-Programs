 ...
 * Contributor(s):   -;
 *
 * $Id: IntervalCategoryItemLabelGeneratorTests.java,v 1.1 2007/10/10 19:29:20 vauchers Exp $
 *
 * Changes
 * -------
...
public class IntervalCategoryItemLabelGeneratorTests extends TestCase {
    ...
    public void testEquals() {
        ...
        g1 = new IntervalCategoryItemLabelGenerator(new DecimalFormat("0.000"));
        assertFalse(g1.equals(g2));
        g2 = new IntervalCategoryItemLabelGenerator(new DecimalFormat("0.000"));
        assertTrue(g1.equals(g2));
        
        g1 = new IntervalCategoryItemLabelGenerator(new SimpleDateFormat("d-MMM"));
        assertFalse(g1.equals(g2));
        g2 = new IntervalCategoryItemLabelGenerator(new SimpleDateFormat("d-MMM"));
        assertTrue(g1.equals(g2));
    ...
    public void testSerialization() {
        ...
        IntervalCategoryItemLabelGenerator g1
            = new IntervalCategoryItemLabelGenerator(DateFormat.getInstance());
        IntervalCategoryItemLabelGenerator g2 = null;
