 ...
 * Contributor(s):   -;
 *
 * $Id: StandardCategoryItemLabelGeneratorTests.java,v 1.1 2007/10/10 19:29:20 vauchers Exp $
 *
 * Changes
 * -------
...
public class StandardCategoryItemLabelGeneratorTests extends TestCase {
    ...
    public void testEquals() {
        ...
        g1 = new StandardCategoryItemLabelGenerator(new DecimalFormat("0.000"));
        assertFalse(g1.equals(g2));
        g2 = new StandardCategoryItemLabelGenerator(new DecimalFormat("0.000"));
        assertTrue(g1.equals(g2));
        
        g1 = new StandardCategoryItemLabelGenerator(new SimpleDateFormat("d-MMM"));
        assertFalse(g1.equals(g2));
        g2 = new StandardCategoryItemLabelGenerator(new SimpleDateFormat("d-MMM"));
        assertTrue(g1.equals(g2));
    ...
    public void testCloning() {
        ...
        try {
            ...
            System.err.println("StandardCategoryItemLabelGenerator.testCloning: failed to clone.");
        }
        assertTrue(g1 != g2);
    ...
    public void testSerialization() {
        ...
        StandardCategoryItemLabelGenerator g1
            = new StandardCategoryItemLabelGenerator(DateFormat.getInstance());
        StandardCategoryItemLabelGenerator g2 = null;
