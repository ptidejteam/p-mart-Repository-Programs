 ...
 *
 * $Id: BoxAndWhiskerXYItemLabelGenerator.java,v 1.1 2007/10/10 19:29:21 vauchers Exp $
 *
 * Changes
 * -------
...
import java.text.MessageFormat;  // for Javadocs
 ...
 * <P>
 * The tooltip text and item label text are composed using a {@link MessageFormat} object, that
 * can aggregate some or all of the following string values into a message:
 * <table>
 ...
 */
public class BoxAndWhiskerXYItemLabelGenerator extends AbstractXYItemLabelGenerator
     ...
     */
    public BoxAndWhiskerXYItemLabelGenerator() {
        super(
     ...
     */
    public BoxAndWhiskerXYItemLabelGenerator(String toolTipFormat, 
                                             String itemLabelFormat,
                                             DateFormat dateFormat, 
                                             NumberFormat numberFormat) {
        
        super(toolTipFormat, itemLabelFormat, dateFormat, numberFormat);
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof BoxAndWhiskerXYItemLabelGenerator) {
