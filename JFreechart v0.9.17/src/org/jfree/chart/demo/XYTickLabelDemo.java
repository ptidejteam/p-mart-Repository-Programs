 ...
 * Contributor(s):   -;
 *
 * $Id: XYTickLabelDemo.java,v 1.1 2007/10/10 19:29:07 vauchers Exp $
 *
 * Changes
 * -------
...
public class XYTickLabelDemo extends ApplicationFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (source == this.symbolicAxesCheckBox) {
            ...
            boolean val = this.symbolicAxesCheckBox.isSelected();
        ...
        if (source == this.symbolicAxesCheckBox || source == this.verticalTickLabelsCheckBox) {
            boolean val = this.verticalTickLabelsCheckBox.isSelected();
            ...
            PlotOrientation val = this.horizontalPlotCheckBox.isSelected() 
            ...
            String s = this.fontSizeTextField.getText();
            if (s.length() > 0) {
