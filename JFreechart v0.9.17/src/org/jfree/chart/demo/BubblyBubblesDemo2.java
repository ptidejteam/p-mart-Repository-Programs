 ...
 *
 * $Id: BubblyBubblesDemo2.java,v 1.1 2007/10/10 19:29:07 vauchers Exp $
 *
 * Changes
 * -------
...
public class BubblyBubblesDemo2 extends ApplicationFrame {
    ...
    public BubblyBubblesDemo2(String title) {
        ...
        this.m_series = createInitialSeries();

        MatrixSeriesCollection dataset = new MatrixSeriesCollection(this.m_series);
