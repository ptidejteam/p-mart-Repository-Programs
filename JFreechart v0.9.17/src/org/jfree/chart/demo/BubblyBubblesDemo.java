 ...
 *
 * $Id: BubblyBubblesDemo.java,v 1.1 2007/10/10 19:29:07 vauchers Exp $
 *
 * Changes
 * -------
...
public class BubblyBubblesDemo extends ApplicationFrame {
     ...
     */
    private NormalizedMatrixSeries mSeries;
     ...
     */
    public BubblyBubblesDemo(String title) {
        super(title);

        this.mSeries = createInitialSeries();

        MatrixSeriesCollection dataset = new MatrixSeriesCollection(this.mSeries);
    ...
    public static void main(String[] args) {
        BubblyBubblesDemo demo = new BubblyBubblesDemo(TITLE);
        demo.pack();
    ...
    private class UpdaterThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                ...
                mSeries.update(i, j, mSeries.get(i, j) + 1);
