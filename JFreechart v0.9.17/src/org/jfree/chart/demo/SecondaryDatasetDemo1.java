 ...
 * Contributor(s):   -;
 *
 * $Id: SecondaryDatasetDemo1.java,v 1.1 2007/10/10 19:29:07 vauchers Exp $
 *
 * Changes
 * -------
...
public class SecondaryDatasetDemo1 extends ApplicationFrame implements ActionListener {
    ...
    public SecondaryDatasetDemo1(String title) {
        ...
        JFreeChart chart = ChartFactory.createTimeSeriesChart(
            "Secondary Dataset Demo 1", "Time", "Value", dataset1, true, true, false
        );
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getActionCommand().equals("ADD_DATASET")) {
            if (this.secondaryDatasetIndex < 19) {
                ...
                this.plot.setSecondaryDataset(
                    this.secondaryDatasetIndex, 
                    createRandomDataset("S" + this.secondaryDatasetIndex)
                );
                this.plot.setSecondaryRenderer(
                    this.secondaryDatasetIndex, new StandardXYItemRenderer()
                );
            }
        }
    ...
    public static void main(String[] args) {
        ...
        SecondaryDatasetDemo1 demo = new SecondaryDatasetDemo1("Secondary Dataset Demo 1");
        demo.pack();
