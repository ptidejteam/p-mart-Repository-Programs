...
(jfreechart-0.9.17-install.pdf) from the JFreeChart home
...
(b)  JCommon - version 0.9.1 or later.  The runtime jar file is
...
(f)  Log4j - a utility library for logging.  The log4j-1.2.8.jar file 
included in the JFreeChart distribution.  Log4j is licensed under the
terms of the Apache Software License:

    http://logging.apache.org/log4j/LICENSE.txt
...
it you need the files jcommon-0.9.2.jar, jfreechart-0.9.17.jar and
jfreechart-0.9.17-demo.jar.
...
Use the following command:
    ...
    java -jar jfreechart-0.9.17-demo.jar
...
java -classpath lib/jcommon-0.9.2.jar:jfreechart-0.9.17.jar:lib/log4j-1.2.8.jar:jfreechart-0.9.17-demo.jar org.jfree.chart.demo.JFreeChartDemo
