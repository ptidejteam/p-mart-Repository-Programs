...
public class GanttDialogCalendar extends JDialog implements ActionListener
{
	...
	public GanttDialogCalendar(JFrame parent)
	{
		...
		/*bWork = new JRadioButton("Working Day", new ImageIcon(getClass().getResource("/icons/working_day_16.gif")), true);
		bNonWork = new JRadioButton("Working Day", new ImageIcon(getClass().getResource("/icons/non_working_day_16.gif")), false);*/
		
		bWork = new JRadioButton("Working Day", true);
		bNonWork = new JRadioButton("Non-Working Day", false);
		
		/*panel3.add(bWork, BorderLayout.WEST);
		panel3.add(bNonWork, BorderLayout.EAST);*/
