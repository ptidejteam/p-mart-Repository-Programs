...
public class GanttURLChooser extends JDialog
{
	...
	/** The constructor*/
	public GanttURLChooser(GanttProject parent, boolean opening, 
			String currentURL, String currentUser, String currentPass)
	{
		super(parent, opening ? (GanttProject.correctLabel(GanttLanguage.getInstance().getText("openFromServer"))) : 
			(GanttProject.correctLabel(GanttLanguage.getInstance().getText("saveToServer"))), true);
