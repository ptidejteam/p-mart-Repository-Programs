 ...
 */
public class CSVSettingsPanel extends GeneralOptionPanel implements ActionListener{
	...
	{
		super(GanttProject.correctLabel(GanttLanguage.getInstance().getText("csvexport")),
				  GanttLanguage.getInstance().getText("settingsCVSExport"),parent);
		appli = parent;
		...
		lblSeparatedField.setFont(new Font(lblSeparatedField.getFont().getFontName(),Font.BOLD,
					lblSeparatedField.getFont().getSize()));
	    ...
	    //addUsingGBL(separatorFieldPanel, new JLabel(language.getText("space")),   gbc, 1, 1, 1, 1);
		...
		lblTaskField.setFont(new Font(lblTaskField.getFont().getFontName(),Font.BOLD,
				lblTaskField.getFont().getSize()));
	    ...
	    lblResField.setFont(new Font(lblResField.getFont().getFontName(),Font.BOLD,
	    		lblResField.getFont().getSize()));
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==bSeparatedText && bSeparatedText.isSelected()){
