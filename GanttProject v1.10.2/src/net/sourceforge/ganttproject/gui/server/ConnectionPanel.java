 ...
 * @author athomas
 *
 * The connection panel for http acces.
 */
public class ConnectionPanel extends GeneralOptionPanel {
	...
	{
		super(GanttProject.correctLabel(GanttLanguage.getInstance().getText("openFromServer")),
				  GanttLanguage.getInstance().getText("settingsConnection"),
				  parent);
		...
		/*passwordPanel.add(tfPassword = new JPasswordField(), BorderLayout.CENTER);
		vb.add(passwordPanel);
		vb.add(new JPanel());*/
