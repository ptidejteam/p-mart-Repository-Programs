...
/**
 * List of Documents MRU
 * (<b>m</b>ost <b>r</b>ecently <b>u</b>sed)
 * 
...
public class DocumentsMRU {
	 ...
	 * If the list is already full, an old entry is removed,
	...
	public boolean add(Document document) {
		...
		if (! document.isValidForMRU()) return false;
	 ...
	 * If the list is already full, the document will <b>not</b>
	 * be appended.
	 * 
	 * @param document the Document that should be added
	 * @return wether the list has changed through the addition
