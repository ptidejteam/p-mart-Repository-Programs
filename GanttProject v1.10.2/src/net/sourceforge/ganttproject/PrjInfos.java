...
/**
 * @author athomas
 * Class to store the project informations
 */
public class PrjInfos {
	...
	/** Constructor. */
	public PrjInfos(String sProjectName,
			        String sDescription,
