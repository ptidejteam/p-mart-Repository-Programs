...
public class SWTUtils {
     ...
     * a font with the same height as the awt one.
    ...
    public static FontData toSwtFontData(Device device, java.awt.Font font, 
        ...
        if (ensureSameHeight) {            
            ...
            if (tmpGC.getFontMetrics().getHeight() 
                    > DUMMY_PANEL.getFontMetrics(font).getHeight()) {
                while (tmpGC.getFontMetrics().getHeight() 
                        > DUMMY_PANEL.getFontMetrics(font).getHeight()) {
                    tmpFont.dispose();
                    height--;
                    fontData.setHeight(height);
            ...
            else if (tmpGC.getFontMetrics().getHeight() 
                    < DUMMY_PANEL.getFontMetrics(font).getHeight()) {
                while (tmpGC.getFontMetrics().getHeight() 
                        < DUMMY_PANEL.getFontMetrics(font).getHeight()) {
                    tmpFont.dispose();
    ...
    public static java.awt.Font toAwtFont(Device device, FontData fontData, 
        ...
        if (ensureSameHeight) {
            ...
            java.awt.Font tmpAwtFont = new java.awt.Font(fontData.getName(), 
                    style, height);
            if (DUMMY_PANEL.getFontMetrics(tmpAwtFont).getHeight() 
                    > tmpGC.getFontMetrics().getHeight()) {
                while (DUMMY_PANEL.getFontMetrics(tmpAwtFont).getHeight() 
                        > tmpGC.getFontMetrics().getHeight()) {
                    height--;                
            ...
            else if (DUMMY_PANEL.getFontMetrics(tmpAwtFont).getHeight() 
                    < tmpGC.getFontMetrics().getHeight()) {
                while (DUMMY_PANEL.getFontMetrics(tmpAwtFont).getHeight() 
                        < tmpGC.getFontMetrics().getHeight()) {
                    height++;
