 ...
 * Contributor(s):   -;
 *
 * $Id: StandardXYItemLabelGenerator.java,v 1.1 2007/10/10 19:39:13 vauchers Exp $
 *
 * Changes
 * -------
...
public class StandardXYItemLabelGenerator extends AbstractXYItemLabelGenerator  
     ...
     * Creates an item label generator using default number formatters.
     * 
     * @param xFormat  the formatter for the x-values.
     */
    public StandardXYItemLabelGenerator(DateFormat xFormat) {
        this(
            DEFAULT_TOOLTIP_FORMAT, DEFAULT_ITEM_LABEL_FORMAT, 
     ...
     */
    public StandardXYItemLabelGenerator(DateFormat dateFormat, NumberFormat numberFormat) {
        this(DEFAULT_TOOLTIP_FORMAT, DEFAULT_ITEM_LABEL_FORMAT, dateFormat, numberFormat);
    }
     ...
     */
    public StandardXYItemLabelGenerator(String toolTipFormat,
                                        String itemLabelFormat,
                                        NumberFormat xFormat, 
                                        NumberFormat yFormat) {
        
        super(toolTipFormat, itemLabelFormat, xFormat, yFormat);
