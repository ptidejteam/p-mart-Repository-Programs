 ...
 * Contributor(s):   -;
 *
 * $Id: DifferenceChartDemo2.java,v 1.1 2007/10/10 19:39:17 vauchers Exp $
 *
 * Changes
 * -------
...
public class DifferenceChartDemo2 extends ApplicationFrame {
     ...
     * @return a value.
     */  
    private Long time(int hour, int min) {
    ...
    private JFreeChart createChart(XYDataset dataset) {
        ...
        Color c = new Color(255, 60, 24, 63);
        Marker bst = new IntervalMarker(
    ...
    public static void main(String[] args) {
        ...
        DifferenceChartDemo2 demo = new DifferenceChartDemo2("Difference Chart Demo 2");
        demo.pack();
