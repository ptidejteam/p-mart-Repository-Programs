 ...
 *
 * $Id: ContourPlotDemo2.java,v 1.1 2007/10/10 19:39:16 vauchers Exp $
 *
 * Changes
 * -------
...
public class ContourPlotDemo2 extends ApplicationFrame {
    ...
    private ContourDataset createDataset() {
        ...
        Double[] oDoubleX = (Double[]) DefaultContourDataset.formObjectArray(this.tmpDoubleX);
        Double[] oDoubleY = (Double[]) DefaultContourDataset.formObjectArray(this.tmpDoubleY);
        Double[] oDoubleZ = (Double[]) DefaultContourDataset.formObjectArray(this.tmpDoubleZ);

        Date[] tmpDateX = new Date[this.tmpDoubleX.length];
        for (int i = 0; i < this.tmpDoubleX.length; i++) {
    ...
    private void initShoreline() {
        double[] yyOutline = {6.93E+00, 6.91E+00, 6.90E+00, 6.88E+00, 6.86E+00,
        ...
        double[] xxOutline = {1.46171E+01, 1.45984E+01, 1.45883E+01, 1.45818E+01,
