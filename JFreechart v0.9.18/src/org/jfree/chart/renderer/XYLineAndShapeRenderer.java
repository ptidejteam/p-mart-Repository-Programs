 ...
 * Contributor(s):   -;
 *
 * $Id: XYLineAndShapeRenderer.java,v 1.1 2007/10/10 19:39:14 vauchers Exp $
 *
 * Changes:
 * --------
...
public class XYLineAndShapeRenderer extends AbstractXYItemRenderer 
     ...
     * <p>
     * The default implementation passes control to the <code>getSeriesLinesVisible</code> method.
    ...
    public boolean getItemLineVisible(int series, int item) {
        return getSeriesLinesVisible(series);
    }
    ...
    /**
     * Sets the 'lines visible' for ALL series.
     *
    ...
    public boolean getItemShapeVisible(int series, int item) {
        return getSeriesShapesVisible(series);
    }
    ...
    public boolean getSeriesShapesVisible(int series) {
        ...
        if (this.shapesVisible != null) {
            return this.shapesVisible.booleanValue();
        }
    ...
    /**
     * Sets the 'shapes visible' for ALL series.
     *
     * @param visible  the flag.
     */
