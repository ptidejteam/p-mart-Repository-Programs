 ...
 *                   
 *
 * $Id: StackedXYBarRenderer.java,v 1.1 2007/10/10 19:39:14 vauchers Exp $
 *
 * Changes
 * -------
 ...
 * {@link org.jfree.data.TableXYDataset}. For example, the
 * dataset class {@link org.jfree.data.CategoryTableXYDataset}
...
public class StackedXYBarRenderer extends XYBarRenderer
{
	 ...
	 * creates a new renderer.
	 * 
	 * @param margin the percentual amount of the bars tha are cut away.
	 */	
		...
		int pass)
	{
		...
		double translatedStartY =
			rangeAxis.valueToJava2D(ph, dataArea, plot.getRangeAxisEdge());

		double translatedEndY =
			rangeAxis.valueToJava2D(
				valueNumber.doubleValue() + ph,
				dataArea,
