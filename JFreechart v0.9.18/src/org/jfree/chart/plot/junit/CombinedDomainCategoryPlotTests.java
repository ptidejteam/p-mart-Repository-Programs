 ...
 * Contributor(s):   -;
 *
 * $Id: CombinedDomainCategoryPlotTests.java,v 1.1 2007/10/10 19:39:32 vauchers Exp $
 *
 * Changes
 * -------
...
public class CombinedDomainCategoryPlotTests extends TestCase {
    ...
    private CombinedDomainCategoryPlot createPlot() {
        ...
        renderer1.setBaseToolTipGenerator(new StandardCategoryItemLabelGenerator());
        ...
        renderer2.setBaseToolTipGenerator(new StandardCategoryItemLabelGenerator());
