 ...
 * Contributor(s):   -;
 *
 * $Id: KeyedObject.java,v 1.1 2007/10/10 19:39:25 vauchers Exp $
 *
 * Changes:
 * --------
...
public class KeyedObject implements Cloneable, PublicCloneable, Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((object instanceof KeyedObject) == false) {
            return false;
        }
        KeyedObject ko = (KeyedObject) object;
        if (ObjectUtils.equal(this.key, ko.key) == false) {
            return false;
        }

        if (ObjectUtils.equal(this.object, ko.object) == false) {
            return false;
        }
