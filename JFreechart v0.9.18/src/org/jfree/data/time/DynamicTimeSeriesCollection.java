 ...
 *
 * $Id: DynamicTimeSeriesCollection.java,v 1.1 2007/10/10 19:39:31 vauchers Exp $
 *
 * Changes
 * -------
...
public class DynamicTimeSeriesCollection extends AbstractSeriesDataset
    ...
    public float getY(int series, int item) {             // Don't synchronize this!!
        ValueSequence values = this.valueHistory[series];      // Instead, synchronize the loop that
