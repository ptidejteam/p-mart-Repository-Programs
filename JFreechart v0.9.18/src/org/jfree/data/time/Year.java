 ...
 * Contributor(s):   -;
 *
 * $Id: Year.java,v 1.1 2007/10/10 19:39:31 vauchers Exp $
 *
 * Changes
 * -------
...
public class Year extends RegularTimePeriod implements Serializable {
    ...
    public long getFirstMillisecond(Calendar calendar) {
        ...
        Day jan1 = new Day(1, SerialDate.JANUARY, this.year);
    ...
    public long getLastMillisecond(Calendar calendar) {
        ...
        Day dec31 = new Day(31, SerialDate.DECEMBER, this.year);
