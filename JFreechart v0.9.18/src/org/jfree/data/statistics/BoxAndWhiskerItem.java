 ...
 * Contributor(s):   -;
 *
 * $Id: BoxAndWhiskerItem.java,v 1.1 2007/10/10 19:39:16 vauchers Exp $
 *
 * Changes
 * -------
...
public class BoxAndWhiskerItem implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BoxAndWhiskerItem) {
            ...
            boolean b0 = ObjectUtils.equal(this.mean, item.mean);
            boolean b1 = ObjectUtils.equal(this.median, item.median);
            boolean b2 = ObjectUtils.equal(this.q1, item.q1);
            boolean b3 = ObjectUtils.equal(this.q3, item.q3);
            boolean b4 = ObjectUtils.equal(this.minRegularValue, item.minRegularValue);
            boolean b5 = ObjectUtils.equal(this.maxRegularValue, item.maxRegularValue);
            boolean b6 = ObjectUtils.equal(this.minOutlier, item.minOutlier);
            boolean b7 = ObjectUtils.equal(this.maxOutlier, item.maxOutlier);
            boolean b8 = ObjectUtils.equal(this.outliers, item.outliers);
