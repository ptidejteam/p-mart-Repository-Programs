 ...
 *
 * $Id: DatasetUtilities.java,v 1.1 2007/10/10 19:39:25 vauchers Exp $
 *
 ...
 * 31-Mar-2004 : Exposed the extent iteration algorithms to use one of them and applied noninstantiation pattern (AS);
 */
...
public final class DatasetUtilities {
    ...
    public static Range getDomainExtent(Dataset data) {
        ...
        // hasn't implemented DomainInfo, so iterate...
        	...
        	return iterateDomainExtent((XYDataset) data);
        }
        else {
