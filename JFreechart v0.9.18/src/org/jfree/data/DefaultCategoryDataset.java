 ...
 * Contributor(s):   -;
 *
 * $Id: DefaultCategoryDataset.java,v 1.1 2007/10/10 19:39:25 vauchers Exp $
 *
 * Changes
 * -------
...
public class DefaultCategoryDataset extends AbstractDataset
    ...
    public boolean equals(Object o) {
        ...
        if ((o instanceof CategoryDataset) == false) {
            return false;
        }

        CategoryDataset cd = (CategoryDataset) o;
        if (getRowKeys().equals(cd.getRowKeys()) == false) {
            return false;
        }

        if (getColumnKeys().equals(cd.getColumnKeys()) == false) {
            return false;
        }
