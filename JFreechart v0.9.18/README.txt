...
(jfreechart-0.9.18-install.pdf) from the JFreeChart home
...
it you need the files jcommon-0.9.3.jar, jfreechart-0.9.18.jar and
jfreechart-0.9.18-demo.jar.
...
Use the following command:
    ...
    java -jar jfreechart-0.9.18-demo.jar
...
java -classpath lib/jcommon-0.9.3.jar:jfreechart-0.9.18.jar:lib/log4j-1.2.8.jar:jfreechart-0.9.18-demo.jar org.jfree.chart.demo.JFreeChartDemo
