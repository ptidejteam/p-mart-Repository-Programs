 ...
 *                   Arnaud Lelievre;
 *
 * $Id: CategoryPlot.java,v 1.1 2007/10/10 19:34:47 vauchers Exp $
 *
...
public class CategoryPlot extends Plot 
    ...
    public void draw(Graphics2D g2, Rectangle2D plotArea, PlotState parentState,
        ...
        if (order == DatasetRenderingOrder.STANDARD) {
            for (int i = 0; i < this.datasets.size(); i++) {
                boolean b = render(g2, dataArea, i, state);
                foundData = foundData || b;
            }
        }
        else {
    ...
    private List getDatasetsMappedToRangeAxis(int index) {
        ...
        for (int i = 0; i < this.datasetToRangeAxisMap.size(); i++) {
