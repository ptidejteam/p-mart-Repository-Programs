 ...
 *                   Eduardo Ramalho;
 *
 * $Id: XYPlot.java,v 1.1 2007/10/10 19:34:47 vauchers Exp $
 *
...
public class XYPlot extends Plot implements ValueAxisPlot,
    ...
    /** 
     * The order of the dataset rendering (STANDARD draws the primary dataset last so that it
    ...
    protected static final LogContext logger = Log.createContext(XYPlot.class);
    ...
    private List getDatasetsMappedToDomainAxis(Integer axisIndex) {
        ...
        for (int i = 0; i < this.domainAxisMap.size(); i++) {
    ...
    private List getDatasetsMappedToRangeAxis(Integer index) {
        List result = new ArrayList();
        for (int i = 0; i < this.rangeAxisMap.size(); i++) {
    ...
    public void zoomHorizontalAxes(double factor) {
        ...
        if (orient == PlotOrientation.HORIZONTAL) {
            for (int i = 0; i < this.rangeAxes.size(); i++) {
                ValueAxis rangeAxis2 = (ValueAxis) this.rangeAxes.get(i);
                if (rangeAxis2 != null) {
            ...
            for (int i = 0; i < this.domainAxes.size(); i++) {
                ValueAxis domainAxis2 = (ValueAxis) this.domainAxes.get(i);
                if (domainAxis2 != null) {
