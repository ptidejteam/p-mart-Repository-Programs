 ...
 *
 * $Id: CategoryStepRenderer.java,v 1.1 2007/10/10 19:34:42 vauchers Exp $
 *
 * Changes
 * -------
...
public class CategoryStepRenderer extends AbstractCategoryItemRenderer
     ...
     *  
     * @param shouldStagger should the horizontal part of the step be staggered by series? 
     */
    public CategoryStepRenderer(boolean shouldStagger) {
        setStagger(shouldStagger);
    }
