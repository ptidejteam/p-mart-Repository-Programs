 ...
 *                   Barak Naveh;
 *
 * $Id: StandardLegend.java,v 1.1 2007/10/10 19:34:49 vauchers Exp $
 *
...
public class StandardLegend extends Legend implements Serializable {
    ...
    protected static final LogContext logger = Log.createContext(StandardLegend.class);
    ...
    private void drawSeriesElements(Graphics2D g2, List items, 
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            g2.setPaint(this.itemPaint);
            g2.setFont(this.itemFont);
            RefineryUtilities.drawAlignedString(item.getItem().getLabel(), g2,
