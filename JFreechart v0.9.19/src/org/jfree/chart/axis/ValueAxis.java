 ...
 *
 * $Id: ValueAxis.java,v 1.1 2007/10/10 19:34:54 vauchers Exp $
 *
...
public abstract class ValueAxis extends Axis implements Cloneable, PublicCloneable, Serializable {
    ...
    public void setRangeWithMargins(Range range, boolean turnOffAutoRange, boolean notify) {
        ...
        this.range = Range.expand(range, getLowerMargin(), getUpperMargin());
        if (notify) {
            notifyListeners(new AxisChangeEvent(this));
        }
    }
     ...
     */
    public abstract double translateValueToJava2D(double value,
            Rectangle2D area,
            RectangleEdge edge);   
