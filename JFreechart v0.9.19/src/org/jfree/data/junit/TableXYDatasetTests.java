 ...
 *
 * $Id: TableXYDatasetTests.java,v 1.1 2007/10/10 19:34:52 vauchers Exp $
 *
 * Changes
 * -------
...
public class TableXYDatasetTests extends TestCase {
    ...
    public void testTableXYDataset() {
        ...
        assertEquals(6, dataset.getXValue(0, 5).intValue());
        assertEquals(null, dataset.getYValue(0, 5));
        assertEquals(6, dataset.getXValue(1, 5).intValue());
        assertEquals(2, dataset.getYValue(1, 5).intValue());

        // after adding a point to a series, check that there are now 7 items in each series
        series2.add(7, 2);
        assertEquals(7, dataset.getItemCount());
        assertEquals(null, dataset.getYValue(0, 6));
        assertEquals(2, dataset.getYValue(1, 6).intValue());
    ...
    public void testRemoveAllValuesForX() {
        ...
        assertEquals(new Double(1.0), dataset.getXValue(0, 0));
        assertEquals(new Double(3.0), dataset.getXValue(0, 1));
        assertEquals(new Double(4.0), dataset.getXValue(0, 2));
        assertEquals(new Double(5.0), dataset.getXValue(0, 3));
        assertEquals(new Double(6.0), dataset.getXValue(0, 4));
    }
