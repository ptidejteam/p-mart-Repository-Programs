 ...
 * Contributor(s):   -;
 *
 * $Id: StatisticsPackageTests.java,v 1.1 2007/10/10 19:34:55 vauchers Exp $
 *
 * Changes
 * -------
...
public class StatisticsPackageTests extends TestCase {
    ...
    public static Test suite() {
        final TestSuite suite = new TestSuite("org.jfree.data.statistics");
     ...
     */
    public StatisticsPackageTests(final String name) {
        super(name);
    }
