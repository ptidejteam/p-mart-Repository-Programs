 ...
 * Contributor(s):   -;
 *
 * $Id: DataTimePackageTests.java,v 1.1 2007/10/10 19:34:48 vauchers Exp $
 *
 * Changes
 * -------
...
/**
 * Some tests for the <code>org.jfree.data.timr</code> package that can be run using JUnit.
...
public class DataTimePackageTests extends TestCase {
    ...
    public static Test suite() {
        final TestSuite suite = new TestSuite("org.jfree.data.time");
