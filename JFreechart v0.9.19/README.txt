...
(jfreechart-0.9.19-install.pdf) from the JFreeChart home
...
it you need the files jcommon-0.9.4.jar, jfreechart-0.9.19.jar and
jfreechart-0.9.19-demo.jar.
...
Use the following command:
    ...
    java -jar jfreechart-0.9.19-demo.jar
...
java -classpath lib/jcommon-0.9.4.jar:jfreechart-0.9.19.jar:jfreechart-0.9.19-demo.jar org.jfree.chart.demo.JFreeChartDemo
