 ...
 *
 * $Id: RollingMethods.java,v 1.1 2006/02/21 01:10:50 vauchers Exp $
 */
...
public final class RollingMethods
{
	...
	private static int roll(int times, int sides, int modifier, int keepCount, int reroll)
	{
		...
		if (Logging.isDebugMode())
		{
			...
			Logging.debugPrint("rolls: ", rollString.toString());
		}
		...
		if (Logging.isDebugMode())
		{
			Logging.debugPrint("total: ", total);
		}
	 ...
	 * @see pcgen.util.DiceExpressionFunctions
	 *
