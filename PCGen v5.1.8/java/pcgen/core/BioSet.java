...
public final class BioSet
{
	...
	private static Map ageMap = new HashMap();
	...
	private static String mapFind(Map m, final String argRegionName, final String argRaceName, final String addKey, final String altRaceName)
	{
		//
	...
	private static String getValueInMaps(String argRegionName, String argRaceName, String addKey)
	{
