/*
 * EqBuilder.java
 * @(#) $Id: EqBuilder.java,v 1.1 2006/02/21 01:10:53 vauchers Exp $
 *
...
final class EqBuilder extends JPanel
{
	...
	private void jButtonSpellActionPerformed(EquipmentModifier eqMod, String extraInfo)
	{
		...
		ChooseSpellDialog csd = new ChooseSpellDialog((JFrame) Utility.getParentNamed(getParent(), "pcgen.gui.EQFrame"), eqType, metaAllowed, classList, levelList, spellBooks);
		csd.show();
	...
	**/
	...
	private boolean setEquipment(Equipment aEq, boolean bReloading)
	{
		...
		{
			Logging.debugPrint("No base equipment found: " + aEq.getName() + ", aborting EqBuilder:" + sBaseKey);
			return false;
		}
	...
	private final class EquipmentModModel extends AbstractTableModel
	{
		...
		public int getColumnCount()
		{
			switch (tableType)
			{
				...
				default:
					Logging.debugPrint("In EqBuilder.getColumnCount the table type " + tableType + " is not handled.");
					break;
			}
			return 0;
		}
		...
		public String getColumnName(int column)
		{
			switch (tableType)
			{
				...
				default:
					Logging.debugPrint("In EqBuilder.getColumnName the table type " + tableType + " is not handled.");
					break;
			}
			return null;
		}
		...
		public Class getColumnClass(int column)
		{
			switch (tableType)
			{
				...
				default:
					Logging.debugPrint("In EqBuilder.getColumnClass the table type " + tableType + " is not handled.");
					break;
			}
			return null;
		}
		...
		private void setFilter(List aFilter, int listCount)
		{
