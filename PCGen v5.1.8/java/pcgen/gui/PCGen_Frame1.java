 ...
 * Last Edited: $Date: 2006/02/21 01:10:53 $
 *
 */
...
import pcgen.gui.utils.InfoPreview;
...
//		CustomData.writeCustomFiles();
	...
	final class MenuItems extends JMenuBar
	{
		...
		public MenuItems()
		{
			...
			Logging.debugPrint(FOPResourceChecker.getMissingResourceMessage());
	...
	static final class PopupListener extends MouseAdapter
	{
		...
		public void mousePressed(MouseEvent e)
		{
			...
			if (index < FIRST_CHAR_TAB)
			{
				// Only display the context menu if you can do something with it
				if (Globals.displayListsHappy())
				{
