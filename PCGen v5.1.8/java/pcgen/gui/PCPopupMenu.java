...
final class PCPopupMenu extends JPopupMenu
{
	...
	public PCPopupMenu(FrameActionListener frameActionListener)
	{
		...
		shiftBeginningItem = Utility.createMenuItem("Shift beginning", frameActionListener.shiftRightPopupActionListener, "pcPopupMenu.shift.beginning", 'B', null, "Shift PC tab left all the way", "BBack16.gif", true);
		shiftEndItem = Utility.createMenuItem("Shift end", frameActionListener.shiftLeftPopupActionListener, "pcPopupMenu.shift.end", 'E', null, "Shift PC tab right all the way", "FForward16.gif", true);
	}
	...
	public void setRevertToSavedItem(JMenuItem revertToSavedItem)
	{
		this.revertToSavedItem = revertToSavedItem;
	}
}
