 ...
 *
 * @(#) $Id: ClassBasePanel.java,v 1.1 2006/02/21 01:10:59 vauchers Exp $
 */
...
class ClassBasePanel extends BasePanel
{
	...
	private void initComponents()
	{
		...
		add(visible, gridBagConstraints);
		...
		gridBagConstraints.gridwidth = 5;
		add(specials, gridBagConstraints);
	...
	public void updateView(PObject thisPObject)
	{
		...
		specials.setText(obj.specialsString());
		...
		visible.setSelected(obj.isVisible());
	}
	...
	public void updateData(PObject thisPObject)
	{
		...
		obj.setSpecialsString(specials.getText().trim());
		...
		obj.setVisible(visible.getSelectedObjects() != null);
