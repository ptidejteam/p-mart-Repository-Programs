 ...
 *
 * @(#) $Id: ClassAbilityPanel.java,v 1.1 2006/02/21 01:10:59 vauchers Exp $
 */
...
public class ClassAbilityPanel extends JPanel implements PObjectUpdater
{
	...
	private JComboBox spellStat = new JComboBox();
	private JComboBox spellType = new JComboBox();
	...
	private void initComponentContents()
	{
		...
		// Make list of stats
		//
		for (e = Globals.getStatList().iterator(); e.hasNext();)
		{
