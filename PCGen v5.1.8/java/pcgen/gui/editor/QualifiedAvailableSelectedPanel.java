 ...
 *
 * @(#) $Id: QualifiedAvailableSelectedPanel.java,v 1.1 2006/02/21 01:10:59 vauchers Exp $
 */
...
final class QualifiedAvailableSelectedPanel extends AvailableSelectedPanel
{
	...
	private JComboBox cmbQualifier = new JComboBox();
	...
	final void setQualifierModel(final DefaultComboBoxModel model)
	{
		cmbQualifier.setModel(model);
	}

	final int getQualifierItemCount()
	{
		return cmbQualifier.getItemCount();
	}

	final Object getQualifierItemAt(final int idx)
	{
		return cmbQualifier.getItemAt(idx);
	}

	final int getQualifierSelectedIndex()
	{
		return cmbQualifier.getSelectedIndex();
	}

	final void setQualifierSelectedIndex(final int idx)
	{
		cmbQualifier.setSelectedIndex(idx);
	}

	final Object getQualifierSelectedItem()
	{
	...
	final void setVariableModel(final DefaultComboBoxModel model)
	{
		if (cmbVariable != null)
		{
	...
	final int getVariableSelectedIndex()
	{
		if (cmbVariable != null)
		{
	...
	final Object getVariableSelectedItem()
	{
		if (cmbVariable != null)
		{
	...
	final void setVariableSelectedIndex(final int idx)
	{
		if (cmbVariable != null)
		{
	...
	final void setVariableEnabled(final boolean isEnabled)
	{
		if (cmbVariable != null)
		{
