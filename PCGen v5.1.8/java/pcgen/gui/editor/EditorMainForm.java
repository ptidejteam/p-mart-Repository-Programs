 ...
 *
 * @(#) $Id: EditorMainForm.java,v 1.1 2006/02/21 01:10:59 vauchers Exp $
...
//				thisPObject.addVariable("-9|" + aString.substring(7));
			...
			{
				Logging.errorPrint("Unknown advanced setting: " + aString);
			}
		}
...
*/
	...
	private static boolean parseSynergyBonus(final String aString, List availableList, List selectedList)
	{
