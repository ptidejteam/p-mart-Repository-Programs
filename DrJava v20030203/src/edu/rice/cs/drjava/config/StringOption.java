 ...
 * @version $Id: StringOption.java,v 1.1 2005/04/27 20:30:32 elmoutam Exp $
 */
...
{  
  ...
  // format() is defined here to avoid the unnecessary 
  // call to toString() in the default format() method.
