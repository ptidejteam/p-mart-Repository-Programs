...
public class Password
{
    ...
    public static String askPassword(JComponent aApp)
    {
        ...
        if(lUserResponseObj instanceof Integer)
        {
            ...
            {
                case JOptionPane.OK_OPTION: return new String(lPwd.password.getPassword());
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$()
    {
        ...
        mainPanel.add(password, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(250, -1), null));
    }
}