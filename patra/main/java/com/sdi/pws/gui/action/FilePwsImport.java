...
import com.sdi.pws.codec.AutoCodec;
...
public class FilePwsImport
extends FileImport
{
    private static final Codec codec = new AutoCodec();
    ...
    {
        return GuiUtil.browseForSafe(application, prefs);
    }

    protected String askPassphrase()
    {
       return Password.askPassword(application);
    }

    public FilePwsImport(JComponent aAppFrame, DatabaseHolder aHolder, Preferences aPrefs)
    {
        super(GuiUtil.getText("action.filepwsimport"));
