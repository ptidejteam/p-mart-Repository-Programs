...
{   
    ...
    public FileXmlImport(JComponent aAppFrame, DatabaseHolder aHolder, Preferences aPrefs)
    {
        super(GuiUtil.getText("action.filexmlimport"));
