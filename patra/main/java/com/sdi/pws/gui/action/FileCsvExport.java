...
public class FileCsvExport
extends FileExport
{
    private static final Codec codec = new CsvCodec();

    public FileCsvExport(JComponent aAppFrame, DatabaseHolder aHolder, Preferences aPrefs)
    {
        super(GuiUtil.getText("action.filecsvexport"));
