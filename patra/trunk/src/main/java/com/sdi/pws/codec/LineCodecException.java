...
public class LineCodecException
extends FileCodecException
{
    private String lineNumber;

    public LineCodecException(String aMsg, String aFileName, String aLineNumber)
    {
        super(aMsg, aFileName);
        lineNumber = aLineNumber;
    }

    public LineCodecException(String aMsg, String aFileName, String aLineNumber, Throwable aCause)
    {
    ...
    public String getFormattedMessage()
    {
        ...
        return MessageFormat.format(lMsg, new Object[]{this.getFileName(), this.getLineNumber()});
    }
}
