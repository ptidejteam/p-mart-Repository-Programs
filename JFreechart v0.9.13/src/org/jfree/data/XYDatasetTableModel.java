 ...
 * ------------------------
 * (C)opyright 2003, by Bryan Scott and Contributors.
 *
 ...
 * <P>
 * TO DO:
 * <ul><li>implement proper naming for x axis (getColumnName)</li>
 * <li>implement setValueAt to remove READ-ONLY constraint (not sure how)</li></ul>
 *
 * @author           Bryan Scott
 */
