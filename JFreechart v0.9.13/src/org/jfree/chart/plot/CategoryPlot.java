 ...
 *                   Arnaud Lelievre;
 *
 * $Id: CategoryPlot.java,v 1.1 2007/10/10 19:15:33 vauchers Exp $
 *
...
public class CategoryPlot extends Plot 
    ...
    protected void drawAxes(Graphics2D g2, Rectangle2D plotArea, Rectangle2D dataArea) {
        ...
        // make sure the lists used to sort the axes by location start empty...
        ...
        // we are finished with the temporary storage, leave each list empty...
        this.axesAtTop.clear();
        this.axesAtBottom.clear();
        this.axesAtLeft.clear();
        this.axesAtRight.clear();
