 ...
 *
 * $Id: ValueAxis.java,v 1.1 2007/10/10 19:15:30 vauchers Exp $
 *
...
public abstract class ValueAxis extends Axis implements Cloneable, PublicCloneable, Serializable {
    ...
    public static final double DEFAULT_AUTO_RANGE_MINIMUM_SIZE = Double.MIN_VALUE * 10.0;
    ...
    /**
     * Sets the paint used to draw the axis line.  An {@link AxisChangeEvent} is sent to all 
