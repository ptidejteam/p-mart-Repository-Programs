 ...
 * Contributor(s):   -;
 *
 * $Id: CategoryAxisTests.java,v 1.1 2007/10/10 19:15:36 vauchers Exp $
 *
 * Changes
 * -------
...
public class CategoryAxisTests extends TestCase {
    ...
    public void testEquals() {
        ...
        a1.setVerticalCategoryLabels(true);
        assertFalse(a1.equals(a2));
        a2.setVerticalCategoryLabels(true);
        assertTrue(a1.equals(a2));
        
        // private boolean skipCategoryLabelsToFit;
        a1.setSkipCategoryLabelsToFit(true);
        assertFalse(a1.equals(a2));
        a2.setSkipCategoryLabelsToFit(true);
        assertTrue(a1.equals(a2));
