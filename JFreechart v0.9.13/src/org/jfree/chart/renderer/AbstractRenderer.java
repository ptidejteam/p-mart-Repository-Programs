 ...
 *
 * $Id: AbstractRenderer.java,v 1.1 2007/10/10 19:15:26 vauchers Exp $
 *
 * Changes:
 * --------
...
public abstract class AbstractRenderer implements Cloneable, Serializable {
    ...
    /** A temporary reference to plot rendering info (may be <code>null</code>). */
    private transient PlotRenderingInfo info;
     ...
     *
     * @return The plot rendering info.
     */
    ...
    /**
     * Sets the plot rendering info.
     *
     * @param info  the plot rendering info.
     */
    public void setInfo(PlotRenderingInfo info) {
        this.info = info;
    }
    ...
    public Stroke getSeriesOutlineStroke(int series) {
        ...
        Stroke stroke = (Stroke) this.outlineStrokeList.getStroke(series);
        if (stroke == null) {
            DrawingSupplier supplier = getDrawingSupplier();
            if (supplier != null) {
                stroke = supplier.getNextStroke();
