...
(jfreechart-0.9.13-install.pdf) from the JFreeChart home
...
(b)  JCommon - version 0.8.8 or later.  The runtime jar file is
...
it you need the files jcommon-0.8.8.jar, jfreechart-0.9.13.jar and
jfreechart-0.9.13-demo.jar.
...
Use the following command:
    ...
    java -jar jfreechart-0.9.13-demo.jar
...
java -classpath lib/jcommon-0.8.8.jar:jfreechart-0.9.13.jar:jfreechart-0.9.13-demo.jar org.jfree.chart.demo.JFreeChartDemo
