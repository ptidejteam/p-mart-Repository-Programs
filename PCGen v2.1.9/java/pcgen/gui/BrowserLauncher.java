 ...
 *
 * <br>Jonas Karlsson removed support for MRJ < 3.0, added pcgen-specific support for setting browser path.
 *
 * @author Eric Albert (<a href="mailto:ejalbert@cs.stanford.edu">ejalbert@cs.stanford.edu</a>)
 * @author Jonas Karlsson (<a href="mailto:pjak@yahoo.com</a>)
 * @version 1.2.1 (Released July 28, 1999)
 */
public class BrowserLauncher
{
	...
	/** JVM constant for MRJ 3.0 or later */
	private static final int MRJ_3_0 = 1;
	...
	static
	{
		...
		if ("Mac OS".equals(osName))
		{
			...
			try
			{
				...
				if (version >= 3.0)
				{
					// For the time being, assume that all post-3.0 versions of MRJ work the same
					jvm = MRJ_3_0;
				}
				else
				{
