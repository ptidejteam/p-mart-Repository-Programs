 ...
 *                   Thierry Saura;
 *
 * $Id: StackedVerticalBarRenderer.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
 * Changes
 * -------
            ...
            if (hasLinkingLines()) {
                ...
                if (categoryIndex==0) {
                    ...
                    if (positiveValue) {
                        ...
                        if (lastX>0.0) {
                            Line2D line = new Line2D.Double(rectX, barY,
                                lastX,
                        ...
                        double lastX = pointsRegister[position-2*data.getSeriesCount()];
                        if (lastX>0.0) {
                            Line2D line = new Line2D.Double(rectX, barY+barHeight,
                                lastX,
                                pointsRegister[position-2*data.getSeriesCount()+1]);
                            g2.setPaint(Color.black);
                            g2.draw(line);
