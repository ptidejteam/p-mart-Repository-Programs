 ...
 * Contributor(s):   -;
 *
 * $Id: HorizontalAxis.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
...
/**
 * An interface that must be supported by all horizontal axes for layout
 * purposes.
 */
public interface HorizontalAxis {
	 ...
	 * @param g2    The graphics device.
	 * @param plot      The plot that the axis belongs to.
	 * @param drawArea      The area within which the plot (including axes)
	 *      should be drawn.
