 ...
 *
 * $Id: OverlaidXYPlot.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
 * Changes:
 * --------
...
public class OverlaidXYPlot extends XYPlot {
	...
	/**
	 * Sets the first series index.  This is used to give all series in the
	 * plot (including subplots) a unique number for identification purposes.
	 * Need to find a more robust method.
	 *
