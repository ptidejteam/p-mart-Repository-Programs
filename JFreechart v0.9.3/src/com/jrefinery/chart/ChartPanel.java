 ...
 *                   Andreas Schneider;
 *
 * $Id: ChartPanel.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
...
public class ChartPanel extends JPanel implements ChartPanelConstants,
    ...
    public void setChart(JFreeChart chart) {
        ...
        this.horizontalZoom =
            this.horizontalZoom && (plot instanceof HorizontalValuePlot);
        this.verticalZoom =
            this.verticalZoom && (plot instanceof VerticalValuePlot);
        repaint();
    ...
    public String getToolTipText(MouseEvent e) {
        ...
        if (this.info.isGenerateToolTips()) {
            ...
            if (entities!=null) {
                ...
                ChartEntity entity =
                    entities.getEntity((int)((e.getX()-insets.left)/scaleX),
    ...
    /**
     * Handles a 'mouse entered' event.  This method does nothing, but is
     * required for implementation of the MouseListener interface.
     *
    ...
    /**
     * Handles a 'mouse exited' event.  This method does nothing, but is
     * required for implementation of the MouseListener interface.
     *
     * @param e  The mouse event.
     */
    ...
    public void mouseDragged(MouseEvent e) {
        ...
        if (this.horizontalZoom && this.verticalZoom) {
            ...
            zoomRectangle =
                new Rectangle2D.Double(zoomPoint.getX(), zoomPoint.getY(),
                    xmax - zoomPoint.getX(), ymax - zoomPoint.getY());
        }
          else if (this.horizontalZoom) {
            double xmax = Math.min(e.getX(), scaledDataArea.getMaxX());
            zoomRectangle =
                new Rectangle2D.Double(zoomPoint.getX(), scaledDataArea.getMinY(),
                    xmax - zoomPoint.getX(), scaledDataArea.getHeight());
        }
          else if (this.verticalZoom) {
            double ymax = Math.min(e.getY(), scaledDataArea.getMaxY());
            zoomRectangle =
                new Rectangle2D.Double(scaledDataArea.getMinX(), zoomPoint.getY(),
    ...
    /**
     * Increases the range on the vertical axis, centered about a Java2D
     * y coordinate.
     * <P>
    ...
    private void drawVerticalAxisTrace(int y) {
        ...
        if (((int)dataArea.getMinY()<y) && (y<(int)dataArea.getMaxY())) {
            ...
            if (horizontalTraceLine!=null) {
                ...
                horizontalTraceLine =
                    new Line2D.Float((int)dataArea.getMinX(), y,
                        (int)dataArea.getMaxX(), y);
            }
            g2.draw(horizontalTraceLine);
        }
    ...
    public void doSaveAs() throws IOException {
        ...
        ExtensionFileFilter filter =
            new ExtensionFileFilter("PNG Image Files", ".png");
        ...
        boolean print, boolean zoom)
    {
        ...
        if (zoom) {
            ...
            zoomInBothAxesMenuItem
                .setActionCommand(ZOOM_IN_BOTH_ACTION_COMMAND);
            ...
            zoomInHorizontalMenuItem
                .setActionCommand(ZOOM_IN_HORIZONTAL_ACTION_COMMAND);
            ...
            zoomInVerticalMenuItem
                .setActionCommand(ZOOM_IN_VERTICAL_ACTION_COMMAND);
            ...
            zoomOutHorizontalMenuItem
                .setActionCommand(ZOOM_OUT_HORIZONTAL_ACTION_COMMAND);
            ...
            zoomOutVerticalMenuItem
                .setActionCommand(ZOOM_OUT_VERTICAL_ACTION_COMMAND);
            ...
            autoRangeBothMenuItem
                .setActionCommand(AUTO_RANGE_BOTH_ACTION_COMMAND);
            ...
            autoRangeHorizontalMenuItem
                .setActionCommand(AUTO_RANGE_HORIZONTAL_ACTION_COMMAND);
            ...
            autoRangeVerticalMenuItem
                .setActionCommand(AUTO_RANGE_VERTICAL_ACTION_COMMAND);
