 ...
 *                   Richard Atkinson;
 *
 * $Id: VerticalNumberAxis3D.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
 * Changes
 * -------
...
public class VerticalNumberAxis3D extends VerticalNumberAxis {
	 ...
	 * @param crosshairValue The value at which to draw an optional
	 *      crosshair (null permitted).
	...
	public void draw(Graphics2D g2, Rectangle2D drawArea, Rectangle2D dataArea){
		...
		while (iterator.hasNext()) {
			...
			float yy = (float)this
				.translateValueToJava2D(tick.getNumericalValue(), dataArea);
