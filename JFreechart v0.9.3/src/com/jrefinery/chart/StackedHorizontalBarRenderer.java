 ...
 *
 * $Id: StackedHorizontalBarRenderer.java,v 1.1 2007/10/10 19:52:15 vauchers Exp $
 *
 * Changes
 * -------
...
/**
 * A renderer that handles the drawing of "stacked" bars for a horizontal bar
 * plot.
 */
		...
		Object previousCategory)
	{
		...
		if (value!=null) {
			...
			if (data.getCategoryCount()>1) {
				...
				rectY = rectY
					+ (categoryIndex*categoryGapSpan
						/ (data.getCategoryCount()-1));
			}
