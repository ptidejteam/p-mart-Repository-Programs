 ...
 * Contributor(s):   -;
 *
 * $Id: MinMaxCategoryRenderer.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
 * Changes:
 * --------
...
public class MinMaxCategoryRenderer extends AbstractCategoryItemRenderer {
    ...
    protected Icon minIcon = getIcon(new Arc2D.Double(-4, -4,
            8, 8, 0, 360, Arc2D.OPEN), null, Color.black);

    /** The icon used to indicate the maximum value.*/
    protected Icon maxIcon = getIcon(new Arc2D.Double(-4, -4,
            8, 8, 0, 360, Arc2D.OPEN), null, Color.black);

    /** The icon used to indicate the values.*/
    protected Icon objectIcon = getIcon(new Line2D.Double(-4,
            0, 4, 0), false, true);
    ...
    public void drawCategoryItem (Graphics2D g2, Rectangle2D dataArea, CategoryPlot plot,
            ValueAxis axis, CategoryDataset data, int series, Object category,
            ...
            if (this.plotLines) {
                if (previousCategory != null) {
                    ...
                    if (previousValue != null) {
                        ...
                        double x0 = plot.getCategoryCoordinate(categoryIndex
                                - 1, dataArea);
            ...
            if (this.info != null) {
                ...
                if (entities != null && shape != null) {
                    ...
                    if (this.toolTipGenerator != null) {
                        tip = this.toolTipGenerator.generateToolTip(data, series,
                                category);
                    }
                    CategoryItemEntity entity = new CategoryItemEntity(shape,
                            tip, series, category, categoryIndex);
    ...
    public void drawRangeMarker (Graphics2D g2, CategoryPlot plot, ValueAxis axis,
        ...
        Line2D line = new Line2D.Double(axisDataArea.getMinX(), y, axisDataArea.getMaxX(),
                y);
