 ...
 *
 * $Id: DateAxis.java,v 1.1 2007/10/10 19:52:15 vauchers Exp $
 *
...
public abstract class DateAxis extends ValueAxis {
     ...
     * the ValueAxis superclass, as this form is maintained for convenience
     * only).
     */
     ...
     * @param tickLabelFormatter Formmater to use for date formatting.
    ...
    protected DateAxis(String label,
        ...
        this.range = range;
        if (this.autoRangeMinimumSize.longValue()<=0) {
            this.autoRangeMinimumSize = new Long(4);
        }
    ...
    public Date calculateLowestVisibleTickValue(DateUnit unit) {
        ...
        return this.nextStandardDate(getMinimumDate(), unit.getField(),
            unit.getCount());
    ...
    public Date calculateHighestVisibleTickValue(DateUnit unit) {
        ...
        return this.previousStandardDate(getMaximumDate(), unit.getField(),
            unit.getCount());

    }

    /**
     * Returns the previous "standard" date (based on the specified field and
     * units).
     *
     * @param date      the reference date.
     * @param field     a DateUnit field.
    ...
    /**
     * Returns the index of the largest tick unit that will fit within the axis
     * range.
     *
     * @return the index of the largest tick unit that will fit within the axis
     *      range.
     */
    protected int findAxisMagnitudeIndex() {

        long axisMagnitude =
            this.getMaximumDate().getTime()-this.getMinimumDate().getTime();
        int index = 0;
    ...
    /**
     * The approximate magnitude of each of the standard tick units.  This
     * array is used to find an index into the standardTickUnits array.
     */
    ...
    /**
     * An array of Calendar fields that will be used for automatic tick
     * generation.
     */
    ...
    /**
     * An array of strings, corresponding to the tickValues array, and used to
     * create a DateFormat object for displaying tick values.
     */
