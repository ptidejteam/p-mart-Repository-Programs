 ...
 *                   Andreas Schneider;
 *
 * $Id: Plot.java,v 1.1 2007/10/10 19:52:15 vauchers Exp $
 *
...
/**
 * The base class for all plots in JFreeChart.  The JFreeChart class delegates
 * the drawing of axes and data to the plot.  This base class provides
...
public abstract class Plot implements AxisChangeListener, DatasetChangeListener, AxisConstants {
    ...
    /**
     * The index of the first series.  This defaults to zero... when you combine
     * plots you might want to set this to a higher index to ensure that series
        ...
        float foregroundAlpha)
    {
        ...
        this.seriesPaint = new Paint[] {Color.red, Color.blue, Color.green,
            Color.yellow, Color.orange, Color.magenta, Color.cyan, Color.pink,
            Color.lightGray};
    ...
    /**
     * Sets the index of the first series.  For a single plot, this defaults to
     * zero, but when you combine plots this will be set to a higher value to
     * ensure that all series have a unique index (and therefore color).
     *
     ...
     * @return Paint used to outline any shapes for the specified series.
     */
     ...
     * @param info  An object for collecting information about the drawing of
     *      the chart.
     */
    ...
    /**
     * Performs a zoom on the plot.  Subclasses will implement a behaviour that
     * is appropriate to the type of plot.
     *
