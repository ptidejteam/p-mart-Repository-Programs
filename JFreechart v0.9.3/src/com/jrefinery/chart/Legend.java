 ...
 *                   Jim Moore;
 *
 * $Id: Legend.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
...
public abstract class Legend {
	...
	/** A reference to the chart that the legend belongs to (used for access to
	 *  the dataset).
	 */
	...
	/**
	 * Sets the flag that controls whether or not outlines are drawn around key
	 * boxes.
	 *
	 * @param flag The flag.
	 */
	 ...
	 * @param available     The area within which the legend (and plot) should
	 *      be drawn.
	 *
	...
	protected void notifyListeners(LegendChangeEvent event) {
		...
		while (iterator.hasNext()) {
			LegendChangeListener listener =
				(LegendChangeListener)iterator.next();
