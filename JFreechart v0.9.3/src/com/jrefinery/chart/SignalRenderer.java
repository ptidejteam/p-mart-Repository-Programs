 ...
 *                   Richard Atkinson;
 *
 * $Id: SignalRenderer.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
 * Changes
 * -------
	...
	implements XYItemRenderer
{
		...
		CrosshairInfo crosshairInfo)
	{
		...
		double xx = horizontalAxis
			.translateValueToJava2D(x.doubleValue(), dataArea);
		double yy = verticalAxis
			.translateValueToJava2D(y.doubleValue(), dataArea);
			...
			|| (type==SignalsDataset.ENTER_SHORT))
		{
			...
			path.lineTo((float)(xx+shapeWidth/2),
				(float)(yy-direction*shapeHeight/3));
			path.lineTo((float)(xx+shapeWidth/6),
				(float)(yy-direction*shapeHeight/3));
			path.lineTo((float)(xx+shapeWidth/6),
				(float)(yy-direction*shapeHeight));
			path.lineTo((float)(xx-shapeWidth/6),
				(float)(yy-direction*shapeHeight));
			path.lineTo((float)(xx-shapeWidth/6),
				(float)(yy-direction*shapeHeight/3));
