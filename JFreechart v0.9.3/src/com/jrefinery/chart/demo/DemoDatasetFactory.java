 ...
 *
 * $Id: DemoDatasetFactory.java,v 1.1 2007/10/10 19:52:20 vauchers Exp $
 *
 * Changes
 * -------
...
public class DemoDatasetFactory {
  ...
  public static IntervalCategoryDataset createSampleGantDataset() {
    ...
    s1.add(task1,  new TimeAllocation(createDate( 1,  Calendar.APRIL,    2001), createDate(5,  Calendar.APRIL,     2001)));
    s1.add(task2,  new TimeAllocation(createDate( 9,  Calendar.APRIL,    2001), createDate(9,  Calendar.APRIL,     2001)));
    s1.add(task3,  new TimeAllocation(createDate(10,  Calendar.APRIL,    2001), createDate(5,  Calendar.MAY,       2001)));
    s1.add(task4,  new TimeAllocation(createDate( 6,  Calendar.MAY,      2001), createDate(30, Calendar.MAY,       2001)));
    s1.add(task5,  new TimeAllocation(createDate( 2,  Calendar.JUNE,     2001), createDate(2,  Calendar.JUNE,      2001)));
    s1.add(task6,  new TimeAllocation(createDate( 3,  Calendar.JUNE,     2001), createDate(31, Calendar.JULY,      2001)));
    s1.add(task7,  new TimeAllocation(createDate( 1,  Calendar.AUGUST,   2001), createDate(8,  Calendar.AUGUST,    2001)));
    s1.add(task8,  new TimeAllocation(createDate(10,  Calendar.AUGUST,   2001), createDate(10, Calendar.AUGUST,    2001)));
    s1.add(task9,  new TimeAllocation(createDate(12,  Calendar.AUGUST,   2001), createDate(12, Calendar.SEPTEMBER, 2001)));
    s1.add(task10, new TimeAllocation(createDate(13, Calendar.SEPTEMBER, 2001), createDate(31, Calendar.OCTOBER,   2001)));
    s1.add(task11, new TimeAllocation(createDate(1,  Calendar.NOVEMBER,  2001), createDate(15, Calendar.NOVEMBER,  2001)));
    s1.add(task12, new TimeAllocation(createDate(28, Calendar.NOVEMBER,  2001), createDate(30, Calendar.NOVEMBER,  2001)));

    GanttSeries s2 = new GanttSeries("Actual");
    s2.add(task1,  new TimeAllocation(createDate( 1, Calendar.APRIL,     2001), createDate( 5, Calendar.APRIL,     2001)));
    s2.add(task2,  new TimeAllocation(createDate( 9, Calendar.APRIL,     2001), createDate( 9, Calendar.APRIL,     2001)));
    s2.add(task3,  new TimeAllocation(createDate(10, Calendar.APRIL,     2001), createDate(15, Calendar.MAY,       2001)));
    s2.add(task4,  new TimeAllocation(createDate(15, Calendar.MAY,       2001), createDate(17, Calendar.JUNE,      2001)));
    s2.add(task5,  new TimeAllocation(createDate(30, Calendar.JUNE,      2001), createDate(30, Calendar.JUNE,      2001)));
    s2.add(task6,  new TimeAllocation(createDate( 1, Calendar.JULY,      2001), createDate(12, Calendar.SEPTEMBER, 2001)));
    s2.add(task7,  new TimeAllocation(createDate(12, Calendar.SEPTEMBER, 2001), createDate(22, Calendar.SEPTEMBER, 2001)));
    s2.add(task8,  new TimeAllocation(createDate(25, Calendar.SEPTEMBER, 2001), createDate(27, Calendar.SEPTEMBER, 2001)));
    s2.add(task9,  new TimeAllocation(createDate(27, Calendar.SEPTEMBER, 2001), createDate(30, Calendar.OCTOBER,   2001)));
    s2.add(task10, new TimeAllocation(createDate(31, Calendar.OCTOBER,   2001), createDate(17, Calendar.NOVEMBER,  2001)));
    s2.add(task11, new TimeAllocation(createDate(18, Calendar.NOVEMBER,  2001), createDate( 5, Calendar.DECEMBER,  2001)));
    s2.add(task12, new TimeAllocation(createDate(10, Calendar.DECEMBER,  2001), createDate(11, Calendar.DECEMBER,  2001)));
