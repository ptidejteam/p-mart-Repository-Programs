 ...
 *                   Bryan Scott;
 *
 * $Id: JFreeChartDemoBase.java,v 1.1 2007/10/10 19:52:20 vauchers Exp $
 *
 * Changes
 * --------------------------
 ...
 *
 * If you would like to add a chart to the swing and/or servlet demo
 * do so here.
 */
...
public class JFreeChartDemoBase {
  ...
  public final static String baseResourceClass = "com.jrefinery.chart.demo.resources.DemoResources";
  ...
  public JFreeChart createHighLowChart() {
    ...
    public JFreeChart createGanttChart() {
      ...
      IntervalCategoryDataset data = DemoDatasetFactory.createSampleGantDataset();

      JFreeChart chart = ChartFactory.createGanttChart(title, domain, range,
          data, true);
