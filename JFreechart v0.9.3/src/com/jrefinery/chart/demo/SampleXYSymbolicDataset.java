	...
	implements XYDataset, XisSymbolic, YisSymbolic
{
	 ...
	 * @param seriesName
	 */
	public SampleXYSymbolicDataset(String datasetName, Integer[][] xValues,
		Integer[][] yValues, String[] xSymbolicValues, String[] ySymbolicValues,
		String[] seriesName)
	{
	 ...
	 */
	public static String[] combineYSymbolicDataset(YisSymbolic dataset1,
	 ...
	 */
	public static String[] combineXSymbolicDataset(XisSymbolic dataset1,
