 ...
 * Contributor(s):   -;
 *
 * $Id: StatisticalBarChartDemo.java,v 1.1 2007/10/10 19:52:20 vauchers Exp $
 *
 * Changes
 * -------
...
public class StatisticalBarChartDemo {
  ...
  public StatisticalBarChartDemo() {
       ...
       DefaultStatisticalCategoryDataset dataset = new DefaultStatisticalCategoryDataset(mean, stdDev);
