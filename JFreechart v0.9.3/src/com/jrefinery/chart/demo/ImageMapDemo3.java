 ...
 * Contributor(s):   -;
 *
 * $Id: ImageMapDemo3.java,v 1.1 2007/10/10 19:52:20 vauchers Exp $
 *
 * Changes
 * -------
...
/**
 * ImageMapDemo3 constructor comment.
 */
public ImageMapDemo3() {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        try {
            ...
            writer.println("<IMG SRC=\"xychart100.png\" WIDTH=\"600\" HEIGHT=\"400\" BORDER=\"0\""+
                           " USEMAP=\"#chart\">");
            writer.println("</BODY>");
            writer.println("</HTML>");
            writer.close();
