 ...
 * 05-Apr-2002 : BRS. Changed servletName
...
public class ImageDataAvailable extends BaseImageServlet implements Constants {
  ...
  public void init(ServletConfig config) throws ServletException {
    servletName = "Servlet ImageDataAvailable";
    defaultChartType = 20 ;
    super.init(config);
  }
  ...
  protected String generateSQL(HttpServletRequest request) {
    ...
    if (voyage == 0) {
      ...
      query += " from "+ dbSchema +"summary_track a " ;
      for (i = 0; i < obs_codes.length; ++i) {
        query += ", "+ dbSchema +"summary_data " + ((char)(alphaStart+i)) ;
      }
      ...
      query += " where a.set_code = " + voyage
            ...
            + dbSchema +"summary_data where set_code = " + voyage + ")"
