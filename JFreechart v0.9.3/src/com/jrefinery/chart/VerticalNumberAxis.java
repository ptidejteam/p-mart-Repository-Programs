 ...
 *                   Richard Atkinson;
 *
 * $Id: VerticalNumberAxis.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
    ...
    public Rectangle2D reserveAxisArea(Graphics2D g2, Plot plot,
        ...
        if (!visible) {
            return new Rectangle2D.Double(drawArea.getX(),
                drawArea.getY(), 0.0, drawArea.getHeight()-reservedHeight);
        }
        ...
        if (tickLabelsVisible) {
            ...
            tickLabelWidth = tickLabelWidth
                + getMaxTickLabelWidth(g2, approximatePlotArea);
        }
