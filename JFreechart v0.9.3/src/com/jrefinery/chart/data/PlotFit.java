 ...
 *
 * $Id: PlotFit.java,v 1.1 2007/10/10 19:52:22 vauchers Exp $
 *
...
public class PlotFit {
	 ...
	 * Matthew Wright:  implements what I'm doing in code now... not the best
	 * way to do this?
	 *
	...
	public XYDataset getFit() {
		...
		for(int i = 0; i < seriescount; i++) {
			...
			seriesnames[i + seriescount] = dataset.getSeriesName(i) + " "
				+ alg.getName();
		}
