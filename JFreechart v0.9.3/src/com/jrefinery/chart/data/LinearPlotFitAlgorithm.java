 ...
 *
 * $Id: LinearPlotFitAlgorithm.java,v 1.1 2007/10/10 19:52:22 vauchers Exp $
 *
...
public class LinearPlotFitAlgorithm implements PlotFitAlgorithm {
	...
	public void setXYDataset(XYDataset data) {
		...
		for(int i = 0; i < datasets.size(); i++) {
			...
			linear_fit[i] = Statistics
				.getLinearFit((Number[])pair.elementAt(0),
	...
	public Number getY(int series, Number x) {
		 ...
		 //  a = linear_fit[i][0]
		 //  b = linear_fit[i][1]
		return new Double(linear_fit[series][0]
			+ linear_fit[series][1] * x.doubleValue());
