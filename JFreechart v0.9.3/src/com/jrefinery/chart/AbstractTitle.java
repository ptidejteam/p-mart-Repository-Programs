 ...
 *
 * $Id: AbstractTitle.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
...
public abstract class AbstractTitle extends Object implements Cloneable {
	...
	/** Useful constant for the title position (also used for vertical
	 *  alignment).
	 */
	...
	/** Useful constant for the title position (also used for horizontal
	 *  alignment).
	 */
	...
	public static final Spacer DEFAULT_SPACER =
		new Spacer(Spacer.RELATIVE, 0.05, 0.30, 0.05, 0.15);
	 ...
	 * Constructs a new AbstractTitle, using default attributes where necessary.
	 *
	 * @param position      The relative position of the title (TOP, BOTTOM,
	 *      RIGHT and LEFT).
	 ...
	 *      MIDDLE or BOTTOM).
	 *
	 * @throws IllegalArgumentException If an invalid location or alignment
	 *      value is passed.
	 */
	protected AbstractTitle(int position, int horizontalAlignment,
	 ...
	 * @param verticalAlignment     The vertical alignment of the title (TOP,
	 *      MIDDLE or BOTTOM).
	 * @param spacer    The amount of space to leave around the outside of the
	 *      title.
	 *
	 * @throws IllegalArgumentException If an invalid location or alignment
	 *      value is passed.
		...
		int horizontalAlignment, int verticalAlignment, Spacer spacer)
	{
		...
		if (!this.isValidPosition(position)) {
			throw new IllegalArgumentException(
				"AbstractTitle(): Invalid position.");
		}
	 ...
	 *
	 * @return A boolean that indicates whether or not the notification
	 *      mechanism is enabled.
	 */
	 ...
	 *
	 * @param flag      A boolean that indicates whether or not the notification
	 *      mechanism is enabled.
	 */
	 ...
	 *
	 * @param position      The relative position of the title (use one of the
	 *      constants TOP, BOTTOM, RIGHT and LEFT, or the equivalent NORTH,
	 *      SOUTH, EAST and WEST).
	 */
		...
		if (this.notify) {
			...
			while (iterator.hasNext()) {
				TitleChangeListener listener =
					(TitleChangeListener)iterator.next();
