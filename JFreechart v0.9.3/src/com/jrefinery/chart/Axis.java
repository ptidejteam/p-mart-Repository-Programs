 ...
 *
 * $Id: Axis.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
...
public abstract class Axis implements AxisConstants {
	...
	/** Storage for registered listeners (objects interested in receiving
	 *  change events for the axis).
	 */
	 ...
	 *      label.
	 * @param tickLabelsVisible     Flag indicating whether or not the tick
	 *      labels are visible.
	 ...
	 *      tick labels.
	 * @param tickMarkVisible      Flag indicating whether or not tick marks
	 *      are visible.
	...
	public void setLabelFont(Font font) {
		...
		if (font==null) {
			throw new IllegalArgumentException(
				"Axis.setLabelFont(...): null not permitted.");
		}
	...
	public void setLabelPaint(Paint paint) {
		...
		if (paint==null) {
			throw new IllegalArgumentException(
				"Axis.setLabelPaint(...): null not permitted.");
		}
	...
	public void setTickLabelFont(Font font) {
		...
		if (font==null) {
			throw new IllegalArgumentException(
				"Axis.setTickLabelFont(...): null not permitted.");
		}
	...
	public void setTickLabelPaint(Paint paint) {
		...
		if (paint==null) {
			throw new IllegalArgumentException(
				"Axis.setTickLabelPaint(...): null not permitted.");
		}
	...
	public void setTickLabelInsets(Insets insets) {
		...
		if (insets==null) {
			throw new IllegalArgumentException(
				"Axis.setTickLabelInsets(...): null not permitted.");
		}
	...
	public void setTickMarkStroke(Stroke stroke) {
		...
		if (stroke==null) {
			throw new IllegalArgumentException(
				"Axis.setTickMarkStroke(...): null not permitted.");
		}
	 ...
	 * @param plotArea      The area within which the axes and plot should be
	 *      drawn.
	 ...
	 */
	public abstract void refreshTicks(Graphics2D g2, Rectangle2D plotArea,
		Rectangle2D dataArea);
