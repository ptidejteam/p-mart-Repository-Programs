 ...
 * Contributor(s):   -;
 *
 * $Id: ChartChangeEvent.java,v 1.1 2007/10/10 19:52:24 vauchers Exp $
 *
...
public class ChartChangeEvent extends java.util.EventObject {
	...
	/**
	 * Event type indicating a general change to a chart (typically just
	 * requires a redraw).
	 */
	...
	/**
	 * Standard constructor: returns a new ChartChangeEvent object, type
	 * GENERAL.
	...
	/**
	 * Full constructor: returns a new ChartChangeEvent object with the
	 * specified type.
	 *
	 ...
	 *
	 * @return a reference to the chart that generated the change event.
	 */
