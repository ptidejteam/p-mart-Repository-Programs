 ...
 *
 * $Id: DateTitle.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
...
public class DateTitle extends TextTitle {
	...
	public DateTitle(int dateStyle) {
		this(dateStyle, Locale.getDefault(),
			new Font("Dialog", Font.PLAIN, 12), Color.black);
	}

	/**
	 * Constructs a new DateTitle with the specified attributes.
	 * @param dateStyle     the Date style to use (SHORT, MEDIUM, LONG, or FULL
	 *      constants from java.text.DateFormat).
	 * @param locale    the locale to use to format this date (if you are
	 *      unsure what to use here, use Locale.getDefault() for your default
	 *      locale).
	 * @param font      the font used to display the date.
	 * @param paint     the paint used to display the date.
	 * @param position      the relative location of this title (use constants
	 *      in AbstractTitle).
	 * @param horizontalAlignment   the horizontal text alignment of this title
	 *      (use constants in AbstractTitle).
	 * @param verticalAlignment     the vertical text alignment of this title
	 *      (use constants in AbstractTitle).
	 * @param spacer    Determines the blank space around the outside of the
	 *      title.
	 */
	 ...
	 * @param dateStyle     the Date style to use (SHORT, MEDIUM, LONG, or FULL
	 *      constants from java.util.DateFormat).
	 * @param locale    the locale to use to format this date (if you are unsure
	 *      what to use here, use Locale.getDefault() for your default locale).
	 * @param font      the font used to display the date.
	 * @param paint     the paint used to display the date.
	 */
	public DateTitle(int dateStyle, Locale locale, Font font, Paint paint) {
