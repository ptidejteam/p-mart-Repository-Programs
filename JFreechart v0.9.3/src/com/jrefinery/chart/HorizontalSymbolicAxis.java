...
public class HorizontalSymbolicAxis extends HorizontalNumberAxis implements HorizontalAxis {
     ...
     *        range when the range is determined automatically. If the value 0 falls within the
     *        margin and this flag is <code>true</code>, then the margin is truncated at zero.
    ...
    public HorizontalSymbolicAxis(String label, String[] sv,
        ...
        boolean crosshairVisible, double crosshairValue, Stroke crosshairStroke,
     ...
     */
    private void selectAutoTickUnit(Graphics2D g2, Rectangle2D drawArea,
    ...
    {
        if (visible) super.draw(g2, drawArea, plotArea);
        ...
        Rectangle2D plotArea, boolean firstGridLineIsDark)
    {
        ...
        if (plot.outlineStroke!= null) {
            outlineStrokeWidth = ((BasicStroke)plot.outlineStroke)
                .getLineWidth();
        }
        else {
        ...
        while (iterator.hasNext()) {
            ...
            xx1 = this.translateValueToJava2D(tick.getNumericalValue()-0.5d,
                plotArea);
            xx2 = this.translateValueToJava2D(tick.getNumericalValue()+0.5d,
                plotArea);
            ...
            symbolicGridLine =  new Rectangle2D.Double(xx1,
