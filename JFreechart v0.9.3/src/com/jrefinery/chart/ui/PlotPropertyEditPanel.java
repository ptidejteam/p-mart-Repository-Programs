 ...
 *
 * $Id: PlotPropertyEditPanel.java,v 1.1 2007/10/10 19:52:22 vauchers Exp $
 *
...
public class PlotPropertyEditPanel extends JPanel implements ActionListener {
    ...
    public PlotPropertyEditPanel(Plot plot) {
        ...
        if (domainAxisPropertyPanel!=null) {
            domainAxisPropertyPanel.setBorder(BorderFactory
        ...
        if (rangeAxisPropertyPanel!=null) {
            rangeAxisPropertyPanel.setBorder(BorderFactory
                .createEmptyBorder(2,2,2,2));
    ...
    private void attemptOutlineStrokeSelection() {
        StrokeChooserPanel panel =
            new StrokeChooserPanel(null, availableStrokeSamples);
