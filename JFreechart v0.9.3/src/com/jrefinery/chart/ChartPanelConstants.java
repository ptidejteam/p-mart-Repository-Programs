 ...
 * Contributors:     -;
 *
 * $Id: ChartPanelConstants.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
 * Changes:
 * --------
...
public interface ChartPanelConstants {
	...
	public static final String ZOOM_IN_HORIZONTAL_ACTION_COMMAND =
		"ZOOM_IN_HORIZONTAL";

	/** Zoom in (vertical axis only) action command. */
	public static final String ZOOM_IN_VERTICAL_ACTION_COMMAND =
		"ZOOM_IN_VERTICAL";
	...
	public static final String ZOOM_OUT_HORIZONTAL_ACTION_COMMAND =
		"ZOOM_HORIZONTAL_BOTH";

	/** Zoom out (vertical axis only) action command. */
	public static final String ZOOM_OUT_VERTICAL_ACTION_COMMAND =
		"ZOOM_VERTICAL_BOTH";

	/** Zoom reset (both axes) action command. */
	public static final String AUTO_RANGE_BOTH_ACTION_COMMAND =
		"AUTO_RANGE_BOTH";

	/** Zoom reset (horizontal axis only) action command. */
	public static final String AUTO_RANGE_HORIZONTAL_ACTION_COMMAND =
		"AUTO_RANGE_HORIZONTAL";

	/** Zoom reset (vertical axis only) action command. */
	public static final String AUTO_RANGE_VERTICAL_ACTION_COMMAND =
		"AUTO_RANGE_VERTICAL";
