 ...
 *
 * $Id: WindAxis.java,v 1.1 2007/10/10 19:52:15 vauchers Exp $
 *
 * Changes
 * -------
...
public abstract class WindAxis extends Axis {
	...
	/**
	 * Full constructor - initialises the attributes for a ValueAxis.  This is
	 * an abstract class, subclasses include HorizontalValueAxis and
	 * VerticalValueAxis.
	 *
	 ...
	 *      label.
	 * @param showTickLabels    Flag indicating whether or not tick labels are
	 *      visible.
	 * @param tickLabelFont     The font used to display tick labels.
	 * @param tickLabelPaint    The paint used to draw tick labels;
	 * @param tickLabelInsets   Determines the amount of blank space around
	 *      tick labels.
	 * @param showTickMarks     Flag indicating whether or not tick marks are
	 *      visible.
	 * @param tickMarkStroke    The stroke used to draw tick marks (if visible).
	 * @param autoRange     Flag indicating whether or not the axis range is
	 *      automatically adjusted to fit the data.
	 * @param autoTickValue     A flag indicating whether or not the tick value
	 *      is automatically calculated;
	 * @param showGridLines     Flag indicating whether or not grid lines are
	 *      visible for this axis.
	 ...
	 */
	public WindAxis(String label, Font labelFont, Paint labelPaint,
		Insets labelInsets,
	 ...
	 *
	 * @return <code>true</code> if the axis range is automatically adjusted.
	 */
	...
	/**
	 * Returns true if the tick value is calculated automatically.
	 *
	 * @return <code>true</code> if the tick value is calculated automatically.
	 */
	...
	/**
	 * Sets a flag indicating whether or not the tick value is calculated
	 * automatically, and notifies registered listeners that the axis has
	 * been modified.
	 *
	...
	/**
	 * Returns true if the grid lines are visible for this axis.
	 *
	 * @return <code>true</code> if the grid lines are visible for this axis.
	 */
	 ...
	 *
	 * @return the Stroke used to draw the grid lines.
	 */
	 ...
	 *
	 * @return the Paint used to color the grid lines.
	 */
	...
	/**
	 * Converts a value from the data source to a Java2D user-space co-ordinate
	 * relative to the specified plotArea.  The coordinate will be an x-value
	 * for horizontal axes and a y-value for vertical axes (refer to the
	 * subclass).
	 * <p>
	 * Note that it is possible for the coordinate to fall outside the
	 * plotArea.
	 *
	 * @param dataValue   data value to translate.
