 ...
 *                   Richard Atkinson;
 *
 * $Id: AreaXYItemRenderer.java,v 1.1 2007/10/10 19:52:15 vauchers Exp $
 *
 * Changes:
 * --------
...
public class AreaXYItemRenderer extends AbstractXYItemRenderer implements XYItemRenderer {
        ...
        CrosshairInfo crosshairInfo)
    {
        ...
        double transX1 = horizontalAxis
            .translateValueToJava2D(x1.doubleValue(), dataArea);
        double transY1 = verticalAxis
            .translateValueToJava2D(y1.doubleValue(), dataArea);
        ...
        if (this.plotLines) {
            if (item>0) {
                ...
                double transX0 = horizontalAxis
                    .translateValueToJava2D(x0.doubleValue(), dataArea);
                double transY0 = verticalAxis
                    .translateValueToJava2D(y0.doubleValue(), dataArea);
        ...
        if (horizontalAxis.isCrosshairLockedOnData()) {
            if (verticalAxis.isCrosshairLockedOnData()) {
                // both axes
                crosshairInfo.updateCrosshairPoint(x1.doubleValue(),
                    y1.doubleValue());
            }
            else {
