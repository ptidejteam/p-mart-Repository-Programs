 ...
 *                   Bob Orchard;
 *
 * $Id: MeterPlot.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
 * Changes
 * -------
...
public class MeterPlot extends Plot {
    ...
    protected Paint dialBackgroundPaint;

    /** The paint for the needle. */
    protected Paint needlePaint;
    ...
    protected int tickLabelType;

    /** The tick label font. */
    protected Font tickLabelFont;

    /** The 'normal' level color. */
    Paint normalPaint = DEFAULT_NORMAL_PAINT;

    /** The 'warning' level color. */
    Paint warningPaint = DEFAULT_WARNING_PAINT;

    /** The 'critical' level color. */
    Paint criticalPaint = DEFAULT_CRITICAL_PAINT;
     ...
     * @param tcikLabelFont  The label font.
     *
     */
    public MeterPlot(MeterDataset data,
                     Insets insets,
