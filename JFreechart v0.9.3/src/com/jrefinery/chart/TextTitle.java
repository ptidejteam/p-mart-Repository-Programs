 ...
 *
 * $Id: TextTitle.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
...
public class TextTitle extends AbstractTitle {
	 ...
	 * @param text      The title text.
	 * @param font      The title font.
	 * @param horizontalAlignment   The horizontal alignment (use the constants
	 *      defined in AbstractTitle).
	 */
	 ...
	 * @param font      The title font.
	 * @param paint     The title color.
	 * @param position      The title position (use the constants defined in
	 *      AbstractTitle).
	 * @param horizontalAlignment   The horizontal alignment (use the constants
	 *      defined in AbstractTitle).
	 * @param verticalAlignment     The vertical alignment (use the constants
	 *      defined in AbstractTitle).
	 ...
	 * @return  An object that implements the Paint interface used to paint
	 *      this title;
	 */
	 ...
	 *
	 * @return <code>true</code> if position is <code>TOP</code> or
	 *      <code>BOTTOM</code>.
	 */
	...
	public void draw(Graphics2D g2, Rectangle2D area) {
		...
		if (this.position == TOP || this.position == BOTTOM) {
			...
			"TextTitle.draw(...) - invalid title position.");
	...
	protected void drawHorizontal(Graphics2D g2, Rectangle2D area) {
		...
		if (this.horizontalAlignment==CENTER) {
			titleX = titleX
				+ ((area.getWidth()-leftSpace-rightSpace)/2)-(titleWidth/2);
		}
