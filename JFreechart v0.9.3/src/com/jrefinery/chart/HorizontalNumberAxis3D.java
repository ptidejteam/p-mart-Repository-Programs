 ...
 *
 * $Id: HorizontalNumberAxis3D.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
 * Changes
 * -------
...
public class HorizontalNumberAxis3D extends HorizontalNumberAxis {
    ...
    public void draw(Graphics2D g2, Rectangle2D drawArea, Rectangle2D plotArea){
        ...
        if (label!=null) {
            ...
            float labely = (float)(drawArea.getMaxY()
                - labelInsets.bottom - lm.getDescent() - lm.getLeading());
    ...
    public double reserveHeight(Graphics2D g2, Plot plot, Rectangle2D drawArea){
        ...
        if (label!=null) {
            LineMetrics metrics = labelFont
                .getLineMetrics(label, g2.getFontRenderContext());
     ...
     *      drawn.
     * @param reservedWidth     The space already reserved for the vertical
     *      axis.
     ...
     * @param drawArea      The area within which the plot and axes should be
     *      drawn.
     * @param vertical      A flag that indicates whether or not the tick
     *      labels are 'vertical'.
        ...
        boolean vertical)
    {
        ...
        if (vertical) {
            ...
            while (iterator.hasNext()) {
                Tick tick = (Tick)iterator.next();
                Rectangle2D labelBounds = font
                    .getStringBounds(tick.getText(), frc);
