 ...
 *                   Tomer Peretz;
 *
 * $Id: HorizontalBarRenderer3D.java,v 1.1 2007/10/10 19:52:15 vauchers Exp $
 *
 * Changes
 * -------
        ...
        if (dataValue!=null) {
            ...
            if (itemWidth>BAR_OUTLINE_WIDTH_THRESHOLD) {
                ...
                if (plot.getLabelsVisible()) {
                    ...
                    LineMetrics lm = plot.getLabelFont().getLineMetrics(str, g2.getFontRenderContext());
                    double middleOffset = (rectHeight + lm.getAscent() - lm.getDescent())/2 ;
                    double stringOffset = labelFont.getStringBounds(str, g2.getFontRenderContext()).getWidth();
