 ...
 *
 * $Id: OverlaidVerticalCategoryPlot.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
 * Changes
 * -------
...
public class OverlaidVerticalCategoryPlot extends VerticalCategoryPlot {
	...
	public OverlaidVerticalCategoryPlot(String domainAxisLabel,
		String rangeAxisLabel, Object[] categories)
	{
	...
	public List getLegendItemLabels() {
		...
		if (subplots!=null) {
			...
			while (iterator.hasNext()) {
				VerticalCategoryPlot plot =
					(VerticalCategoryPlot)iterator.next();
