 ...
 *
 * $Id: HighLowRenderer.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
 * Changes
 * -------
	...
	implements XYItemRenderer
{
		...
		CrosshairInfo crosshairInfo)
	{
		...
		double xx = domainAxis
			.translateValueToJava2D(x.doubleValue(), dataArea);
		double yyHigh = rangeAxis
			.translateValueToJava2D(yHigh.doubleValue(), dataArea);
		double yyLow = rangeAxis
			.translateValueToJava2D(yLow.doubleValue(), dataArea);
		double yyOpen = rangeAxis
			.translateValueToJava2D(yOpen.doubleValue(), dataArea);
		double yyClose = rangeAxis
			.translateValueToJava2D(yClose.doubleValue(), dataArea);
