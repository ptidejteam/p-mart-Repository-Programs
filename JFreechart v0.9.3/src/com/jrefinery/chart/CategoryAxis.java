 ...
 * Contributor(s):   -;
 *
 * $Id: CategoryAxis.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
...
public abstract class CategoryAxis extends Axis {
	 ...
	 *      labels are visible.
	 * @param categoryLabelFont     The font used to display category (tick)
	 *      labels.
	 * @param categoryLabelPaint    The paint used to draw category (tick)
	 *      labels.
