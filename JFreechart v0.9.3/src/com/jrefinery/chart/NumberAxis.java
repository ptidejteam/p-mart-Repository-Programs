 ...
 *
 * $Id: NumberAxis.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
...
public abstract class NumberAxis extends ValueAxis {
     ...
     */
    protected NumberAxis(String label, Font labelFont, Paint labelPaint,
        Insets labelInsets,
        ...
        Stroke crosshairStroke, Paint crosshairPaint)
    {
        ...
        if (lowerBound>=upperBound) {
            throw new IllegalArgumentException(
                "NumberAxis(...): lower bound must be less than upper bound.");
        }
