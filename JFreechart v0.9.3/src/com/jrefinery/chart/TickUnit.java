 ...
 * Contributor(s):   -;
 *
 * $Id: TickUnit.java,v 1.1 2007/10/10 19:52:15 vauchers Exp $
 *
 ...
 * <P>
 * This class (and subclasses) should be immutable, the reason being that
...
public abstract class TickUnit implements Comparable {
	 ...
	 * <P>
	 * Subclasses of TickUnit may implement special formatting by overriding
	 * this method.
	 *
