 ...
 *
 * $Id: ValueAxis.java,v 1.1 2007/10/10 19:52:15 vauchers Exp $
 *
...
public abstract class ValueAxis extends Axis {
    ...
    /** Flag that indicates whether or not the axis automatically scales to fit
     *  the chart data.
     */
    protected boolean autoRange;

    /**
     * The minimum size for the axis range (excluding margins) when it is automatically calculated
     * to fit the data.
     */
    ...
    public void setAutoRangeMinimumSize(Number size) {
        ...
        if (size==null) {
            throw new IllegalArgumentException(
                "NumberAxis.setAutoRangeMinimumSize(Number): "
                + "null not permitted.");
        }
    ...
    public void setGridStroke(Stroke stroke) {
        ...
        if (stroke==null) {
            throw new IllegalArgumentException(
                "ValueAxis.setGridStroke(...): null not permitted");
        }
