 ...
 *                   Wolfgang Irler;
 *
 * $Id: JFreeChart.java,v 1.1 2007/10/10 19:52:15 vauchers Exp $
 *
...
public class JFreeChart implements JFreeChartConstants,
     ...
     * @param plot  Controller of the visual representation of the data.
     * @param createLegend  Flag indicating whether or not a legend should
        ...
        while (iterator.hasNext()) {
            ...
            switch (currentTitle.getPosition()) {
                ...
                case AbstractTitle.BOTTOM : {
                    ...
                    currentTitle.draw(g2, titleArea);
                    nonTitleArea.setRect(nonTitleArea.getX(),
                        nonTitleArea.getY(), availableWidth,
...
class JFreeChartInfo extends ProjectInfo {
    ...
    public JFreeChartInfo() {
        ...
        this.name = "JFreeChart";   //resources.getString("project.name");
        this.version = "0.9.3";     //resources.getString("project.version");
        this.info = "http://www.object-refinery.com/jfreechart";
                                    //resources.getString("project.info");
        this.copyright = "(C)opyright 2000-2002, by Simba Management Limited and Contributors";
                                    //resources.getString("project.copyright");
        this.logo = null;  // load only when required
