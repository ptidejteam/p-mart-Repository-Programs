 ...
 * Contributor(s):   -;
 *
 * $Id: Month.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
 * Changes
 * -------
...
public class Month extends TimePeriod {
    ...
    public Month(int month, Year year) {
        ...
        if ((month<1) && (month>12)) {
            throw new IllegalArgumentException(
                "Month(...): month outside valid range.");
        }
    ...
    public TimePeriod previous() {
        ...
        if (this.month!=SerialDate.JANUARY) {
            ...
            if (prevYear!=null) result =
                new Month(SerialDate.DECEMBER, prevYear);
            else result = null;
        }
        return result;
    ...
    public TimePeriod next() {
        ...
        if (month != SerialDate.DECEMBER) {
            ...
            if (nextYear!=null) result =
                new Month(SerialDate.JANUARY, nextYear);
            else result = null;
        }
        return result;
    }
     ...
     *
     * @param s     the string to parse.
     * @return <code>nukl</code> if the string is not parseable, the year
     *      otherwise.
     */
