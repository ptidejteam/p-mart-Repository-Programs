 ...
 * Contributor(s):   -;
 *
 * $Id: DefaultIntervalCategoryDataset.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
 * Changes
 * -------
    ...
    implements IntervalCategoryDataset
{
     ...
     * @param starts        The start values data, indexed as
        ...
        if (starts!=null && ends!=null) {
            ...
            if (series_count>0) {
                ...
                if (categories!=null) {
                    ...
                    this.categories =
                        this.generateNames(category_count, prefix);
                }
    ...
    public String getSeriesName(int series) {
        ...
        if ((series>=this.getSeriesCount()) || (series<0)) {
            ...
            throw new IllegalArgumentException(
                "DefaultIntervalCategoryDataset.getSeriesName(int): "
                + "no such series.");
        }
