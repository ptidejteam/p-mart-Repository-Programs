 ...
 * Contributor(s):   -;
 *
 * $Id: DefaultCategoryDataset.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
 ...
 */
public class DefaultCategoryDataset extends AbstractSeriesDataset
    implements CategoryDataset
{
            ...
            if (series_count>0) {
                ...
                if (categories!=null) {
                    ...
                    this.categories = this
                        .generateNames(category_count, prefix);
                }
    ...
    public void setSeriesName(int series, String name) {
        ...
        if (name == null) {
            throw new IllegalArgumentException(
                "DefaultCategoryDataset.setSeriesName(...): null "
                + "not permitted.");
        }
    ...
    public Number getValue(int series, Object category) {
        ...
        if ((series<0) || (series>=this.getSeriesCount())) {
            throw new IllegalArgumentException(
                "DefaultCategoryDataset.getValue(...): "
