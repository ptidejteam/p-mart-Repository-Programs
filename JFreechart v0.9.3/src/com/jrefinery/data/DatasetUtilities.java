 ...
 *
 * $Id: DatasetUtilities.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
...
public class DatasetUtilities {
    ...
    public static Range getDomainExtent(Dataset data) {
        ...
        if ((data instanceof CategoryDataset) && !(data instanceof XYDataset)) {
            throw new IllegalArgumentException(
                "Datasets.getMinimumDomainValue(...): "
        ...
        else return null; // unrecognised dataset...how should this be handled?
     ...
     *
     * @param data      The dataset.
     * @return The minimum domain value in the dataset (or null if all the
    ...
    public static Number getMinimumDomainValue(Dataset data) {
        ...
        // hasn't implemented DomainInfo, so iterate...
            ...
            if (minimum==Double.POSITIVE_INFINITY) return null;
            else return new Double(minimum);
        }
     ...
     *
     * @param data      The dataset.
     * @return The maximum domain value in the dataset (or null if all the
     *      values in the dataset are null).
     */
    public static Number getMaximumDomainValue(Dataset data) {
        ...
        if ((data instanceof CategoryDataset) && !(data instanceof XYDataset)) {
            throw new IllegalArgumentException(
                "Datasets.getMaximumDomainValue(...): "
                + "CategoryDataset does not have numerical domain.");
        }
        ...
        // hasn't implemented DomainInfo, so iterate...
            ...
            if (maximum==Double.NEGATIVE_INFINITY) return null;
            else return new Double(maximum);
     ...
     *
     * @param data      The dataset.
     * @return The minimum range value in the dataset (or null if all the
     *      values in the dataset are null).
     */
     ...
     *
     * @param data      The dataset.
     * @return The maximum range value in the dataset (or null if all the
     *      values in the dataset are null).
     */
