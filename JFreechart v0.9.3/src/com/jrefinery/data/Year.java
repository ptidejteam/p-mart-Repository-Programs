 ...
 * Contributor(s):   -;
 *
 * $Id: Year.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
 * Changes
 * -------
...
public class Year extends TimePeriod {
     ...
     * @return The year preceding this one (or null if the current year is
     *      1900).
     */
     ...
     * @return The year following this one (or null if the current year is
     *      9999).
     */
    ...
    public static Year parseYear(String s) throws TimePeriodFormatException {
        ...
        try {
            ...
            throw new TimePeriodFormatException(
                "Year.parseYear(string): cannot parse string.");
        }
