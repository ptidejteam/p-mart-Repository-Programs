 ...
 * Contributor(s):   -;
 *
 * $Id: Day.java,v 1.1 2007/10/10 19:52:14 vauchers Exp $
 *
 * Changes
 * -------
...
public class Day extends TimePeriod {
    ...
    protected static final DateFormat standardDateFormat =
        new SimpleDateFormat("yyyy-MM-dd");

    /** A date formatter for the default locale. */
    protected static final DateFormat dateFormatShort =
        DateFormat.getDateInstance(
                                                                                  DateFormat.SHORT);

    /** A date formatter for the default locale. */
    protected static final DateFormat dateFormatMedium =
        DateFormat.getDateInstance(
                                                                                 DateFormat.MEDIUM);

    /** A date formatter for the default locale. */
    protected static final DateFormat dateFormatLong =
     ...
     * <P>
     * Implementation note: the reference that is returned should be an
    ...
    /**
     * Returns the day following this one, or null if some limit has been
     * reached.
     *
     ...
     * the specified object: negative == before, zero == same,
     * positive == after.
     *
