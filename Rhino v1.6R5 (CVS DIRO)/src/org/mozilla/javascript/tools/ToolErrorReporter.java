...
public class ToolErrorReporter implements ErrorReporter {
	 ...
	 * org.mozilla.javascript.tools.shell.resources.Messages property file. For
	...
	public static String getMessage(String messageId, Object[] args) {
		...
		try {
			...
			// final File file = new
			// File("bin/org/mozilla/javascript/resources/");
			// final String[] whereAmI = file.list();
			// for (int i = 0; i < whereAmI.length; i++) {
			// System.out.println(whereAmI[i]);
			// }
			// System.out.println(new File(
			// "bin/org/mozilla/javascript/resources/Messages.properties")
			// .exists());
