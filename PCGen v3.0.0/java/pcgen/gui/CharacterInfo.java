...
public class CharacterInfo extends JPanel
{
	...
	private static String in_resources;
...
//			in_templates = characterInfoProperties.getString("in_templates");
	...
	private void jbInit() throws Exception
	{
		...
		{
			characterInfoTabbedPane.add(infoSummary, in_summary);
		}
		...
		characterInfoTabbedPane.add(infoEquipping, in_equipping);
		characterInfoTabbedPane.add(infoResources, in_resources);
