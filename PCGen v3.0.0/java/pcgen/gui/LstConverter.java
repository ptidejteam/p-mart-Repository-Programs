 ...
 */
public class LstConverter extends JFrame
{
	private LstConverter mainClass;
	List lstNameList = new ArrayList(); // list of file names
	List lstPathList = new ArrayList(); // list of paths
	List lstTypeList = new ArrayList(); // list of types
	List okList = new ArrayList(); // list of items to be run
	List doneList = new ArrayList(); // list of items already run
	...
	public LstConverter()
	{
		...
		try
		{
			loadLSTFilesInDirectory(SettingsHandler.getPccFilesLocation().toString());
			jbInit();
		}
						...
						switch (thisType)
						{
							case 1: // race
								if (field > 1 && field < 8)
								{
									if (!bString.equals("0"))
									{
										bString = "STATADJ" + (field - 2) + ":" + bString;
										bStream.write(bString.getBytes());
									}
								}
								else if (field == 8)
							...
							case 2: // class
								if (field == 2)
									...
									bString = "FORTITUDECHECK:" + bString;
								else if (field == 10)
									bString = "REFLEXCHECK:" + bString;
								else if (field == 11)
									bString = "WILLPOWERCHECK:" + bString;
								bStream.write(bString.getBytes());
								break;
							case 3: // spell
								if (field == 2)
...
//		System.exit(0);
	...
	public static final class OkRenderer extends JComboBox implements TableCellRenderer
	{
	...
	public static final class TypeRenderer extends JComboBox implements TableCellRenderer
	{
	...
	public static final class DoneRenderer extends JComboBox implements TableCellRenderer
	{
