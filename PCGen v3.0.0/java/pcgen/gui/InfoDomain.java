...
public class InfoDomain extends FilterAdapterPanel
{
	...
	private void setDeityInfoText(Deity aDeity)
	{
		if (aDeity != null)
		{
			StringBuffer infoText = new StringBuffer().append("<html><b>").append(aDeity.getName());
			...
			if (deities != null && row >= 0 && row < deities.size())
			{
				...
				switch (column)
				{
					...
					case 0:
						...
						{
							retVal = new StringBuffer().append("<html><b>").append(aDeity.getName()).append("</b></html>").toString();
						}
						...
						{
							retVal = new StringBuffer().append("<html>").append(SettingsHandler.getPrereqFailColorAsHtml()).append(aDeity.getName()).append("</font></html>").toString();
						}
						break;
					case 1:
		...
		public Object getValueAt(int row, int col)
		{
			...
			switch (col)
			{
				...
				case 0:
					...
					{
						retVal.append("<html><b>").append(rowText).append("</b></html>");
					}
					else if (aDomain != null && !aDomain.qualifiesForDomain())
					{
						retVal.append("<html>").append(SettingsHandler.getPrereqFailColorAsHtml()).append(rowText).append("</font></html>");
					}
					else
					{
						retVal.append(rowText);
