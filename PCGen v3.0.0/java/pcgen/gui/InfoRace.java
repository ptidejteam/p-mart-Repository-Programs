...
public class InfoRace extends FilterAdapterPanel
{
	...
	public static final int VIEW_SOURCE = 2;
	...
	private void initComponents()
	{
		...
		if ((iView >= VIEW_NAME) && (iView <= VIEW_SOURCE))
			viewMode = iView;
	 ...
	 **/
	public class RaceModel extends AbstractTreeTableModel implements TreeTableModel
	{
