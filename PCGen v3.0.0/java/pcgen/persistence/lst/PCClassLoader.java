 ...
 *
 * $Id: PCClassLoader.java,v 1.1 2006/02/21 00:02:33 vauchers Exp $
 */
...
public class PCClassLoader
{
	...
	public static void parseLine(PCClass pcClass, String inputLine, File sourceFile, int lineNum) throws PersistenceLayerException
	{
		...
		for (; colToken.hasMoreTokens(); col++)
		{
			...
			if (pcClass.isNewItem() && col == 1 && colString.indexOf(":") > 0)
				col = 11;
			if (option < 15)
				option = col;
			if (col == 0 && option == 15)
			...
			switch (option)
			{
				...
				case 7:
					...
					break;
				case 8:
					pcClass.setFortitudeCheckType(colString);
					break;
				case 9:
					pcClass.setReflexCheckType(colString);
					break;
				case 10:
					pcClass.setWillCheckType(colString);
					break;
				default:
					if (colString.startsWith("HD:"))
						...
						pcClass.setFortitudeCheckType(colString.substring(15));
					else if (colString.startsWith("REFLEXCHECK:"))
						pcClass.setReflexCheckType(colString.substring(12));
					else if (colString.startsWith("WILLPOWERCHECK:"))
						pcClass.setWillCheckType(colString.substring(15));
					...
					else if (colString.startsWith("CAST:"))
					{
						...
						pcClass.setIntModToSkills(!colString.substring(15).equals("No"));
						...
						pcClass.setGoldString(colString.substring(5));
