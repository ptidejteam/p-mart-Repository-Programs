 ...
 *
 * $Id: SettingsHandler.java,v 1.1 2006/02/21 00:02:22 vauchers Exp $
 */
package pcgen.core;
...
import pcgen.gui.InfoEquipping;
import pcgen.gui.InfoFeats;
import pcgen.gui.InfoInventory;
import pcgen.gui.InfoRace;
import pcgen.gui.InfoSkills;
import pcgen.gui.InfoSpells;
...
public class SettingsHandler
{
	...
	private static int equipTab_AvailableListMode = InfoEquipping.VIEW_TYPE;
	private static int equipTab_SelectedListMode = InfoEquipping.VIEW_NAME;
	private static int excSkillCost = 0;
	private static int featAutoColor = 0xB2B200;			// dark yellow
	private static int featTab_AvailableListMode = InfoFeats.VIEW_TYPENAME;
	private static int featTab_SelectedListMode = InfoFeats.VIEW_NAMEONLY;
	...
	private static int inventoryTab_AvailableListMode = InfoInventory.VIEW_TYPE_SUBTYPE_NAME;
	private static boolean inventoryTab_IgnoreCost = false;
	private static int inventoryTab_SelectedListMode = InfoInventory.VIEW_NAME;
	...
	private static int raceTab_ListMode = InfoRace.VIEW_NAME;
	/**
	 * Method:
	 * 0: One random number
	 * 1: 4d6 Drop Lowest.
	...
	private static int skillsTab_AvailableListMode = InfoSkills.VIEW_TYPE_NAME;
	private static int skillsTab_SelectedListMode = InfoSkills.VIEW_NAME;
	private static String skinLFThemePack = null;
	private static int spellsTab_AvailableListMode = InfoSpells.VIEW_CLASS;
	private static int spellsTab_SelectedListMode = InfoSpells.VIEW_CLASS;
	...
	public static void readGUIOptionsProperties()
	{
		...
		//(! System.getProperty("os.name").substring(0,3).equalsIgnoreCase("LIN")))
		{
	...
	private static Dimension getOptionsFromProperties()
	{
		Dimension d = new Dimension(0, 0);
		...
		setSelectedTemplate(getOptions().getProperty("pcgen.files.selectedTemplate", getTemplatePath().getAbsolutePath() + File.separator + "csheet.htm"));
		setSelectedPartyTemplate(getOptions().getProperty("pcgen.files.selectedPartyTemplate", getTemplatePath().getAbsolutePath() + File.separator + "psheet.htm"));
		...
		setRollMethod(getPCGenOption("rollMethod", 1));
		setRollMethodExpression(getPCGenOption("rollMethodExpression", "roll(4,6,[2,3,4])"));
		setLooknFeel(getPCGenOption("looknFeel", 0));
		...
		setEquipTab_AvailableListMode(getPCGenOption("EquipTab.availableListMode", InfoEquipping.VIEW_TYPE));
		setEquipTab_SelectedListMode(getPCGenOption("EquipTab.selectedListMode", InfoEquipping.VIEW_NAME));
		setFeatTab_AvailableListMode(getPCGenOption("FeatTab.availableListMode", InfoFeats.VIEW_TYPENAME));
		setFeatTab_SelectedListMode(getPCGenOption("FeatTab.selectedListMode", InfoFeats.VIEW_NAMEONLY));
		setInventoryTab_IgnoreCost(getPCGenOption("InventoryTab.ignoreCost", false));
		setInventoryTab_AvailableListMode(getPCGenOption("InventoryTab.availableListMode", InfoInventory.VIEW_TYPE_SUBTYPE_NAME));
		setInventoryTab_SelectedListMode(getPCGenOption("InventoryTab.selectedListMode", InfoInventory.VIEW_NAME));
		setRaceTab_ListMode(getPCGenOption("RaceTab.ListMode", InfoRace.VIEW_NAME));
		setSkillsTab_AvailableListMode(getPCGenOption("SkillsTab.availableListMode", InfoSkills.VIEW_TYPE_NAME));
		setSkillsTab_SelectedListMode(getPCGenOption("SkillsTab.selectedListMode", InfoSkills.VIEW_NAME));
		setSpellsTab_AvailableListMode(getPCGenOption("SpellsTab.availableListMode", InfoSpells.VIEW_CLASS));
		setSpellsTab_SelectedListMode(getPCGenOption("SpellsTab.selectedListMode", InfoSpells.VIEW_CLASS));
	...
	private static void setOptionsProperties()
	{
		...
		setPCGenOption("looknFeel", getLooknFeel());
	...
	public static void setPurchaseStatMode(final boolean argPurchaseStatMode)
	{
		purchaseStatMode = argPurchaseStatMode;
	}

	public static int getPurchaseScoreMin()
	{
		return purchaseAbilityScoreMin;
	}

	public static void setPurchaseScoreMin(final int argPurchaseAbilityScoreMin)
	{
		purchaseAbilityScoreMin = argPurchaseAbilityScoreMin;
	}

	public static int getPurchaseScoreMax()
	{
		return purchaseAbilityScoreMax;
	}

	public static void setPurchaseScoreMax(final int argPurchaseAbilityScoreMax)
	{
		purchaseAbilityScoreMax = argPurchaseAbilityScoreMax;
	}
	...
	public static void setLooknFeel(final int argLooknFeel)
	{
		looknFeel = argLooknFeel;
	}
	...
	{
		return abilityScoreCost[abilityScoreIndex];
	}
