...
public class Skill extends PObject
{
	...
	public Integer modifier()
	{
		...
		if (aCheck != ACHECK_NONE)
		{
			...
			else
			{
				...
				{
					final int load = Globals.loadTypeForStrength(aPC.adjStats(Constants.STRENGTH), totalWeight);
					switch (load)
					{
	...
	public Object clone()
	{
		...
		newSkill.classList = classList;
		newSkill.choiceList = choiceList;
