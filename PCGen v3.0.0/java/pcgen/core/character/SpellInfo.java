...
public class SpellInfo
{
	...
	private boolean specialtySlot = false;
	private ArrayList featList = null; // a List of Feat objects
	private int times = 0; // times the spell is in this list
	private CharacterSpell owner = null;

	public SpellInfo(final CharacterSpell o, final int l, final int t, final String b)
	{
		owner = o;
		actualLevel = l;
		times = t;
	...
	public String toString()
	{
		if (featList == null || featList.isEmpty())
			return "";
		StringBuffer aBuf = new StringBuffer(" [" + featList.get(0).toString());
	...
	public void setOwner(CharacterSpell c)
	{
		owner = c;
	}
	...
	public void setBook(final String s)
	{
		book = s;
	}
	...
	public void setActualLevel(final int level)
	{
		actualLevel = level;
	}

	public boolean isInSpecialtySlot()
	{
		return specialtySlot;
	}

	public void setIsInSpecialitySlot(final boolean slot)
	{
		specialtySlot = slot;
	}
	...
	public void addFeatToList(Feat aFeat)
	{
		if (featList == null)
	...
	public void addFeatsToList(ArrayList aList)
	{
		if (featList == null)
			featList = new ArrayList();
