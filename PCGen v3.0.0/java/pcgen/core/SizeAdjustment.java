...
public class SizeAdjustment extends Object
{
	...
	public void setType(String aString)
	{
		...
		{
			final String aType = (aTok.nextToken()).trim();
	...
	public void setMultiple(String aString)
	{
		...
		{
			GuiFacade.showMessageDialog(null, "Incorrect size count in size adjustment info", Constants.s_APPNAME, JOptionPane.ERROR_MESSAGE);
			return;
		}
		...
		while (aTok.hasMoreTokens())
		{
			final String aMult = aTok.nextToken();
