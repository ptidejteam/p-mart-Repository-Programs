 ...
 *
 * $Id: PCAlignmentLoader.java,v 1.1 2006/02/21 00:57:49 vauchers Exp $
 */
...
final class PCAlignmentLoader
{
	...
	public static void parseLine(PCAlignment obj, String inputLine, File sourceFile, int lineNum) throws PersistenceLayerException
	{
		...
		while (colToken.hasMoreTokens())
		{
			...
			{
				throw new PersistenceLayerException("Illegal alignment info " + sourceFile.getName() +
