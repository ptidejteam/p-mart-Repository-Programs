 ...
 *
 * $Id: PCClassLoader.java,v 1.1 2006/02/21 00:57:49 vauchers Exp $
 */
...
//					pcClass.setCheck3Type(colString);
				...
				default:
					...
					else if (colString.startsWith("AGESET:"))
					{
						...
						System.err.println("AGESET is a depreciated tag. This functionality is now handled in biosettings.lst");
					}
