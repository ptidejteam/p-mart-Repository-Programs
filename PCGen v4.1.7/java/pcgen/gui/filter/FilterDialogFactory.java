...
public final class FilterDialogFactory implements FilterConstants
{
	...
	public static String getSelectedFiltersToolTipText()
	{
		...
		if (f != null)
		{
			...
			{
				buffer.append("<br>" + in_curSelFil);
				int mode = f.getFilterMode();
				if (mode == MATCH_ALL)
				{
					buffer.append("<br>" + in_matchAllOf);
				}
				else if (mode == MATCH_ALL_NEGATE)
				{
					buffer.append("<br>" + in_matchNotAllOf);
				}
				else if (mode == MATCH_ANY)
				{
					buffer.append("<br>" + in_matchAnyOf);
				}
				else if (mode == MATCH_ANY_NEGATE)
				{
					buffer.append("<br>" + in_matchNotAnyOf);
				}
				buffer.append("<ul>");
			...
			{
				buffer.append("<br>" + in_curNoSelFil);
			}
		}
		else
		{
			buffer.append("<br>" + in_curActTab);
		}
...
final class FilterSelectDialog extends JDialog implements ActionListener, FilterConstants
{
	...
	FilterSelectDialog()
	{
		super(Globals.getRootFrame(), PropertyFactory.getString("in_filOp"));
		init();
	}
...
//                  saveButton.setPreferredSize( buttonDimension );
		...
		optionPanel.setBorder(BorderFactory.createTitledBorder(
			...
			PropertyFactory.getString("in_options"),
			TitledBorder.LEFT,
			TitledBorder.TOP,
		...
		else if (src.equals(saveButton))
		{
			...
			if (selectedModel.size() < 1)
			{
				...
				JOptionPane.showMessageDialog(null,
					PropertyFactory.getString("in_filterErP1") + Constants.s_LINE_SEP + PropertyFactory.getString("in_filterErP2"),
...
final class FilterNameDialog extends JDialog implements ActionListener, FilterConstants
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else
		{
			...
			{
				JOptionPane.showMessageDialog(null,
					PropertyFactory.getString("in_filterEr2P1") + " '" + name + "'!",
					PropertyFactory.getString("in_filterErWarn"),
					JOptionPane.ERROR_MESSAGE);
			}
			else
			{
				...
				JOptionPane.showMessageDialog(null,
					PropertyFactory.getString("in_filterEr3P1") + " '" +
					name.charAt(index) +
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if (src.equals(createButton))
		{
			...
			catch (FilterParseException ex)
			{
				...
				JOptionPane.showMessageDialog(null,
					ex.getMessage(),
					PropertyFactory.getString("in_error"),
					JOptionPane.ERROR_MESSAGE);
				ex.printStackTrace();
			}
			if (filter != null)
