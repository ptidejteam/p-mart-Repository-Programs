...
/**
 * @deprecated  As of ver 3.1.2 moved all of this functionality into InfoDescription.java
 * @author  Bryan McRoberts (merton_monk@yahoo.com)
 * @version $Revision: 1.1 $
 */

class InfoNotes extends JPanel
{
	...
	final class NoteTreeNode extends DefaultMutableTreeNode
	{
		NoteItem item;
