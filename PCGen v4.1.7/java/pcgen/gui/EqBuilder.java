/*
 * EqBuilder.java
 * @(#) $Id: EqBuilder.java,v 1.1 2006/02/21 00:57:40 vauchers Exp $
 *
	...
	private void jButtonWeightActionPerformed()
	{
		...
		if (selectedValue != null)
		{
			...
			try
			{
				...
				aNewEq.setWeightMod(new Float(newWeight.doubleValue() - aNewEq.getWeightAsDouble()));
				showItemInfo();
			}
			catch (Exception e)
			{
...
*/
	 ...
	 *
	 */
	final private class EquipmentModModel extends AbstractTableModel
	{
