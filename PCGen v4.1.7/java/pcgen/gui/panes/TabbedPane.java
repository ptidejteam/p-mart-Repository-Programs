...
public class TabbedPane extends JTabbedPane
{
	...
	private static final String[] tips
		= {PropertyFactory.getString("in_tabTips1"),
			 PropertyFactory.getString("in_tabTips2"),
			 PropertyFactory.getString("in_tabTips3"),
			 PropertyFactory.getString("in_tabTips4"),
			 PropertyFactory.getString("in_tabTips5"),
			 PropertyFactory.getString("in_tabTips6"),
			 PropertyFactory.getString("in_tabTips7"),
			 PropertyFactory.getString("in_tabTips8"),
			 PropertyFactory.getString("in_tabTips9"),
			 PropertyFactory.getString("in_tabTips10"),
			 PropertyFactory.getString("in_tabTips11"),
			 PropertyFactory.getString("in_tabTips12")};
	...
	protected final void addNewTabAt(int index, ActionEvent e)
	{
		add(new JPanel());
	}
