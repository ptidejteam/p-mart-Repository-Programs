...
public class SpinningTabbedPane extends JTabbedPane
{
	...
	private class NewMenuItem extends JMenuItem
	{
		NewMenuItem(int index)
		{
			...
			setMnemonic(PropertyFactory.getMnemonic("in_mn_new", 0));
	...
	private class CloseMenuItem extends JMenuItem
	{
		CloseMenuItem(int index)
		{
			...
			setMnemonic(PropertyFactory.getMnemonic("in_mn_close", 0));
	...
	private class LockMenuItem extends JMenuItem
	{
		LockMenuItem(int index)
		{
			...
			setMnemonic(PropertyFactory.getMnemonic("in_mn_lock", 0));
	...
	private class UnlockMenuItem extends JMenuItem
	{
		UnlockMenuItem(int index)
		{
			...
			setMnemonic(PropertyFactory.getMnemonic("in_mn_unlock", 0));
			setIcon(Utilities.LOCK_ICON);
		}
	}
	...
	private class RenameMenuItem extends JMenuItem
	{
		RenameMenuItem(int index, MouseEvent e)
		{
			...
			setMnemonic(PropertyFactory.getMnemonic("in_mn_rename", 0));
		}
	}
	...
	private class PlaceMenu extends JMenu
	{
		PlaceMenu(int placement)
		{
			...
			setMnemonic(PropertyFactory.getMnemonic("in_mn_placeTabs", 0));
	...
	private class MoveMenu extends JMenu
	{
		MoveMenu(int index)
		{
			...
			setMnemonic(PropertyFactory.getMnemonic("in_mn_movetab", 0));
	...
	private class GroupMenu extends JMenu
	{
		GroupMenu(int index, int placement)
		{
			...
			setMnemonic(PropertyFactory.getMnemonic("in_mn_groupTabs", 0));
	...
	private static final void addPopupMenuItems(JPopupMenu popupMenu, int index,
		MouseEvent e)
	{
	}

	private final void addNewTabAt(int index, ActionEvent e)
	{
		add(new JPanel());
	}
