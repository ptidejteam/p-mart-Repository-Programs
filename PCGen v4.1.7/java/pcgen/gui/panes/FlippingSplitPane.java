...
public final class FlippingSplitPane extends JSplitPane
{
	...
	private static final ImageIcon CENTER_ICON
		= Utilities.getImageIcon("resources/MediaStop16.gif");
	/** Icon for Flip item in popup menu. */
	private static final ImageIcon FLIP_ICON
		= Utilities.getImageIcon("resources/Refresh16.gif");
	/** Icon for Reset item in popup menu. */
	private static final ImageIcon RESET_ICON
		= Utilities.getImageIcon("resources/Redo16.gif");
	...
	private class CenterMenuItem extends JMenuItem
	{
		CenterMenuItem()
		{
			...
			setMnemonic(PropertyFactory.getMnemonic("in_mn_center", 0));
			setIcon(CENTER_ICON);
	...
	private class FlipMenuItem extends JMenuItem
	{
		FlipMenuItem()
		{
			...
			setMnemonic(PropertyFactory.getMnemonic("in_mn_flip", 0));
			setIcon(FLIP_ICON);
	...
	private class ResetMenuItem extends JMenuItem
	{
		ResetMenuItem()
		{
			...
			setMnemonic(PropertyFactory.getMnemonic("in_mn_reset", 0));
			setIcon(RESET_ICON);
	...
	private class ContinuousLayoutMenuItem extends JCheckBoxMenuItem
	{
		ContinuousLayoutMenuItem()
		{
			...
			setMnemonic(PropertyFactory.getMnemonic("in_mn_smothRes", 0));
	...
	private class OneTouchExpandableMenuItem extends JCheckBoxMenuItem
	{
		OneTouchExpandableMenuItem()
		{
			...
			setMnemonic(PropertyFactory.getMnemonic("in_mn_oneTouchExp", 0));
	...
	private class OptionsMenu extends JMenu
	{
		OptionsMenu()
		{
			...
			setMnemonic(PropertyFactory.getMnemonic("in_mn_options", 0));
