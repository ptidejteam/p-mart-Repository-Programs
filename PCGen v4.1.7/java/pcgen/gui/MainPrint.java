...
//		buttonPanel.add(templatePathButton);
	...
	private void getTemplatePath()
	{
		...
		fcTemplates.setCurrentDirectory(SettingsHandler.getPDFOutputSheetPath());
...
//  				unblock();
			...
			{
				Globals.errorPrint(ex.getMessage());
				JOptionPane.showMessageDialog(null,
...
//  				unblock();
	...
	private void printToFile(File outFile, int pcIndex) throws IOException
	{
		...
		final File template = new File(SettingsHandler.getPDFOutputSheetPath().getAbsolutePath() + File.separator +
...
//  			aPC.print(template, bw);
	...
	private class TemplateListModel extends AbstractListModel
	{
		...
		{
			final File templateFolder = SettingsHandler.getPDFOutputSheetPath();
	...
	private class ButtonListener implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			else if (src.equals(printButton))
			{
				...
				{
					JOptionPane.showMessageDialog(null,
						PropertyFactory.getString("in_printNoTemplate"),
						"PCGen",
						JOptionPane.ERROR_MESSAGE);
				}
				else
