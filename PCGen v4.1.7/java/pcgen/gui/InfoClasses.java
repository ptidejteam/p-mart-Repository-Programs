...
final class InfoClasses extends FilterAdapterPanel
{
	 ...
	 */
	final private class ClassModel extends AbstractTreeTableModel implements TreeTableModel
	{
...
// 			return;
	...
	private void updateCharacterInfo()
	{
		...
		lDefense.setText(Integer.toString(aPC.DefenseTotal()));
	...
	private void setInfoLabelText(PCClass aClass)
	{
		...
		if (aClass != null)
		{
			...
			b.append(" &nbsp;<b>" + PropertyFactory.getString("in_type") + "</b>:").append(aClass.getType());
			final String cString = aClass.preReqHTMLStrings(false);
			if (cString.length() > 0)
				b.append(" &nbsp;<b>" + PropertyFactory.getString("in_requirements") + "</b>:").append(cString);
			String bString = aClass.getSource();
			if (bString.length() > 0)
				b.append(" <b>" + PropertyFactory.getString("in_sourceLabel") + "</b>:").append(bString);
			...
			{
				b.append(" <b>" + PropertyFactory.getString("in_defense") + "</b>:").append(aClass.defenseString());
				b.append(" <b>" + PropertyFactory.getString("in_reputation") + "</b>:").append(aClass.getReputationString());
			}
			...
			{
				b.append(" <b>" + PropertyFactory.getString("in_spellType") + "</b>:").append(aClass.getSpellType());
				b.append(" <b>" + PropertyFactory.getString("in_baseStat") + "</b>:").append(aClass.getSpellBaseStat());
			}
				...
				if (!e.getValueIsAdjusting())
				{
					...
					if (temp == null)
					{
						...
						JOptionPane.showMessageDialog(null,
							PropertyFactory.getString("in_clNoClass"), Constants.s_APPNAME, JOptionPane.ERROR_MESSAGE);
						return;
					}
	...
	private void addClass(ActionEvent evt, int levels)
	{
		if (Globals.getGameModeAlignmentText().length() != 0)
		{
			...
			{
				JOptionPane.showMessageDialog(null,
					PropertyFactory.getString("in_clSelAlign"), Constants.s_APPNAME, JOptionPane.ERROR_MESSAGE);
				return;
			}
		}
