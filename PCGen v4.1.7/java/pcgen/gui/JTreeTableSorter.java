...
//Globals.debugPrint("sortNodeOnColumn start: " + java.util.Calendar.getInstance().getTime());
...
//Globals.debugPrint("sortNodeOnColumn end: " + java.util.Calendar.getInstance().getTime());
		return node;
	}
