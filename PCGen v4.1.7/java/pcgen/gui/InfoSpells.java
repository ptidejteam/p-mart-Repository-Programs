...
//Globals.errorPrint("MMaddSB:MMaddSpell: " + className + ":" + spLevel + ":" + aSpell.getName() + ":" + bookName + ":feats:"+selFeatList.size());
	 ...
	 * created    den 11 maj 2001
	 */
	final class SpellFeatModel extends AbstractTableModel
	{
		/**
		 *  Contains the feats
		 *
	 ...
	 **/
	final class SpellModel extends AbstractTreeTableModel implements TreeTableModel
	{
 ...
 */
	...
	final class MMFrame extends JFrame
	{
		MainMM mainMM = null;
...
//  			contentPane.add(mainMM);
	...
	final class MainMM extends JPanel
	{
