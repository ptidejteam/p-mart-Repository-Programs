...
public final class FOPResourceChecker
{
	...
	static
	{
		...
		//TODO: optimize stringbuffer initial size
	...
	private static void checkResource()
	{
		...
		{
			resourceBuffer.append("Missing resource: fop.jar not found." + Constants.s_LINE_SEP);
		...
		{
			resourceBuffer.append("Missing resource: xalan.jar not found." + Constants.s_LINE_SEP);
			missingResourceCount++;
		}
		try
		{
		...
		{
			resourceBuffer.append("Missing resource: xerces.jar not found." + Constants.s_LINE_SEP);
			missingResourceCount++;
		}
		try
		{
		...
		{
			resourceBuffer.append("Missing resource: batik.jar not found." + Constants.s_LINE_SEP);
			missingResourceCount++;
		}
