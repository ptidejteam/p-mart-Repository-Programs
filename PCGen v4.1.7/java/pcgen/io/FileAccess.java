...
public final class FileAccess
{
	...
	private static HashMap outputFilter = null;

// --Recycle Bin START (10/15/02 9:04 PM):
//	public static String getCurrentOutputFilter()
//	{
//		return outputFilterName;
//	}
// --Recycle Bin STOP (10/15/02 9:04 PM)

	static void setCurrentOutputFilter(String filterName)
	{
		...
		final File aFile = new File(filterName);
		try
		{
	...
	static void encodeWrite(Writer output, String aString)
	{
