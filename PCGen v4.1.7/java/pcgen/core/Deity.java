...
public final class Deity extends PObject
{
	...
	private void buildDomainList()
	{
		if ((domainList == null) || (domainList.size() == 0))
		{
			...
			else
			{
				...
				domainList.ensureCapacity(colToken.countTokens());
				...
				while (colToken.hasMoreTokens())
				{
					...
					if (nextTok.length() > 0)
					{
						domainList.add(Globals.getDomainKeyed(nextTok));
					}
	 ...
	 * @param aString String containing the numeric alignments (with no spaces
	...
	/**
	 * This method sets a description of this deity.
	 * @param aDescription String description of this deity.
	 */
	 ...
	 * to this deity.
	 * @return ArrayList of String names of races
	 */
	 ...
	 * @return ArrayList containing the names of the pantheons this deity belongs to
	 */
	 ...
	 * should be included
	 */
	public String preReqHTMLStrings(boolean includeHeader) throws NoSuchElementException
	{
		final ArrayList prereqs = new ArrayList();
		addPreReqTo(prereqs);
	 ...
	 * @param aList ArrayList of SpecialAbility objects granted by
	 * this deity.
	 */
