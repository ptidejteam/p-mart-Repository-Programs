...
public class AllJUnitTests extends TestCase
{
	...
	public static Test suite()
	{
		...
		suite.addTest(test.pcgen.AllJUnitTests.suite());
		suite.addTest(test.pcgen.core.AllJUnitTests.suite());
		suite.addTest(test.pcgen.gui.AllJUnitTests.suite());
		suite.addTest(test.pcgen.xml.AllJUnitTests.suite());
		return suite;
	}
