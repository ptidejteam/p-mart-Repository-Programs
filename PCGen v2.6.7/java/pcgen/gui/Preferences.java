...
public class Preferences extends JMenu
{
	...
	private void jbInit() throws Exception
	{
		...
		featAutoColor.setForeground(new Color(Globals.getFeatAutoColor()));
		featAutoColor.addActionListener(colorListener);
		featVirtualColor.setForeground(new Color(Globals.getFeatVirtualColor()));
	...
	private final class ColorListener implements ActionListener
	{
		public void actionPerformed(ActionEvent actionEvent)
		{
			...
			if (newColor != null)
			{
				...
				{
					Globals.setFeatAutoColor(newColor.getRGB());
				}
				else if (source == featVirtualColor)
				{
					Globals.setFeatVirtualColor(newColor.getRGB());
				}
			}
		}
	}
		...
		public void actionPerformed(ActionEvent actionEvent)
		{
			...
			else if (source == templateEqSet)
			{
				...
				if (fc.showOpenDialog(getParent().getParent()) == JFileChooser.APPROVE_OPTION) //ugly, but it works
				{
					...
					{
						//it must be a psheet
						Globals.setSelectedEqSetTemplate(newTemplate.getAbsolutePath());
						Globals.setTemplatePath(newTemplate.getParentFile());
					}
				}
			}
