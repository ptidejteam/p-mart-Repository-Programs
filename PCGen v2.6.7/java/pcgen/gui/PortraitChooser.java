...
{
//          private final static String default_portrait_name = File.separator + Globals.s_NONE + ".";
	private static final String default_portrait_name = Globals.s_NONE;

	/* a filename filter for jpg and gif files */
	...
	static
	{
		directory = new File(Globals.getDefaultPath());
	...
	public PortraitChooser()
	{
		...
		if (default_portrait == null)
		{
			default_portrait = Toolkit.getDefaultToolkit().getImage(
				this.getClass().getResource("/pcgen/gui/resource/DefaultPortrait.gif"));
		}
	...
	private void initComponents()
	{
		...
		portraitLabel.addComponentListener(new java.awt.event.ComponentAdapter()
		{
		...
		JPanel portraitPanel = new JPanel(new java.awt.GridLayout(1, 1));
		...
		this.add(portraitPanel, 0, 0, 2, 1);
		...
		dirButton.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				if (JFC.showOpenDialog(PortraitChooser.this) == JFileChooser.APPROVE_OPTION)
				{
	 ...
	 * <br>author: Thomas Behr 18-04-02
	 */
	private class PortraitModel extends javax.swing.AbstractListModel implements javax.swing.ComboBoxModel
	{
