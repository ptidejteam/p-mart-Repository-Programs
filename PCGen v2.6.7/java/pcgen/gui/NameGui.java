...
//    buttonAndNameBox.add(Box.createVerticalGlue());
	...
	class AcceptListener implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			if ("".equals(generatedName.getText()))
			{
				Toolkit.getDefaultToolkit().beep();
				return;
			}
			...
			{
				PCGen_Frame1.setTabName(Globals.getCurrentPC(), generatedName.getText());
				Globals.getCurrentPC().setName(generatedName.getText());
				/**
				 * added this to address bug #495558
				 *
				 * author: Thomas Behr 20-12-01
				 */
				PCGen_Frame1.getCurrentCharacterInfo().setTxtName(generatedName.getText());
			}
			else
			{
				Toolkit.getDefaultToolkit().beep();
