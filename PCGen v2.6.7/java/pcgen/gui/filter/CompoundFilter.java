...
public class CompoundFilter extends AbstractPObjectFilter implements CustomFilter, FilterConstants
{
	private String connect;
	private PObjectFilter filter1;
	private PObjectFilter filter2;

	public CompoundFilter(PObjectFilter filter1, PObjectFilter filter2, String connect)
	{
		super();
