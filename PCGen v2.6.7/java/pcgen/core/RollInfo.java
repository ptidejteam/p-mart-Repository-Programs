 ...
 *
 * $Id: RollInfo.java,v 1.1 2006/02/20 23:57:30 vauchers Exp $
 */
...
public class RollInfo
{
	...
	public String toString()
	{
		...
		if (modifier > 0)
			buf.append("+" + modifier);
		else if (modifier < 0) buf.append("-" + -modifier);

		if (totalFloor != Integer.MIN_VALUE) buf.append("t" + totalFloor);
		if (totalCeiling != Integer.MAX_VALUE) buf.append("T" + totalCeiling);
