 ...
 *
 * $Id: Constants.java,v 1.1 2006/02/20 23:57:30 vauchers Exp $
 */
package pcgen.core;
...
public interface Constants
{
	...
	/** Abbrievation for Strength */
	String STRENGTH_ABBR = "STR";
	/** Abbrievation for Dexterity */
	String DEXTERITY_ABBR = "DEX";
	/** Abbreviation for Constitution */
	String CONSTITUTION_ABBR = "CON";
	/** Abbreviation for Intelligence */
	String INTELLIGENCE_ABBR = "INT";
	/** Abbreviation for Wisdom */
	String WISDOM_ABBR = "WIS";
	/** Abbreviation for Charisma */
	String CHARISMA_ABBR = "CHA";
