...
public class Deity extends PObject
{
	...
	private String followerAlignments = "TN";
	...
	{
		final boolean flag = followerAlignments.lastIndexOf(String.valueOf(index)) > -1;
	...
	public String preReqHTMLStrings(boolean includeHeader)
	{
		...
		addPreReqTo(prereqs);
		prereqs.add("PREALIGN:" + Utility.commaDelimit(followerAlignments));
