...
/*
 * $Header: /home/cvs/cvsgelo/cvsroot/guehene-dpl-pcgen\040v2.6.7/java/pcgen/core/CharacterFeat.java,v 1.1 2006/02/20 23:57:30 vauchers Exp $
 */
package pcgen.core;
...
public class CharacterFeat
{
	...
	public boolean isInList(String aType)
	{
		...
		return containsAssociated(aType);
	}
	...
	{
		Utility.modChoices(feat, addIt, new ArrayList(), new ArrayList(), true);
	}
	...
	public int addStatBonuses(String aString)
	{
		...
		for (int e=0; e<getAssociatedCount(); e++)
		{
			PCClass aClass = (PCClass)aPC.getClassNamed(getAssociated(e));
