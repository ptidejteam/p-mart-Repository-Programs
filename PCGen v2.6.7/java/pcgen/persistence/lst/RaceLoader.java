 ...
 *
 * $Id: RaceLoader.java,v 1.1 2006/02/20 23:57:40 vauchers Exp $
 */
...
public class RaceLoader
{
	...
	public static void parseLine(Race obj, String inputLine, File sourceFile, int lineNum) throws PersistenceLayerException
	{
		...
		while (colToken.hasMoreTokens())
		{
			...
			{
				obj.setFavoredClass(colString.substring(9));
			}
			else if (colString.startsWith("XTRASKILLPTSPERLVL:"))
			{
				obj.setBonusSkillsPerLevel(Integer.parseInt(colString.substring(19)));
			}
