 ...
 *
 * $Id: PCTemplateLoader.java,v 1.1 2006/02/20 23:57:40 vauchers Exp $
 */
...
public class PCTemplateLoader
{
	...
	public static void parseLine(PCTemplate obj, String inputLine, File sourceFile, int lineNum) throws PersistenceLayerException
	{
		...
		while (colToken.hasMoreTokens())
		{
			...
			{
				String DR = "".equals(obj.getDR())
					? colString.substring(3)
					: obj.getDR() + "," + colString.substring(3);
				obj.setDR(DR);
			}
				...
				obj.setNonProficiencyPenalty(Integer.parseInt(colString.substring(6)));
			...
			else if (colString.startsWith("SPELL:"))
				obj.addSpells(colString.substring(6));
