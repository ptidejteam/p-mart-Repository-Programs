...
public interface RecipientHandler extends java.io.Serializable {
    ...
    static final long serialVersionUID = 2907475233293971071L;
    ...
    */
    ...
    /** 
    * Look for an email address. This methodd returns the
    * RecipientType identifier of the recipient if it exists,
    * and -1 if not.
    */
