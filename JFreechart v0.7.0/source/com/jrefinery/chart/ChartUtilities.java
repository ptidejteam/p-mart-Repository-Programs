 ...
 * --------------------
 * (C) Copyright 2001 by Simba Management Limited and Contributors.
 *
 * Original Author:  David Gilbert (for Simba Management Limited);
 * Contributor(s):   Wolfgang Irler;
 *
 * $Id: ChartUtilities.java,v 1.1 2007/10/10 18:54:39 vauchers Exp $
 *
 * Changes
 * -------
...
public class ChartUtilities {
    ...
    public static void saveChartAsJPEG(File file, JFreeChart chart, int width, int height) {
        ...
        try {
            ...
            System.out.println("Problem in SaveChartAsJPEG: ");
            System.out.println(e.getMessage());
        }
