/*
 * (c) Copyright 2004 Farouk Zaidi and Yann-Gaël Guéhéneuc
...
public class DeepMethodInvocationAnalyzer {
	...
	private static final int[][] OPCODE_ARITIES =
		{
				{ JVMConstants.INEG, JVMConstants.LNEG, JVMConstants.DNEG,
						...
						JVMConstants.D2L, JVMConstants.D2F,
						JVMConstants.ISTORE, JVMConstants.ISTORE_0,
						JVMConstants.ISTORE_1, JVMConstants.ISTORE_2,
						JVMConstants.ISTORE_3, JVMConstants.ASTORE,
						JVMConstants.ASTORE_0, JVMConstants.ASTORE_1,
						JVMConstants.ASTORE_2, JVMConstants.ASTORE_3,
						JVMConstants.FSTORE, JVMConstants.FSTORE_0,
						JVMConstants.FSTORE_1, JVMConstants.FSTORE_2,
						JVMConstants.FSTORE_3, JVMConstants.LSTORE,
						JVMConstants.LSTORE_0, JVMConstants.LSTORE_1,
						JVMConstants.LSTORE_2, JVMConstants.LSTORE_3,
						JVMConstants.DSTORE, JVMConstants.DSTORE_0,
						JVMConstants.DSTORE_1, JVMConstants.DSTORE_2,
						JVMConstants.DSTORE_3, JVMConstants.ARRAYLENGTH,
						JVMConstants.IFNONNULL, JVMConstants.IFNULL,
						JVMConstants.IFEQ, JVMConstants.IFNE,
						JVMConstants.IFLT, JVMConstants.IFGE,
						JVMConstants.IFGT, JVMConstants.IFLE,
						JVMConstants.IINC, JVMConstants.IRETURN,
				...
				{ JVMConstants.IADD, JVMConstants.LADD, JVMConstants.FADD,
						JVMConstants.DADD, JVMConstants.ISUB,
						JVMConstants.LSUB, JVMConstants.FSUB,
						JVMConstants.DSUB, JVMConstants.IMUL,
						JVMConstants.LMUL, JVMConstants.FMUL,
						JVMConstants.DMUL, JVMConstants.IDIV,
						JVMConstants.LDIV, JVMConstants.FDIV,
						JVMConstants.DDIV, JVMConstants.IREM,
						JVMConstants.LREM, JVMConstants.FREM,
						JVMConstants.DREM, JVMConstants.ISHL,
						JVMConstants.LSHL, JVMConstants.ISHR,
						JVMConstants.LSHR, JVMConstants.IUSHR,
						JVMConstants.LUSHR, JVMConstants.IAND,
						JVMConstants.LAND, JVMConstants.IOR, JVMConstants.LOR,
						JVMConstants.IXOR, JVMConstants.LXOR,
						JVMConstants.IALOAD, JVMConstants.LALOAD,
						JVMConstants.FALOAD, JVMConstants.DALOAD,
						JVMConstants.AALOAD, JVMConstants.BALOAD,
						JVMConstants.CALOAD, JVMConstants.SALOAD,
						JVMConstants.LCMP, JVMConstants.FCMPL,
						JVMConstants.DCMPL, JVMConstants.FCMPG,
						JVMConstants.DCMPG, JVMConstants.IF_ACMPNE,
						JVMConstants.IF_ACMPEQ, JVMConstants.IF_ICMPEQ,
						JVMConstants.IF_ICMPNE, JVMConstants.IF_ICMPLT,
						JVMConstants.IF_ICMPGE, JVMConstants.IF_ICMPGT,
						JVMConstants.IF_ICMPLE },
	...
	private String[] makeCoupleAfterALoad0(
		...
		if (opCodeAfterAload0 == JVMConstants.GETFIELD) {
			...
			if (opCodeAfterAload0 == JVMConstants.DUP
				...
				String[] classAndField =
					getInfosAt2Bytes(offsetALoad0 + 3, rawCode, aMethodInfo
						.getDeclaringClassConstantPool());
	...
	private String[] makeCoupleForStaticAttributes(
		...
		final String[] couple = new String[2];
		final String[] infos =
			getInfosAt2Bytes(offset + 1, rawCode, aMethodInfo
				.getDeclaringClassConstantPool());
	...
	private int processPushPop(
		...
		if (getOpCode(methodOffset, rawCode) != JVMConstants.INSTANCEOF) {
			infosOfMethod =
				this.getInfosAt2Bytes(methodOffset + 1, rawCode, aMethodInfo
					.getDeclaringClassConstantPool());
		}
		else {
	...
	private int processStoreOperator(
		...
		if (opCode == JVMConstants.PUTFIELD || opCode == JVMConstants.PUTSTATIC) {
			...
			final String[] couple = new String[2];
			final String[] infos =
				this.getInfosAt2Bytes(operatorOffset + 1, rawCode, aMethodInfo
					.getDeclaringClassConstantPool());
