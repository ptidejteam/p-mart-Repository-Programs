 ...
 */
/*
 * $Id: EnvironmentCheck.java,v 1.1 2006/03/01 21:16:02 vauchers Exp $
 */
 ...
 * @version $Id: EnvironmentCheck.java,v 1.1 2006/03/01 21:16:02 vauchers Exp $
 */
public class EnvironmentCheck
{
  ...
  protected boolean writeEnvironmentReport(Hashtable h)
  {
    ...
    logMsg(
      "#---- BEGIN writeEnvironmentReport($Revision: 1.1 $): Useful stuff found: ----");
  ...
  public void appendEnvironmentReport(Node container, Document factory, Hashtable h)
  {
    ...
    try
    {
      ...
      envCheckNode.setAttribute("version", "$Revision: 1.1 $");
