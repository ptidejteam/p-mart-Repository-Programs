...
/**
 * A Variable is something that alters a computed variable within pcgen.  Examples include stats, saves, and base attack bonuses.
 * @author Scott Ellsworth
...
public class Variable
{
	...
	public Variable(String inDefinition)
	{
		...
		else if (stringTokenizer.countTokens() != 3)
		{
			...
			System.out.println("ERROR: variable " + definition + " does not have two or three pipe-separated values");
		...
		//System.out.println("Creating variable "+definition);
	}
