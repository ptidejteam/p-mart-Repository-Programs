 ...
 *
 * $Id: Utility.java,v 1.1 2006/02/21 01:07:41 vauchers Exp $
 */
package pcgen.core;
...
public final class Utility
{
	...
	{
		return unSplit(strings, separator + " ");
	}
	...
	static boolean modChoices(PObject obj, ArrayList availableList, ArrayList selectedList, boolean process)
	{
		...
		else if ("SPELLS".equals(choiceType))
		{
			...
			while (aTok.hasMoreTokens())
			{
				...
				{
					ArrayList aList = Globals.getSpellsIn(lvl, className, domainName);
...
//		return fileName.toString();
	...
	{
		if (aFile.startsWith("http:") || aFile.startsWith("ftp:"))
		{
			return true;
		}
		else
