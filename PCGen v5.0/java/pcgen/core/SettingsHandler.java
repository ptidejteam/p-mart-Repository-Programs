...
public final class SettingsHandler
{
	...
	private static File pcgenFilesDir = null;
...
//	private static int pcgSaveFormat = 2;
	...
	private static void readFilePaths()
	{
		...
		catch (IOException e)
		{
			...
			Globals.debugPrint("No filepaths.ini file found, will create one when exiting.");
		}
		finally
		{
			try
			...
			catch (IOException ex)
			{
				...
				Globals.errorPrint("Can't close filepaths.ini file", ex);
			}
		}
	}
...
/////////////////////////////////////////////////
	...
	public static void writeOptionsProperties()
	{
		...
		{
			Globals.errorPrint("Can't write options file", e);
		}
		finally
		{
			try
	...
	public static void writeFilePaths()
	{
		...
		if (fType.equals("user"))
		{
			...
			if (!aFile.exists())
			{
				...
				aFile.mkdir();
				Globals.errorPrint(aLoc + " doesn't exist. Creating");
			}
			else if (!aFile.isDirectory())
			{
				JOptionPane.showMessageDialog(null, "ERROR: " + aLoc + " is not a Directory", Constants.s_APPNAME, JOptionPane.ERROR_MESSAGE);
			}
		}
		...
		{
			Globals.errorPrint("Can't write filepaths.ini file", e);
		}
		finally
		{
			try
			...
			{
				// Not much to do about it...
				Globals.errorPrint("Can't close filepaths.ini file after writing", ex);
			}
		}
	}
...
//	}
	...
	public static void setPcgenFilesDir(final File aFile)
	{
		...
		if (aFile != null)
		{
			setFilePaths(aFile.getAbsolutePath());
		}
	}
