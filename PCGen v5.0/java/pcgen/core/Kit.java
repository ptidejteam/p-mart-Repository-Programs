...
public final class Kit extends PObject implements Comparable
{
	...
	/**
	 * Method addKitSkills
	 * @param thingsToAdd ArrayList
	 * @param warnings ArrayList
	 */
...
//System.err.println("eqMods=" + eqMods);
...
//System.err.println("not found");
	 ...
	 * @param kitNo int
	 */
	public void processKit(ArrayList thingsToAdd, int kitNo)
	{
		BigDecimal goldSpent = new BigDecimal("0");
