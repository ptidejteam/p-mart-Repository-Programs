 ...
 *
 * @(#) $Id: CustomData.java,v 1.1 2006/02/21 01:07:41 vauchers Exp $
 */
...
public final class CustomData
{
	...
	private static void writeCustomPObjects(String filename, Iterator it)
	{
		...
		{
			Globals.errorPrint("Error in writeCustomPObjects", e);
		}
		finally
		{
			try
			...
			{
				Globals.errorPrint("Error in writeCustomPObjects while closing", ex);
			}
		}
	}
	...
	private static void writeCustomBioSet()
	{
		...
		{
			Globals.errorPrint("Error in writeCustomBioSet", e);
		}
		finally
		{
			try
			...
			{
				Globals.errorPrint("Error in writeCustomBioSet while closing", ex);
			}
		}
	...
	private static void writeCustomSpells()
	{
		...
		{
			Globals.errorPrint("Error in writeCustomSpells", e);
		}
		finally
		{
			try
			...
			{
				Globals.errorPrint("Error in writeCustomSpells while closing", ex);
			}
		}
	}
	...
	public static void writeCustomItems()
	{
		...
		{
			Globals.errorPrint("Error in writeCustomItems", e);
		}
		finally
		{
			try
			...
			{
				Globals.errorPrint("Error in writeCustomItems while closing", ex);
			}
		}
	}
	...
	public static void writePurchaseModeConfiguration()
	{
		...
		{
			Globals.errorPrint("Error in writePurchaseModeConfiguration", e);
		}
		finally
		{
			try
			...
			{
				Globals.errorPrint("Error in writePurchaseModeConfiguration while closing", ex);
			}
		}
	}
