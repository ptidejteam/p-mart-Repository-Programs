 ...
 *
 * $Id: WeaponProfDataStore.java,v 1.1 2006/02/21 01:07:42 vauchers Exp $
 */
package pcgen.core;
...
public class WeaponProfDataStore
{
	...
	public final ArrayList getArrayCopy()
	{
	...
	{
		return getNames(delim, addArrayMarkers);
	}

	public final void addUniqueAsStringTo(ArrayList dest)
	{
