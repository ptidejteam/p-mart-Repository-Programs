...
public final class Campaign extends PObject
{
	...
	private HashMap publisherMap = new HashMap();
	...
	public ArrayList getSection15AsList()
	{
	...
	public ArrayList getLicenseFiles()
	{
		return licenseFiles;
	}

	public ArrayList getLicenseAsList()
	{
		ArrayList aList = new ArrayList();
		if (licenseText != null)
		{
	...
	public void addPublisher(String arg)
	{
		if (arg.startsWith("PUBNAME"))
		{
			arg = arg.substring(7);
		}
		String key = arg.substring(0, arg.indexOf(":"));
		publisherMap.put(key, arg.substring(arg.indexOf(":") + 1));
	}
