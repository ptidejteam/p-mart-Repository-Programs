 ...
 *
 * $Id: SkillLoader.java,v 1.1 2006/02/21 01:07:48 vauchers Exp $
 */
...
final class SkillLoader
{
	...
	public static void parseLine(Skill obj, String inputLine, URL sourceURL, int lineNum) throws PersistenceLayerException
	{
		...
		while (colToken.hasMoreTokens())
		{
			...
			{
				Globals.errorPrint("SYNERGY is a deprecated tag. This functionality is now handled using the BONUS tag.");
