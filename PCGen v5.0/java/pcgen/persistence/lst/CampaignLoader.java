 ...
 *
 * $Id: CampaignLoader.java,v 1.1 2006/02/21 01:07:48 vauchers Exp $
 */
...
final class CampaignLoader
{
	...
	public static void parseLine(Campaign campaign, String inputLine, URL sourceURL)
	{
		...
		{
			campaign.setGame(inputLine.substring(9));
		}
		...
		else if (inputLine.startsWith("OPTION:"))
		{
			...
			{
				Globals.errorPrint("Invalid option line in source file " + sourceURL.toString() + " : " + inputLine);
			}
		}
