 ...
 *
 * $Id: PCClassLoader.java,v 1.1 2006/02/21 01:07:48 vauchers Exp $
 */
...
//					pcClass.setCheck3Type(colString);
				...
				default:
					...
					{
						Globals.errorPrint("GOLD: tag in " + sourceURL.toString() + " no longer supported due to OGL compliance");
					}
					...
					{
						Globals.debugPrint("SUBSA: tag in " + sourceURL.toString() + " ignored");
					}
