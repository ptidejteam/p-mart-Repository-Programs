 ...
 *
 * $Id: DomainLoader.java,v 1.1 2006/02/21 01:07:48 vauchers Exp $
 */
...
final class DomainLoader
{
	...
	public static void parseLine(Domain obj, String inputLine, URL sourceURL, int lineNum) throws PersistenceLayerException
	{
		...
		while (colToken.hasMoreTokens())
		{
			...
			{
				Globals.debugPrint("SKILL: support for " + sourceURL.toString() + " has been removed. Use CSKILL: instead");
			}
