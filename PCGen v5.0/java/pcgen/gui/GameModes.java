...
final class GameModes extends JMenu
{
	...
	private void updateMenu()
	{
		...
		{
			(Globals.getRootFrame()).setGameModeTitle();
		}
	}
		...
		public void actionPerformed(ActionEvent actionEvent)
		{
			...
			if (campaignNum >= 0)
			{
				...
				try
				{
					...
					{
						JOptionPane.showMessageDialog(Globals.getRootFrame(), PropertyFactory.getString("in_campaignChangeError"), Constants.s_APPNAME, JOptionPane.INFORMATION_MESSAGE);
						return;
					}
