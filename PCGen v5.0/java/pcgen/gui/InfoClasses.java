...
//						experienceFocusLost(null); // force xp messages as neccessary
	...
	private static boolean maybeSetExperience(int xp)
	{
		...
		aPC.setXP(xp);
		if (xp >= aPC.minXPForNextECL())
		{
			JOptionPane.showMessageDialog(null, SettingsHandler.getGame().getLevelUpMessage(), Constants.s_APPNAME, JOptionPane.INFORMATION_MESSAGE);
		}
		return true;
	}
	...
	private void updateCharacterInfo()
	{
		...
		int mytempvar = (int) aPC.getTotalBonusTo("VAR", Globals.getGameModeVariableDisplayName(), true);
		lVariableDisplay.setText(Integer.toString(mytempvar));
		int mytempvar2 = (int) aPC.getTotalBonusTo("VAR", Globals.getGameModeVariableDisplay2Name(), true);
		lVariableDisplay2.setText(Integer.toString(mytempvar2));
		int mytempvar3 = (int) aPC.getTotalBonusTo("VAR", Globals.getGameModeVariableDisplay3Name(), true);
	...
	private void updateXP()
	{
		...
		txtNextLevel.setValue(aPC.minXPForNextECL());
	}
