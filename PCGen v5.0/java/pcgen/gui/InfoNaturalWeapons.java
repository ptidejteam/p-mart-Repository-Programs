 ...
 *
 * @(#) $Id: InfoNaturalWeapons.java,v 1.1 2006/02/21 01:07:48 vauchers Exp $
 */
...
//System.err.println("before: " + naturalWeapons);
			Collections.sort(naturalWeapons, new Comparator()
			{
				public final int compare(final Object o1, final Object o2)
				{
					...
					return ((Equipment) o1).getName().compareTo(((Equipment) o2).getName());
				}
			});
...
//System.err.println(aPC.getKitInfo());
		...
		for (int i = 0; i < weaponCount; ++i)
		{
			...
			final int wpBonus = (int) aPC.getTotalBonusTo("WEAPONPROF=" + eq.profName(), "TOHIT", true);
...
//System.err.println("wpBonus=" + wpBonus);
			...
			{
				toHit -= 5 - (int) aPC.getTotalBonusTo("COMBAT", "TOHIT-SECONDARY", true);
			}
			else
			{
				//
				...
				//
				toHit += (int) aPC.getTotalBonusTo("COMBAT", "TOHIT-PRIMARY", true);
			}
			if (eq.isMelee())
			{
