 ...
 *
 * @(#) $Id: SourceBasePanel.java,v 1.1 2006/02/21 01:07:44 vauchers Exp $
 */
...
class SourceBasePanel extends BasePanel
{
	...
	public void updateView(PObject thisPObject)
	{
		...
		if (a.equals(""))
		{
			a = theCampaign.getSourceFile().toString();
	...
	final class SourceTableModel extends AbstractTableModel
	{
		...
		ArrayList optionValues = null;
		ArrayList licenseList = null;
		ArrayList copyrightList = null;
		...
		public ArrayList getCopyrightList()
		{
			return copyrightList;
		}

		public void setLists(ArrayList optList, ArrayList licList, ArrayList copyList)
		{
		...
		public void setValueAt(Object aValue, int rowIndex, int columnIndex)
		{
			...
			if (rowIndex < copyrightList.size())
			{
				copyrightList.set(rowIndex, (String) aValue);
				return;
			}
			rowIndex -= copyrightList.size();
			if (rowIndex < licenseList.size())
			{
				licenseList.set(rowIndex, (String) aValue);
				return;
			}
		}
	}
