 ...
 *
 * @(#) $Id: JListModel.java,v 1.1 2006/02/21 01:07:44 vauchers Exp $
 */
...
final class JListModel extends AbstractListModel
{
	...
	private void initModel(ArrayList argListData, boolean argSort)
	{
		sort = argSort;
		setData(argListData);
	}

	public void setData(ArrayList argListData)
	{
		listData = (ArrayList) argListData.clone();
		if (sort)
		{
...
//	}
	...
	void addElementAt(int index, Object obj, final boolean allowDup)
	{
		if (allowDup || !listData.contains(obj))
		{
			addElement(index, obj);
		}
	}
