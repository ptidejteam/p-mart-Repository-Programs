 ...
 *
 * @(#) $Id: SourceFilesPanel.java,v 1.1 2006/02/21 01:07:44 vauchers Exp $
 */
...
final class SourceFilesPanel extends JPanel
{
	...
	private void initComponents()
	{
		...
		aButton.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent evt)
			{
				...
				if (d == null || d.equals(""))
				{
					d = theCampaign.getSourceFile().toString();
	...
	public void updateView(PObject thisPObject)
	{
		...
		ArrayList aList = theCampaign.getLines();
	...
	{
		ArrayList fList = fileModel.getFileList();
		ArrayList lList = fileModel.getLocationList();
	...
	final class SourceFileModel extends AbstractTableModel
	{
		...
		public void setFileList(ArrayList aList)
		{
			fileList = aList;
		}

		public void setLocationList(ArrayList aList)
		{
			locationList = aList;
		}
		...
		public String getColumnName(int columnIndex)
		{
			...
			switch (columnIndex)
			{
				...
				case 1:
					...
					break;
				default:
					Globals.errorPrint("Unhandled column " + columnIndex + " at SourceFilesPanel.getColumnName");
					break;
			}
			return rc;
		}
		...
		public Object getValueAt(int rowIndex, int columnIndex)
		{
			...
			switch (columnIndex)
			{
				...
				default:
					Globals.errorPrint("Unhandled column " + columnIndex + " at SourceFilesPanel.getValueAt");
					break;
			}
			return rc;
		}
