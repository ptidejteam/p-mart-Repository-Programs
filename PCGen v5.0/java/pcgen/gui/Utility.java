...
public final class Utility
{
	...
	public static final void setGuiTextInfo(Object obj, String in_String)
	{
		if (properties == null)
		{
			...
			{
				Globals.errorPrint("Exception in Utility::setGuiTextInfo", mrex);
			}
		}
	 ...
	 */
	static void buildConstraints(GridBagConstraints gbc, int gx, int gy, int gw, int gh, double wx, double wy)
	{
		gbc.gridx = gx;
		gbc.gridy = gy;
		gbc.gridwidth = gw;
