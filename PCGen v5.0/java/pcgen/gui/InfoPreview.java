...
public final class InfoPreview extends JPanel
{
	...
	private static File getTempPreviewFile()
	{
		...
		catch (IOException ioe)
		{
			...
			Globals.errorPrint("Could not create temporary preview file.", ioe);
		}
  ...
  */
	...
	private void previewInternal()
	{
		...
		catch (IOException ex)
		{
			...
			Globals.errorPrint("Could not preview file. It probably looks ok in a browser though.", ex);
		}
	...
	public static void previewInBrowser()
	{
		...
		catch (Exception ex)
		{
			...
			Globals.errorPrint("Could not preview file in external browser. Sorry...", ex);
		}
