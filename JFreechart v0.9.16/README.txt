...
(jfreechart-0.9.16-install.pdf) from the JFreeChart home
...
it you need the files jcommon-0.9.1.jar, jfreechart-0.9.16.jar and
jfreechart-0.9.16-demo.jar.
...
java -classpath lib/jcommon-0.9.1.jar:jfreechart-0.9.16.jar:jfreechart-0.9.16-demo.jar org.jfree.chart.demo.JFreeChartDemo
