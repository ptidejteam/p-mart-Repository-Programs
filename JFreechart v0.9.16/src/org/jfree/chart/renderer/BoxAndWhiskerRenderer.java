 ...
 *                   Tim Bardzil;
 *
 * $Id: BoxAndWhiskerRenderer.java,v 1.1 2007/10/10 19:25:28 vauchers Exp $
 *
 * Changes
 * -------
...
public class BoxAndWhiskerRenderer extends AbstractCategoryItemRenderer {
    ...
    public void drawHorizontalItem(Graphics2D g2,
        ...
        if (xQ1 != null && xQ3 != null && xMax != null && xMin != null) {
            ...
            double xxQ1 = rangeAxis.translateValueToJava2D(xQ1.doubleValue(), dataArea, location);
            double xxQ3 = rangeAxis.translateValueToJava2D(xQ3.doubleValue(), dataArea, location);
            double xxMax = rangeAxis.translateValueToJava2D(xMax.doubleValue(), dataArea, location);
            double xxMin = rangeAxis.translateValueToJava2D(xMin.doubleValue(), dataArea, location);
        ...
        if (xMean != null) {
            double xxMean = rangeAxis.translateValueToJava2D(xMean.doubleValue(), dataArea, location);
        ...
        if (xMedian != null) {
            double xxMedian = rangeAxis.translateValueToJava2D(
                xMedian.doubleValue(),
                dataArea,
                location);
