 ...
 *
 * $Id: StackedXYAreaRenderer.java,v 1.1 2007/10/10 19:25:28 vauchers Exp $
 *
 * Changes:
 * --------
 ...
 */
public class StackedXYAreaRenderer extends XYAreaRenderer implements Cloneable, 
                                                                     PublicCloneable,
                                                                     Serializable {
        ...
        if (pass == 0) {
            ...
            if (item == 0) {
                ...
                if (plot.getOrientation() == PlotOrientation.VERTICAL) {
                    areaState.area.addPoint((int) transX1, (int) transY2);
                } 
                else if (plot.getOrientation() == PlotOrientation.HORIZONTAL) {
                    areaState.area.addPoint((int) transY2, (int) transX1);
                }
            }
            ...
            if (plot.getOrientation() == PlotOrientation.VERTICAL) {
                ...
                areaState.area.addPoint((int) point.getX(), (int) point.getY());
