 ...
 *
 * $Id: BarRenderer3D.java,v 1.1 2007/10/10 19:25:28 vauchers Exp $
 *
 * Changes
 * -------
...
public class BarRenderer3D extends BarRenderer 
    ...
    public BarRenderer3D(double xOffset, double yOffset) {
        ...
        ItemLabelPosition p1 = new ItemLabelPosition(
            ItemLabelAnchor.INSIDE12, TextAnchor.TOP_CENTER, TextAnchor.TOP_CENTER, 0.0
        );
    ...
    public void drawItem(Graphics2D g2,
        ...
        double transL0 = rangeAxis.translateValueToJava2D(barL0L1[0], adjusted, edge);
        double transL1 = rangeAxis.translateValueToJava2D(barL0L1[1], adjusted, edge);
        ...
        double y0 = bar.getMinY() - this.yOffset;
        double y1 = bar.getMinY();
        double y2 = bar.getMaxY() - this.yOffset;
