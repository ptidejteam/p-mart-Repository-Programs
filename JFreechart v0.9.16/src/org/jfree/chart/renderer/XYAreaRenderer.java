 ...
 *
 * $Id: XYAreaRenderer.java,v 1.1 2007/10/10 19:25:28 vauchers Exp $
 *
 * Changes:
 * --------
 ...
 * @author Hari
 */
public class XYAreaRenderer extends AbstractXYItemRenderer implements XYItemRenderer, 
                                                                      Cloneable,
                                                                      PublicCloneable,
                                                                      Serializable {
                         ...
                         int pass) 
    {
        ...
        double transX2 = domainAxis.translateValueToJava2D(
                x2.doubleValue(), dataArea, plot.getDomainAxisEdge()
        );
        double transY2 = rangeAxis.translateValueToJava2D(
                y2.doubleValue(), dataArea, plot.getRangeAxisEdge()
        );
        
        double transZero = rangeAxis.translateValueToJava2D(0.0, dataArea, plot.getRangeAxisEdge());
        ...
        if (item == 0) {  // create a new area polygon for the series
            ...
            double zero = rangeAxis.translateValueToJava2D(0.0, dataArea, plot.getRangeAxisEdge());
