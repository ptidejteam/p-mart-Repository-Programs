 ...
 *
 * $Id: StackedBarRenderer3D.java,v 1.1 2007/10/10 19:25:28 vauchers Exp $
 *
 * Changes
 * -------
...
public class StackedBarRenderer3D extends BarRenderer3D 
    ...
    public void drawItem(Graphics2D g2,
        ...
        double barW0 = domainAxis.getCategoryMiddle(column, getColumnCount(), adjusted,
        ...
        if (value > 0.0) {
            ...
            translatedValue = rangeAxis.translateValueToJava2D(positiveBase + value, adjusted, 
                                                               location);
        }
        else {
            translatedBase = rangeAxis.translateValueToJava2D(negativeBase, adjusted, location);
            translatedValue = rangeAxis.translateValueToJava2D(negativeBase + value, adjusted, 
                                                               location);
        }
