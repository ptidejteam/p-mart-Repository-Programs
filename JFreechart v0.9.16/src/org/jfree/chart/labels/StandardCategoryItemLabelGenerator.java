 ...
 *
 * $Id: StandardCategoryItemLabelGenerator.java,v 1.1 2007/10/10 19:25:31 vauchers Exp $
 *
 * Changes
 * -------
...
public class StandardCategoryItemLabelGenerator implements CategoryItemLabelGenerator,
     ...
     *
     * @param formatter  the number formatter.
     * @param showSeriesNameInToolTips  a flag that controls whether or not the series name is included in
     *                                  tooltips.
     */
    public StandardCategoryItemLabelGenerator(NumberFormat formatter, 
