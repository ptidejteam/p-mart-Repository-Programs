 ...
 *                   Eduardo Ramalho;
 *
 * $Id: XYPlot.java,v 1.1 2007/10/10 19:25:34 vauchers Exp $
 *
...
public class XYPlot extends Plot implements ValueAxisPlot,
    ...
    public void draw(Graphics2D g2,
        ...
        crosshairInfo.setAnchor(anchor);
        if (anchor != null) {
            crosshairInfo.setCrosshairX(getDomainAxis().translateJava2DToValue(anchor.getX(), dataArea, RectangleEdge.BOTTOM));
            crosshairInfo.setCrosshairY(getRangeAxis().translateJava2DToValue(anchor.getY(), dataArea, RectangleEdge.LEFT));
        }
        else {
            crosshairInfo.setCrosshairX(getDomainCrosshairValue());
            crosshairInfo.setCrosshairY(getRangeCrosshairValue());
        }
    ...
    public void zoom(double percent) {
        ...
        if (percent > 0.0) {
            ...
            domainAxis.setRange(center - scaledRange / 2.0, center + scaledRange / 2.0);
            ...
            rangeAxis.setRange(center - scaledRange / 2.0, center + scaledRange / 2.0);
        }
        else {
