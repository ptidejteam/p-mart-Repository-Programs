...
public class ThermometerPlot
  ...
  public void draw(Graphics2D g2, Rectangle2D plotArea, PlotState parentState,
    ...
    if ( (this.dataset != null) && (this.dataset.getValue() != null)) {
      ...
      // draw the axis...
      if ( (rangeAxis != null) && (axisLocation != NONE)) {
        ...
        switch (axisLocation) {
          case RIGHT:
            ...
            rangeAxis.draw(g2, cursor, plotArea, drawArea, RectangleEdge.RIGHT);
            break;
          ...
          default:
            ...
            rangeAxis.draw(g2, cursor, plotArea, drawArea, RectangleEdge.LEFT);
            break;
        }
      ...
      switch (valueLocation) {
        ...
        case LEFT:
          ...
          int stringWidth = (int) ( (metrics.getStringBounds(valueString, g2)).
                                   getWidth());
