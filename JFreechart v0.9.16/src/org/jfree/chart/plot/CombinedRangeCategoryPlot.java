 ...
 *
 * $Id: CombinedRangeCategoryPlot.java,v 1.1 2007/10/10 19:25:34 vauchers Exp $
 *
 * Changes:
 * --------
...
public class CombinedRangeCategoryPlot extends CategoryPlot 
    ...
    public void remove(CategoryPlot subplot) {
        ...
        ValueAxis range2 = getSecondaryRangeAxis(0);
        if (range2 != null) {
            range2.configure();
        }
    ...
    public void draw(Graphics2D g2, Rectangle2D plotArea, PlotState parentState,
        ...
        AxisState state = getRangeAxis().draw(g2, cursor, plotArea, dataArea, getRangeAxisEdge());
        if (parentState == null) {
            parentState = new PlotState();
        }
        parentState.getSharedAxisStates().put(getRangeAxis(), state);
        ...
        for (int i = 0; i < this.subplots.size(); i++) {
            ...
            plot.draw(g2, subplotArea[i], parentState, subplotInfo);
        }
