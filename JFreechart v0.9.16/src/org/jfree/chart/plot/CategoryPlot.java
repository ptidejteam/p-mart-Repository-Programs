 ...
 *                   Arnaud Lelievre;
 *
 * $Id: CategoryPlot.java,v 1.1 2007/10/10 19:25:34 vauchers Exp $
 *
...
public class CategoryPlot extends Plot 
     ...
     * @param state  collects info as the chart is drawn.
     */
    ...
    public void render2(Graphics2D g2, Rectangle2D dataArea, PlotRenderingInfo info) {
        ...
        for (int i = 0; i < this.secondaryDatasets.size(); i++) {
            ...
            if (!DatasetUtilities.isEmptyOrNull(data2)) {
                ...
                if (renderer != null) {
                    CategoryItemRendererState state = renderer.initialise(g2, dataArea, this, 
                                                                          new Integer(i), info);
