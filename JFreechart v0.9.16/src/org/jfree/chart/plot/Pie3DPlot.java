 ...
 *                   Dave Crane;
 *
 * $Id: Pie3DPlot.java,v 1.1 2007/10/10 19:25:34 vauchers Exp $
 *
 * Changes
 * -------
...
public class Pie3DPlot extends PiePlot implements Serializable {
    ...
    public void draw(Graphics2D g2, Rectangle2D plotArea, PlotState parentState,
        ...
        while (iterator.hasNext()) {
            ...
            if (segment != null) {
                ...
                drawSide(g2, pieArea, segment, front, back, paint, outlinePaint, false, true);
            }
            cat++;
        }
        ...
        while (iterator.hasNext()) {
            ...
            if (segment != null) {
                paint = getSectionPaint(cat);
                outlinePaint = getSectionOutlinePaint(cat);
                drawSide(g2, pieArea, segment, front, back, paint, outlinePaint, true, false);
            }
            cat++;
        }
    ...
    public void drawSide(Graphics2D g2,
                         Rectangle2D plotArea, Arc2D arc, Area front, Area back,
