 ...
 *
 * $Id: SegmentedTimeline.java,v 1.1 2007/10/10 19:25:36 vauchers Exp $
 *
 * Changes
 * -------
...
//                }
                ...
                if (x < segmentsIncludedSize) {
                    result = segmentsIncludedSize * y 
                             + x - wholeExceptionsBeforeDomainValue * segmentSize;
                             // - partialTimeInException;; 
                }
                else {
                    result = segmentsIncludedSize * (y + 1) 
                             - wholeExceptionsBeforeDomainValue * segmentSize;
                             // - partialTimeInException;
                }
            }
        }
    ...
    public long getTime(Date date) {
        ...
        if (this.adjustForDaylightSaving) {
            ...
            workingCalendarNoDST.set(Calendar.MILLISECOND, 
                                     workingCalendar.get(Calendar.MILLISECOND));
