 ...
 *                   Arnaud Lelievre;
 *
 * $Id: ChartPanel.java,v 1.1 2007/10/10 19:25:38 vauchers Exp $
 *
        ...
        if (useBuffer) {
            ...
            if (refreshBuffer) {
                ...
                if (scale) {
                    ...
                    chart.draw(bufferG2, chartArea, this.anchor, this.info);
                    bufferG2.setTransform(saved);
                }
                else {
                    chart.draw(bufferG2, bufferArea, this.anchor, this.info);
                }
