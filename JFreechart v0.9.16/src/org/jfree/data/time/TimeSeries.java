 ...
 *
 * $Id: TimeSeries.java,v 1.1 2007/10/10 19:25:32 vauchers Exp $
 *
 * Changes
 * -------
...
public class TimeSeries extends Series implements Cloneable, Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (super.equals(object) && object instanceof TimeSeries) {
            ...
            if (result == true) {
                ...
                if (count == s.getItemCount()) {
                    for (int i = 0; i < count; i++) {
                        match = match && getDataItem(i).equals(s.getDataItem(i));
                        if (!match) {
                            continue;
                        }
                    }
