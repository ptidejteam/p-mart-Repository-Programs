 ...
 *
 * This file...
 * $Id: PlotPropertyEditPanel.java,v 1.1 2007/10/10 18:58:02 vauchers Exp $
 *
...
public class PlotPropertyEditPanel extends JPanel implements ActionListener {
    ...
    public PlotPropertyEditPanel(Plot plot) {
        ...
        verticalAxisPropertyPanel = AxisPropertyEditPanel.getInstance(plot.getAxis(Axis.VERTICAL));
        ...
        horizontalAxisPropertyPanel = AxisPropertyEditPanel.getInstance(plot.getAxis(Axis.HORIZONTAL));
    ...
    public void updatePlotProperties(Plot plot) {
        ...
        if (this.horizontalAxisPropertyPanel!=null) {
            this.horizontalAxisPropertyPanel.setAxisProperties(plot.getAxis(Axis.HORIZONTAL));
        }

        if (this.verticalAxisPropertyPanel!=null) {
            this.verticalAxisPropertyPanel.setAxisProperties(plot.getAxis(Axis.VERTICAL));
        }
