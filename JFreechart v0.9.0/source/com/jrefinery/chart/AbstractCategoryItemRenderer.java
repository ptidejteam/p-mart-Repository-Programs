 ...
 * Contributor(s):   -;
 *
 * $Id: AbstractCategoryItemRenderer.java,v 1.1 2007/10/10 19:01:18 vauchers Exp $
 *
 * Changes:
 * --------
...
public abstract class AbstractCategoryItemRenderer implements CategoryItemRenderer {
     ...
     */
    public AbstractCategoryItemRenderer(CategoryToolTipGenerator toolTipGenerator) {
    ...
    public void setToolTipGenerator(CategoryToolTipGenerator toolTipGenerator) {
        this.toolTipGenerator = toolTipGenerator;
        // this should probably generate a change event...
    }
