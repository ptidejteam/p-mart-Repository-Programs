 ...
 *                   Jon Iles;
 *
 * $Id: ChartFactory.java,v 1.1 2007/10/10 19:01:18 vauchers Exp $
 *
 * Changes
 * -------
...
public class ChartFactory {
    ...
    /**
     * Creates a horizontal stacked bar chart with default settings.
     *
     * @param title The chart title.
     * @param domainAxisLabel The label for the category axis.
     * @param rangeAxisLabel The label for the value axis.
     ...
     * @param legend A flag specifying whether or not a legend is required.
     *
     * @return A horizontal stacked bar chart.
     */
    public static JFreeChart createHorizontalStackedBarChart(String title,
                                                             String domainAxisLabel,
                                                             String rangeAxisLabel,
                                                             CategoryDataset data,
                                                             boolean legend) {
