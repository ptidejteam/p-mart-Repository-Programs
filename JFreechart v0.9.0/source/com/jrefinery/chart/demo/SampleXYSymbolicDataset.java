...
public class SampleXYSymbolicDataset extends AbstractSeriesDataset implements XYDataset, XisSymbolic, YisSymbolic {
    ...
    public Number getYValue(int series, int item) {
        ...
        /**
     * Sets the x-value for the specified series and item with the specified new <CODE>Number</CODE> value.  Series are numbered 0, 1, ...
         * <P>
    ...
    public void setXValue(int series, int item, Number newValue) {
        ...
        /**
     * Sets the y-value for the specified series and item with the specified new <CODE>Number</CODE> value.  Series are numbered 0, 1, ...
         * <P>
    ...
    public int getItemCount(int series) {
        ...
        /**
         * This function modify <CODE>dataset1</CODE> and <CODE>dataset1</CODE> in order that they share the
         * same Y symbolic value list.<P>
         * The sharing Y symbolic value list is obtained adding the Y symbolic data list of the fist data set
         * to the Y symbolic data list of the second data set.<P>
         * This function is use with the <I>CombinedPlot</I> functions of JFreeChart.
         *
         * @param	dataset1 the first data set to combine.
         * @param	dataset2 the second data set to combine.
         * @throws	ClassCastException if <CODE>dataset1</CODE> and <CODE>dataset2</CODE> is not an instance of SampleYSymbolicDataset.
        ...
        public static String[] combineYSymbolicDataset(YisSymbolic dataset1, YisSymbolic dataset2) {
                ...
                for (int i=0; i<s1length; i++) ySymbolicValuesCombined.add(sDatasetSymbolicValues1[i]);
        ...
        /**
         * This function modify <CODE>dataset1</CODE> and <CODE>dataset1</CODE> in order that they share the
         * same X symbolic value list.<P>
         * The sharing X symbolic value list is obtained adding the X symbolic data list of the fist data set
         * to the X symbolic data list of the second data set.<P>
         * This function is use with the <I>CombinedPlot</I> functions of JFreeChart.
         *
         * @param	dataset1 the first data set to combine.
         * @param	dataset2 the second data set to combine.
        ...
        public static String[] combineXSymbolicDataset(XisSymbolic dataset1, XisSymbolic dataset2) {
                ...
                for (int i=0; i<s1length; i++) xSymbolicValuesCombined.add(sDatasetSymbolicValues1[i]);
                for (int i=0; i<s2length; i++) {
        ...
        public Object clone() {
                ...
                return new SampleXYSymbolicDataset(nDatasetName, nXValues, nYValues, nXSymbolicValues, nYSymbolicValues, seriesName);
        }
