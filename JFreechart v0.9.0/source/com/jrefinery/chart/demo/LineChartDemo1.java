 ...
 * Contributor(s):   -;
 *
 * $Id: LineChartDemo1.java,v 1.1 2007/10/10 19:01:20 vauchers Exp $
 *
 * Changes
 * -------
...
//        rangeAxis.setStandardTickUnits(TickUnits.createIntegerTickUnits());
        com.jrefinery.chart.NumberTickUnit unit = new com.jrefinery.chart.NumberTickUnit(1.0, new java.text.DecimalFormat("0.00%"));
