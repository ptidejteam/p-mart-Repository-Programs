...
public class Options extends JMenu
{
	...
	private JCheckBoxMenuItem method7 = new JCheckBoxMenuItem("5d6 drop lowest and middle");
	...
	private JCheckBoxMenuItem autoMethod1 = new JCheckBoxMenuItem("Racially resized armor and shields");
...
//		method3.setEnabled(false);
		...
		method7.addActionListener(checkBoxHandler);
//		method7.setEnabled(false);
		...
		switch (Globals.getHpRollMethod())
		{
			...
			case Globals.s_HP_PERCENTAGE:
				...
				break;
			case Globals.s_HP_LIVING_GREYHAWK:
				hpLivingGreyhawk.setSelected(true);
				break;
			case Globals.s_HP_LIVING_CITY:
		...
		autoMethod1.setSelected(Globals.getAutogen(Globals.AUTOGEN_RACIAL));

		autoCreateMethods.add(autoMethod2);
		autoMethod2.addActionListener(checkBoxHandler);
		autoMethod2.setSelected(Globals.getAutogen(Globals.AUTOGEN_MASTERWORK));

		autoCreateMethods.add(autoMethod3);
		autoMethod3.addActionListener(checkBoxHandler);
		autoMethod3.setSelected(Globals.getAutogen(Globals.AUTOGEN_MAGIC));

		autoCreateMethods.add(autoMethod4);
		autoMethod4.addActionListener(checkBoxHandler);
		autoMethod4.setSelected(Globals.getAutogen(Globals.AUTOGEN_EXOTICMATERIAL));
	}
	...
	private final class CheckBoxListener implements ActionListener
	{
		public void actionPerformed(ActionEvent actionEvent)
		{
			...
			else if (source == hpLivingGreyhawk)
			{
				...
				hpPercentage.setSelected(false);
				hpLivingCity.setSelected(false);
				Globals.setHpRollMethod(Globals.s_HP_LIVING_GREYHAWK);
			}
			else if (source == hpLivingCity)
			{
				...
				hpPercentage.setSelected(false);
				hpLivingGreyhawk.setSelected(false);
				Globals.setHpRollMethod(Globals.s_HP_LIVING_CITY);
			}
			...
			{
				Globals.setAutogen(Globals.AUTOGEN_RACIAL, ((JCheckBoxMenuItem)source).isSelected());
			}
			else if (source == autoMethod2)
			{
				Globals.setAutogen(Globals.AUTOGEN_MASTERWORK, ((JCheckBoxMenuItem)source).isSelected());
			}
			else if (source == autoMethod3)
			{
				Globals.setAutogen(Globals.AUTOGEN_MAGIC, ((JCheckBoxMenuItem)source).isSelected());
			}
			else if (source == autoMethod4)
			{
				Globals.setAutogen(Globals.AUTOGEN_EXOTICMATERIAL, ((JCheckBoxMenuItem)source).isSelected());
			}
		}
	}
