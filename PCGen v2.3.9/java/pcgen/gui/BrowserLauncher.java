...
public class BrowserLauncher
{
	...
	public static void openURL(String url) throws IOException
	{
		...
		{
			System.err.println("Opening default system browser");
			...
			switch (jvm)
			{
				...
				case MRJ_3_1:
					try
					{
						System.err.println("Invoking openURL on " + url);
		...
		{
			System.err.println("Opening with browser " + Globals.getBrowserPath());
			// On MacOS X, one must use open -a to launch an app.
			if (jvm == MRJ_3_1 && Globals.getBrowserPath().getName().toLowerCase().endsWith(".app"))
			{
				System.err.println("Executing open -a " + Globals.getBrowserPath().getAbsolutePath() + " " + url);
				Runtime.getRuntime().exec(new String[]{"open", "-a", Globals.getBrowserPath().getAbsolutePath(), url});
			}
			else
			{
				System.err.println("Executing " + Globals.getBrowserPath().getAbsolutePath() + " " + url);
