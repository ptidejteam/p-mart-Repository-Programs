			...
			switch (column)
			{
				...
				case 9: //Melee BAB
					if (isIncomplete)
					{
						...
						retVal = curChar.getAttackString(0, curChar.calcStatMod(Globals.STRENGTH));
					break;
				case 10: //Ranged BAB
					if (isIncomplete)
					{
						...
						retVal = curChar.getAttackString(1, curChar.calcStatMod(Globals.DEXTERITY));
					break;
				case 11: //Fort Save
					if (isIncomplete)
					{
						...
						retVal = new Integer(curChar.getBonus(1, true) + curChar.calcStatMod(Globals.CONSTITUTION));
					break;
				case 12: //Ref Save
					if (isIncomplete)
					{
						...
						retVal = new Integer(curChar.getBonus(2, true) + curChar.calcStatMod(Globals.DEXTERITY));
					break;
				case 13: //Will Save
					if (isIncomplete)
					{
						...
						retVal = new Integer(curChar.getBonus(3, true) + curChar.calcStatMod(Globals.WISDOM));
					break;
				case 14: //size
					if (isIncomplete)
					{
