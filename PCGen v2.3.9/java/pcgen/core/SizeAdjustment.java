...
public class SizeAdjustment extends Object
{
	...
	private void setMultiple(String aString)
	{
		final StringTokenizer aTok = new StringTokenizer(aString, "|", false);
		if (aTok.countTokens() != 9)
		{
			JOptionPane.showMessageDialog(null, "Incorrect size count in size adjustment info", Globals.s_APPNAME, JOptionPane.ERROR_MESSAGE);
			return;
		}
	...
	// #								F  |D  |T  |S  |M|L|H|G|C
	// Weight	Ammunition.Armor.Shield.Weapon	0.1|0.1|0.1|0.5|1|2|5|8|11
	// Cost	Ammunition.Armor.Shield.Weapon	0.5|0.5|0.5|1.0|1|2|4|8|16
	// AC		Ammunition.Armor.Shield.Weapon	0.5|0.5|0.5|1.0|1|1|1|1|1
		...
		while (aTok.hasMoreElements())
		{
			...
			switch (iCount)
			{
				...
				case 2:
					...
					break;
				default:
					JOptionPane.showMessageDialog(null, "Illegal size adjustment info " + sourceFile.getName() +
						":" + Integer.toString(lineNum) + " \"" + aString + "\"", Globals.s_APPNAME, JOptionPane.ERROR_MESSAGE);
			}
			iCount += 1;
		}
	}
