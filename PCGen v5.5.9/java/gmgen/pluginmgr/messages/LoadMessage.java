...
/**
 *  Send this message to inform all components that a file load has taken place.
 *
 *@author     Soulcatcher
 *@created    May 23, 2003
 */
public class LoadMessage extends GMBMessage {
	/**
	 *  Constructor for the StateChangedMessage object
	 *
	 *@param  comp Component sending the state changed message
	 */
	public LoadMessage(GMBComponent comp) {
		super(comp);
	}
}
