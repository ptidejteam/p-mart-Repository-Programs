/*
 *  HelpMenuItemAddMessage.java - A GMBus message
 *  :noTabs=false:
 *
...
/**
 * Send this message to the GMBus is you want the main interface to add an item to the help menu
 *
 *@author     Soulcatcher
 *@created    May 23, 2003
 */
public class HelpMenuItemAddMessage extends GMBMessage {
	 ...
	 */
	public HelpMenuItemAddMessage(GMBComponent comp, JMenuItem item) {
		super(comp);
		this.item = item;
	}
