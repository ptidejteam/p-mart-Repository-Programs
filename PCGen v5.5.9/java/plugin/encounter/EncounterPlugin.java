...
public class EncounterPlugin extends GMBPlugin implements ActionListener, ItemListener, MouseListener {
	...
	private JMenuItem encounterHelpItem = new JMenuItem();
	...
	public void initMenus() {
		...
		encounterHelpItem.setMnemonic('n');
		encounterHelpItem.setText("Encounter Generator");
		encounterHelpItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				helpMenuItem(evt);
			}
		});
		GMBus.send(new HelpMenuItemAddMessage(this, encounterHelpItem));
	}
	...
	public void handleMessage(GMBMessage message) {
		if(message instanceof StateChangedMessage) {
			if(GMGenSystemView.getTabPane().getSelectedComponent() instanceof EncounterView) {
				updateUI();
				encounterHelpItem.setEnabled(false);
				encounterToolsItem.setEnabled(false);
			}
			else {
				encounterHelpItem.setEnabled(true);
