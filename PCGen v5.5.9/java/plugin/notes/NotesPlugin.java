...
public class NotesPlugin extends GMBPlugin {
	...
	private JMenuItem notesHelpItem = new JMenuItem();
	...
	private void initMenus() {
		...
		notesHelpItem.setMnemonic('o');
		notesHelpItem.setText("Notes");
		notesHelpItem.addActionListener(
			new ActionListener() {
				public void actionPerformed(ActionEvent evt) {
					helpMenuItem(evt);
				}
	...
	/**
	 *  Method that handles the help menu item
	 *
	 *@param  evt  Action Event of a click on the help menu item
	 */
