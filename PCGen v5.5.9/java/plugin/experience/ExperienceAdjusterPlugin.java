...
public class ExperienceAdjusterPlugin extends GMBPlugin implements ActionListener, ChangeListener, KeyListener /*Observer*/ {
	...
	protected JMenuItem experienceHelpItem = new JMenuItem();
	...
	public static final String LOG_NAME = "Experience Adjuster";
	...
	public void initMenus() {
		...
		experienceHelpItem.setMnemonic('E');
		experienceHelpItem.setText("Experience Adjuster");
		experienceHelpItem.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				helpMenuItem(evt);
			}
		});
		GMBus.send(new HelpMenuItemAddMessage(this, experienceHelpItem));
	}
	...
	public void helpMenuItem(java.awt.event.ActionEvent evt) {
	}
	...
	public void handleAddExperienceToPartyButton() {
		eaModel.addExperienceToParty(eaModel.getPartyExperience());
	...
	public void handleMessage(GMBMessage message) {
		if(message instanceof CombatRequestMessage) {
			...
			if(GMGenSystemView.getTabPane().getSelectedComponent() instanceof ExperienceAdjusterView) {
				experienceHelpItem.setEnabled(false);
				...
				experienceHelpItem.setEnabled(true);
