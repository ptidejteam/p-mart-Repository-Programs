...
public class DiceBagPlugin extends GMBPlugin {
	...
	private class ActionDelegate extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			else if (DICEBAG_HELP_COMMAND.equals(command)) {
				helpMenuItem(e);
			}
		}
	}
	/** Menu item command string for help menu item */
	private static final String DICEBAG_HELP_COMMAND = "HELP_MENU_ENTRY";
	...
	private JMenuItem notesHelpItem;
	...
	private void handleStateChangedMessage(StateChangedMessage message) {
		...
		if (GMGenSystemView.getTabPane().getSelectedComponent().equals(theController.getComponent())) {
			...
			notesHelpItem.setEnabled(false);
	 ...
	 */
	private void helpMenuItem(ActionEvent evt) {
		//TODO:  Implement help?
	}

	/**
	 * <p>Adds DiceBag menu items to tools and help menus.</p>
	 */
	private void initMenus() {
		...
		notesHelpItem =
			makeMenuItem(
				"DiceBag",
				DICEBAG_HELP_COMMAND,
				null,
				"Dice Bag Plugin Help",
				new Integer(KeyEvent.VK_G));
		GMBus.send(new HelpMenuItemAddMessage(this, notesHelpItem));
	}
