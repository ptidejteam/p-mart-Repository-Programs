 ...
 *
 * @(#) $Id: LstEditorMain.java,v 1.1 2006/02/21 01:28:08 vauchers Exp $
 */
...
public final class LstEditorMain extends JFrame
{
	...
	private void btnDeleteActionPerformed()
	{
		...
		// Popup "Are you sure?"
		//
		if (GuiFacade.showConfirmDialog(null, "Are you sure?", Constants.s_APPNAME, GuiFacade.YES_NO_OPTION, GuiFacade.QUESTION_MESSAGE) != GuiFacade.NO_OPTION)
		{
			final PObject lstItem = (PObject) lstLstFileContent.getSelectedValue();
	...
	private void editIt(PObject editItem)
	{
		try
		{
			...
			for (; ;)
			{
				...
				{
					GuiFacade.showMessageDialog(null, "Cannot save; already exists.", Constants.s_APPNAME, GuiFacade.ERROR_MESSAGE);
					continue;
				}
				break;
			}
