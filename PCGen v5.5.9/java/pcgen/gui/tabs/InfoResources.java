...
public class InfoResources extends FilterAdapterPanel
{
	...
	private void setInfoText(Object obj)
	{
		...
		if (obj instanceof Race)
		{
			...
			{
				final StringBuffer movelabel = new StringBuffer(aRace.getMovementType(0)).append(" ").append(aRace.getMovement(0)).append(Globals.getDistanceUnit()).append(" ");
		...
		public Object getValueAt(Object node, int column)
		{
			...
			switch (column)
			{
				...
				case COL_MOVE:
					...
					{
						final StringBuffer movelabel = new StringBuffer(race.getMovementType(0)).append(" ").append(race.getMovement(0)).append(Globals.getDistanceUnit()).append(" ");
