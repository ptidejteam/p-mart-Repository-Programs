 ...
 *
 * @(#) $Id: LevelAbilitiesPanel.java,v 1.1 2006/02/21 01:28:20 vauchers Exp $
 */
...
//		this.add(lblTemp, gridBagConstraints);
	...
	private void btnAddActionPerformed()
	{
		...
		{
			GuiFacade.showMessageDialog(null, "You must enter a level type, level, ability type and ability details.", Constants.s_APPNAME, GuiFacade.ERROR_MESSAGE);
			return;
		}
