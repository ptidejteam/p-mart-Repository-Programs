...
public class SystemCollections
{
	...
	public static PCAlignment getAlignmentAtIndex(final int index)
	{
		PCAlignment align;
	...
	/**
	 * Add a unit set to the list. If there already is a unit set 
	 * defined with the same name, replace it.
	 * @param unitSet  
	 */
	public static void addToUnitSetList(UnitSet unitSet)
	{
		final String name = unitSet.getName();
		for (ListIterator i = unitSetList.listIterator(); i.hasNext(); )
		{
			final UnitSet us = (UnitSet)i.next();
	...
	/**
	 * Return an <b>unmodifiable</b> version of the unit info list.
	 * @return
	 */
