...
final class LevelAbilityList extends LevelAbility
{
	...
	LevelAbilityList(PObject aowner, int aLevel, String aList)
	{
	...
	public void processChoice(List aArrayList, List selectedList, String eString)
	{
		for (int index = 0; index < selectedList.size(); ++index)
		{
			...
			String theBonus;
			List selectedBonusList = new ArrayList();
