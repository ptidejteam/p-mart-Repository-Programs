...
public class CertificateTrustWindow implements SECertificateListener {
	...
	public boolean trustCertificate(final String resource,
	...
	protected class trustDialog {
		...
		protected trustDialog(AESemaphore _sem, Display display,
				String resource, X509Certificate cert) {
			sem = _sem;
			...
			info_label.setText(MessageText
					.getString("security.certtruster.intro"));
			...
			resource_label.setText(MessageText
					.getString("security.certtruster.resource"));
			gridData = new GridData(GridData.FILL_BOTH);
			...
			issued_by_label.setText(MessageText
					.getString("security.certtruster.issuedby"));
			gridData = new GridData(GridData.FILL_BOTH);
			gridData.horizontalSpan = 1;
			...
			issued_to_label.setText(MessageText
					.getString("security.certtruster.issuedto"));
			gridData = new GridData(GridData.FILL_BOTH);
			gridData.horizontalSpan = 1;
			...
			prompt_label.setText(MessageText
					.getString("security.certtruster.prompt"));
			gridData = new GridData(GridData.FILL_BOTH);
			gridData.horizontalSpan = 3;
			...
			Label labelSeparator = new Label(shell, SWT.SEPARATOR
					| SWT.HORIZONTAL);
