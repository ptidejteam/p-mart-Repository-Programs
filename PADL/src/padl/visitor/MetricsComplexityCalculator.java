	...
	private void close(final IAbstractModel p) {
		...
		for (int i = 0; i < this.valuesForAllModules.size(); i++) {
			Output.getInstance().normalOutput().println(
				this.valuesForAllModules.get(i));
		}
		Output.getInstance().normalOutput().print("C = S + D = ");
		Output.getInstance().normalOutput().print(S);
		Output.getInstance().normalOutput().print(" + ");
		Output.getInstance().normalOutput().print(D);
		Output.getInstance().normalOutput().print(" = ");
		Output.getInstance().normalOutput().println(S + D);
		Output.getInstance().normalOutput().println("----");
	}
