...
public abstract class DesignMotifModelAdapter implements IDesignMotifModel,
	...
	public DesignMotifModelAdapter(final char[] actorID) {
		try {
			this.wrappedDesignMotifModel =
				Factory.getInstance().createDesignMotifModel(actorID);
		}
		catch (final ModelDeclarationException e) {
			this.wrappedDesignMotifModel = null;
	...
	public void removeModelListeners(final List aListOfModelListeners) {
		this.wrappedDesignMotifModel.removeModelListeners(aListOfModelListeners);
	}
	...
	public void setFactory(final IFactory aFactory) {
		this.wrappedDesignMotifModel.setFactory(aFactory);
	}
