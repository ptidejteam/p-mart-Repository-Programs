...
public class Field extends Element implements IElementMarker, IField {
	...
	public Field(final char[] anID, final char[] aName,
			final char[] aFieldType, final int aCardinality)
	...
	public void setCardinality(int cardinality)
		...
		if (cardinality < 1) {
			throw new ModelDeclarationException(MultilingualManager.getString(
					"CARDINALITY", Field.class, new Object[] { new Integer(
							cardinality) }));
		}
	...
	public String toString(final int tab) {
		if (Constants.DEBUG) {
			Output.getInstance().debugOutput()
