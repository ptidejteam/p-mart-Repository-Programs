...
class Package extends Constituent implements IPackage {
	...
	private GenericContainerOfConstituents container = new GenericContainerOfNaturallyOrderedConstituents(
			this, GenericContainerConstants.INITIAL_SIZE_PACKAGES);
	...
	public void startCloneSession() {
		...
		((Package) this.getClone()).container = new GenericContainerOfNaturallyOrderedConstituents(
