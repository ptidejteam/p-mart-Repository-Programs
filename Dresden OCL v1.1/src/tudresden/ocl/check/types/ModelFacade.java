 ...
 *
 *  @see tudresden.ocl.check.types.testfacade.TestModelFacade
 *  @author Frank Finger
 */
public interface ModelFacade {

  /** @param name the name of an application type (not the name of a predefined
