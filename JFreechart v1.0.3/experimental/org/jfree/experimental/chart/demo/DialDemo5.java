...
public class DialDemo5 extends JFrame implements ChangeListener {
    ...
    public DialDemo5(String title) {
        ...
        hoursDataset = new DefaultValueDataset(6.0);
        dataset2 = new DefaultValueDataset(15.0);
    ...
    public void stateChanged(ChangeEvent e) {
        this.hoursDataset.setValue(new Integer(slider1.getValue()));
        this.dataset2.setValue(new Integer(slider2.getValue()));
    }
