...
public class NpcTab extends JPanel
{
  ...
  {"Any", "Lawful Good", "Lawful Neutral", "Lawful Evil", "Neutral Good", "Neutral ", "Neutral Evil", "Chaotic Good", "Chaotic Neutral", "Chaotic Evil",  };
  ...
  private void initComponents()
  {
    ...
    buildConstraints(c,0,2,1,1,1,1);
    c.fill = GridBagConstraints.NONE;
    c.anchor = GridBagConstraints.EAST;
    ...
    buildConstraints(c,0,4,1,1,1,1);
    c.fill = GridBagConstraints.NONE;
    c.anchor = GridBagConstraints.EAST;
    ...
    buildConstraints(c,0,1,6,1,1,1);
    gridbag.setConstraints(blank, c);
    north.add(blank);

    buildConstraints(c,2,0,1,1,1,1);
    c.fill = GridBagConstraints.NONE;
    c.anchor = GridBagConstraints.EAST;
    gridbag.setConstraints(primL, c);
    north.add(primL);

    buildConstraints(c,3,0,1,1,1,1);
    c.fill = GridBagConstraints.HORIZONTAL;
    c.anchor = GridBagConstraints.WEST;
    ...
    buildConstraints(c,2,2,1,1,1,1);
    c.fill = GridBagConstraints.NONE;
    c.anchor = GridBagConstraints.EAST;
    gridbag.setConstraints(secL, c);
    north.add(secL);

    buildConstraints(c,3,2,1,1,1,1);
    c.fill = GridBagConstraints.HORIZONTAL;
    c.anchor = GridBagConstraints.WEST;
    ...
    buildConstraints(c,2,4,1,1,1,1);
    c.fill = GridBagConstraints.NONE;
    c.anchor = GridBagConstraints.EAST;
    gridbag.setConstraints(triL, c);
    north.add(triL);

    buildConstraints(c,3,4,1,1,1,1);
    c.fill = GridBagConstraints.HORIZONTAL;
    c.anchor = GridBagConstraints.WEST;
    ...
    buildConstraints(c,0,3,6,1,1,1);
    gridbag.setConstraints(blank2, c);
    north.add(blank2);

    buildConstraints(c,4,0,1,1,1,1);
    c.fill = GridBagConstraints.NONE;
    c.anchor = GridBagConstraints.EAST;
    gridbag.setConstraints(prleL, c);
    north.add(prleL);

    buildConstraints(c,5,0,1,1,1,1);
    c.fill = GridBagConstraints.NONE;
    c.anchor = GridBagConstraints.WEST;
    ...
    buildConstraints(c,4,2,1,1,1,1);
    c.fill = GridBagConstraints.NONE;
    c.anchor = GridBagConstraints.EAST;
    gridbag.setConstraints(secleL, c);
    north.add(secleL);

    buildConstraints(c,5,2,1,1,1,1);
    c.fill = GridBagConstraints.NONE;
    c.anchor = GridBagConstraints.WEST;
    ...
    buildConstraints(c,4,4,1,1,1,1);
    c.fill = GridBagConstraints.NONE;
    c.anchor = GridBagConstraints.EAST;
    gridbag.setConstraints(trileL, c);
    north.add(trileL);

    buildConstraints(c,5,4,1,1,1,1);
    c.fill = GridBagConstraints.NONE;
    c.anchor = GridBagConstraints.WEST;
    ...
    buildConstraints(c,1,5,2,1,1,1);
    c.fill = GridBagConstraints.NONE;
    ...
    buildConstraints(c,3,5,2,1,1,1);
    c.fill = GridBagConstraints.NONE;
    c.anchor = GridBagConstraints.CENTER;
  ...
  private void fillLists()
  {
    ...
    //for (int i = 1; i != raceQList.size(); i++)
    //raceC.addItem(raceQList.get(i));
 ...
 */
  ...
  //Race
    ...
    {
      Race race = (Race)Globals.getRaceMap().get(raceChoice);
