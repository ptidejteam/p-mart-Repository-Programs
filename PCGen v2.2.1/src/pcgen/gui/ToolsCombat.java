...
// Packages for the CombatTableSorter class.
		...
		public Object getValueAt(int row, int column)
		{
			...
			switch (column)
			{
				...
				case 15: //Move
					...
					String movelabel = curChar.getRace().getMovementType(0) + " " + curChar.movement(0) + "'";
					for (int x = 1; x < curChar.getRace().getMovements().length; x++)
						movelabel += ", " + curChar.getRace().getMovementType(x) + " " + curChar.movement(x) + "'";
					return movelabel;
			}
			return null;
		}
		...
		public final int compare(int row1, int row2)
		{
			...
			if (sortingColumn == 3)
			{
				...
				if (i1 == i2)
				{
					...
					PlayerCharacter tempChar1 = (PlayerCharacter)Globals.getPcList().get(actualrow1);
					PlayerCharacter tempChar2 = (PlayerCharacter)Globals.getPcList().get(actualrow2);

					//System.out.println("TempChar1: " + tempChar1.adjStats(1));
					//System.out.println("TempChar1: " + (tempChar1.adjStats(1) / 2 - 5));
					//System.out.println("TempChar2: " + tempChar2.adjStats(1));
					//System.out.println("TempChar2: " + (tempChar2.adjStats(1) / 2 - 5));

					if ((tempChar1.adjStats(1) / 2 - 5) < (tempChar2.adjStats(1) / 2 - 5))
						return lessThan;
					if ((tempChar1.adjStats(1) / 2 - 5) > (tempChar2.adjStats(1) / 2 - 5))
						return greaterThan;
				}
