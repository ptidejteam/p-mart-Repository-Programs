...
public class ToolsQStats extends JPanel
{
	...
	public class QuickStatsTableModel extends AbstractTableModel
	{
		...
		public Object getValueAt(int row, int column)
		{
			...
			PlayerCharacter oldChar = Globals.getCurrentPC(); //keep char of current char in case it gets changed during Skill lookup
			Iterator skillIter;
			...
			switch (column)
			{
				...
				case 4: //alignment or WP
					...
					return Globals.s_ALIGNSHORT[curChar.getAlignment()];
				case 5: //HP or VP
					if (isIncomplete)
					{
						return new Integer(0);
