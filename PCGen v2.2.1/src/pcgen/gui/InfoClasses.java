		...
		public Object getValueAt(int rowIndex, int columnIndex)
		{
			if (displayClasses != null)
			{
				...
				switch (columnIndex)
				{
					...
					case 8:
						return (Globals.isStarWarsMode() || Globals.isSidewinderMode()) ? c.defenseString() : c.getSpellType();

					case 9:
						return (Globals.isStarWarsMode() || Globals.isSidewinderMode()) ? c.reputationString() : c.getSpellBaseStat();
