...
* subclass for all recipient related header fields. This means that is you instanciate a
...
public class DefaultMessage implements Message, Serializable {
    ...
    */
    ...
    public DefaultMessage(Body messageBody, String defaultCharset) {
        recipientHandler = new DefaultHandler(defaultCharset);
        this.messageBody = messageBody;
    }
    ...
    */
    ...
    protected class DefaultHandler implements RecipientHandler, Serializable {
        
        private String defaultCharset;
        
        /** Default constructor. */
        
        public DefaultHandler(String charset) {
