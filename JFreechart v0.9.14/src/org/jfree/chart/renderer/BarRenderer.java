 ...
 *
 * $Id: BarRenderer.java,v 1.1 2007/10/10 19:19:08 vauchers Exp $
 *
 * Changes
 * -------
...
public class BarRenderer extends AbstractCategoryItemRenderer 
    ...
    public void drawItem(Graphics2D g2,
        ...
        double transL0 = rangeAxis.translateValueToJava2D(base, dataArea, edge);
        double transL1 = rangeAxis.translateValueToJava2D(value, dataArea, edge);
     ...
     * @return
     */
    private double calculateSeriesWidth(double space, CategoryAxis axis, 
