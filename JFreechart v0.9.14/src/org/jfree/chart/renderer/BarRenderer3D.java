 ...
 *
 * $Id: BarRenderer3D.java,v 1.1 2007/10/10 19:19:08 vauchers Exp $
 *
 * Changes
 * -------
    ...
    protected void drawHorizontalItem(Graphics2D g2,
        ...
        if (dataValue != null) {
            ...
            if (seriesCount > 1) {
                ...
                y2 = y2 + row * (state.getBarWidth() + seriesGap);
            }
            else {
                y2 = y2 + row * state.getBarWidth();
            }

            // HEIGHT
            double y0 = y2 + state.getBarWidth();
        ...
        if (value != null) {
            ...
            if (seriesCount > 1) {
                double seriesGap = adjusted.getWidth() * getItemMargin()
                                   / (categoryCount * (seriesCount - 1));
                x0 = x0 + row * (state.getBarWidth() + seriesGap);
            }
            else {
                x0 = x0 + row * state.getBarWidth();
            }
            ...
            double x1 = x0 + state.getBarWidth();
