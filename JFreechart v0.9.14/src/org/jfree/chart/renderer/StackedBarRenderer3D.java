 ...
 *
 * $Id: StackedBarRenderer3D.java,v 1.1 2007/10/10 19:19:08 vauchers Exp $
 *
 * Changes
 * -------
...
public class StackedBarRenderer3D extends BarRenderer3D 
    ...
    protected void calculateBarWidth(CategoryPlot plot, 
        ...
        if (data != null) {
            ...
            double used = space * (1 - domainAxis.getLowerMargin() - domainAxis.getUpperMargin()
                                     - categoryMargin);
            if (columns > 0) {
                state.setBarWidth(used / columns);
            }
            else {
    ...
    protected void drawHorizontalItem(Graphics2D g2,
        ...
        if (value != null) {
            ...
            double x0 = x2 + state.getBarWidth();
        ...
        if (value != null) {
            ...
            if ((y0 - y2) != 0) {
                ...
                if (xx > 0) {
                    ...
                    barT3d.closePath();
                    //if (seriesPaint instanceof Color) {
                    //    g2.setPaint(seriesPaint); //.brighter());
                    //}
                    g2.fill(barT3d);
                }
            }
