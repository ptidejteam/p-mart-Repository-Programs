 ...
 *                   Nicolas Brodu;
 *
 * $Id: TextTitle.java,v 1.1 2007/10/10 19:19:00 vauchers Exp $
 *
...
public class TextTitle extends AbstractTitle implements Serializable, Cloneable {
    ...
    public double getPreferredWidth(Graphics2D g2) {
        ...
        Rectangle2D titleBounds = fm.getStringBounds(text, g2);
    ...
    protected void drawHorizontal(Graphics2D g2, Rectangle2D area) {
        ...
        Rectangle2D titleBounds = fm.getStringBounds(this.text, g2);
        LineMetrics lineMetrics = font.getLineMetrics(this.text, frc);
