 ...
 * Contributor(s):   -;
 *
 * $Id: XYAreaChartDemo.java,v 1.1 2007/10/10 19:19:02 vauchers Exp $
 *
 * Changes
 * -------
...
public class XYAreaChartDemo extends ApplicationFrame {
     ...
     */
    public XYAreaChartDemo(String title) {
    ...
    public static void main(String[] args) {
        ...
        XYAreaChartDemo demo = new XYAreaChartDemo("Area XY Chart Demo");
        demo.pack();
