...
public class ConfigurableAwtPopupMenu extends PopupMenu implements ConfigurableUI {
  ...
  public ConfigurableAwtPopupMenu() {
    super();
  }

  /**
   * This creates a new ConfigurableAwtPopupMenu using the menuID as the
  ...
  public ConfigurableAwtPopupMenu(String menuID, VariableBundle vars) {
    super();
