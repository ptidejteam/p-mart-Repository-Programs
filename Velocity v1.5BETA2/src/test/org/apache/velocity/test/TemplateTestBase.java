...
public interface TemplateTestBase
{
     ...
     */
    public static final String TEST_COMPARE_DIR = "C:/Documents and Settings/wglass/My Documents/Workspace/internal/velocity/trunk/test";

    /**
     * Directory relative to the distribution root, where the
     * test cases should put their output
     */
    public static final String TEST_RESULT_DIR = "C:/Documents and Settings/wglass/My Documents/Workspace/internal/velocity/trunk/bin/test";
