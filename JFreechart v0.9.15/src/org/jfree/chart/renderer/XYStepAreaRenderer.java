 ...
 * -----------------------
 * (C) Copyright 2003 by Matthias Rose and Contributors.
 *
 * Original Author:  Matthias Rose (based on AreaXYRenderer.java);
 ...
 *                   Matthias Rose;
 *
 * $Id: XYStepAreaRenderer.java,v 1.1 2007/10/10 19:21:55 vauchers Exp $
 *
 * Changes:
 * --------
