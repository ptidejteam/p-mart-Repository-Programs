 ...
 *                    Jerome Fisher;
 *
 * $Id: CandlestickRenderer.java,v 1.1 2007/10/10 19:21:54 vauchers Exp $
 *
 * Changes
 * -------
...
public class CandlestickRenderer extends AbstractXYItemRenderer 
     ...
     * @see org.jfree.chart.renderer.CandlestickRenderer#setCandleWidth
     */
     ...
     * @see org.jfree.chart.renderer.CandlestickRenderer#setAutoWidthMethod
     * @see org.jfree.chart.renderer.CandlestickRenderer#setAutoWidthGap
     * @see org.jfree.chart.renderer.CandlestickRenderer#setAutoWidthFactor
     * @see org.jfree.chart.renderer.CandlestickRenderer#setMaxCandleWidthInMilliseconds
     */
    ...
    public void setAutoWidthMethod(int autoWidthMethod) {
        if (this.autoWidthMethod != autoWidthMethod) {
            Integer oldValue = new Integer(this.autoWidthMethod);
            this.autoWidthMethod = autoWidthMethod;
            firePropertyChanged("CandlestickRenderer.autoWidthMethod", 
                                oldValue, new Integer(autoWidthMethod));
        }
    }
    ...
    public void setAutoWidthFactor(double autoWidthFactor) {
        if (this.autoWidthFactor != autoWidthFactor) {
            Double oldValue = new Double(this.autoWidthFactor);
            this.autoWidthFactor = autoWidthFactor;
            firePropertyChanged("CandlestickRenderer.autoWidthFactor", 
                                oldValue, new Double(autoWidthFactor));
        }
    }
    ...
    public void setAutoWidthGap(double autoWidthGap) {
        if (this.autoWidthGap != autoWidthGap) {
            Double oldValue = new Double(this.autoWidthGap);
            this.autoWidthGap = autoWidthGap;
            firePropertyChanged("CandlestickRenderer.autoWidthGap", 
                                oldValue, new Double(autoWidthGap));
        }
    }
    ...
    public void drawItem(Graphics2D g2, 
        ...
        double xx = domainAxis.translateValueToJava2D(x.doubleValue(), dataArea, domainEdge);
            ...
            switch (autoWidthMethod) {
                ...
                case WIDTHMETHOD_SMALLEST:
                    ...
                    for (int i = 0; i < itemCount; i++) {
                        double pos = domainAxis.translateValueToJava2D(
                ...
                case WIDTHMETHOD_INTERVALDATA:
                    ...
                    double startPos = domainAxis.translateValueToJava2D(
                        intervalXYData.getStartXValue(series, item).doubleValue(), dataArea, 
                        plot.getDomainAxisEdge());
                    double endPos = domainAxis.translateValueToJava2D(
        ...
        if (yOpen.doubleValue() > yClose.doubleValue()) {
            if (upPaint != null) {
                g2.setPaint(upPaint);
                g2.fill(body);
            }
