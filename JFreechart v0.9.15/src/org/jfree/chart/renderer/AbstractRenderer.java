 ...
 *
 * $Id: AbstractRenderer.java,v 1.1 2007/10/10 19:21:54 vauchers Exp $
 *
 * Changes:
 * --------
...
public abstract class AbstractRenderer implements Cloneable, Serializable {
    ...
    public AbstractRenderer() {
        ...
        this.baseNegativeItemLabelPosition = new ItemLabelPosition(
            ItemLabelAnchor.OUTSIDE6, TextAnchor.TOP_CENTER, TextAnchor.TOP_CENTER, 0.0
        );
    ...
    public Paint getSeriesPaint(int series) {
        ...
        Paint paint = this.paintList.getPaint(series);
        if (paint == null) {
     ...
     * @param notify  a flag that controls whether or not registered listeners are notified.
     */
    ...
    public Paint getSeriesOutlinePaint(int series) {
        ...
        Paint paint = this.outlinePaintList.getPaint(series);
        if (paint == null) {
            DrawingSupplier supplier = getDrawingSupplier();
            if (supplier != null) {
    ...
    public Stroke getSeriesStroke(int series) {
        ...
        // otherwise look up the paint table
        Stroke stroke = strokeList.getStroke(series);
        if (stroke == null) {
            DrawingSupplier supplier = getDrawingSupplier();
            if (supplier != null) {
    ...
    public Stroke getSeriesOutlineStroke(int series) {
        ...
        Stroke stroke = this.outlineStrokeList.getStroke(series);
        if (stroke == null) {
            DrawingSupplier supplier = getDrawingSupplier();
            if (supplier != null) {
                stroke = supplier.getNextStroke();
    ...
    public Paint getSeriesItemLabelPaint(int series) {
        ...
        // otherwise look up the paint table
        Paint paint = this.itemLabelPaintList.getPaint(series);
        if (paint == null) {
     ...
     * Returns the positive item label position.
     * 
     * @return the positive item label position.
     */
     ...
     * 
     * @param position  the position.
     * @param notify  a flag that controls whether or not a change event is generated.
     */
     ...
     * 
     * @return the negative item label position.
     */
     ...
     * 
     * @param position  the position.
     * @param notify  a flag that controls whether or not the change event is generated.
     */
    ...
    public void notifyListeners(RendererChangeEvent event) {
        ...
        for (int i = listeners.length - 2; i >= 0; i -= 2) {
            if (listeners[i] == RendererChangeListener.class) {
                ((RendererChangeListener) listeners[i + 1]).rendererChanged(event);
            }
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AbstractRenderer) {
            ...
            boolean b29 = ObjectUtils.equal(this.baseNegativeItemLabelPosition, 
                                            renderer.baseNegativeItemLabelPosition);
...
//        result = 37 * result + ObjectUtils.hashCode(this.baseItemLabelAngle);    
     ...
     * @return The rotation anchor.
     * 
     * @deprecated Use getSeriesPositiveItemLabelRotationAnchor/
     *             getSeriesNegativeItemLabelRotationAnchor.
     */
     ...
     * 
     * @deprecated Use setSeriesPositiveItemLabelRotationAnchor/
     *             setSeriesNegativeItemLabelRotationAnchor.
     */
     ...
     * @return The anchor point.
     * 
     * @deprecated Use getBasePositiveItemLabelRotationAnchor/
     *             getBaseNegativeItemLabelRotationAnchor.
     */
     ...
     * 
     * @deprecated Use getPositiveItemLabelAngle/getNegativeItemLabelAngle.
     */
     ...
     * @return The angle (in radians).
     * 
     * @deprecated Use getSeriesPositiveItemLabelAngle/getSeriesNegativeItemLabelAngle.
     */
     ...
     * 
     * @deprecated Use setPositiveItemLabelAngle/setNegativeItemLabelAngle.
     */
     ...
     * 
     * @deprecated Use setSeriesPositiveItemLabelAngle/setSeriesNegativeItemLabelAngle.
     */
     ...
     * @return The angle.
     * 
     * @deprecated Use getBasePositiveItemLabelAngle/getBaseNegativeItemLabelAngle.
     */
     ...
     * @param angle  the angle.
     * 
     * @deprecated Use setBasePositiveItemLabelAngle/setBaseNegativeItemLabelAngle.
     */
