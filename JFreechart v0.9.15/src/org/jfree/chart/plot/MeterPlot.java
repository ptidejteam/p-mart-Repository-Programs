 ...
 *                   Nicolas Brodu;
 *
 * $Id: MeterPlot.java,v 1.1 2007/10/10 19:22:00 vauchers Exp $
 *
 * Changes
 * -------
...
public class MeterPlot extends Plot implements Serializable, Cloneable {
    ...
    public void draw(Graphics2D g2, Rectangle2D plotArea, PlotState parentState,
        ...
        if (data != null) {
            ...
            if (normalRange!=null) drawArcFor(g2, meterArea, data, MeterDataset.NORMAL_DATA);
			if (warningRange!=null) drawArcFor(g2, meterArea, data, MeterDataset.WARNING_DATA);
			if (criticalRange!=null) drawArcFor(g2, meterArea, data, MeterDataset.CRITICAL_DATA);
