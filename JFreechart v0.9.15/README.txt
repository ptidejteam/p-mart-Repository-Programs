...
(jfreechart-0.9.15-install.pdf) from the JFreeChart home
...
(b)  JCommon - version 0.9.0 or later.  The runtime jar file is
...
it you need the files jcommon-0.9.0.jar, jfreechart-0.9.15.jar and
jfreechart-0.9.15-demo.jar.
...
Use the following command:
    ...
    java -jar jfreechart-0.9.15-demo.jar
...
java -classpath lib/jcommon-0.9.0.jar:jfreechart-0.9.15.jar:jfreechart-0.9.15-demo.jar org.jfree.chart.demo.JFreeChartDemo
