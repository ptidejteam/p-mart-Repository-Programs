...
public class RFC_New extends AbstractMetric implements IMetric, IUnaryMetric {
	...
	public String getDefinition() {
		return "Response For Class The RFC of c is a count of the number of methods of c and the number of methods of other classes that are invoked by the methods of c.";
	}
	protected double concretelyCompute(final IFirstClassEntity anEntity) {
		...
		return setOfCalledMethods.size()+super.classPrimitives.listOfDeclaredMethods(anEntity).size();
	}
}
