...
public class CacheManager {
	...
	public static CacheManager getInstance(
		...
		if (CacheManager.UniqueInstance == null
				|| CacheManager.UniqueInstance.abstractLevelModel != anAbstractLevelModel) {

			CacheManager.UniqueInstance =
				new CacheManager(anAbstractLevelModel);
		}
	...
	private CacheManager(final IAbstractLevelModel anAbstractLevelModel) {
