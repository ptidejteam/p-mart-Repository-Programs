 ...
 * Contributor(s):   -;
 *
 * $Id: ClusteredXYBarRendererTests.java,v 1.1 2007/10/10 20:53:40 vauchers Exp $
 *
 * Changes
 * -------
...
public class ClusteredXYBarRendererTests extends TestCase {
    ...
    public void testFindDomainBounds() {
        ...
        assertEquals(0.9, r.getLowerBound(), 0);
        assertEquals(13.1, r.getUpperBound(), 0);
        
        renderer = new ClusteredXYBarRenderer(0.0, true);
        r = renderer.findDomainBounds(dataset);
        // sv added arg to compile
        assertEquals(0.8, r.getLowerBound(), 0);
        assertEquals(13.0, r.getUpperBound(), 0);
