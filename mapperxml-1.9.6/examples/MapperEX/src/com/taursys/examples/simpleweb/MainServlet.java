...
public class MainServlet extends ServletApp {
  ...
  public static final String BUSINESS_DELEGATE =
      "com.taursys.examples.simpleweb.BusinessDelegate";
  ...
  public void init(ServletConfig config) throws ServletException {
    ...
    // Create/initialize shared resources
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    // Provide addess to shared resources
    request.setAttribute(BUSINESS_DELEGATE, bd);
    //
