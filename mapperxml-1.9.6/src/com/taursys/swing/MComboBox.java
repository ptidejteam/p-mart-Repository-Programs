...
public class MComboBox extends JComboBox implements EnableListener {
  ...
  /**
   * Set the option list value holder for the MComboBoxModel of this MComboBox.
   * This method does nothing if the current model is not an MComboBoxModel.
   * @param holder the new option list holder for the MComboBoxModel.
   * @deprecated use setListValueHolder instead - this method will be removed
   * in the final release of 1.9.7
   */
  public void setOptionListValueHolder(ListValueHolder holder) {
    setListValueHolder(holder);
  }

  /**
   * Get the option list value holder for the MComboBoxModel of this MComboBox.
   * This method returns null if the current model is not an MComboBoxModel.
   * @return the option list holder for the MComboBoxModel or null.
   * @deprecated use getListValueHolder instead - this method will be removed
   * in the final release of 1.9.7
   */
  public ListValueHolder getOptionListValueHolder() {
    return getListValueHolder();
  }

  /**
   * Set the property names in the ListValueHolder which will provide the selection values.
   * These names must correspond with the propertyNames for the valueHolder.
   * @param optionListPropertyNames the property names in the ListValueHolder which will provide the selection values.
   * @deprecated use setListPropertyNames instead - this method will be removed
   * in the final release of 1.9.7
   */
  public void setOptionListPropertyNames(String[] optionListPropertyNames) {
    setListPropertyNames(optionListPropertyNames);
  }

  /**
   * Get the property names in the ListValueHolder which will provide the selection values.
   * These names must correspond with the propertyNames for the valueHolder.
   * @return the property names in the ListValueHolder which will provide the selection values.
   * @deprecated use getListPropertyNames instead - this method will be removed
   * in the final release of 1.9.7
   */
  public String[] getOptionListPropertyNames() {
    return getListPropertyNames();
  }

  /**
   * Set the property name in the OptionListValueHolder which will provide the selection value.
   * This name must correspond with the propertyNams for the valueHolder.
   * @param propertyName the property name in the OptionListValueHolder which will provide the selection value.
   * @deprecated use setListPropertyName instead - this method will be removed
   * in the final release of 1.9.7
   */
  public void setOptionListPropertyName(String optionListPropertyName) {
    setListPropertyName(optionListPropertyName);
  }

  /**
   * Get the property name in the OptionListValueHolder which will provide the selection value.
   * This name must correspond with the propertyName for the valueHolder.
   * @return the property name in the OptionListValueHolder which will provide the selection value.
   * @deprecated use getListPropertyName instead - this method will be removed
   * in the final release of 1.9.7
   */
  public String getOptionListPropertyName() {
    return getListPropertyName();
  }
