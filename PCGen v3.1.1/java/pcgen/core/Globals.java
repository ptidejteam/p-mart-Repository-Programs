 ...
 *
 * $Id: Globals.java,v 1.1 2006/02/21 00:05:26 vauchers Exp $
 */
package pcgen.core;
...
/////////////////////////////////////////////////
	...
	public static int getIndexOfCheck(String check)
	{
		int i = -1;
	...
	public static PObject getCheckNamed(String name)
	{
	...
	public static String getHelpContextFileList(int index)
	{
	...
	public static void addHelpContextFileList(String a)
	{
	...
	public static Feat getWeaponProfFeat(String weaponType)
	{
		for (Iterator e = getFeatList().iterator(); e.hasNext();)
		{
...
//		}
	...
	public static void setLevelInfo(ArrayList levelInfo)
	{
	...
	public static void setArmorTypes(TreeSet argArmorTypes)
	{
		armorTypes = argArmorTypes;
	}

	public static TreeSet getArmorTypes()
	{
		return armorTypes;
	}

	public static ArmorProf getArmorProfType(String name)
	{
	...
	public static ArrayList getArmorProfList()
	{
		return armorProfList;
	}

	public static void setArmorProfList(ArrayList armorProfList)
	{
		Globals.armorProfList = armorProfList;
	}
	...
	*/
	 ...
	 */
	public static void debugPrint(String param1, boolean param2)
	{
		if (!Globals.isDebugMode())
		{
			return;
	 ...
	 */
	public static void debugPrint(String param1, int param2)
	{
		if (!Globals.isDebugMode())
		{
			return;
...
//		}
		...
		//PersistenceManager.initFile(modeFilePrefix + "pointbuymethods.lst", LstConstants.POINTBUY_TYPE, new ArrayList());
	 ...
	 */
	public static int loadTypeForLoadScore(int loadScoreValue, Float weight)
	{
	 ...
	 */
	public static Float maxLoadForLoadScore(int loadScoreValue)
	{
	...
	public static String translateFeatName(final String oldName)
	{
		if (featNameTranslation != null)
		{
