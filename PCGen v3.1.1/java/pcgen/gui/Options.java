 ...
 */
class Options extends JMenu // extends Preferences
{
...
//	private JCheckBoxMenuItem summaryTabShown = new JCheckBoxMenuItem("<html>Show <b>Summary</b> tab</html>");
	...
	private JCheckBoxMenuItem hideOGL = new JCheckBoxMenuItem("Hide Open Game License display at start");
...
/* Mynex wants these options eliminated, so I'll comment them out (in the event they ever decide to return)
	...
	private void addSourceMenu(JMenu parent)
	{
		...
		sourceMenu.add(hideOGL);
		Utility.setDescription(hideOGL, "Hide licence display at start until next release of PCGen");
		hideOGL.addActionListener(checkBoxHandler);
		hideOGL.setSelected(!SettingsHandler.showLicense());
		hideOGL.setMnemonic('L');
	...
	public static void initializePurchaseModeMethods()
	{
		...
		final String methodName = SettingsHandler.getPurhaseModeMethodName();
...
/////////////////////////////////////////////////
	...
	private final class CheckBoxListener implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent actionEvent)
		{
			...
			else if (source == hideOGL)
			{
				SettingsHandler.setShowLicense(!hideOGL.isSelected());
			}
...
/* Mynex wants these options eliminated, so I'll comment them out (in the event they ever decide to return)
	...
	private static void ShowPurchaseModeConfiguration()
	{
		...
		Utility.centerFrame(pmsFrame, false);
