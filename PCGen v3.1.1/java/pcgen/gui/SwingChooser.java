 ...
 */
class SwingChooser extends JDialog implements ChooserInterface
{
	...
	private static String in_add;
	private static String in_close;
	private static String in_remove;
	...
	static
	{
		...
		try
		{
			...
			in_add = chooserProperties.getString("in_add");
			in_close = chooserProperties.getString("in_close");
			in_remove = chooserProperties.getString("in_remove");
	...
	private static class ChooserTableModel extends AbstractTableModel
	{
		 ...
		 * author       Matt Woodard
		 */
		void setColumnsNames(String[] names)
		{
			mColumnNames = names;
	 ...
	 * author       Matt Woodard
	 */
	public SwingChooser(java.awt.Dialog owner)
	{
		super(owner);
		initComponents();
	}
	 ...
	 * author       Matt Woodard
	 */
	public SwingChooser(java.awt.Dialog owner, String title)
	{
		super(owner, title);
		initComponents();
	}
	 ...
	 * author       Matt Woodard
	 */
	public SwingChooser(java.awt.Dialog owner, String title, boolean modal)
	{
	 ...
	 * author       Matt Woodard
	 */
	public SwingChooser(java.awt.Dialog owner, boolean modal)
	{
		super(owner, modal);
		initComponents();
	}
	 ...
	 * author       Matt Woodard
	 */
	public SwingChooser(java.awt.Frame owner)
	{
		super(owner);
		initComponents();
	}
	 ...
	 * author       Matt Woodard
	 */
	public SwingChooser(java.awt.Frame owner, String title)
	{
		super(owner, title);
		initComponents();
	}
	 ...
	 * author       Matt Woodard
	 */
	public SwingChooser(java.awt.Frame owner, String title, boolean modal)
	{
		super(owner, title, modal);
		initComponents();
	}
	 ...
	 * author       Matt Woodard
	 */
	public SwingChooser(java.awt.Frame owner, boolean modal)
	{
		super(owner, modal);
		initComponents();
	}
	...
	private void initComponents()
	{
		...
		// Create buttons
		mAddButton = new JButton(in_add);
		mAddButton.setMnemonic(KeyEvent.VK_A);
		mCloseButton = new JButton(in_close);
		mCloseButton.setMnemonic(KeyEvent.VK_C);
		mRemoveButton = new JButton(in_remove);
