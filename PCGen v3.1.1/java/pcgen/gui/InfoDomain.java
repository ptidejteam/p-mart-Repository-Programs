...
class InfoDomain extends FilterAdapterPanel
{
			...
			public void mouseClicked(MouseEvent f)
			{
				...
				if (f.getClickCount() == 1)
				{
					...
					if (domainName != null)
					{
						...
						if (aDomain != null)
						{
							domainInfo.setText("<html><b>" + aDomain.piSubString() +
	...
	public void updateCharacterInfo()
	{
		...
		for (int i = 0; i < aPC.getCharacterDomainList().size(); i++)
		{
			...
			{
				final pcgen.core.Domain aCDDomain = aCD.getDomain();
		...
		if (aPC.getDeity() != null)
		{
			...
			while (aTok.hasMoreElements())
			{
				 ...
				 * author: Thomas Behr 09-02-02
				 */
				if (accept(Globals.getDomainNamed(aString)) && !dataList.contains(aString))
				{
