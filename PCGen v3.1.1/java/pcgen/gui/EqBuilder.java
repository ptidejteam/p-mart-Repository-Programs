/*
 * EqBuilder.java
 * @(#) $Id: EqBuilder.java,v 1.1 2006/02/21 00:05:32 vauchers Exp $
 *
...
class EqBuilder extends JPanel
{
		...
		for (Iterator e = Globals.getClassList().iterator(); e.hasNext();)
		{
			...
			if ((baseStat != null) && (baseStat.length() > 0) && !baseStat.equalsIgnoreCase(Constants.s_NONE))
			{
				...
				for (Iterator e2 = Globals.getSpellMap().values().iterator(); e2.hasNext();)
				{
					...
					if (aSpell.levelForKey("CLASS", aClass.getName()) < 9999)
					{
...
//			Globals.debugPrint("metamagic: " + metamagicFeats);
	...
	private String getSpellItemName(Spell aSpell)
	{
		...
		if (castingClass != null)
		{
			...
			final int spellLevel = aSpell.levelForKey("CLASS", castAs);
...
//		}
	...
	private void showItemInfo()
	{
		...
		if (customName.length() != 0)
		{
			aInfo.append("Name: ").append(customName).append('\n');
		}
		String sprop = "";
...
*/
	 ...
	 *
	 */
	final class EquipmentModModel extends AbstractTableModel
	{
