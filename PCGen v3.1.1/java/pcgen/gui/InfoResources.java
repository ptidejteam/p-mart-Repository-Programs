 ...
 * Last Edited: $Date: 2006/02/21 00:05:32 $
 *
 *************************************************************************/
...
//Globals.errorPrint("--done-- focusGained: "+aPC.getName());
	...
	private String followerStatBlock(Follower aF, PlayerCharacter newPC)
	{
		...
		if (Globals.isStarWarsMode() || Globals.isWheelMode() || Globals.isSpycraftMode())
		{
			b.append("<i>Total</i>: ").append(aPC.DefenseTotal());
		...
		{
			b.append("<i>Total</i>: ").append(aPC.totalAC());
			b.append(" <i>Flatfooted</i>: ").append(aPC.flatFootedAC());
			b.append(" <i>Touch</i>: ").append(aPC.touchAC());
			b.append("<br>");
		}
...
//Globals.errorPrint("IR  --done-- updateCharacterInfo");
	 ...
	 **/
	class FollowerModel extends AbstractTreeTableModel implements TreeTableModel
	{
		...
		public void resetModel(int mode, boolean available)
		{
			...
			if (aPC.hasSpecialAbility("Summon Familiar") &&
			  !selectedList.contains("Familiar"))
