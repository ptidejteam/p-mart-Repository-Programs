						...
						switch (thisType)
						{
							case 1: // race
									...
									(field > 1 && field < 8))
								{
									...
									if (!bString.equals("0"))
									{
//										STATADJ: has been replaced in v3.1.0
//										bString = "STATADJ" + (statNum) + ":" + bString;
							...
							case 2: // class
								...
								{
									if (hasTagless)
										bString = getFormulaFor(0, bString.substring(4));
...
//									bString = "FORTITUDECHECK:" + bString; //JKXXX Should I remove this?
