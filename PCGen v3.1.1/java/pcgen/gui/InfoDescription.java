...
class InfoDescription extends JPanel
{
	...
	//private JTextArea bioText = new JTextArea(aPC.getBio());
	//private JTextArea descriptionText = new JTextArea(aPC.getDescription());
	...
	private void initComponents()
	{
		...
		final JLabel labelName = new JLabel(PropertyFactory.getString("in_nameLabel") + ": ");
...
/*
		...
		pane1.add(scroll);
		pane2.add(scroll2);
		TitledBorder title1 = BorderFactory.createTitledBorder(etched, PropertyFactory.getString("in_bioInfoString"));
		title1.setTitleJustification(TitledBorder.CENTER);
		pane1.setBorder(title1);
		pane1.setLayout(new BoxLayout(pane1, BoxLayout.Y_AXIS));

		TitledBorder title2 = BorderFactory.createTitledBorder(etched, PropertyFactory.getString("in_descripInfoString"));
...
*/
		...
		splitPane = new FlippingSplitPane(FlippingSplitPane.HORIZONTAL_SPLIT, notesScroll, dataScroll);
		...
		//Utility.setDescription(wtBox, PropertyFactory.getString("in_randCheckTipString"));
		//Utility.setDescription(htBox, PropertyFactory.getString("in_randCheckTipString"));
...
// Without a class, everone is young
	...
	public void refreshDisplay()
	{
		...
		//bioText.setText(aPC.getBio());
		//descriptionText.setText(aPC.getDescription());
		//startListeners();
	}
