...
class InfoClasses extends FilterAdapterPanel
{
	...
	private JLabel lblChecks = new JLabel();
...
/////////////////////////////////////////////////
// Moved to Summary tab
//	private JLabel lblAlignment = new JLabel(Globals.getGameModeAlignmentText() + ":");
...
/////////////////////////////////////////////////
// Moved to menu: Settings-->House Rules
...
/////////////////////////////////////////////////
	...
	private void initComponents()
	{
		...
		buildConstraints(gridBagConstraints2, 0, 0, 1, 1, 0, 0);
		gridBagConstraints2.insets = new Insets(0, 0, 0, 5);
		gridBagConstraints2.anchor = GridBagConstraints.EAST;
		jPanel1.add(jButtonHP, gridBagConstraints2);

		lblChecks.setForeground(Color.black);
		buildConstraints(gridBagConstraints2, 2, 1, 2, 3, 0, 0);
		gridBagConstraints2.fill = GridBagConstraints.BOTH;
		lblChecks.setText(getCheckText());
		jPanel1.add(lblChecks, gridBagConstraints2);

		lblReputation.setText(Globals.getGameModeReputationText());
		...
		buildConstraints(gridBagConstraints2, 0, 1, 1, 1, 0, 0);
		jPanel1.add(lblFeats, gridBagConstraints2);

		lblSkills.setText("Skills");
		lblSkills.setForeground(Color.black);
		buildConstraints(gridBagConstraints2, 0, 2, 1, 1, 0, 0);
		jPanel1.add(lblSkills, gridBagConstraints2);

		lblBAB.setText("BAB");
		lblBAB.setForeground(Color.black);
		buildConstraints(gridBagConstraints2, 0, 3, 1, 1, 0, 0);
		jPanel1.add(lblBAB, gridBagConstraints2);

		lblDefense.setText(Globals.getGameModeDefenseText());
		lblDefense.setForeground(Color.black);
		buildConstraints(gridBagConstraints2, 0, 4, 1, 1, 0, 0);
		jPanel1.add(lblDefense, gridBagConstraints2);

		lblWoundPoints.setText(Globals.getGameModeWoundPointsText());
		lblWoundPoints.setForeground(Color.black);
		buildConstraints(gridBagConstraints2, 2, 5, 1, 1, 0, 0);
...
/////////////////////////////////////////////////
		...
		buildConstraints(gridBagConstraints2, 1, 0, 1, 1, 0, 0);
		gridBagConstraints2.insets = new Insets(0, 0, 0, 0);
		gridBagConstraints2.fill = GridBagConstraints.HORIZONTAL;
		gridBagConstraints2.anchor = GridBagConstraints.CENTER;
		...
		buildConstraints(gridBagConstraints2, 3, 4, 1, 1, 0, 0);
		gridBagConstraints2.insets = new Insets(0, 4, 0, 4);
		jPanel1.add(lReputation, gridBagConstraints2);

/////////////////////////////////////////////////
// Yanked for WotC compliance
//		lMaxHPPct.setText("Max " + Globals.getGameModeHPText() + " %");
//		lMaxHPPct.setForeground(Color.black);
//		buildConstraints(gridBagConstraints2, 2, 0, 1, 1, 0, 0);
//		gridBagConstraints2.anchor = GridBagConstraints.EAST;
...
//		});
//
//		buildConstraints(gridBagConstraints2, 3, 0, 1, 1, 0, 0);
...
/////////////////////////////////////////////////
	...
	String getCheckText()
	{
		...
		for (Iterator i = Globals.getCheckList().iterator(); i.hasNext();)
		{
			...
			buf.append("<tr><td>").append(obj.getName()).append("</td> <td>");
			final int b = aPC.getBonus(x++, true);
			buf.append(Delta.toString(b)).append("</td></tr>");
		}
...
/////////////////////////////////////////////////
// Moved to Summary tab
//		aString = Globals.getGameModeAlignmentText();
//		if (aString.length() != 0)
//		{
//			lblAlignment.setText(aString + ":");
