...
class UIFactory
{
	...
	static
	{
		...
		// THIS DOESN'T WORK YET.  --bko XXX
		// Add the Linux L&F before asking the UIManager.
		try
		{
	...
	public static int indexOfSystemLookAndFeel()
	{
		return systemIndex;
	}
	...
	{
		String lnfName = getLookAndFeelName(SettingsHandler.getLookAndFeel());
	...
	public static void setLookAndFeel(Object looknfeel)
	{
		try
		{
			...
			if (laf instanceof javax.swing.plaf.metal.MetalLookAndFeel)
				((javax.swing.plaf.metal.MetalLookAndFeel)laf).setCurrentTheme(new javax.swing.plaf.metal.DefaultMetalTheme());
