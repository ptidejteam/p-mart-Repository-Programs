 ...
 * @(#) $Id: NewWeaponInfoDialog.java,v 1.1 2006/02/21 00:05:32 vauchers Exp $
 *
...
class NewWeaponInfoDialog extends JDialog
{
	private JButton btnCancel;
	private JButton btnOK;
	private JComboBox cmbCritMult;
	private JComboBox cmbCritRange;
	private JComboBox cmbDamageDieCount;
	private JComboBox cmbDamageDieSides;
	...
	private void initComponents()
	{
		...
		btnOK = new JButton();
		cmbDamageDieCount = new JComboBox();
		cmbDamageDieSides = new JComboBox();
		cmbCritRange = new JComboBox();
		cmbCritMult = new JComboBox();
...
//		cmbDamageDieCount = new javax.swing.JComboBox();
//		cmbDamageDieSides = new javax.swing.JComboBox();
//		cmbCritRange = new javax.swing.JComboBox();
//		cmbCritMult = new javax.swing.JComboBox();
	...
	public String getDamage()
	{
		...
		{
			damage = ((Integer)cmbDamageDieCount.getItemAt(cmbDamageDieCount.getSelectedIndex())).toString() + "d" +
			  ((Integer)cmbDamageDieSides.getItemAt(cmbDamageDieSides.getSelectedIndex())).toString();
		}
		return damage;
	}
	...
	public String getCritMultiplier()
	{
		...
		{
			return ((Integer)cmbCritMult.getItemAt(cmbCritMult.getSelectedIndex())).toString();
		}
		return "";
	}
	...
	public String getCritRange()
	{
		...
		{
			return ((Integer)cmbCritRange.getItemAt(cmbCritRange.getSelectedIndex())).toString();
		}
		return "";
	}
