 ...
 *
 * $Id: DomainLoader.java,v 1.1 2006/02/21 00:05:41 vauchers Exp $
 */
...
class DomainLoader
{
	...
	public static void parseLine(Domain obj, String inputLine, File sourceFile, int lineNum) throws PersistenceLayerException
	{
		...
		while (colToken.hasMoreTokens())
		{
			...
			{
				Globals.debugPrint("SKILL: support for " + sourceFile.getName() + " has been removed. Use CSKILL: instead");
			}
