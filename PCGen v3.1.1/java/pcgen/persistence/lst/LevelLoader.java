 ...
 *
 * $Id: LevelLoader.java,v 1.1 2006/02/21 00:05:41 vauchers Exp $
 */
...
class LevelLoader
{
	 ...
	 */
	public static void parseLine(LevelInfo levelInfo, String inputLine, File sourceFile, int lineNum)
	{
		int tokenNum = 0;
		String aString;
