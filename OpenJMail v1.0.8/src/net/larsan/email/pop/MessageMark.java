...
public class MessageMark {
    ...
    /** Message size in bytes or maildrop size in bytes. Default to -1 if not known. */
    
    public final int size;
    
    /** Message UIDL. Default to null if not known. */
    ...
    */
    ...
    public MessageMark(int number, String uidl) {
        this.number = number;
        this.uidl = uidl;
        size = -1;
    }
