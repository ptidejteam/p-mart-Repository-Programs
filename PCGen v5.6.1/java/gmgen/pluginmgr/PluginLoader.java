...
public class PluginLoader {
	 ...
	 *
	 *@param  parentFrame  Frame/App that uses this PluginLoader to load plugins
	 */
	public PluginLoader(Frame parentFrame) {
		PluginLoader.parentFrame = parentFrame;
		...
		for (int i = 0; i < jars.size(); i++) {
			((Plugin.JAR) jars.elementAt(i)).getClassLoader().startAllPlugins();
		}
	}
