...
/**
 *  Send this message to inform all components that the state of component has changed.
 *
 *@author     Soulcatcher
 *@created    May 23, 2003
 */
public class StateChangedMessage extends GMBMessage {
	JMenu editMenu;
	 ...
	 */
	public StateChangedMessage(GMBComponent comp, JMenu editMenu) {
		super(comp);
