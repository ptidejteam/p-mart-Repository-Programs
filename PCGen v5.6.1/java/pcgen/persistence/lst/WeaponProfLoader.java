 ...
 *
 * $Id: WeaponProfLoader.java,v 1.1 2006/02/21 01:33:26 vauchers Exp $
 */
...
public final class WeaponProfLoader extends LstObjectFileLoader
{
		...
		throws PersistenceLayerException
	{
		...
		while (colToken.hasMoreTokens())
		{
			...
			else if (col == 0) // First column is name, without a tag
			{
			...
			{
				Logging.errorPrint(
					"Illegal weapon proficiency info '"
						+ lstLine
						+ "' in "
						+ source.toString());
			}
	...
	/**
	 * @see pcgen.persistence.lst.LstFileLoader#finishObject(pcgen.core.PObject)
	 */
