 ...
 *
 * @(#) $Id: MovementPanel.java,v 1.1 2006/02/21 01:33:33 vauchers Exp $
 */
...
//		this.add(lblTemp, gridBagConstraints);
	...
	private void btnAddActionPerformed()
	{
		...
		{
			GuiFacade.showMessageDialog(null, "You must enter a movement type, adjustment and amount.", Constants.s_APPNAME, GuiFacade.ERROR_MESSAGE);
			return;
		}
