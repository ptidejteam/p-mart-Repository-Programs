...
public class FakeWindowsLookAndFeel extends WindowsLookAndFeel
{
	...
	protected void initComponentDefaults(UIDefaults table)
	{
		...
		Object[] defaults = {
			...
			"Tree.openIcon", makeIcon(wlafClass, "icons/TreeOpen.gif"),
			"Tree.closedIcon", makeIcon(wlafClass, "icons/TreeClosed.gif"),
			...
			"OptionPane.errorIcon", makeIcon(wlafClass, "icons/Error.gif"),
			"OptionPane.informationIcon", makeIcon(wlafClass, "icons/Inform.gif"),
			"OptionPane.warningIcon", makeIcon(wlafClass, "icons/Warn.gif"),
