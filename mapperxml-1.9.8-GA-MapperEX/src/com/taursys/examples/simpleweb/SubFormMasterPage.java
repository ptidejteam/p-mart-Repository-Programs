 ...
 * @version 2.0
 */
public class SubFormMasterPage extends ServletForm {
  private SubFormHeaderPage header = new SubFormHeaderPage();
  private SubFormNewsPage news = new SubFormNewsPage();

  /**
   * Constructs a new SubFormMasterPage and initializes component properties.
   */
  public SubFormMasterPage() {
    try {
      jbInit();
    }
    catch(Exception e) {
  ...
  private void jbInit() throws Exception {
    this.setDocumentURI("resource:///forms/SubFormMasterPage.html");
    header.setId("headerSection");
    header.setSourceId("standardHeader");
    news.setId("rightSection");
    news.setSourceId("newsSection");
    this.add(header);
    this.add(news);
  }
