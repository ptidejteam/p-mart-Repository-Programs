...
public interface InterTrackerProtocol {
  ...
  /** Called to find which tasks that have been run by this tracker are now
   * closed, i.e., their job is complete.  This is used to, e.g., notify a map
   * task that its output is no longer needed and may be removed. */
