...
import pcgen.core.money.utils.FileContentParser;
import pcgen.core.money.utils.iParsingClient;
...
public final class DenominationList extends ArrayList implements iParsingClient
{
	...
	public void parsedTokens(List items)
	{
		...
		if (hasError)
		{
			Logging.errorPrint("Coin error - File " + currentFile + ", Coin " + name + errorBuf.toString());
		}
	}
