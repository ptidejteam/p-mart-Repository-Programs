 ...
 *
 * $Id: SkillLoader.java,v 1.1 2006/02/21 01:18:47 vauchers Exp $
 */
...
final class SkillLoader
{
	...
	public static void parseLine(Skill obj, String inputLine, URL sourceURL, int lineNum) throws PersistenceLayerException
	{
		if (obj == null)
		{
			return;
		...
		while (colToken.hasMoreTokens())
		{
			...
			{
				Logging.errorPrint("SYNERGY is a deprecated tag in " + sourceURL.toString() + ". This functionality is now handled using the BONUS tag.");
			...
			{
				throw new PersistenceLayerException("Illegal skill info " + sourceURL.toString() +
