	...
	public static void parseLine(Race race, String inputLine, URL sourceURL, int lineNum) throws PersistenceLayerException
	{
		...
		while (colToken.hasMoreTokens())
		{
			...
			else if (colString.length() > 5 && colString.startsWith("HEIGHT:"))
			{
				...
				Logging.errorPrint("HEIGHT is a deprecated tag in " + sourceURL.toString() + ". This functionality is now handled in biosettings.lst");
			}
...
*/
			...
			else if (colString.startsWith("WEIGHT"))
			{
				...
				Logging.errorPrint("WEIGHT is a deprecated tag in " + sourceURL.toString() + ". This functionality is now handled in biosettings.lst");
			}
