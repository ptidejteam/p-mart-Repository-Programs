...
//  		mainPanel.add(rightButtonPanel, 1, 2, 1, 1);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if (src.equals(saveButton))
		{
			...
			{
				// show warning
				GuiFacade.showMessageDialog(null, PropertyFactory.getString("in_filterErP1") + Constants.s_LINE_SEP + PropertyFactory.getString("in_filterErP2"), PropertyFactory.getString("in_filterErWarn"), GuiFacade.ERROR_MESSAGE);
				return;
			}
...
final class FilterNameDialog extends JDialog implements ActionListener, FilterConstants
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else
		{
			...
			{
				GuiFacade.showMessageDialog(null, PropertyFactory.getString("in_filterEr2P1") + " '" + name + "'!", PropertyFactory.getString("in_filterErWarn"), GuiFacade.ERROR_MESSAGE);
			}
			else
			{
				int index = indexOfIllegalChar(name);
				GuiFacade.showMessageDialog(null, PropertyFactory.getString("in_filterEr3P1") + " '" + name.charAt(index) + "' " + PropertyFactory.getString("in_filterEr3P2"), PropertyFactory.getString("in_filterErWarn"), GuiFacade.ERROR_MESSAGE);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if (src.equals(createButton))
		{
			...
			catch (FilterParseException ex)
			{
				...
				GuiFacade.showMessageDialog(null, ex.getMessage(), PropertyFactory.getString("in_error"), GuiFacade.ERROR_MESSAGE);
			}
			if (filter != null)
			{
				// possible naming
