...
public final class Utility
{
	...
	public static File getTempPreviewFile()
	{
		...
		{
			GuiFacade.showMessageDialog(null, "No HTML template specified in preferences.", "PCGen", GuiFacade.ERROR_MESSAGE);
			return null;
		}
		...
		{
			GuiFacade.showMessageDialog(null, "Could not create temporary preview file.", "PCGen", GuiFacade.ERROR_MESSAGE);
	...
	public static void previewInBrowser(String fileName)
	{
		...
		{
			GuiFacade.showMessageDialog(null, "Could not preview file in external browser. Sorry...", "PCGen", GuiFacade.ERROR_MESSAGE);
	...
	public static void printToWriter(Writer w, String aFile) throws IOException
	{
		...
		if (fileName.startsWith(Constants.s_CHARACTER_TEMPLATE_START) || fileName.startsWith(Constants.s_EQSET_TEMPLATE_START))
		{
