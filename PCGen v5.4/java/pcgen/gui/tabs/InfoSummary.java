 ...
 *
 * $Id: InfoSummary.java,v 1.1 2006/02/21 01:18:57 vauchers Exp $
 */
...
/////////////////////////
	...
	private void addClass(PCClass theClass, int levels)
	{
		...
		if (levels > 0)
		{
			if (SettingsHandler.isFreeClothesAtFirst() && ((aPC.totalNonMonsterLevels()) == 1))
			{
				//
				// See what the PC is already carrying
				//
				List clothes = Globals.getEquipmentOfType(aPC.getEquipmentList(), "Clothing.Resizable", "Magic");
				//
