 ...
 *
 * $Id: KitGear.java,v 1.1 2006/02/21 01:00:32 vauchers Exp $
 */
...
public final class KitGear implements Serializable
{
	...
	public void setQty(String argQty)
	{
		...
		{
			Globals.errorPrint("Invalid qty \"" + argQty + "\" in KitGear.setQty");
		}
	}
	...
	public void setMaxCost(String argMaxCost)
	{
		...
		{
			Globals.errorPrint("Invalid max cost \"" + argMaxCost + "\" in KitGear.setMaxCost");
		}
	}
