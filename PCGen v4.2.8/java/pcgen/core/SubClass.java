 ...
 *
 * $Id: SubClass.java,v 1.1 2006/02/21 01:00:27 vauchers Exp $
 */
...
public final class SubClass extends PCClass
{
	...
	//private String spellListString = null;
	private ArrayList levelArray = null;
	...
	//public void setSpellListString(String arg)
	//{
	//spellListString = arg;
	//}
	...
	public void applyLevelArrayModsTo(PCClass aClass)
	{
		...
		File aFile = new File(aClass.getSourceFile());
		for (Iterator i = levelArray.iterator(); i.hasNext();)
		{
			try
			{
				String aLine = (String) i.next();
				PCClassLoader.parseLine(aClass, aLine, aFile, -1);
			}
			catch (Exception exc)
			{
