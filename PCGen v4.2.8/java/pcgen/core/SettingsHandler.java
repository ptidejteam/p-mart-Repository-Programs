 ...
 *
 * $Id: SettingsHandler.java,v 1.1 2006/02/21 01:00:27 vauchers Exp $
 */
package pcgen.core;
...
/////////////////////////////////////////////////
	...
	private static final String[] rollMethodExpressions = {"0", // all 0s
	...
	private static String selectedHTMLOutputSheet = "";
	private static String selectedPDFOutputSheet = "";

	private static String selectedEqSetTemplate = "";
	private static String selectedPartyTemplate = "";
...
//	private static int pcgSaveFormat = 2;
	...
	private static void readFilterSettings()
	{
		...
		finally
		{
			...
			catch (IOException ex)
			{
				...
				Globals.errorPrint("Can't close filter file", ex);
			}
		}
	}
	...
	public static Dimension readOptionsProperties()
	{
		...
		finally
		{
			...
			{
				//Not much to do about it...
				Globals.errorPrint("Can't close options file", ex);
			}
		}
		return d;
	}
	...
	public static Dimension getOptionsFromProperties()
	{
		...
		setSelectedHTMLOutputSheet(getOptions().getProperty("pcgen.files.selectedHTMLOutputSheet", ""));
		setSelectedPDFOutputSheet(getOptions().getProperty("pcgen.files.selectedPDFOutputSheet", ""));
		setSelectedPartyTemplate(getOptions().getProperty("pcgen.files.selectedPartyTemplate", ""));
...
/////////////////////////////////////////////////
	...
	private static void writeFilterSettings()
	{
		...
		{
			Globals.errorPrint("Can't write filter settings", e);
		}
		finally
		{
			try
			...
			{
				//Not much to do about it...
				Globals.errorPrint("Can't close filter file after writing", ex);
			}
		}
	...
	public static void writeOptionsProperties()
	{
		...
		{
			Globals.errorPrint("Can't close options file", e);
		}
		finally
		{
			try
			...
			{
				//Not much to do about it...
				Globals.errorPrint("Can't close options file after writing", ex);
			}
		}
	}
...
/////////////////////////////////////////////////
	...
	{
		if ("".equals(selectedHTMLOutputSheet))
		{
			return getTemplatePath().toString();
		}
		return new File(selectedHTMLOutputSheet).getParentFile().getAbsolutePath();
	}
	...
	{
		if ("".equals(selectedPDFOutputSheet))
		{
			return getTemplatePath().toString();
		}
		return new File(selectedPDFOutputSheet).getParentFile().getAbsolutePath();
	}
