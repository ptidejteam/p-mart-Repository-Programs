 ...
 *
 * @(#) $Id: HP.java,v 1.1 2006/02/21 01:00:21 vauchers Exp $
 */
...
final class HP extends BonusObj
{
	private static final String[] bonusTags = {"BONUS", "CURRENTMAX", "CURRENTMAXPERLEVEL", "WOUNDPOINTS"};
