 ...
 *
 * @(#) $Id: WeaponProf.java,v 1.1 2006/02/21 01:00:21 vauchers Exp $
 */
...
final class WeaponProf extends BonusObj
{
	private String varPart = "";

	private static final String[] bonusTags = {"CRITMULTADD", "CRITRANGEADD", "CRITRANGEDOUBLE", "DAMAGE", "DAMAGE-SHORTRANGE", "PCSIZE", "TOHIT", "TOHITOVERSIZE"};
	...
	{
		return super.getTypeOfBonus() + varPart;
	}
