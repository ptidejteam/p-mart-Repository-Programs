 ...
 *
 * $Id: EquipmentGroup.java,v 1.1 2006/02/21 01:00:27 vauchers Exp $
 */
...
final class EquipmentGroup implements EquipmentCollection, Serializable
{
	...
	{
		//there is no method implementation, either there needs to be one
		//or EquipmentGroup is really an abstract class and this method is also abstract
	}
	...
	{
		return (o instanceof EquipmentGroup) && d_name.equals(((EquipmentGroup) o).getName());
	}
