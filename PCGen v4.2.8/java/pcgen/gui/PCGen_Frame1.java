...
public class PCGen_Frame1 extends JFrame
{
	...
	final String getCurrentPartyDisplayName()
	{
		final File file = new File(partyFileName);
	...
	{
		JOptionPane.showMessageDialog(null, FOPResourceChecker.getMissingResourceMessage() + menuBar.msg, Constants.s_APPNAME, JOptionPane.WARNING_MESSAGE);
	}
		...
		public MenuItems()
		{
			...
			exportPDFItem = Utility.createMenuItem("mnuFileExportPDF", new ActionListener()
			{
				public void actionPerformed(ActionEvent e)
				{
					...
					{
						JOptionPane.showMessageDialog(null, FOPResourceChecker.getMissingResourceMessage() + msg, Constants.s_APPNAME, JOptionPane.WARNING_MESSAGE);
					}
				}
