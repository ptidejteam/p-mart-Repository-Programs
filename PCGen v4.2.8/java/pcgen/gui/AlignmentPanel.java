...
final class AlignmentPanel extends JPanel
{
	...
	private static final HashMap FILTERABLES = new HashMap();
...
// Give the user a chance to bail
		if (unqualified.length() > 0)
		{
			if (JOptionPane.showConfirmDialog(null, PropertyFactory.getString("in_alPaConfirm") + ":" + Constants.s_LINE_SEP + //				PropertyFactory.getString("in_alPaConfirm") + ":" + "\n" +
