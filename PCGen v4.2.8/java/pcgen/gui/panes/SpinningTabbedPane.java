...
public class SpinningTabbedPane extends JTabbedPane
{
	...
	private static final String[] labels = {PropertyFactory.getString("in_top"), // place
																					...
																					PropertyFactory.getString("in_up"), PropertyFactory.getString("in_bottom"), PropertyFactory.getString("in_down"), PropertyFactory.getString("in_up"), // group
																					PropertyFactory.getString("in_left"), PropertyFactory.getString("in_down"), PropertyFactory.getString("in_right"), null, // tab
																					null, null, null, PropertyFactory.getString("in_ungroupTop"), // ungroup child
																					PropertyFactory.getString("in_ungroupLeft"), PropertyFactory.getString("in_ungroupBottom"), PropertyFactory.getString("in_ungroupRight"), PropertyFactory.getString("in_ungroupTop"), // ungroup self
																					PropertyFactory.getString("in_ungroupLeft"), PropertyFactory.getString("in_ungroupBottom"), PropertyFactory.getString("in_ungroupRight"), PropertyFactory.getString("in_ungroupUp"), // ungroup single
	...
	private class RenameActionListener implements ActionListener
	{
		...
		private class RenameTextFieldActionListener implements ActionListener
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				SpinningTabbedPane.this.setTitleAt(index, textField.getText());
