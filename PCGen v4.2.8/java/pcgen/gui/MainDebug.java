...
final class MainDebug extends JPanel
{
	...
	MainDebug()
	{
		...
		try
		{
			...
			{
				JOptionPane.showMessageDialog(null, "You do not have java 1.3 installed. Go to" + " http://java.sun.com/j2se/1.3/jre to get the correct version.", "PCGen", JOptionPane.ERROR_MESSAGE);
			}
			try
			{
				ResourceBundle d_properties = ResourceBundle.getBundle("pcgen/gui/prop/PCGenProp");
				Globals.debugPrint("PCGen version:", d_properties.getString("VersionNumber"));
			}
			...
			{
				JOptionPane.showMessageDialog(null, "If you experience any difficulties, look in the" + " Debug tab and post its contents at http://groups.yahoo.com/group/pcgen", "PCGen", JOptionPane.INFORMATION_MESSAGE);
			}
		}
		catch (Exception e)
		{
	 ...
	 * @since
	 */
	static void btnDebugClear_actionPerformed(ActionEvent e)
	{
