...
final class TableSorter extends TableMap
{
	...
	private final void mergeSort(int[] indices, int[] workspace, final int start, final int end)
	{
...
// Pass all requests to these rows through the mapping array: "indexes".
	...
	public Object getValueAt(int aRow, int aColumn)
	{
		...
		{
			Globals.errorPrint("Row " + aRow + " illegal.");
			aRow = 0;
		}
