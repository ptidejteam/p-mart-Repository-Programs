 ...
 * @(#) $Id: NewWeaponInfoDialog.java,v 1.1 2006/02/21 01:00:21 vauchers Exp $
 *
...
//		cmbCritMult = new javax.swing.JComboBox();
	...
	public String getDamage()
	{
		...
		{
			damage = ((Integer) cmbDamageDieCount.getItemAt(cmbDamageDieCount.getSelectedIndex())).toString() + "d" + ((Integer) cmbDamageDieSides.getItemAt(cmbDamageDieSides.getSelectedIndex())).toString();
		}
		return damage;
	}
