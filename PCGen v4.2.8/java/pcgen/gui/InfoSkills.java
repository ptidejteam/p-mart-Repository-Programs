...
//Globals.errorPrint("cM: createModels");
	 ...
	 */
	private final class SkillModel extends AbstractTreeTableModel implements TreeTableModel
	{
		...
		private class DisplayableSkillsIterator implements ResetableIterator
		{
			...
			public boolean hasNext()
			{
			    ...
			    {
			    	peek = (Skill) it.next();
				if (shouldDisplayThis(peek)) return true;
			    }
		 ...
		 * @param does the new node go here? what part(s)?
		...
		{
			Iterator fI = new DisplayableSkillsIterator(available);
