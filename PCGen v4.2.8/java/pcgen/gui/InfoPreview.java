 ...
 */
final class InfoPreview extends JPanel
{
	...
	InfoPreview()
	{
		...
		addComponentListener(new ComponentAdapter()
		{
			public void componentShown(ComponentEvent evt)
			{
				...
				requestFocus();
				final String templateName = SettingsHandler.getSelectedHTMLOutputSheet();
		...
		if (new File(SettingsHandler.getSelectedHTMLOutputSheet()).exists())
		{
	 ...
	 * @since
	 */
	private void btnBrowseTemplate_actionPerformed(ActionEvent e)
	{
		...
		{
			SettingsHandler.setSelectedHTMLOutputSheet(fc.getSelectedFile().getPath());
			SettingsHandler.setTemplatePath(fc.getSelectedFile().getParentFile());
			txtSelectedTemplate.setText(SettingsHandler.getSelectedHTMLOutputSheet());
		}
		btnPreview.setEnabled(true);
		btnPreviewInBrowser.setEnabled(true);
	}
	 ...
	 * @since
	 */
	private void btnPreview_actionPerformed(ActionEvent e)
	{
	 ...
	 * @since
	 */
	private void btnPreviewInBrowser_actionPerformed(ActionEvent e)
	{
	...
	private static File getTempPreviewFile()
	{
		...
		final String template = SettingsHandler.getSelectedHTMLOutputSheet();
  ...
  */
	...
	private static void printToWriter(Writer w) throws IOException
	{
		...
		File template = new File(SettingsHandler.getSelectedHTMLOutputSheet());
