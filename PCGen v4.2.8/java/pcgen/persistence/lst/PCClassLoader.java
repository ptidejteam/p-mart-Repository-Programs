 ...
 *
 * $Id: PCClassLoader.java,v 1.1 2006/02/21 01:00:36 vauchers Exp $
 */
...
public final class PCClassLoader
{
	...
	public static boolean parseLine(PCClass pcClass, String inputLine, File sourceFile, int lineNum) throws PersistenceLayerException
	{
		...
		if (inputLine.startsWith("SUBCLASS:") || inputLine.startsWith("SUBCLASSLEVEL:"))
		{
			...
			{
				String n = inputLine.substring(9, inputLine.indexOf("\t"));
			...
			if (a != null)
			{
				SubClassLoader.parseLine(a, inputLine, sourceFile, lineNum);
			}
			return true;
		}
