...
class InfoProfile extends JPanel
{
  ...
  ActionListener al1 = new ActionListener()
    {
      ...
      public void actionPerformed(ActionEvent evt)
      {
        if (handedComboBox!=null && handedComboBox.getSelectedItem()!=null)
        {
          ...
          Globals.currentPC.setHanded(handedComboBox.getSelectedItem().toString());
        }
      }
    };
  ...
  ActionListener al2 = new ActionListener()
    {
      ...
      public void actionPerformed(ActionEvent evt)
      {
        ...
        {
          Globals.currentPC.setDirty(true);
          Globals.currentPC.setGender(genderComboBox.getSelectedItem().toString());
        }
      }
    };
  ...
  private void initComponents()
  {
    ...
    rollHtWtButton.addActionListener(
      new ActionListener()
      {
        ...
        public void actionPerformed(ActionEvent evt)
        {
          if (Globals.currentPC.race()==null)
            return;
          Globals.currentPC.race().rollHeightWeight();
          wtText.setText(new Integer(Globals.currentPC.weight()).toString());
          htText.setText(new Integer(Globals.currentPC.height()).toString());
        }
      });
    rollAgeButton.addActionListener(
      new ActionListener()
      {
        ...
        public void actionPerformed(ActionEvent evt)
        {
          if (Globals.currentPC.classList().size()==0 || Globals.currentPC.race()==null)
            return;
          Globals.currentPC.setDirty(true);
          Globals.currentPC.race().rollAgeForClass(((PCClass)Globals.currentPC.classList().get(0)).name());
          ageText.setText(new Integer(Globals.currentPC.age()).toString());
        }
      });
  ...
  public void startListeners()
  {
    ...
    if (ageAdapter==null)
    {
      ageAdapter = new java.awt.event.FocusAdapter()
      {
        public void focusLost(java.awt.event.FocusEvent evt)
        {
          Globals.currentPC.setDirty(true);
          Globals.currentPC.setAge(pcgen.util.Delta.parseInt(ageText.getText()));
        }
      };
    }
    ...
    if (htAdapter==null)
    {
      htAdapter = new java.awt.event.FocusAdapter()
      {
        public void focusLost(java.awt.event.FocusEvent evt)
        {
          Globals.currentPC.setDirty(true);
          Globals.currentPC.setHeight(pcgen.util.Delta.parseInt(htText.getText()));
        }
      };
    }
    ...
    if (wtAdapter==null)
    {
      wtAdapter = new java.awt.event.FocusAdapter()
      {
        public void focusLost(java.awt.event.FocusEvent evt)
        {
          Globals.currentPC.setDirty(true);
          Globals.currentPC.setWeight(pcgen.util.Delta.parseInt(wtText.getText()));
        }
      };
    }
    ...
    {
      playerNameAdapter = new java.awt.event.FocusAdapter()
      {
        public void focusLost(java.awt.event.FocusEvent evt)
        {
          Globals.currentPC.setPlayersName(playerNameText.getText());
        }
      };
    }
  ...
  public void storeDisplay()
  {
    ...
    pc.setAge(pcgen.util.Delta.parseInt(ageText.getText()));
    pc.setHeight(pcgen.util.Delta.parseInt(htText.getText()));
    pc.setWeight(pcgen.util.Delta.parseInt(wtText.getText()));
  ...
  public void refreshDisplay()
  {
    ...
    if(!aPC.race().equals(Globals.s_emptyRace))
    {      String movelabel = aPC.race().movementType(0) + " " + aPC.movement(0) + " feet";      for(int x = 1; x < aPC.race().movements().length; x++)        movelabel += ", " + aPC.race().movementType(x) + " " + aPC.movement(x) + " feet";
      movementLabel.setText(movelabel);
      initLabel.setText(new Integer(aPC.initiativeMod()).toString());
      acLabel.setText(new Integer(aPC.acMod()).toString());
      sizeLabel.setText(aPC.size());
      strBonusLabel.setText(new Integer((aPC.adjStats(0)/2)-5).toString());
      dexBonusLabel.setText(new Integer((aPC.adjStats(1)/2)-5).toString());
      ...
      visionLabel.setText(aPC.race().vision());
      handedComboBox.setSelectedItem(aPC.handed());
      genderComboBox.setSelectedItem(aPC.gender());
      ageText.setText(new Integer(aPC.age()).toString());
      wtText.setText(new Integer(aPC.weight()).toString());
      htText.setText(new Integer(aPC.height()).toString());
    }
    playerNameText.setText(aPC.playersName());
    startListeners();
  }
}
