...
public class Options extends JMenu
{
  ...
  private void jbInit() throws Exception
  {
    ...
    purchaseMode.setSelected(Globals.purchaseStatMode);
    ...
    maxHpAtFirstLevel.setSelected(Globals.hpMaxAtFirstLevel);
  ...
  private final class CheckBoxListener implements ActionListener
  {
    public void actionPerformed(ActionEvent actionEvent)
    {
      ...
      else if (source == method6)
      {
        ...
        method5.setSelected(false);
        method1.setSelected(false);
        Globals.rollMethod = 6;
      }
      else if (source == maxHpAtFirstLevel)
      {
        Globals.hpMaxAtFirstLevel = maxHpAtFirstLevel.isSelected();
      }
      else if (source == hpStandard)
      {
        ...
        Globals.hpRollMethod = Globals.HP_STANDARD;
      }
      else if (source == hpAutomax)
      {
        ...
        hpPercentage.setSelected(false);
        hpRpga.setSelected(false);
        Globals.hpRollMethod = Globals.HP_AUTOMAX;
      }
      else if (source == hpPercentage)
      {
        ...
        hpAutomax.setSelected(false);
        hpRpga.setSelected(false);
        Globals.hpRollMethod = Globals.HP_PERCENTAGE;
      }
      else if (source == hpRpga)
      {
        ...
        hpAutomax.setSelected(false);
        hpPercentage.setSelected(false);
        Globals.hpRollMethod = Globals.HP_RPGA;
      }
    }
  }
  ...
  private final class StatTableModel extends AbstractTableModel
  {
    ...
    {
      return Globals.statCost.length;
    }
    ...
    {
      if (columnIndex == 0)
        return new Integer(Globals.statCost[rowIndex]);
      ...
      int columnIndex)
    {
      if (newValue instanceof Integer)
      {
        if (columnIndex == 0)
        {
          Globals.statCost[rowIndex] = ((Integer)newValue).intValue();
