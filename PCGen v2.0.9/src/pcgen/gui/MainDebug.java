...
public class MainDebug extends javax.swing.JPanel
{
  ...
  JScrollPane debugCenter = new JScrollPane();
  JPanel debugSouth = new JPanel();
  static JTextArea txtAreaDebug = new JTextArea();
  JTextField txtDebugField = new JTextField();
  FlowLayout flowLayout3 = new FlowLayout();
  JLabel lblDebugSouth = new JLabel();
  JButton btnDebugGo = new JButton();
  JButton btnDebugClear = new JButton();
  ...
  public MainDebug ()
  {
    ...
    try {
      ...
      if (aString.indexOf("1.3") == -1 && aString.indexOf("1.4") == -1)
      {
        ...
        " http://java.sun.com/j2se/1.3/jre to get the correct version.");
      }
      try
      {
  ...
  void btnDebugGo_actionPerformed(ActionEvent e)
  {
    ...
    if (Globals.currentPC!=null)
      txtAreaDebug.append(Globals.currentPC.name()+":"+keyWord + " = " + Globals.currentPC.getVariable(keyWord,true,true,"",""));
    else
