...
public class pcGenGUI
{
  ...
  /*
  REMOVED: SG Not used anywhere else?
  static final Globals aGlobeal = new Globals();
  */
  ...
  public pcGenGUI()
  {
    ...
    Globals.sortPObjectList(Globals.campaignList);
    ...
    if (Globals.leftUpperCorner != null) {
      x = new Double(Globals.leftUpperCorner.getX()).intValue();
      y = new Double(Globals.leftUpperCorner.getY()).intValue();
    }
