...
public class ToolsQStats extends JPanel
{
  ...
  private void setPreferredWidths()
  {
    ...
    d_StatTable.getColumnModel().getColumn(5).setPreferredWidth(75);   //HP or VP
    d_StatTable.getColumnModel().getColumn(6).setPreferredWidth(75);   //AC or Defense
  ...
  {
    private final String[] alignments = {"LG", "LN", "LE", "NG", "N", "NE", "CG", "CN", "CE", "None"};
    ...
    {
      if (columnIndex < 4 || ((columnIndex == 4) && !Globals.starWarsMode) || columnIndex == 12)
      {
        return String.class;
      }
      else
    ...
    public Object getValueAt(int row, int column)
    {
      ...
      PlayerCharacter oldChar = Globals.currentPC; //keep char of current char in case it gets changed during Skill lookup
      Iterator skillIter;
      ...
      switch (column)
      {
        ...
        case 4: //alignment or WP
          ...
          return alignments[curChar.alignment()];
        case 5: //HP or VP
          if (isIncomplete)
          {
            return new Integer(0);
        ...
        case 13: //Listen
          ...
          skillIter = curChar.skillList().iterator();
          while (skillIter.hasNext())
          {
            Skill aSkill = (Skill)skillIter.next();
            if (aSkill.qualifiedName().equals("Listen"))
            {
              Globals.currentPC = curChar;  //in order for skill bonuses to calculate correctly we have to point currentPC to this char
              Integer skillVal = new Integer(aSkill.modifier().intValue() + aSkill.rank().intValue());
              Globals.currentPC = oldChar;  //reset the currentPC
              return skillVal;
            }
          }
          return new Integer(0);
