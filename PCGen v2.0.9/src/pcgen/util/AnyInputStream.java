...
public class AnyInputStream
{
     ...
     * @see #createLocation .
     */
    private static final AnyInputStream THIS
	= new AnyInputStream ( );

    /**
     * Where to search for jar files?
     */
    public static final String SEARCH_JAR_PATHS_PROPERTY
	= "pcgen.jar.paths";
     ...
     * files is loaded.
     */
    static java.util.Collection searchJarPaths = null;
    ...
    {
	java.util.Collection rawSearchJarPaths = pcgen.util.Boot.getPropertyStrings
	...
	try {
	    ...
	    return THIS.new Location (url, url.openStream ( ));
	}
