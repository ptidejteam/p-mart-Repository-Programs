...
public class FileAccess
{
				...
				if (br != null)
				{
					...
					for (; ;)
					{
						...
						if (filterEntry.size() >= 2)
						{
							...
							{
								e.printStackTrace();
								System.out.println("Exception in setCurrentOutputFilter");
							}
						}
					}
					br.close();
	...
	public static void write(Writer output, String aString)
	{
		...
		{
			JOptionPane.showMessageDialog(null, exception.getMessage(), Constants.s_APPNAME, JOptionPane.ERROR_MESSAGE);
		}
	}
