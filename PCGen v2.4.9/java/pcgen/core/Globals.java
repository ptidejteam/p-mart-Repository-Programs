 ...
 *
 * $Id: Globals.java,v 1.1 2006/02/20 23:52:29 vauchers Exp $
 */
...
public class Globals implements Constants
{
	...
	public static String getPCGenOption(String optionName, String defaultValue)
	{
		...
		//{
		//JOptionPane.showMessageDialog(null, "Could not find pcgen.options." + optionName, s_APPNAME, JOptionPane.ERROR_MESSAGE);
		//}
		//x=options.getProperty("pcgen.options." + optionName, defaultValue);
		//JOptionPane.showMessageDialog(null, "pcgen.options." + optionName + "=" + x, s_APPNAME, JOptionPane.ERROR_MESSAGE);
	...
	static Dimension getOptionsFromProperties()
	{
		...
		setPrereqFailColor(getPCGenOption("prereqFailColor", 0));
	...
	private static void setPCGenOption(String optionName, int optionValue)
	{
	...
	private static void setPCGenOption(String optionName, String optionValue)
	{
