		...
		for (int i = 0; i < aString.length(); i++)
		{
				...
				(valString.length() > 3 && (valString.endsWith("MIN") || valString.endsWith("MAX") || valString.endsWith("REQ"))))
			{
				...
				catch (Exception exc)
				{
					...
					JOptionPane.showMessageDialog(null, "Equipment:Math error determining value for " + aString + " " + src + " " + subSrc + "(" + valString + ")", Constants.s_APPNAME, JOptionPane.ERROR_MESSAGE);
				}
				mode = nextMode;
				nextMode = 0;
				valString = "";
