...
public class Options extends JMenu
{
	...
	private void jbInit() throws Exception
	{
		...
		useMonsterDefault.setToolTipText("Use Default Monster Feats and Skills");
		...
		method1.setToolTipText("Roll 4d6 drop lowest (Standard)");
		...
		method7.setToolTipText("Roll 5d6 drop lowest and middle");
		...
		method8.setToolTipText("All the same");
		...
		maxStartingGold.setToolTipText("Set whether starting gold should be maximized");
		...
		hpAutomax.setToolTipText("Always maximum");
		...
		hpLivingCity.setToolTipText
			("First two levels max, 3/4 thereafter");
		hpLivingCity.addActionListener(checkBoxHandler);

		hpRollMethods.add(hpLivingGreyhawk);
		hpLivingGreyhawk.setToolTipText
			("First level max, 1/2 + 1 thereafter");
		...
		skillIncrementBefore.setToolTipText("Set whether skills can be incremented before skill points calculated");
		...
		autoMethod0.setToolTipText("Load from lst files (ignores #; at start of lines)");
		...
		autoMethod1.setToolTipText("Create racially sized armor, shields, clothing (resizable) for all sizes in race list");
		...
		autoMethod2.setToolTipText("Create masterwork ammo, armor, shields, and weapons");
		...
		autoMethod3.setToolTipText("Create +1 to +5 ammo, armor, shields, and weapons");
		...
		autoMethod4.setToolTipText("Create darkwood (wooden), adamantine and mithral (metal) items");
		...
		applyWeightPenaltyToSkills.setToolTipText("Whether to give a penalty of -1 per 5 lbs encumbrance to affected skills (e.g. Swim)");
		...
		applyLoadPenaltyToACandSkills.setToolTipText("Whether to give ACCheck penalties for medium and higher loads.");
		...
		//treatInHandAsEquippedForAttacks.setToolTipText("");
	...
	public static void initializeStatRollingMethod8()
	{
		...
		for (int i = 0; i < method8_.length; i++)
		{
			...
			method8_[i].setToolTipText("All " + (i + Globals.getInitialStatMin()) + "'s");
