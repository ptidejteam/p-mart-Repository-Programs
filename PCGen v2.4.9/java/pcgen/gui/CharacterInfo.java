...
//	private InfoTemplates infoTemplates = new InfoTemplates();
	...
	private InfoDescription description = new InfoDescription();
...
// removed		characterInfoTabbedPane.add(infoEquip, "Equipment", x++);
		...
		characterInfoTabbedPane.add(description, in_descrip, x++);
...
//  			InfoPreview infoPreview = new InfoPreview();
		...
		description.addComponentListener(PToolBar.getCurrentInstance().getComponentListener());
