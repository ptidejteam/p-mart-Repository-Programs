...
// table.
	...
	//
	// Returns an array of TreePaths of currently expanded paths
	//
	public Object[] getExpandedPaths()
	{
		if (tree == null)
		{
			return null;
	...
	//
	// Expands an array of TreePaths
	//
	public void setExpandedPaths(Object[] expandedPaths)
	{
		if ((tree != null) && (expandedPaths != null))
		{
			for (int i = 0; i < expandedPaths.length; i++)
			{
				if (expandedPaths[i] instanceof TreePath)
				{
					try
					{
						tree.fireTreeWillExpand((TreePath)expandedPaths[i]);
						tree.expandPath((TreePath)expandedPaths[i]);
						tree.fireTreeExpanded((TreePath)expandedPaths[i]);
					}
