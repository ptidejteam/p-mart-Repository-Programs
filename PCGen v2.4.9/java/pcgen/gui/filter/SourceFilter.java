...
public class SourceFilter extends AbstractPObjectFilter
{
	...
	{
		this(pObject.getSource(), argDetailLevel);
	}
	...
	public SourceFilter(String src, int argDetailLevel)
	{
		...
		setCategory("Source");
		setName((this.detailLevel == LOW) ? normalize(src) : src);
	...
	public boolean accept(PObject pObject)
	{
		...
		if (detailLevel == LOW)
		{
			return normalize(pObject.getSource()).equals(getName());
		}

		return pObject.getSource().equals(getName());
	}
