 ...
 */
public class CsheetFilter extends FileFilter implements FilenameFilter
{
	private static String in_chaTemplates;
	/**
	 * Resrouce bundles
	 */
	static
	{
		ResourceBundle csheetProperties;
		Locale currentLocale = new Locale(Globals.getLanguage(), Globals.getCountry());
		try
		{
			csheetProperties = ResourceBundle.getBundle("pcgen/gui/properities/LanguageBundle", currentLocale);
			in_chaTemplates = csheetProperties.getString("in_chaTemplates");
		}
