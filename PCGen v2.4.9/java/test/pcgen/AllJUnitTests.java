...
import test.pcgen.AnyInputStreamTest;
import test.pcgen.BootTest;

/**
 * TestSuite that is composed of the individual test classes.  Pick up
 * all the individual PCGen base test cases into this one.
 *
...
public class AllJUnitTests extends TestCase {
  ...
  public static Test suite ( ) {
	  ...
	  suite.addTest (new TestSuite (AnyInputStreamTest.class));
