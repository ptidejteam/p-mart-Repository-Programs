 ...
 *
 * $Id: CombinedRangeXYPlot.java,v 1.1 2007/10/10 19:05:14 vauchers Exp $
 *
 * Changes:
 * --------
...
public class CombinedRangeXYPlot extends XYPlot implements Serializable {
    ...
    protected AxisSpace calculateAxisSpace(Graphics2D g2, Rectangle2D plotArea) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            AxisSpace subSpace = plot.getDomainAxis().reserveSpace(g2, plot, this.subplotAreas[i],
                                                                   plot.getDomainAxisEdge(), null);
