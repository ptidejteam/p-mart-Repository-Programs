 ...
 *
 * $Id: CombinedDomainXYPlot.java,v 1.1 2007/10/10 19:05:14 vauchers Exp $
 *
 * Changes:
 * --------
 ...
 */
public class CombinedDomainXYPlot extends XYPlot implements Serializable {
    ...
    protected AxisSpace calculateAxisSpace(Graphics2D g2, Rectangle2D plotArea) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            AxisSpace subSpace = plot.getRangeAxis().reserveSpace(g2, plot, this.subplotAreas[i],
                                                                  plot.getRangeAxisEdge(), null);
    ...
    public void draw(Graphics2D g2, Rectangle2D plotArea, ChartRenderingInfo info) {
        ...
        axis.draw(g2, cursor, plotArea, dataArea, edge);
