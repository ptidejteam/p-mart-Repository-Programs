 ...
 * Contributor(s):   -;
 *
 * $Id: CombinedDomainCategoryPlot.java,v 1.1 2007/10/10 19:05:14 vauchers Exp $
 *
 * Changes:
 * --------
...
public class CombinedDomainCategoryPlot extends CategoryPlot {
    ...
    protected AxisSpace calculateAxisSpace(Graphics2D g2, Rectangle2D plotArea) {
        ...
        if (fixed != null) {
            ...
            RectangleEdge categoryEdge = Plot.resolveDomainAxisLocation(getDomainAxisLocation(), 
                                                                        orientation);
