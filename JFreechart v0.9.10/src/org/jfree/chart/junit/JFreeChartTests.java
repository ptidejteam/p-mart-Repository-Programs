 ...
 * Contributor(s):   -;
 *
 * $Id: JFreeChartTests.java,v 1.1 2007/10/10 19:05:23 vauchers Exp $
 *
 * Changes:
 * --------
...
public class JFreeChartTests extends TestCase {
    ...
    /**
     * Test for a bug where a null title generates a null pointer exception.
     */
    public void testNullTitle() {
        boolean success = true;
        this.pieChart.setTitle(new TextTitle(null));
        try {
            ByteArrayOutputStream out = new ByteArrayOutputStream();
            ChartUtilities.writeChartAsPNG(out, this.pieChart, 200, 150);
            out.close();
        }
        catch (Exception e) {
            success = false;
