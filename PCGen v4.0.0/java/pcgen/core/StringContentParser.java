...
class StringContentParser
{
	...
	private ArrayList parsedItems = null;
	...
	class ParsedItem
	{
		...
		public ParsedItem(String name, String value)
		{
			itemName = name;
			itemValue = value;
		}
	 ...
	 */
	protected void setParms(String argContent,
	  String[] argDelimiters,
	  iParsingClient argClient)
	{
	 ...
	 *                    parsed item in the tree.
	 */
	public StringContentParser(String argContent,
	  String[] argDelimiters,
	  iParsingClient argClient)
	{
	 ...
	 *                    parsed item in the tree.
	 */
	public void parse(String argContent,
	  String[] argDelimiters,
	  iParsingClient argClient)
	{
		setParms(argContent, argDelimiters, argClient);
	 ...
	 *                       parsed item in the tree.
	 */
	public void parse(iParsingClient argClient)
	{
		client = argClient;
		parseTheContent();
	}
...
//    Globals.debugPrint("\nIn parseItem(): \nitemToParse: \n" + itemToParse + " \n\tdelimiter: " + delimiter);
		...
		{
			final String item = (String)token.nextToken();
