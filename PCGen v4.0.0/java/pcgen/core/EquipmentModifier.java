/*
 * @(#) $Id: EquipmentModifier.java,v 1.1 2006/02/21 00:47:07 vauchers Exp $
 *
...
/* JK 2002-07-24 This code is unused. Commenting it out. Will remove next time I come across it.
	...
	*/
	...
	{
		if (argNamingOption.equalsIgnoreCase("NOLIST"))
		{
			namingOption = NAMINGOPTION_NOLIST;
		}
		else if (argNamingOption.equalsIgnoreCase("NONAME"))
		{
			namingOption = NAMINGOPTION_NONAME;
		}
		else if (argNamingOption.equalsIgnoreCase("NOTHING"))
		{
			namingOption = NAMINGOPTION_NOTHING;
		}
		else if (argNamingOption.equalsIgnoreCase("SPELL"))
		{
