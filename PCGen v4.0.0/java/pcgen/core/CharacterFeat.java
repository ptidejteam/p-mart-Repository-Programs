...
/*
 * $Header: /home/cvs/cvsgelo/cvsroot/guehene-dpl-pcgen\040v4.0.0/java/pcgen/core/CharacterFeat.java,v 1.1 2006/02/21 00:47:07 vauchers Exp $
 */
package pcgen.core;
...
class CharacterFeat
{
	...
	public String qualifiedName()
	{
		...
		if (getAssociatedCount() > 0 && !feat.getName().endsWith("Weapon Proficiency") && !feat.getName().startsWith("Armor Proficiency"))
		{
			// has a sub-detail
			aStrBuf.append(" (");
			int i = 0;
