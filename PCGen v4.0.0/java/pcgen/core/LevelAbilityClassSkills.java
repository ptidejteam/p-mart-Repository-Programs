...
class LevelAbilityClassSkills extends LevelAbility
{
	...
	public ArrayList getChoicesList(String bString)
	{
		...
		for (int index = 0; index < Globals.getSkillList().size(); index++)
		{
			...
			if ((aText.equals("UNTRAINED") && aSkill.getUntrained().equals("Y")) ||
			  (aText.equals("TRAINED") && aSkill.getUntrained().equals("N")) ||
			  (aText.equals("EXCLUSIVE") && aSkill.isExclusive().equals("Y")) ||
			  (aText.equals("NONEXCLUSIVE") && aSkill.isExclusive().equals("N")) ||
			  (aText.equals("CROSSCLASSSKILLS") && (!aSkill.isClassSkill(ownerClass) && !aSkill.isExclusive().equals("Y"))) ||
			  aText.equals("ANY"))
			{
