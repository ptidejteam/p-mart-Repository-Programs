...
class BrowserLauncher
{
	...
	public static void openURL(String url) throws IOException
	{
		...
		{
			Globals.debugPrint("Opening default system browser");
			...
			switch (jvm)
			{
				...
				case MRJ_3_1:
					try
					{
						Globals.errorPrint("Invoking openURL on " + url);
		...
		{
			Globals.errorPrint("Opening with browser " + SettingsHandler.getBrowserPath());
			...
			{
				Globals.errorPrint("Executing open -a " + SettingsHandler.getBrowserPath().getAbsolutePath() + " " + url);
				Runtime.getRuntime().exec(new String[]{"open", "-a", SettingsHandler.getBrowserPath().getAbsolutePath(), url});
			}
			else
			{
				Globals.errorPrint("Executing " + SettingsHandler.getBrowserPath().getAbsolutePath() + " " + url);
