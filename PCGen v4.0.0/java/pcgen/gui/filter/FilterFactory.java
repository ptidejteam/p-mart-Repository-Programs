...
public class FilterFactory implements FilterConstants
{
	...
	private static PObjectFilter createGameFilter(String game)
	{
		return new GameFilter(game);
	}

	private static PObjectFilter createStatusFilter(boolean b)
	{
...
//  	}
	...
	private static PObjectFilter createDomainFilter(String domain)
	{
...
class PCClassFilter extends AbstractPObjectFilter
{
	public PCClassFilter()
	{
		super("Object", "Class");
	}
