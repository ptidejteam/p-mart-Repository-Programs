...
//  					aPC.print(template, bw);
		...
		if (SettingsHandler.showD20Info())
		{
			showManditoryD20Info();
		}
	}
	...
	public static void showManditoryD20Info()
	{
		...
		try
		{
			...
			if (imgIcon != null)
			{
				...
				final JCheckBox jCheckBox1 = new JCheckBox("Show at start up");
				...
				JEditorPane a = new JEditorPane("text/html", aString);
				a.setEditable(false);
...
/*        jCheckBox1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	System.err.println("actionPerformed" + jCheckBox1.isSelected());
            }
        });

        jCheckBox1.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
            	System.err.println("stateChanged" + jCheckBox1.isSelected());
            }
        });
*/
        jCheckBox1.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
            	...
            	System.err.println("itemStateChanged" + jCheckBox1.isSelected());
            }
        });

/*        jCheckBox1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
            	System.err.println("keyTyped" + jCheckBox1.isSelected());
            }
        });

        jCheckBox1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
            	System.err.println("mouseClicked" + jCheckBox1.isSelected());
            }
        });

        jCheckBox1.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
            	System.err.println("propertyChange" + jCheckBox1.isSelected());
            }
        });
*/
				...
				//Point p = Globals.getRootFrame().getLocationOnScreen();
