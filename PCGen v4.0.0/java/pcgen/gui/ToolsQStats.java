...
class ToolsQStats extends JPanel
{
	...
	class QuickStatsTableModel extends AbstractTableModel
	{
		private final String[] dndColNameList = {"Name", "Class(es)", "Race", "Size", "Align", "HP", "AC", "XP", "", "", "", "Initiative", "Move", "Listen", "Spot", "Search"};
		private final String[] wheelColNameList = {"Name", "Class(es)", "Race", "Size", "", "HP", "Defense", "XP", "", "", "", "Initiative", "Move", "Listen", "Spot", "Search"};
		private final String[] swColNameList = {"Name", "Class(es)", "Race", "Size", "WP", "VP", "Defense", "XP", "", "", "", "Initiative", "Move", "Listen", "Spot", "Search"};
		private final String[] sidewColNameList = {"Name", "Class(es)", "Race", "Size", "Body", "Vigor", "AC", "XP", "", "", "", "Initiative", "Move", "Listen", "Spot", "Search"};
		...
		{
			if (columnIndex == 8 && Globals.getCheckList().size() > 0)
				return Globals.getCheckList().get(0).toString();
			if (columnIndex == 9 && Globals.getCheckList().size() > 1)
				return Globals.getCheckList().get(1).toString();
			if (columnIndex == 10 && Globals.getCheckList().size() > 2)
