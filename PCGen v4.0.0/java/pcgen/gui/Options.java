...
*/
	...
	{
		JMenuItem prefsMenu = (JMenuItem)parent.add(Utility.createMenuItem("Preferences...", prefsMenuHandler, null, 'P', null, "Show the preferences dialog", "Preferences16.gif", true));
		//prefsMenu.addActionListener();
	}
