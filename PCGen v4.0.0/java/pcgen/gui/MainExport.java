...
class MainExport extends JPanel
{
...
//		buttonPanel.add(templatePathButton);
	...
	private void printToFile(File outFile, int pcIndex) throws IOException
	{
		...
		final File template = new File(SettingsHandler.getTemplatePath().getAbsolutePath() + File.separator + (String)templateList.getSelectedValue());
		if (partyMode)
		{
