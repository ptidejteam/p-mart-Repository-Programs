 ...
 *
 * $Id: NewPurchaseMethodDialog.java,v 1.1 2006/02/21 00:47:12 vauchers Exp $
 */
...
public class NewPurchaseMethodDialog extends JDialog
{
	...
	public NewPurchaseMethodDialog(Frame parent, boolean modal)
	{
		super(parent, modal);
		initComponents();
	...
	private void okButtonActionPerformed(ActionEvent evt)
	{
		...
		{
			JOptionPane.showMessageDialog(null, "Please enter a name for this method.", Constants.s_APPNAME, JOptionPane.ERROR_MESSAGE);
			return;
		}
		if (getEnteredPoints() <= 0)
		{
			JOptionPane.showMessageDialog(null, "Invalid points value. Please try again.", Constants.s_APPNAME, JOptionPane.ERROR_MESSAGE);
			return;
		}
		wasCancelled = false;
		setVisible(false);
