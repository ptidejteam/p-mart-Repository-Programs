    ...
    implements SwingConstants
{
	...
	= getImageIcon("resources/New16.gif");
    /** Icon for Close item. */
    public static final ImageIcon CLOSE_ICON
	= getImageIcon("resources/Close16.gif");

    /** Icon for Center item. */
    public static final ImageIcon CENTER_ICON
	= getImageIcon("resources/Stop16.gif");
    /** Icon for Flip item. */
    public static final ImageIcon FLIP_ICON
	...
	return pcgen.gui.Utility.getImageIcon(location, description);
    }
     ...
     * @return <code>boolean</code>, the condition
     */
    public static boolean isShiftLeftMouseButton(MouseEvent e)
    {
