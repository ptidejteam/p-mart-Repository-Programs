...
public class HorizontalSymbolicAxis extends HorizontalNumberAxis implements HorizontalAxis {
    ...
    public void drawSymbolicGridLines(Graphics2D g2, Rectangle2D drawArea, Rectangle2D plotArea, boolean firstGridLineIsDark) {
        ...
        while (iterator.hasNext()) {
            ...
            xx1 = this.translateValueToJava2D(tick.getNumericalValue()-0.5d, plotArea);
            xx2 = this.translateValueToJava2D(tick.getNumericalValue()+0.5d, plotArea);
            ...
            symbolicGridLine = new Rectangle2D.Double(xx1, yy + outlineStrokeWidth, xx2 - xx1, plotArea.getMaxY() - yy - outlineStrokeWidth);
