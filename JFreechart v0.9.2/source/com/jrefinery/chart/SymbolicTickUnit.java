 ...
 * Contributor(s):   -;
 *
 * $Id: SymbolicTickUnit.java,v 1.1 2007/10/10 19:41:59 vauchers Exp $
 *
 * Changes
 * -------
...
public class SymbolicTickUnit extends NumberTickUnit {
     ...
     * ex: if the symbolic value list is ["up", "down"] then 0 is convert to "up" and 1 to "down".
     *
    ...
    public String valueToString(double value) {
        ...
        try {
            ...
            throw new IllegalArgumentException("The value"+value+"does not have a "+
