 ...
 * Contributor(s):    -;
 *
 * $Id: CandlestickRenderer.java,v 1.1 2007/10/10 19:41:58 vauchers Exp $
 *
 * Changes
 * -------
...
public class CandlestickRenderer extends AbstractXYItemRenderer implements XYItemRenderer {
     ...
     * <P>
     * If you set the width to a negative value, the renderer will calculate the candle width
    ...
    public void setCandleWidth(double width) {
        ...
        if (width!=this.candleWidth) {
            ...
            this.firePropertyChanged("CandleStickRenderer.candleWidth",
                                     old, new Double(width));
        }
     ...
     * <P>
     * Registered property change listeners are notified that the "CandleStickRenderer.upPaint"
     ...
     * <P>
     * Registered property change listeners are notified that the "CandleStickRenderer.downPaint"
     * property has changed.
     *
     * @param paint The paint.
     */
    ...
    public void drawItem(Graphics2D g2, Rectangle2D dataArea, ChartRenderingInfo info,
        ...
        if (drawVolume) {
            ...
            g2.fill(new Rectangle2D.Double(xx-exactCandleWidth/2, maxY-yyVolume, exactCandleWidth, yyVolume) );
