 ...
 * Contributor(s):   -;
 *
 * $Id: DemoResources.java,v 1.1 2007/10/10 19:42:02 vauchers Exp $
 *
 * Changes
 * -------
...
public class DemoResources extends ListResourceBundle {
    ...
    static final Object[][] contents = {
        ...
        {"chart30.title",       "Thermometer"},
        {"chart30.tab",         "5"},
        {"chart30.description", "A thermometer."},
        {"chart30.zoom",        "false"},

        {"chart31.title",       "Dial"},
        {"chart31.tab",         "5"},
        {"chart31.description", "A dial (or gauge)."},
        {"chart31.zoom",        "false"},
        ...
        {"meter.meter.title", "Meter Chart"},
        {"meter.meter.subtitle", "Subtitle"},
        {"meter.meter.units", "Units"},

        {"meter.thermo.title", "Meter Chart"},
        {"meter.thermo.subtitle", "Subtitle"},
        {"meter.thermo.units", "Units"},
