 ...
 *                   Andreas Schneider;
 *
 * $Id: ChartPanel.java,v 1.1 2007/10/10 19:41:59 vauchers Exp $
 *
...
public class ChartPanel extends JPanel implements ChartPanelConstants,
     ...
     * <P>
     * If the width available on the panel is less than this, then the chart is drawn at the
     ...
     * <P>
     * At the time the chart is drawn on the panel, if the available width is less than this
     * amount, the chart will be drawn using the minimum width then scaled down to fit the
     * available space.
     *
     ...
     * amount, the chart will be drawn using the maximum width then scaled up to fit the
     * available space.
     *
     * @param width The width.
     */
     ...
     * amount, the chart will be drawn using the maximum height then scaled up to fit the
     * available space.
     *
     * @param height The height.
     */
