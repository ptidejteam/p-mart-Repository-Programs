 ...
 *
 * $Id: RollInfo.java,v 1.1 2006/02/21 01:16:13 vauchers Exp $
 */
			...
			while (st.hasMoreTokens())
			{
				...
				switch (tok.charAt(0))
				{
					case '/':
						...
						if (keepTop > times)
						{
							Logging.errorPrint("Bad keepTop in '" + rollString + "': times: " + times + "; keepTop: " + keepTop);
							return;
						}
					...
					case '\\':
						...
						if (keepBottom > times)
						{
							Logging.errorPrint("Bad keepBottom in '" + rollString + "': times: " + times + "; keepBottom: " + keepBottom);
							return;
						}
						keepList = new boolean[times];
						// Rely on fact boolean is false by default.  --bko
