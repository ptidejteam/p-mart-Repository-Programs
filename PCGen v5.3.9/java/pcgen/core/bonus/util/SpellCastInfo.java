...
public class SpellCastInfo
{
	...
	public SpellCastInfo(final String argType, final int argLevel)
	{
		super();
		setType(argType);
		setLevel(argLevel);
	...
	public SpellCastInfo(final PCClass argClass, final int argLevel)
	{
		super();
		setPcClass(argClass);
		setLevel(argLevel);
	...
	private void setPcClass(PCClass pcClass)
	{
