...
public class PCGen_Frame1 extends JFrame
{
	...
	public void setGameModeTitle()
	{
		setTitle("PCGen v. " + PCGenProp.getVersionNumber() 
			+ " - " + SettingsHandler.getGame().getName() + " Campaign");
	}
	...
	private void jbInit() throws Exception
	{
		...
		// add shutdown hook -- This will allow us to handle
		// ungracefull closing of the application (%Quit, kill, etc)
		TryShutdownHook shutdownHook = new TryShutdownHook();
	...
	private class TryShutdownHook extends Thread
	{
		public void run()
		{
			if (tryQuit)
			{
				// handleQuit() hasn't run yet!
				handleQuit();
			}
		}
	}
