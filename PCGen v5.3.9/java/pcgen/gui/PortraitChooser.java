...
public final class PortraitChooser extends JPanel
{
	...
	private JComboBoxEx portraitBox;
	...
	private void initComponents()
	{
		...
		// portrait chooser
		populatePortraits();
		portraitBox = new JComboBoxEx(portraitModel = new PortraitModel(portraits));
	...
	private void initPortrait(boolean resetPortraitsPathToDefaultIfCharacterHasNone)
	{
		...
		{
//			fileChooser.setCurrentDirectory(SettingsHandler.getPortraitsPath());
