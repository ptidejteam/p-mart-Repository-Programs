...
public final class NameGui extends JFrame
{
	...
	public NameGui()
	{
		...
		this.setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource(IconUtilitities.RESOURCE_URL + "PcgenIcon.gif")));
...
//    buttonAndNameBox.add(Box.createVerticalGlue());
		...
		contentPane.add(info, new GridBagConstraints(0, 0, 3, 1, 0, 0, GridBagConstraints.NORTH, GridBagConstraints.NONE, new Insets(5, 0, 5, 0), 0, 0));
		contentPane.add(listScrollPane, new GridBagConstraints(0, 1, 1, 2, 1, 1, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(0, 5, 5, 0), 0, 0));
		contentPane.add(namePlusButtonHolderPanel, new GridBagConstraints(1, 1, 2, 1, 1.3, 1, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		contentPane.add(acceptButton, new GridBagConstraints(2, 2, 1, 1, 0, 0, GridBagConstraints.SOUTHEAST, GridBagConstraints.NONE, new Insets(0, 0, 5, 5), 0, 0));
	}
