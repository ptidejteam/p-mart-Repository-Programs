...
/////////////////////////////////////////////////
	...
	private void purchaseScoreMinDecreaseButtonActionPerformed()
	{
		...
		if (!SettingsHandler.isAnyRangeForAbilities())
		{
	...
	private void purchaseScoreMaxIncreaseButtonActionPerformed()
	{
		...
		if (updateOk)
		{
			purchaseModel.setValueAt(new Integer(purchaseModel.predictNextPurchaseCostMax()), purchaseModel.getRowCount() - 1, 1);
		}
	}
...
//					newValues[i][1] = new Integer(tblStart - nrRows + i);
	...
	private void addMethodButtonActionPerformed()
	{
		...
		if (!npmd.getWasCancelled())
		{
			...
			{
				GuiFacade.showMessageDialog(null, "Cannot add method. Name already exists.", Constants.s_APPNAME, GuiFacade.ERROR_MESSAGE);
			}
		}
	}
